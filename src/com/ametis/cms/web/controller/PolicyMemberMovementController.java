 ...
 * parameter
 */
public class PolicyMemberMovementController implements Controller // extends+ 
// extends- 
{
    ...
    public void setPolicyMemberMovementService(PolicyMemberMovementService policyMemberMovementService) {
    ...
    public ModelAndView deletePerformed(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            PolicyMemberMovement res = policyMemberMovementService.delete(pkey, user);

            if (res != null) {
                request.setAttribute("alert", alertProperties.getMessage("success.delete.policymembermovement", null, "success", Locale.getDefault()));
            } else {
                request.setAttribute("alert", alertProperties.getMessage("fail.delete.policymembermovement", null, "fail", Locale.getDefault()));

            }
            result = searchPerformed(request, response, "searchPolicyMemberMovement");
        } catch (Exception e) {
    ...
    public ModelAndView activatePerformed(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView result = null;
        ...
        try {
            ...
            PolicyMemberMovement res = policyMemberMovementService.activate(id, user);
    ...
    public ModelAndView migratePerformed(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView result = null;
        ...
        try {
            ...
            boolean res = policyMemberMovementService.migrate(id, user);
    ...
    public ModelAndView extractPerformed(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView result = null;
        ...
        try {
        	...
        	boolean res = policyMemberMovementService.extract(id, user);
        	if (res){
        		request.setAttribute("alert", alertProperties.getMessage("success.delete.policymembermovement", null, "success", Locale.getDefault()));
        	}
        	else {
    ...
    public ModelAndView detailPerformed(HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
        ...
        try {
            ...
            if (object == null) {
                request.setAttribute("alert", alertProperties.getMessage("not.found.policymembermovement", null, "fail", Locale.getDefault()));
            }
            /*
            ...
            result.addObject("policyMemberMovement", object);
        ...
        try {
            ...
            if (navigation.equals("gosearch") || navigation.equals("golookup")) {
                ...
                if (searchby != null) {
                     ...
                     */
                    if (searchby.equalsIgnoreCase("movementNumber")) {
                        vLikeP.add("movementNumber");
                        vLikeQ.add(searchtext);
                    }
                    if (searchby.equalsIgnoreCase("movementFilePath")) {
                        vLikeP.add("movementFilePath");
                        vLikeQ.add(searchtext);
                    }
            ...
            count = policyMemberMovementService.getTotal(sLikeP, sLikeQ, sEqP, sEqQ);
            ...
            collection = policyMemberMovementService.search(sLikeP, sLikeQ, sEqP, sEqQ,
            ...
            result.addObject("PolicyMemberMovements", collection);
    ...
    public ModelAndView handleRequest(
        ...
        try {
            if (navigation.equalsIgnoreCase("detail")) {
                 ...
                 */
                result = detailPerformed(request, response, "detailPolicyMemberMovement");
            } else if (navigation.equalsIgnoreCase("delete")) {
                result = deletePerformed(request, response);
            } else if (navigation.equalsIgnoreCase("search") || navigation.equals("gosearch")) {
                result = searchPerformed(request, response, "searchPolicyMemberMovement");
            } 
            else if (navigation.equals("extract")){
            	result = extractPerformed(request, response);
            }
            else if (navigation.equals("migrate")){
            	result = migratePerformed(request, response);
            }
                ...
                result = searchPerformed(request, response, "lookupPolicyMemberMovement");
            }
            else if (navigation.equalsIgnoreCase("listpolicy")) {          
				result = searchPerformed(request, response, "searchPolicyMemberMovement");
				String policyId = request.getParameter("policyId");
				breadcrumb = "<a href=\"policy?navigation=detail&policyId="+policyId+"\" class=\"linkbreadcrumb\">Detail Policy</a> &nbsp;&nbsp;<b>&gt</b> &nbsp;&nbsp;List Policy Member Movement";
			}else {
                result = searchPerformed(request, response, "searchPolicyMemberMovement");
            }
        } catch (Exception e) {
