 ...
 */
public class ExternalClaimDetailController implements Controller // extends+ 
// extends- 
{
...
private ActivityLogService logService;
    ...
    public ModelAndView deletePerformed(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            ExternalClaimDetail res = externalClaimDetailService.delete(pkey, user);

            if (res != null) {
                request.setAttribute("alert", alertProperties.getMessage("success.delete.externalclaimdetail", null, "success", Locale.getDefault()));
            } else {
                request.setAttribute("alert", alertProperties.getMessage("fail.delete.externalclaimdetail", null, "fail", Locale.getDefault()));

            }
            result = searchPerformed(request, response, "searchExternalClaimDetail");
        } catch (Exception e) {
    ...
    public ModelAndView detailPerformed(HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
        ...
        try {
            ...
            if (object == null) {
                request.setAttribute("alert", alertProperties.getMessage("not.found.externalclaimdetail", null, "fail", Locale.getDefault()));
            }
            /*
            ...
            result.addObject("externalClaimDetail", object);
        ...
        try {
            ...
            if (navigation.equals("gosearch") || navigation.equals("golookup")) {
                ...
                if (searchby != null) {
                    ...
                    if (searchby.equalsIgnoreCase("status")) {
                        vLikeP.add("status");
                        vLikeQ.add(searchtext);
                    }
            ...
            count = externalClaimDetailService.getTotal(sLikeP, sLikeQ, sEqP, sEqQ);
            ...
            collection = externalClaimDetailService.search(sLikeP, sLikeQ, sEqP, sEqQ,
            ...
            result.addObject("ExternalClaimDetails", collection);
    ...
    public ModelAndView handleRequest(
        ...
        try {
            if (navigation.equalsIgnoreCase("detail")) {
                 ...
                 */
                result = detailPerformed(request, response, "detailExternalClaimDetail");
                ...
                result = searchPerformed(request, response, "lookupExternalClaimDetail");
            } else if (navigation.equalsIgnoreCase("list")) {
                Integer sessionId = WebUtil.getParameterInteger(request, "id");
                result = searchPerformed(request, response, "listExternalClaimDetail");
