...
*/
public class ProcedureMedicineController implements Controller
...
// extends- 
{
	...
	private ProcedureMedicineService  procedureMedicineService;
	...
	public void setProcedureMedicineService	(ProcedureMedicineService procedureMedicineService){
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProcedureMedicine res = procedureMedicineService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.proceduremedicine",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.proceduremedicine",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProcedureMedicine");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.proceduremedicine",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("procedureMedicine", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = procedureMedicineService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
				"ProcedureMedicine.MedicineId",
				"ProcedureMedicine.ProcedureId",
		// foreign affairs end
	};
		    collection = procedureMedicineService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProcedureMedicines",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProcedureMedicine" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProcedureMedicine" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProcedureMedicine" );
	    }
