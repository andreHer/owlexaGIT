...
*/
public class MedicalProcedureMappingController implements Controller
...
// extends- 
{
	...
	private MedicalProcedureMappingService  medicalProcedureMappingService;
	...
	public void setMedicalProcedureMappingService	(MedicalProcedureMappingService medicalProcedureMappingService){
	this.medicalProcedureMappingService = medicalProcedureMappingService;
	}
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			MedicalProcedureMapping res = medicalProcedureMappingService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.medicalproceduremapping",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.medicalproceduremapping",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchMedicalProcedureMapping");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.medicalproceduremapping",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("medicalProcedureMapping", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = medicalProcedureMappingService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = medicalProcedureMappingService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("MedicalProcedureMappings",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailMedicalProcedureMapping" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupMedicalProcedureMapping" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchMedicalProcedureMapping" );
	    }
