...
*/
public class ProviderTypeProcedureController implements Controller
...
// extends- 
{
	...
	public void setProviderTypeProcedureService	(ProviderTypeProcedureService providerTypeProcedureService){
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProviderTypeProcedure res = providerTypeProcedureService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.providertypeprocedure",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.providertypeprocedure",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProviderTypeProcedure");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.providertypeprocedure",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("providerTypeProcedure", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = providerTypeProcedureService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = providerTypeProcedureService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProviderTypeProcedures",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProviderTypeProcedure" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProviderTypeProcedure" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProviderTypeProcedure" );
	    }
