...
*/
public class ProductTreatmentClausulController implements Controller
...

{
	...
	private ProductTreatmentClausulService  productTreatmentClausulService;
	...
	public void setProductTreatmentClausulService	(ProductTreatmentClausulService productTreatmentClausulService){
	this.productTreatmentClausulService = productTreatmentClausulService;
	}
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProductTreatmentClausul res = productTreatmentClausulService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.producttreatmentclausul",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.producttreatmentclausul",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProductTreatmentClausul");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.producttreatmentclausul",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("productTreatmentClausul", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = productTreatmentClausulService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = productTreatmentClausulService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProductTreatmentClausuls",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProductTreatmentClausul" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProductTreatmentClausul" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProductTreatmentClausul" );
	    }
