...
*/
public class DiagnosisMappingValidator implements Validator
// extends+ 

// extends- 
{
	public boolean supports(Class clazz) {
		return DiagnosisMappingForm.class.isAssignableFrom(clazz);
	}
	public void validate(Object obj, Errors errors) {
								ValidationUtils.rejectIfEmptyOrWhitespace
 (errors,"diagnosisMappingId","DIAGNOSIS_MAPPING_ID_REQUIRED","diagnosisMappingId is required");
																																																																																						ValidationUtils.rejectIfEmptyOrWhitespace
