...
*/
public class QuestionaireValidator implements Validator
// extends+ 
...

{
	public boolean supports(Class clazz) {
		return QuestionaireForm.class.isAssignableFrom(clazz);
	}
	public void validate(Object obj, Errors errors) {
								ValidationUtils.rejectIfEmptyOrWhitespace
 (errors,"questionaireId","QUESTIONAIRE_ID_REQUIRED","questionaireId is required");
																																																		ValidationUtils.rejectIfEmptyOrWhitespace
