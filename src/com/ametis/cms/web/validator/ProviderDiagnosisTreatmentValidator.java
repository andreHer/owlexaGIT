...
*/
public class ProviderDiagnosisTreatmentValidator implements Validator
// extends+ 

// extends- 
{
	public boolean supports(Class clazz) {
		return ProviderDiagnosisTreatmentForm.class.isAssignableFrom(clazz);
	}
	public void validate(Object obj, Errors errors) {
								ValidationUtils.rejectIfEmptyOrWhitespace
 (errors,"providerDiagnosisTreatmentId","PROVIDER_DIAGNOSIS_TREATMENT_ID_REQUIRED","providerDiagnosisTreatmentId is required");
																																																																																																																																						ValidationUtils.rejectIfEmptyOrWhitespace
