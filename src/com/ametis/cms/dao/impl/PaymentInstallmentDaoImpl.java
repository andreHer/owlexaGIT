...
import com.ametis.cms.dao.PaymentInstallmentDao;
...
/**
 * PaymentInstallmentDao adalah bean implementation untuk DAO tabel payment_installment.
*/
public class PaymentInstallmentDaoImpl extends DaoSupportUtil implements PaymentInstallmentDao
...

{
	...
	*/
	...
	public PaymentInstallment get (java.io.Serializable pkey) throws DataAccessException {
		return (PaymentInstallment) this.getHibernateTemplate().get (PaymentInstallment.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(PaymentInstallment.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(PaymentInstallment.class);
		return dc;
	}
...
/*	public Collection searchPaymentInstallment (PaymentInstallment object) throws Exception{
