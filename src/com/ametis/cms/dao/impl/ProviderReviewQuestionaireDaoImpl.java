...
/**
 * ProviderReviewQuestionaireDao adalah bean implementation untuk DAO tabel provider_review_questionaire.
*/
public class ProviderReviewQuestionaireDaoImpl extends DaoSupportUtil implements ProviderReviewQuestionaireDao
...

{
	...
	*/
	...
	public ProviderReviewQuestionaire get (java.io.Serializable pkey) throws DataAccessException {
		return (ProviderReviewQuestionaire) this.getHibernateTemplate().get (ProviderReviewQuestionaire.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(ProviderReviewQuestionaire.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(ProviderReviewQuestionaire.class);
		return dc;
	}
...
/*	public Collection searchProviderReviewQuestionaire (ProviderReviewQuestionaire object) throws Exception{
