...
import com.ametis.cms.dao.ItemCategoryDao;
...
/**
 * ItemCategoryDao adalah bean implementation untuk DAO tabel item_category.
*/
public class ItemCategoryDaoImpl extends DaoSupportUtil implements ItemCategoryDao
...
// extends- 
{
	...
	*/
	...
	public ItemCategory get (java.io.Serializable pkey) throws DataAccessException {
		return (ItemCategory) this.getHibernateTemplate().get (ItemCategory.class, pkey);
	}
...
/*	public Collection searchItemCategory (ItemCategory object) throws Exception{
