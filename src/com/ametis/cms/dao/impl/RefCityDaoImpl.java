...
import com.ametis.cms.dao.RefCityDao;
...
/**
 * RefCityDao adalah bean implementation untuk DAO tabel ref_city.
*/
public class RefCityDaoImpl extends DaoSupportUtil implements RefCityDao
...
// extends- 
{
	...
	*/
	...
	public RefCity get (java.io.Serializable pkey) throws DataAccessException {
		return (RefCity) this.getHibernateTemplate().get (RefCity.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(RefCity.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(RefCity.class);
		return dc;
	}
...
/*	public Collection searchRefCity (RefCity object) throws Exception{
