...
/**
 * CostContainmentTypeDao adalah bean implementation untuk DAO tabel cost_containment_type.
*/
public class CostContainmentTypeDaoImpl extends DaoSupportUtil implements CostContainmentTypeDao
...
// extends- 
{
	...
	*/
	...
	public CostContainmentType get (java.io.Serializable pkey) throws DataAccessException {
		return (CostContainmentType) this.getHibernateTemplate().get (CostContainmentType.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(CostContainmentType.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(CostContainmentType.class);
		return dc;
	}
...
/*	public Collection searchCostContainmentType (CostContainmentType object) throws Exception{
