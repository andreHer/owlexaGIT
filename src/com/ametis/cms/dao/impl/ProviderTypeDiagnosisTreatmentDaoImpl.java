...
/**
 * ProviderTypeDiagnosisTreatmentDao adalah bean implementation untuk DAO tabel provider_type_diagnosis_treatment.
*/
public class ProviderTypeDiagnosisTreatmentDaoImpl extends DaoSupportUtil implements ProviderTypeDiagnosisTreatmentDao
...
// extends- 
{
	...
	*/
	...
	public ProviderTypeDiagnosisTreatment get (java.io.Serializable pkey) throws DataAccessException {
		return (ProviderTypeDiagnosisTreatment) this.getHibernateTemplate().get (ProviderTypeDiagnosisTreatment.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(ProviderTypeDiagnosisTreatment.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(ProviderTypeDiagnosisTreatment.class);
		return dc;
	}
...
/*	public Collection searchProviderTypeDiagnosisTreatment (ProviderTypeDiagnosisTreatment object) throws Exception{
