...
/**
 * MemberGroupDao adalah bean implementation untuk DAO tabel member_group.
*/
public class MemberGroupDaoImpl extends DaoSupportUtil implements MemberGroupDao
...
// extends- 
{
	...
	*/
	...
	public MemberGroup get (java.io.Serializable pkey) throws DataAccessException {
		return (MemberGroup) this.getHibernateTemplate().get (MemberGroup.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(MemberGroup.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(MemberGroup.class);
		return dc;
	}
...
/*	public Collection searchMemberGroup (MemberGroup object) throws Exception{
