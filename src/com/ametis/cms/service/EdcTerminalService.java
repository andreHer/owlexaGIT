...
*/
public interface EdcTerminalService 
...
/*
	...
	*/
	public EdcTerminal getEdcTerminal (String merchantId, String terminalId) throws Exception;
...
//Get Edc Terminal
	public int getTotalEdcTerminalNotInProvider(Integer providerId, String eqColumns) throws Exception;
	public int getTotalEdcTerminal(String deviceNumber) throws Exception;
	public int getTotalEdcTerminalAlert(Date alertDate) throws Exception;
