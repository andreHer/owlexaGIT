...
*/
public class RefCountryServiceImpl implements RefCountryService
...
// extends- 
{
	...
	public void setRefCountryDao (RefCountryDao object){
		this.refCountryDao = object;
	}
	public RefCountryDao getRefCountryDao (){
		return this.refCountryDao;
	}
	/*
	...
	*/
	public RefCountry create (RefCountry object,ActionUser user) throws Exception {
			...
			RefCountry result = refCountryDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public RefCountry trash (java.io.Serializable pkey) throws Exception {
		RefCountry object = refCountryDao.get (pkey);
		refCountryDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public RefCountry get (java.io.Serializable pkey) throws Exception{
		RefCountry object = null;
		object = refCountryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = refCountryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			RefCountry element = (RefCountry) iter.next();
...
// unique Result
	...
	public RefCountry searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = refCountryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RefCountry obj = (RefCountry) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = refCountryDao.getDetachedCriteria();
		return dc;
	}
	public Collection searchCountry(String q) throws Exception {
		 Collection<RefCountry> result = new Vector<RefCountry>();
	        try {
	            Session session = refCountryDao.getCountrySession();

	            String sqlQuery = "SELECT c FROM "
	                    + "RefCountry c WHERE lower(c.countryName) LIKE :keyword AND c.deletedStatus = 0 ORDER BY c.countryName ASC";
