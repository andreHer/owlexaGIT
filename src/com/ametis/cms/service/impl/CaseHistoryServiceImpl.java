...
/**
 * CaseHistory is a servlet controller for case_history Table.
...
// extends- 
{
	...
	public void setCaseHistoryDao (CaseHistoryDao object){
		this.caseHistoryDao = object;
	}
	public CaseHistoryDao getCaseHistoryDao (){
		return this.caseHistoryDao;
	}
	/*
	...
	*/
	public CaseHistory create (CaseHistory object,ActionUser user) throws Exception {
			...
			CaseHistory result = caseHistoryDao.create (object);
			return result;
		}
	/*
	* Method update (CaseHistory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CaseHistory update (CaseHistory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public CaseHistory trash (java.io.Serializable pkey) throws Exception {
		CaseHistory object = caseHistoryDao.get (pkey);
		caseHistoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public CaseHistory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		CaseHistory object = caseHistoryDao.get (pkey);
	...
	*/
	...
	public CaseHistory delete (CaseHistory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CaseHistory get (java.io.Serializable pkey) throws Exception{
		CaseHistory object = null;
		object = caseHistoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CaseHistory get (java.io.Serializable pkey, String[] required) throws Exception{
	    CaseHistory object = null;
	    object = caseHistoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseHistoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CaseHistory element = (CaseHistory) iter.next();
...
// unique Result
	...
	public CaseHistory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = caseHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseHistory obj = (CaseHistory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CaseHistory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = caseHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseHistory obj = (CaseHistory) c.uniqueResult();
	...
	//Add 20150827 by FVO
	public CaseHistory searchUniqueGLApprove(String[] eqColumns, Object[] eqParams)
		throws Exception{
		Criteria c = caseHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DaoSupportUtil.setLimit(0, 1, c);
		DaoSupportUtil.setOrderBy(true,"createdTime",c);
		CaseHistory obj = (CaseHistory) c.uniqueResult();
		return obj;
	}
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseHistoryDao.getDetachedCriteria();
		return dc;
	}
	
	public CaseHistory getLatestCaseHistory(Integer caseId) throws Exception {
		// TODO Auto-generated method stub
		CaseHistory result = null;
		
		String[] eqParam = {"caseId.caseId","deletedStatus"};
		Object[] eqValue = {caseId, Integer.valueOf(0)};
		
		Collection<CaseHistory> caseHistoryList = search(null,null,eqParam,eqValue,false,"historyTime",0,1);
		
		if (caseHistoryList != null){
			Iterator<CaseHistory> iterator = caseHistoryList.iterator();
