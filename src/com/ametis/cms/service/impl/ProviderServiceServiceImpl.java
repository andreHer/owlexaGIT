...

{
	...
	public void setProviderServiceDao (ProviderServiceDao object){
		this.providerServiceDao = object;
	}
	public ProviderServiceDao getProviderServiceDao (){
		return this.providerServiceDao;
	}
	/*
	...
	*/
	public ProviderService create (ProviderService object,ActionUser user) throws Exception {
			...
			ProviderService result = providerServiceDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderService object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderService update (ProviderService object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerServiceDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderService trash (java.io.Serializable pkey) throws Exception {
		ProviderService object = providerServiceDao.get (pkey);
		providerServiceDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderService delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderService object = providerServiceDao.get (pkey);
	...
	*/
	...
	public ProviderService delete (ProviderService object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderService get (java.io.Serializable pkey) throws Exception{
		ProviderService object = null;
		object = providerServiceDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderService get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderService object = null;
	    object = providerServiceDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerServiceDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderService element = (ProviderService) iter.next();
...
// unique Result
	...
	public ProviderService searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerServiceDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderService obj = (ProviderService) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderService searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerServiceDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderService obj = (ProviderService) c.uniqueResult();
	...
	public ProviderService searchUnique (String[] eqColumns, Object[] eqParams, int index, int offset)
			throws Exception{
			Criteria c = providerServiceDao.getCriteria();
			DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
			DaoSupportUtil.setLimit(index, offset, c);
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerServiceDao.getDetachedCriteria();
		return dc;
	}
