...
import com.ametis.cms.dao.MemberSuspendHistoryDao;
...
*/
public class MemberSuspendHistoryServiceImpl implements MemberSuspendHistoryService
...
// extends- 
{
	...
	private MemberSuspendHistoryDao  memberSuspendHistoryDao;

	public void setMemberSuspendHistoryDao (MemberSuspendHistoryDao object){
		this.memberSuspendHistoryDao = object;
	}
	public MemberSuspendHistoryDao getMemberSuspendHistoryDao (){
		return this.memberSuspendHistoryDao;
	}
	/*
	* Method create (MemberSuspendHistory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public MemberSuspendHistory create (MemberSuspendHistory object,ActionUser user) throws Exception {
			...
			MemberSuspendHistory result = memberSuspendHistoryDao.create (object);
			return result;
		}
	/*
	* Method update (MemberSuspendHistory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MemberSuspendHistory update (MemberSuspendHistory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		memberSuspendHistoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MemberSuspendHistory trash (java.io.Serializable pkey) throws Exception {
		MemberSuspendHistory object = memberSuspendHistoryDao.get (pkey);
		memberSuspendHistoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (MemberSuspendHistory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public MemberSuspendHistory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		MemberSuspendHistory object = memberSuspendHistoryDao.get (pkey);
	...
	*/
	...
	public MemberSuspendHistory delete (MemberSuspendHistory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MemberSuspendHistory get (java.io.Serializable pkey) throws Exception{
		MemberSuspendHistory object = null;
		object = memberSuspendHistoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MemberSuspendHistory get (java.io.Serializable pkey, String[] required) throws Exception{
	    MemberSuspendHistory object = null;
	    object = memberSuspendHistoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberSuspendHistoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberSuspendHistory element = (MemberSuspendHistory) iter.next();
...
// unique Result
	...
	public MemberSuspendHistory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = memberSuspendHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberSuspendHistory obj = (MemberSuspendHistory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MemberSuspendHistory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = memberSuspendHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberSuspendHistory obj = (MemberSuspendHistory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberSuspendHistoryDao.getDetachedCriteria();
		return dc;
	}
