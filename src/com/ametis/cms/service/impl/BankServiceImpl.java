 ...
 */
public class BankServiceImpl implements BankService // extends+ 
// extends- 
{

    private BankDao bankDao;

    public void setBankDao(BankDao object) {
        this.bankDao = object;
    }
    ...
    /*
     * Method create (Bank object) berfungsi untuk melakukan penambahan sebuah
    ...
    public Bank create(Bank object, ActionUser user) throws Exception {
        Bank result = bankDao.create(object);
        
        return result;
    }
    /*
     * Method update (Bank object) berfungsi untuk melakukan perubahan terhadap
    ...
    public Bank update(Bank object, ActionUser user) throws Exception {
     ...
     * in any place
     */
    public Bank trash(java.io.Serializable pkey) throws Exception {
        Bank object = bankDao.get(pkey);
        bankDao.delete(object);
        return object;
    }

    /*
     * Method delete (Bank object) berfungsi untuk melakukan penghapusan
     ...
     * if failed
     */
    public Bank delete(java.io.Serializable pkey, ActionUser user) throws Exception {
        Bank object = bankDao.get(pkey);
        bankDao.update(object);
        return object;
    }
     ...
     * if failed
     */
    public Bank delete(Bank object, ActionUser user) throws Exception {
        bankDao.update(object);
        return object;
    }
...
// -- get section - carefull !
     ...
     */
    public Bank get(java.io.Serializable pkey) throws Exception {
        Bank object = null;
        object = bankDao.get(pkey);
        return object;
    }
    /*
     * Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
    ...
    public Bank get(java.io.Serializable pkey, String[] required) throws Exception {
        Bank object = null;
        object = bankDao.get(pkey);
...
// -- 1
    public Collection search(String[] likeColumns, Object[] likeParams,
        ...
        Criteria c = bankDao.getCriteria();
...
// unique Result
    public Bank searchUnique(String eqColumns, Object eqParams, String[] required)
            throws Exception {
        Criteria c = bankDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        Bank obj = (Bank) c.uniqueResult();
        DaoSupportUtil.lazyInit(required, obj);
        return obj;
    }

    public Bank searchUnique(String eqColumns, Object eqParams)
            throws Exception {
        Criteria c = bankDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        Bank obj = (Bank) c.uniqueResult();
...
// -----------------------------------------------
    ...
    public DetachedCriteria getDetachedCriteria() throws Exception {
        DetachedCriteria dc = bankDao.getDetachedCriteria();
        return dc;
    }

    public Bank getBankByName(String bankName) throws Exception {
        ...
        Collection<Bank> bankCollection = search(null, null, eqParam, eqValue, 0, total);

        Bank bank = null;

        if (bankCollection != null) {
            Iterator<Bank> iterator = bankCollection.iterator();
...
// class- 
    ...
    public Collection<Bank> searchBank(String q) throws Exception {
        Collection<Bank> result = new Vector<Bank>();
        try {
	...
	@Override
	public Bank getBankBySwiftCode(String swiftCode) throws Exception {
		// TODO Auto-generated method stub
		String[] eqParam = {"swiftCode","deletedStatus"};
		Object[] eqValue = {swiftCode,0};
		
		Collection<Bank> bankList = search(null,null,eqParam,eqValue,0,1);
