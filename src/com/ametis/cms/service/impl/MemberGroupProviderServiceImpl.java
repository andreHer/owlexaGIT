...
import com.ametis.cms.dao.MemberGroupProviderDao;
...
*/
public class MemberGroupProviderServiceImpl implements MemberGroupProviderService
...

{
	...
	private MemberGroupProviderDao  memberGroupProviderDao;
...
public void setConfigurationService(ConfigurationService configurationService) {
	...
	public void setMemberGroupProviderDao (MemberGroupProviderDao object){
		this.memberGroupProviderDao = object;
	}
	public MemberGroupProviderDao getMemberGroupProviderDao (){
		return this.memberGroupProviderDao;
	}
	/*
	* Method create (MemberGroupProvider object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public MemberGroupProvider create (MemberGroupProvider object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			MemberGroupProvider result = memberGroupProviderDao.create (object);
			return result;
		}
	/*
	* Method update (MemberGroupProvider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MemberGroupProvider update (MemberGroupProvider object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		memberGroupProviderDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MemberGroupProvider trash (java.io.Serializable pkey) throws Exception {
		MemberGroupProvider object = memberGroupProviderDao.get (pkey);
		memberGroupProviderDao.delete (object);
		return object;
	}

	/*
	* Method delete (MemberGroupProvider object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public MemberGroupProvider delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		MemberGroupProvider object = memberGroupProviderDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public MemberGroupProvider delete (MemberGroupProvider object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MemberGroupProvider get (java.io.Serializable pkey) throws Exception{
		MemberGroupProvider object = null;
		object = memberGroupProviderDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MemberGroupProvider get (java.io.Serializable pkey, String[] required) throws Exception{
	    MemberGroupProvider object = null;
	    object = memberGroupProviderDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberGroupProviderDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberGroupProvider element = (MemberGroupProvider) iter.next();
...
// unique Result
	...
	public MemberGroupProvider searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = memberGroupProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberGroupProvider obj = (MemberGroupProvider) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MemberGroupProvider searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = memberGroupProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberGroupProvider obj = (MemberGroupProvider) c.uniqueResult();
	...
	public MemberGroupProvider searchUnique (String[] eqColumns, Object[] eqParams, int index, int offset)
			throws Exception{
			Criteria c = memberGroupProviderDao.getCriteria();
			DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
			DaoSupportUtil.setLimit(index, offset, c);
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberGroupProviderDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public MemberGroupProvider createUpload(MemberGroupProvider object,
