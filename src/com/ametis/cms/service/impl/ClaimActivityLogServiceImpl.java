...
import com.ametis.cms.service.ClaimActivityLogService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.ClaimActivityLog;
import com.ametis.cms.dao.ClaimActivityLogDao;
...
/**
 * ClaimActivityLog is a servlet controller for claim_activity_log Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ClaimActivityLogServiceImpl implements ClaimActivityLogService
...

{
	...
	private ClaimActivityLogDao  claimActivityLogDao;

	public void setClaimActivityLogDao (ClaimActivityLogDao object){
		this.claimActivityLogDao = object;
	}
	public ClaimActivityLogDao getClaimActivityLogDao (){
		return this.claimActivityLogDao;
	}
	/*
	* Method create (ClaimActivityLog object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ClaimActivityLog create (ClaimActivityLog object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ClaimActivityLog result = claimActivityLogDao.create (object);
			return result;
		}
	/*
	* Method update (ClaimActivityLog object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClaimActivityLog update (ClaimActivityLog object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		claimActivityLogDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClaimActivityLog trash (java.io.Serializable pkey) throws Exception {
		ClaimActivityLog object = claimActivityLogDao.get (pkey);
		claimActivityLogDao.delete (object);
		return object;
	}

	/*
	* Method delete (ClaimActivityLog object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ClaimActivityLog delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ClaimActivityLog object = claimActivityLogDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ClaimActivityLog delete (ClaimActivityLog object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClaimActivityLog get (java.io.Serializable pkey) throws Exception{
		ClaimActivityLog object = null;
		object = claimActivityLogDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClaimActivityLog get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClaimActivityLog object = null;
	    object = claimActivityLogDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = claimActivityLogDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClaimActivityLog element = (ClaimActivityLog) iter.next();
...
// unique Result
	...
	public ClaimActivityLog searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = claimActivityLogDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClaimActivityLog obj = (ClaimActivityLog) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClaimActivityLog searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = claimActivityLogDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClaimActivityLog obj = (ClaimActivityLog) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = claimActivityLogDao.getDetachedCriteria();
		return dc;
	}
