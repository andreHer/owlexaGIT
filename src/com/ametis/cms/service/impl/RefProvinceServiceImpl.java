...
/**
 * RefProvince is a servlet controller for ref_province Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class RefProvinceServiceImpl implements RefProvinceService
...
// extends- 
{
	...
	private RefProvinceDao  refProvinceDao;

	public void setRefProvinceDao (RefProvinceDao object){
		this.refProvinceDao = object;
	}
	public RefProvinceDao getRefProvinceDao (){
		return this.refProvinceDao;
	}
	/*
	...
	*/
	public RefProvince create (RefProvince object,ActionUser user) throws Exception {
			...
			RefProvince result = refProvinceDao.create (object);
			return result;
		}
	/*
	* Method update (RefProvince object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public RefProvince update (RefProvince object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public RefProvince trash (java.io.Serializable pkey) throws Exception {
		RefProvince object = refProvinceDao.get (pkey);
		refProvinceDao.delete (object);
		return object;
	}
	...
	*/
	...
	public RefProvince delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		RefProvince object = refProvinceDao.get (pkey);
	...
	*/
	...
	public RefProvince delete (RefProvince object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public RefProvince get (java.io.Serializable pkey) throws Exception{
		RefProvince object = null;
		object = refProvinceDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public RefProvince get (java.io.Serializable pkey, String[] required) throws Exception{
	    RefProvince object = null;
	    object = refProvinceDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = refProvinceDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			RefProvince element = (RefProvince) iter.next();
...
// unique Result
	...
	public RefProvince searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = refProvinceDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RefProvince obj = (RefProvince) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public RefProvince searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = refProvinceDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RefProvince obj = (RefProvince) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = refProvinceDao.getDetachedCriteria();
		return dc;
	}
	public Collection searchProvince(String q, String country)
			throws Exception {
		

        Collection<RefProvince> result = new Vector<RefProvince>();
        try {
            Session session = refProvinceDao.getProvinceSession();

            System.out.println("filter province by LIKE(provinceName) and LIKE(countryName)");
            
            String sqlQuery = "SELECT c FROM "
                    + "RefProvince c WHERE lower(c.provinceName) LIKE :keyword AND lower(c.countryName) LIKE :cword AND c.deletedStatus = 0 ORDER BY c.provinceName ASC";
	...
	public Collection searchProvince(String q) throws Exception {

        Collection<RefProvince> result = new Vector<RefProvince>();
        try {
            Session session = refProvinceDao.getProvinceSession();

            System.out.println("filter province by LIKE(provinceName)");
            String sqlQuery = "SELECT c FROM "
                    + "RefProvince c WHERE lower(c.provinceName) LIKE :keyword AND c.deletedStatus = 0 ORDER BY c.provinceName ASC";
	...
	public Collection searchProvince(String q, Integer countryId)
			throws Exception {
		 Collection<RefProvince> result = new Vector<RefProvince>();
	        try {
	            Session session = refProvinceDao.getProvinceSession();
	            
	            System.out.println("filter province by LIKE(provinceName) and countryid");

	            String sqlQuery = "SELECT c FROM "
	                    + "RefProvince c WHERE lower(c.provinceName) LIKE :keyword AND c.countryId.id = :cid AND c.deletedStatus = 0 ORDER BY c.provinceName ASC";
	            ...
	            query.setString("keyword", "%" + q + "%");
	            query.setInteger("cid", countryId);
	            query.setMaxResults(10);
