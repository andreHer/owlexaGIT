...
import com.ametis.cms.dao.MeasurementUnitDao;
...
/**
 * MeasurementUnit is a servlet controller for measurement_unit Table.
...
private ActivityLogService activityLogService;
	...
	public void setMeasurementUnitDao (MeasurementUnitDao object){
		this.measurementUnitDao = object;
	}
	...
	*/
	public MeasurementUnit create (MeasurementUnit object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			MeasurementUnit result = measurementUnitDao.create (object);
			return result;
		}
	/*
	* Method update (MeasurementUnit object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MeasurementUnit update (MeasurementUnit object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		measurementUnitDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MeasurementUnit trash (java.io.Serializable pkey) throws Exception {
		MeasurementUnit object = measurementUnitDao.get (pkey);
	...
	*/
	...
	public MeasurementUnit delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		MeasurementUnit object = measurementUnitDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public MeasurementUnit delete (MeasurementUnit object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MeasurementUnit get (java.io.Serializable pkey) throws Exception{
		MeasurementUnit object = null;
		object = measurementUnitDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MeasurementUnit get (java.io.Serializable pkey, String[] required) throws Exception{
	    MeasurementUnit object = null;
	    object = measurementUnitDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = measurementUnitDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MeasurementUnit element = (MeasurementUnit) iter.next();
...
// unique Result
	...
	public MeasurementUnit searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = measurementUnitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MeasurementUnit obj = (MeasurementUnit) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MeasurementUnit searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = measurementUnitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MeasurementUnit obj = (MeasurementUnit) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = measurementUnitDao.getDetachedCriteria();
		return dc;
	}
