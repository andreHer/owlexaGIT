...
// extends- 
{
	...
	public void setMemberImportDao (MemberImportDao object){
		this.memberImportDao = object;
	}
	public MemberImportDao getMemberImportDao (){
		return this.memberImportDao;
	}
	/*
	...
	*/
	public MemberImport create (MemberImport object,ActionUser user) throws Exception {
			...
			MemberImport result = memberImportDao.create (object);
			return result;
		}
	/*
	...
	*/
	public MemberImport trash (java.io.Serializable pkey) throws Exception {
		MemberImport object = memberImportDao.get (pkey);
		memberImportDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public MemberImport get (java.io.Serializable pkey) throws Exception{
		MemberImport object = null;
		object = memberImportDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberImportDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberImport element = (MemberImport) iter.next();
...
// unique Result
	...
	public MemberImport searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = memberImportDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberImport obj = (MemberImport) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberImportDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public Collection<MemberImport> getPrintingList(Integer clientId) throws Exception {
		// TODO Auto-generated method stub
		Collection<MemberImport> importList = new Vector<MemberImport>();
		
		
		try {
			String q = "SELECT im FROM MemberImport im WHERE im.printCard = :pc AND im.policyId.clientId.clientId = :cid";
			
			Session session = memberImportDao.getImportSession();
			
			Query query = session.createQuery(q);
			query.setString("pc", "Y");
			query.setInteger("cid", clientId);
			
			importList = query.list();
		}
		catch (Exception e){
			e.printStackTrace();
		}
...
Collection<MemberImport> importList = new Vector<MemberImport>();
		...
		try {
			String q = "SELECT im FROM MemberImport im WHERE im.policyId is NULL";
	...
	public Collection<MemberImport> getClientUnbilledMovement (Integer clientId, String movementType) throws Exception {
		...
		try {
			String q = "SELECT im FROM MemberImport im WHERE im.invoiceItemId is NULL "
					+ "AND im.policyId.clientId.clientId = :cid AND im.deletedStatus = 0 AND im.actionType = :actionType";
			
			Session session = memberImportDao.getImportSession();
			
			Query query = session.createQuery(q);		
			query.setInteger("cid", clientId);
			query.setString("actionType", movementType);
	...
	public Collection<MemberImport> getPolicyUnbilledMovement(Integer policyId, String movementType) throws Exception {
		...
		try {
			String q = "SELECT im FROM MemberImport im WHERE im.invoiceItemId is NULL "
					+ "AND im.policyId.policyId = :policyId AND im.deletedStatus = 0 AND im.actionType = :actionType";
