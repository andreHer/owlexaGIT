...
*/
public class ExcessChargeServiceJasindoImpl implements ExcessChargeService
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			status.setPaymentStatusId(PaymentStatus.PAYMENT_OPEN);
			object.setExcessChargeStatus(status);
			
			String counter = generateExcessCounterNumber(object);
			
			String excessNumber = counter +"/EKS/"+month+"/"+dateTime.getYear();
	...
	*/
	private String generateExcessCounterNumber (ExcessCharge excessCharge){
		...
		int res = numberCounterService.getNextExcessCounter(excessCharge.getClaimId().getMemberId().getClientId().getClientId());
...
*/
	...
	@Override
	public boolean confirmExcessLetterSent(Serializable pkey,
