...
import com.ametis.cms.dao.ExchangeRateDao;
...
/**
 * ExchangeRate is a servlet controller for exchange_rate Table.
...
// extends- 
{
	...
	public void setExchangeRateDao (ExchangeRateDao object){
		this.exchangeRateDao = object;
	}
	public ExchangeRateDao getExchangeRateDao (){
		return this.exchangeRateDao;
	}
	/*
	* Method create (ExchangeRate object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ExchangeRate create (ExchangeRate object,ActionUser user) throws Exception {
			...
			ExchangeRate result = exchangeRateDao.create (object);
			return result;
		}
	/*
	* Method update (ExchangeRate object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ExchangeRate update (ExchangeRate object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ExchangeRate trash (java.io.Serializable pkey) throws Exception {
		ExchangeRate object = exchangeRateDao.get (pkey);
		exchangeRateDao.delete (object);
		return object;
	}

	/*
	* Method delete (ExchangeRate object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ExchangeRate delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ExchangeRate object = exchangeRateDao.get (pkey);
	...
	*/
	...
	public ExchangeRate delete (ExchangeRate object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ExchangeRate get (java.io.Serializable pkey) throws Exception{
		ExchangeRate object = null;
		object = exchangeRateDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ExchangeRate get (java.io.Serializable pkey, String[] required) throws Exception{
	    ExchangeRate object = null;
	    object = exchangeRateDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = exchangeRateDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ExchangeRate element = (ExchangeRate) iter.next();
...
// unique Result
	...
	public ExchangeRate searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = exchangeRateDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExchangeRate obj = (ExchangeRate) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ExchangeRate searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = exchangeRateDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExchangeRate obj = (ExchangeRate) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = exchangeRateDao.getDetachedCriteria();
		return dc;
	}
