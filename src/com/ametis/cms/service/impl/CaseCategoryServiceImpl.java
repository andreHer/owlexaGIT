...
private ActivityLogService activityLogService;
	...
	public void setCaseCategoryDao (CaseCategoryDao object){
		this.caseCategoryDao = object;
	}
	public CaseCategoryDao getCaseCategoryDao (){
		return this.caseCategoryDao;
	}
	/*
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			CaseCategory result = caseCategoryDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public CaseCategory trash (java.io.Serializable pkey) throws Exception {
		CaseCategory object = caseCategoryDao.get (pkey);
		caseCategoryDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public CaseCategory get (java.io.Serializable pkey) throws Exception{
		CaseCategory object = null;
		object = caseCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseCategoryDao.getCriteria();
...
// unique Result
	...
	public CaseCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = caseCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseCategory obj = (CaseCategory) c.uniqueResult();
	...
	public Collection searchInpatientCategory () throws Exception{
		...
		Criteria c = caseCategoryDao.getCriteria();
		c.add(	Expression.or(Property.forName("caseType").eq(Integer.valueOf(CaseCategory.CASE_GL)) 
						, Property.forName("caseType").eq(Integer.valueOf(CaseCategory.CASE_BOTH))));
	...
	public Collection searchOutpatientCategory () throws Exception{
		...
		Criteria c = caseCategoryDao.getCriteria();
		c.add(	Expression.or(Property.forName("caseType").eq(Integer.valueOf(CaseCategory.CASE_GN)) 
						, Property.forName("caseType").eq(Integer.valueOf(CaseCategory.CASE_BOTH))));
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseCategoryDao.getDetachedCriteria();
		return dc;
	}
	public CaseCategory getCaseCategory(String caseCategoryCode)
			throws Exception {
		// TODO Auto-generated method stub
		CaseCategory result = searchUnique("caseCategoryCode", caseCategoryCode);
		return result;
	}
	@Override
	public CaseCategory getCaseCategoryEDC(String caseCategoryCode)
			throws Exception {
		// TODO Auto-generated method stub
		System.out.println("GET CASE CATEGORY EDC = " + caseCategoryCode);
		CaseCategory result = searchUnique("caseCategoryEdcCode", caseCategoryCode);
		return result;
	}
