...
/**
 * ProviderDoctor is a servlet controller for provider_doctor Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderDoctorServiceImpl implements ProviderDoctorService
...
// extends- 
{
	...
	private ProviderDoctorDao  providerDoctorDao;
	...
	public void setProviderDoctorDao (ProviderDoctorDao object){
		this.providerDoctorDao = object;
	}
	public ProviderDoctorDao getProviderDoctorDao (){
		return this.providerDoctorDao;
	}
	/*
	...
	*/
	public ProviderDoctor create (ProviderDoctor object,ActionUser user) throws Exception {
		...
		ProviderDoctor result = providerDoctorDao.create (object);
		return result;
	}
	public ProviderDoctor createUpload (ProviderDoctor object,MultipartFile file,ActionUser user) throws Exception {
	...
	@Override
	public boolean addDoctor (Integer providerId, Collection<ProviderDoctor> doctorList, ActionUser user) throws Exception{
		...
		for (Iterator iterator = doctorList.iterator(); iterator.hasNext();) {
			...
			ProviderDoctor providerDoctor = (ProviderDoctor) iterator.next();
			if (providerDoctor != null){
				providerDoctor.setProviderId(provider);
				
				create(providerDoctor,user);
			}
	...
	/*
	* Method update (ProviderDoctor object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderDoctor update (ProviderDoctor object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerDoctorDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderDoctor trash (java.io.Serializable pkey) throws Exception {
		ProviderDoctor object = providerDoctorDao.get (pkey);
		providerDoctorDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderDoctor delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderDoctor object = providerDoctorDao.get (pkey);
	...
	*/
	...
	public ProviderDoctor delete (ProviderDoctor object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderDoctor get (java.io.Serializable pkey) throws Exception{
		ProviderDoctor object = null;
		object = providerDoctorDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderDoctor get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderDoctor object = null;
	    object = providerDoctorDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerDoctorDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderDoctor element = (ProviderDoctor) iter.next();
...
// unique Result
	...
	public ProviderDoctor searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerDoctorDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderDoctor obj = (ProviderDoctor) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderDoctor searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerDoctorDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderDoctor obj = (ProviderDoctor) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerDoctorDao.getDetachedCriteria();
		return dc;
	}
