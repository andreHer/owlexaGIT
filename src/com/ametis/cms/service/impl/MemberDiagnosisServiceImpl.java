...
import com.ametis.cms.dao.MemberDiagnosisDao;
...
/**
 * MemberDiagnosis is a servlet controller for member_diagnosis Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class MemberDiagnosisServiceImpl implements MemberDiagnosisService
...

{
	...
	private MemberDiagnosisDao  memberDiagnosisDao;
private ActivityLogService activityLogService;
	...
	public void setMemberDiagnosisDao (MemberDiagnosisDao object){
		this.memberDiagnosisDao = object;
	}
	public MemberDiagnosisDao getMemberDiagnosisDao (){
		return this.memberDiagnosisDao;
	}
	/*
	* Method create (MemberDiagnosis object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public MemberDiagnosis create (MemberDiagnosis object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			MemberDiagnosis result = memberDiagnosisDao.create (object);
			return result;
		}
	/*
	* Method update (MemberDiagnosis object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MemberDiagnosis update (MemberDiagnosis object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		memberDiagnosisDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MemberDiagnosis trash (java.io.Serializable pkey) throws Exception {
		MemberDiagnosis object = memberDiagnosisDao.get (pkey);
		memberDiagnosisDao.delete (object);
		return object;
	}

	/*
	* Method delete (MemberDiagnosis object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public MemberDiagnosis delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		MemberDiagnosis object = memberDiagnosisDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public MemberDiagnosis delete (MemberDiagnosis object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MemberDiagnosis get (java.io.Serializable pkey) throws Exception{
		MemberDiagnosis object = null;
		object = memberDiagnosisDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MemberDiagnosis get (java.io.Serializable pkey, String[] required) throws Exception{
	    MemberDiagnosis object = null;
	    object = memberDiagnosisDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberDiagnosisDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberDiagnosis element = (MemberDiagnosis) iter.next();
...
// unique Result
	...
	public MemberDiagnosis searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = memberDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberDiagnosis obj = (MemberDiagnosis) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MemberDiagnosis searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = memberDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberDiagnosis obj = (MemberDiagnosis) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberDiagnosisDao.getDetachedCriteria();
		return dc;
	}
