...
*/
public class CaseItemServiceImpl implements CaseItemService
...
private ActivityLogService activityLogService;
	...
	public void setCaseItemDao (CaseItemDao object){
		this.caseItemDao = object;
	}
	...
	*/
	public CaseItem create (CaseItem object,ActionUser actionUser) throws Exception {
			...
			CaseItem result = caseItemDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public CaseItem trash (java.io.Serializable pkey) throws Exception {
		CaseItem object = caseItemDao.get (pkey);
		caseItemDao.delete (object);
		return object;
	}
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CaseItem element = (CaseItem) iter.next();
...
// unique Result
	...
	public CaseItem searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = caseItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseItem obj = (CaseItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseItemDao.getDetachedCriteria();
		return dc;
	}
	
	public Collection<CaseItem> getCaseItem(Integer caseId) throws Exception {
		// TODO Auto-generated method stub
		Collection<CaseItem> result = null;
	...
	public CaseItem getCaseItem(Integer caseId, Integer itemId) throws Exception{
		...
		if (caseId != null && itemId != null){
			String[] eqParam = {"deletedStatus","caseId.caseId","itemId.itemId"};
			Object[] eqValue = {Integer.valueOf(0),caseId,itemId};
			
			Collection<CaseItem> caseItemList = search(null,null,eqParam,eqValue,0,1);
			
			if (caseItemList != null){
				Iterator<CaseItem > iterator = caseItemList.iterator();
