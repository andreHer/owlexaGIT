...
import com.ametis.cms.dao.TreatmentClassDao;
...
/**
 * TreatmentClass is a servlet controller for treatment_class Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class TreatmentClassServiceImpl implements TreatmentClassService
...
// extends- 
{
	...
	private TreatmentClassDao  treatmentClassDao;

	public void setTreatmentClassDao (TreatmentClassDao object){
		this.treatmentClassDao = object;
	}
	public TreatmentClassDao getTreatmentClassDao (){
		return this.treatmentClassDao;
	}
	/*
	* Method create (TreatmentClass object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public TreatmentClass create (TreatmentClass object,ActionUser user) throws Exception {
			...
			TreatmentClass result = treatmentClassDao.create (object);
			return result;
		}
	/*
	* Method update (TreatmentClass object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public TreatmentClass update (TreatmentClass object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		treatmentClassDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public TreatmentClass trash (java.io.Serializable pkey) throws Exception {
		TreatmentClass object = treatmentClassDao.get (pkey);
		treatmentClassDao.delete (object);
		return object;
	}

	/*
	* Method delete (TreatmentClass object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public TreatmentClass delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		TreatmentClass object = treatmentClassDao.get (pkey);
	...
	*/
	...
	public TreatmentClass delete (TreatmentClass object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public TreatmentClass get (java.io.Serializable pkey) throws Exception{
		TreatmentClass object = null;
		object = treatmentClassDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public TreatmentClass get (java.io.Serializable pkey, String[] required) throws Exception{
	    TreatmentClass object = null;
	    object = treatmentClassDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = treatmentClassDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			TreatmentClass element = (TreatmentClass) iter.next();
...
// unique Result
	...
	public TreatmentClass searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = treatmentClassDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentClass obj = (TreatmentClass) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public TreatmentClass searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = treatmentClassDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentClass obj = (TreatmentClass) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = treatmentClassDao.getDetachedCriteria();
		return dc;
	}
