...
import com.ametis.cms.dao.RoleDao;
...
/**
 * Role is a servlet controller for role Table.
...
private ActivityLogService activityLogService;
	...
	public void setRoleDao (RoleDao object){
		this.roleDao = object;
	}
	...
	/*
	* Method create (Role object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Role create (Role object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Role result = roleDao.create (object);
			return result;
		}
	/*
	* Method update (Role object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Role update (Role object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Role trash (java.io.Serializable pkey) throws Exception {
		Role object = roleDao.get (pkey);
		roleDao.delete (object);
		return object;
	}

	/*
	* Method delete (Role object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Role delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		Role object = roleDao.get (pkey);
...
if (actionUser != null){
	...
	*/
	...
	public Role delete (Role object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Role get (java.io.Serializable pkey) throws Exception{
		Role object = null;
		object = roleDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Role get (java.io.Serializable pkey, String[] required) throws Exception{
	    Role object = null;
	    object = roleDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = roleDao.getCriteria();
...
// unique Result
	...
	public Role searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = roleDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Role obj = (Role) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Role searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = roleDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Role obj = (Role) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = roleDao.getDetachedCriteria();
		return dc;
	}
	
	public Collection getMemberGroupRole() throws Exception {
		// TODO Auto-generated method stub
		
		Collection<Role> membergroup= new Vector<Role>();
		
		Role pr1 = new Role();
		pr1.setRoleId(Role.MEMBER_GROUP);
		pr1.setRoleName("MEMBER_GROUP");
