...
*/
public class GroupClaimUtilReportServiceImpl implements GroupClaimUtilReportService
...
// extends- 
{
	...
	private GroupClaimUtilReportDao  groupClaimUtilReportDao;

	public void setGroupClaimUtilReportDao (GroupClaimUtilReportDao object){
		this.groupClaimUtilReportDao = object;
	}
	public GroupClaimUtilReportDao getGroupClaimUtilReportDao (){
		return this.groupClaimUtilReportDao;
	}
	/*
	...
	*/
	public GroupClaimUtilReport create (GroupClaimUtilReport object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			GroupClaimUtilReport result = groupClaimUtilReportDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		groupClaimUtilReportDao.update (object);
      	return object;
	}
	public Collection<GroupClaimUtilReport> getGroupClaimUtilReport (Date date, int index, int offset) throws Exception{
		Collection<GroupClaimUtilReport> result = null;
		
		try {
			String[] eqParam = {"reportDate"};
			Object[] eqValue = {date};
			result = search(null, null, eqParam, eqValue, index, offset);
		}
		catch (Exception e){
			e.printStackTrace();
		}
	...
	public Collection<GroupClaimUtilReport> getGroupClaimUtilReport (int index, int offset) throws Exception{
		...
		try {
			...
			String eqParamStr = null;
			Object eqValueStr = null;
			
			Collection<GroupClaimUtilReport> tmp = search(null,null,eqParamStr,eqValueStr,false,"reportDate",0,1);
			
			if (tmp != null){
				Iterator<GroupClaimUtilReport> iterator = tmp.iterator();
				
				while (iterator.hasNext()){
					GroupClaimUtilReport report = iterator.next();
					
					if (report != null){
						eqValueStr = report.getReportDate();
					}
				}
			}
			
			eqParamStr = "reportDate";
			
			result = search(null, null, eqParamStr, eqValueStr, index, offset);
		}
		catch (Exception e){
			e.printStackTrace();
		}
	...
	*/
	public GroupClaimUtilReport trash (java.io.Serializable pkey) throws Exception {
		GroupClaimUtilReport object = groupClaimUtilReportDao.get (pkey);
		groupClaimUtilReportDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public GroupClaimUtilReport get (java.io.Serializable pkey) throws Exception{
		GroupClaimUtilReport object = null;
		object = groupClaimUtilReportDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = groupClaimUtilReportDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			GroupClaimUtilReport element = (GroupClaimUtilReport) iter.next();
...
// unique Result
	...
	public GroupClaimUtilReport searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = groupClaimUtilReportDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		GroupClaimUtilReport obj = (GroupClaimUtilReport) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = groupClaimUtilReportDao.getDetachedCriteria();
		return dc;
	}
