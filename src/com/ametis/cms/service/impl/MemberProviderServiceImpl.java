...
/**
 * MemberProvider is a servlet controller for member_provider Table.
...

{
	...
	private MemberProviderDao  memberProviderDao;
	...
	public void setMemberProviderDao (MemberProviderDao object){
		this.memberProviderDao = object;
	}
	public MemberProviderDao getMemberProviderDao (){
		return this.memberProviderDao;
	}
	/*
	...
	*/
	public MemberProvider create (MemberProvider object,ActionUser user) throws Exception {
			...
			MemberProvider result = memberProviderDao.create (object);
			return result;
		}
	/*
	* Method update (MemberProvider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MemberProvider update (MemberProvider object,ActionUser user) throws Exception{
		...
		if (user != null && user.getUser() != null){
 		...
 		memberProviderDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MemberProvider trash (java.io.Serializable pkey) throws Exception {
		MemberProvider object = memberProviderDao.get (pkey);
		memberProviderDao.delete (object);
		return object;
	}
	...
	*/
	...
	public MemberProvider delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		MemberProvider object = memberProviderDao.get (pkey);
	...
	*/
	...
	public MemberProvider delete (MemberProvider object,ActionUser user) throws Exception{
		object.setDeletedTime (new java.sql.Timestamp (System.currentTimeMillis()));
...
// -- get section - carefull !
	...
	*/
	public MemberProvider get (java.io.Serializable pkey) throws Exception{
		MemberProvider object = null;
		object = memberProviderDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MemberProvider get (java.io.Serializable pkey, String[] required) throws Exception{
	    MemberProvider object = null;
	    object = memberProviderDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberProviderDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberProvider element = (MemberProvider) iter.next();
...
// unique Result
	...
	public MemberProvider searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = memberProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberProvider obj = (MemberProvider) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	
	public MemberProvider searchUnique (String[] eqColumns, Object[] eqParams, int index, int offset)
			throws Exception{
			Criteria c = memberProviderDao.getCriteria();
			DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
			DaoSupportUtil.setLimit(index, offset, c);
	...
	public MemberProvider searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = memberProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberProvider obj = (MemberProvider) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberProviderDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public MemberProvider createUpload(MemberProvider object,MultipartFile file, ActionUser user) throws Exception {
