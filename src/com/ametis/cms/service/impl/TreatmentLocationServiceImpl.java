...
/**
 * TreatmentLocation is a servlet controller for treatment_location Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class TreatmentLocationServiceImpl implements TreatmentLocationService
...

{
	...
	private TreatmentLocationDao  treatmentLocationDao;

	public void setTreatmentLocationDao (TreatmentLocationDao object){
		this.treatmentLocationDao = object;
	}
	public TreatmentLocationDao getTreatmentLocationDao (){
		return this.treatmentLocationDao;
	}
	/*
	...
	*/
	public TreatmentLocation create (TreatmentLocation object,com.ametis.cms.datamodel.ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			TreatmentLocation result = treatmentLocationDao.create (object);
			return result;
		}
	/*
	* Method update (TreatmentLocation object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public TreatmentLocation update (TreatmentLocation object,com.ametis.cms.datamodel.ActionUser  user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		treatmentLocationDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public TreatmentLocation trash (java.io.Serializable pkey) throws Exception {
		TreatmentLocation object = treatmentLocationDao.get (pkey);
		treatmentLocationDao.delete (object);
		return object;
	}
	...
	*/
	...
	public TreatmentLocation delete (java.io.Serializable pkey,com.ametis.cms.datamodel.ActionUser  user) throws Exception{
		TreatmentLocation object = treatmentLocationDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public TreatmentLocation delete (TreatmentLocation object,com.ametis.cms.datamodel.ActionUser  user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public TreatmentLocation get (java.io.Serializable pkey) throws Exception{
		TreatmentLocation object = null;
		object = treatmentLocationDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public TreatmentLocation get (java.io.Serializable pkey, String[] required) throws Exception{
	    TreatmentLocation object = null;
	    object = treatmentLocationDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = treatmentLocationDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			TreatmentLocation element = (TreatmentLocation) iter.next();
...
// unique Result
	...
	public TreatmentLocation searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = treatmentLocationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentLocation obj = (TreatmentLocation) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public TreatmentLocation searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = treatmentLocationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentLocation obj = (TreatmentLocation) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = treatmentLocationDao.getDetachedCriteria();
		return dc;
	}
