...
/**
 * PolicyMember is a servlet controller for policy_member Table.
...
// extends- 
{
	...
	public void setPolicyMemberDao (PolicyMemberDao object){
		this.policyMemberDao = object;
	}
	public PolicyMemberDao getPolicyMemberDao (){
		return this.policyMemberDao;
	}
	/*
	...
	*/
	public PolicyMember create (PolicyMember object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			PolicyMember result = policyMemberDao.create (object);
			return result;
		}
	/*
	* Method update (PolicyMember object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PolicyMember update (PolicyMember object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public PolicyMember trash (java.io.Serializable pkey) throws Exception {
		PolicyMember object = policyMemberDao.get (pkey);
		policyMemberDao.delete (object);
		return object;
	}
	...
	*/
	...
	public PolicyMember delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PolicyMember object = policyMemberDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public PolicyMember delete (PolicyMember object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PolicyMember get (java.io.Serializable pkey) throws Exception{
		PolicyMember object = null;
		object = policyMemberDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PolicyMember get (java.io.Serializable pkey, String[] required) throws Exception{
	    PolicyMember object = null;
	    object = policyMemberDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = policyMemberDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PolicyMember element = (PolicyMember) iter.next();
...
// unique Result
	...
	public PolicyMember searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = policyMemberDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyMember obj = (PolicyMember) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PolicyMember searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = policyMemberDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyMember obj = (PolicyMember) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = policyMemberDao.getDetachedCriteria();
		return dc;
	}
