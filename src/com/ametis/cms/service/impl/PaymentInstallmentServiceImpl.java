...
public class PaymentInstallmentServiceImpl implements PaymentInstallmentService{
	...
	public void setPaymentInstallmentDao (PaymentInstallmentDao object){
		this.paymentInstallmentDao = object;
	}
	public PaymentInstallmentDao getPaymentInstallmentDao (){
		return this.paymentInstallmentDao;
	}
	/*
	...
	*/
	public PaymentInstallment create (PaymentInstallment object,ActionUser user) throws Exception {
			...
			PaymentInstallment result = paymentInstallmentDao.create (object);
			return result;
		}
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		paymentInstallmentDao.update (object);
      	return object;
	}
	...
	*/
	public PaymentInstallment trash (java.io.Serializable pkey) throws Exception {
		PaymentInstallment object = paymentInstallmentDao.get (pkey);
		paymentInstallmentDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public PaymentInstallment get (java.io.Serializable pkey) throws Exception{
		PaymentInstallment object = null;
		object = paymentInstallmentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = paymentInstallmentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PaymentInstallment element = (PaymentInstallment) iter.next();
...
// unique Result
	...
	public PaymentInstallment searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = paymentInstallmentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PaymentInstallment obj = (PaymentInstallment) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = paymentInstallmentDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public int getTotalInstallment(Integer paymentId) throws Exception {
		...
		Object[] eqValue = {Integer.valueOf(0),paymentId};
		
		Integer result = getTotal(null,null,eqParam,eqValue);
		
		return result;
	}
	public int getTotalInstallmentDisposition(Integer paymentId) throws Exception {
		// TODO Auto-generated method stub
		String[] eqParam = {"deletedStatus","paymentId.paymentId","status"};
		Object[] eqValue = {Integer.valueOf(0),paymentId,PaymentStatus.PAYMENT_DISPOSITION};
	...
	public boolean confirmPayment(Long installmentId, String approvalNote,Date confirmDate,
		...
		PaymentInstallment installment = get(installmentId);
		
		if (installment != null){
			
			installment.setStatus(PaymentStatus.PAYMENT_PAID);
			installment.setPaymentDate(confirmDate);
			installment.setApprovalNote(approvalNote);
			
			if (user != null && user.getUser() != null){
				installment.setApprovedBy(user.getUser().getUsername());
			}
			
			
			update(installment,user);
		
			String[] eqParam = {"paymentInstallmentId.paymentInstallmentId","deletedStatus"};
			Object[] eqValue = {installmentId,Integer.valueOf(0)};
			...
			for (Iterator iterator = claimList.iterator(); iterator.hasNext();) {
				...
				claim.setPaidTime(new java.sql.Timestamp(confirmDate.getTime()));
				
				claimService.pay(claim, user);
			}
	...
	@Override
	public Collection<PaymentInstallment> getInstallmentList(Integer batchId)
			throws Exception {
		// TODO Auto-generated method stub
		Collection<PaymentInstallment> result = null;
		
		String[] eqParam  = {"paymentBatchId.id","deletedStatus"};
		Object[] eqValue = {batchId,Integer.valueOf(0)};
