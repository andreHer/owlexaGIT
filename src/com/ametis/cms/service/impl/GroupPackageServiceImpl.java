...
/**
 * GroupPackage is a servlet controller for group_package Table.
...

{
	...
	private GroupPackageDao  groupPackageDao;
private ActivityLogService activityLogService;
	...
	public void setGroupPackageDao (GroupPackageDao object){
		this.groupPackageDao = object;
	}
	public GroupPackageDao getGroupPackageDao (){
		return this.groupPackageDao;
	}
	/*
	...
	*/
	public GroupPackage create (GroupPackage object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			GroupPackage result = groupPackageDao.create (object);
			return result;
		}
	/*
	* Method update (GroupPackage object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public GroupPackage update (GroupPackage object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public GroupPackage trash (java.io.Serializable pkey) throws Exception {
		GroupPackage object = groupPackageDao.get (pkey);
		groupPackageDao.delete (object);
		return object;
	}
	...
	*/
	...
	public GroupPackage delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		GroupPackage object = groupPackageDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public GroupPackage delete (GroupPackage object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public GroupPackage get (java.io.Serializable pkey) throws Exception{
		GroupPackage object = null;
		object = groupPackageDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public GroupPackage get (java.io.Serializable pkey, String[] required) throws Exception{
	    GroupPackage object = null;
	    object = groupPackageDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = groupPackageDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			GroupPackage element = (GroupPackage) iter.next();
...
// unique Result
	...
	public GroupPackage searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = groupPackageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		GroupPackage obj = (GroupPackage) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public GroupPackage searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = groupPackageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		GroupPackage obj = (GroupPackage) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = groupPackageDao.getDetachedCriteria();
		return dc;
	}
