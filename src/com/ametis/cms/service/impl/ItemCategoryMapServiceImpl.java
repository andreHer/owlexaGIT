...
import com.ametis.cms.dao.ItemCategoryMapDao;
...
/**
 * ItemCategoryMap is a servlet controller for item_category_map Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ItemCategoryMapServiceImpl implements ItemCategoryMapService
...
// extends- 
{
	...
	private ItemCategoryMapDao  itemCategoryMapDao;

	public void setItemCategoryMapDao (ItemCategoryMapDao object){
		this.itemCategoryMapDao = object;
	}
	public ItemCategoryMapDao getItemCategoryMapDao (){
		return this.itemCategoryMapDao;
	}
	/*
	* Method create (ItemCategoryMap object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ItemCategoryMap create (ItemCategoryMap object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ItemCategoryMap result = itemCategoryMapDao.create (object);
			return result;
		}
	/*
	* Method update (ItemCategoryMap object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ItemCategoryMap update (ItemCategoryMap object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		itemCategoryMapDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ItemCategoryMap trash (java.io.Serializable pkey) throws Exception {
		ItemCategoryMap object = itemCategoryMapDao.get (pkey);
		itemCategoryMapDao.delete (object);
		return object;
	}

	/*
	* Method delete (ItemCategoryMap object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ItemCategoryMap delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ItemCategoryMap object = itemCategoryMapDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ItemCategoryMap delete (ItemCategoryMap object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ItemCategoryMap get (java.io.Serializable pkey) throws Exception{
		ItemCategoryMap object = null;
		object = itemCategoryMapDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ItemCategoryMap get (java.io.Serializable pkey, String[] required) throws Exception{
	    ItemCategoryMap object = null;
	    object = itemCategoryMapDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = itemCategoryMapDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ItemCategoryMap element = (ItemCategoryMap) iter.next();
...
// unique Result
	...
	public ItemCategoryMap searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = itemCategoryMapDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ItemCategoryMap obj = (ItemCategoryMap) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ItemCategoryMap searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = itemCategoryMapDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ItemCategoryMap obj = (ItemCategoryMap) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = itemCategoryMapDao.getDetachedCriteria();
		return dc;
	}
