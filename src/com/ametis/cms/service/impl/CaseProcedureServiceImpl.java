...
/**
 * CaseProcedure is a servlet controller for case_procedure Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class CaseProcedureServiceImpl implements CaseProcedureService
...
// extends- 
{
	...
	public void setCaseProcedureDao (CaseProcedureDao object){
		this.caseProcedureDao = object;
	}
	public CaseProcedureDao getCaseProcedureDao (){
		return this.caseProcedureDao;
	}
	public boolean addProcedure(Integer caseId,
			Collection<CaseProcedure> procedureList, ActionUser user)
			throws Exception {
		...
		try {
			...
			if (theCase != null){
				...
				for (Iterator iterator = procedureList.iterator(); iterator.hasNext();) {
					...
					CaseProcedure caseProcedure = (CaseProcedure) iterator.next();
					caseProcedure.setCaseId(theCase);
					
					create(caseProcedure,user);
	...
	*/
	public CaseProcedure create (CaseProcedure object,ActionUser user) throws Exception {
			...
			CaseProcedure result = caseProcedureDao.create (object);
			return result;
		}
	/*
	* Method update (CaseProcedure object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CaseProcedure update (CaseProcedure object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		caseProcedureDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public CaseProcedure trash (java.io.Serializable pkey) throws Exception {
		CaseProcedure object = caseProcedureDao.get (pkey);
		caseProcedureDao.delete (object);
		return object;
	}
	...
	*/
	...
	public CaseProcedure delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		CaseProcedure object = caseProcedureDao.get (pkey);
	...
	*/
	...
	public CaseProcedure delete (CaseProcedure object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CaseProcedure get (java.io.Serializable pkey) throws Exception{
		CaseProcedure object = null;
		object = caseProcedureDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CaseProcedure get (java.io.Serializable pkey, String[] required) throws Exception{
	    CaseProcedure object = null;
	    object = caseProcedureDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseProcedureDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CaseProcedure element = (CaseProcedure) iter.next();
...
// unique Result
	...
	public CaseProcedure searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = caseProcedureDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseProcedure obj = (CaseProcedure) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CaseProcedure searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = caseProcedureDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseProcedure obj = (CaseProcedure) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseProcedureDao.getDetachedCriteria();
		return dc;
	}
