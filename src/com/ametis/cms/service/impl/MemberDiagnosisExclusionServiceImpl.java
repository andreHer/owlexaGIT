...
import com.ametis.cms.dao.MemberDiagnosisExclusionDao;
...
/**
 * MemberDiagnosisExclusion is a servlet controller for member_diagnosis_exclusion Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class MemberDiagnosisExclusionServiceImpl implements MemberDiagnosisExclusionService
...

{
	...
	private MemberDiagnosisExclusionDao  memberDiagnosisExclusionDao;

	public void setMemberDiagnosisExclusionDao (MemberDiagnosisExclusionDao object){
		this.memberDiagnosisExclusionDao = object;
	}
	public MemberDiagnosisExclusionDao getMemberDiagnosisExclusionDao (){
		return this.memberDiagnosisExclusionDao;
	}
	...
	/*
	* Method create (MemberDiagnosisExclusion object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public MemberDiagnosisExclusion create (MemberDiagnosisExclusion object,ActionUser user) throws Exception {
			...
			MemberDiagnosisExclusion result = memberDiagnosisExclusionDao.create (object);
			return result;
		}
	/*
	* Method update (MemberDiagnosisExclusion object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MemberDiagnosisExclusion update (MemberDiagnosisExclusion object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		memberDiagnosisExclusionDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MemberDiagnosisExclusion trash (java.io.Serializable pkey) throws Exception {
		MemberDiagnosisExclusion object = memberDiagnosisExclusionDao.get (pkey);
		memberDiagnosisExclusionDao.delete (object);
		return object;
	}

	/*
	* Method delete (MemberDiagnosisExclusion object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public MemberDiagnosisExclusion delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		MemberDiagnosisExclusion object = memberDiagnosisExclusionDao.get (pkey);
	...
	*/
	...
	public MemberDiagnosisExclusion delete (MemberDiagnosisExclusion object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MemberDiagnosisExclusion get (java.io.Serializable pkey) throws Exception{
		MemberDiagnosisExclusion object = null;
		object = memberDiagnosisExclusionDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MemberDiagnosisExclusion get (java.io.Serializable pkey, String[] required) throws Exception{
	    MemberDiagnosisExclusion object = null;
	    object = memberDiagnosisExclusionDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberDiagnosisExclusionDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberDiagnosisExclusion element = (MemberDiagnosisExclusion) iter.next();
...
// unique Result
	...
	public MemberDiagnosisExclusion searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = memberDiagnosisExclusionDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberDiagnosisExclusion obj = (MemberDiagnosisExclusion) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MemberDiagnosisExclusion searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = memberDiagnosisExclusionDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberDiagnosisExclusion obj = (MemberDiagnosisExclusion) c.uniqueResult();
	...
	public MemberDiagnosisExclusion searchUnique (String[] eqColumns, Object[] eqParams,int index,int offset)
			throws Exception{
			Criteria c = memberDiagnosisExclusionDao.getCriteria();
			DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
			DaoSupportUtil.setLimit(index, offset, c);
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberDiagnosisExclusionDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public boolean isExcludedDiagnosis(Integer diagnosisId, Integer memberId)
			throws Exception {
		// TODO Auto-generated method stub
		
		boolean result = false;
		
		if (diagnosisId != null && memberId != null){
			String[] eqParam = {"memberId.memberId","diagnosisId.diagnosisId","deletedStatus"};
			Object[] eqValue = {memberId,diagnosisId,0};
	...
	@Override
	public MemberDiagnosisExclusion createUpload(
			MemberDiagnosisExclusion object, MultipartFile file, ActionUser user)
			throws Exception {
	...
	@Override
	public MemberDiagnosisExclusion getMemberExclusion(Integer diagnosisId,
			Integer memberId) throws Exception {
		// TODO Auto-generated method stub
		MemberDiagnosisExclusion result = null;
		
		try {
			String[] eqParam = {"diagnosisId.diagnosisId","memberId.memberId","deletedStatus"};
			Object[] eqValue = {diagnosisId,memberId,0};
			
			Collection<MemberDiagnosisExclusion> exList = search(null,null,eqParam,eqValue,0,1);
			if (exList != null){
				Iterator<MemberDiagnosisExclusion> iterator = exList.iterator();
