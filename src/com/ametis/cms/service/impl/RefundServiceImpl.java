...
import com.ametis.cms.service.RefundService;
...
/**
 * Refund is a servlet controller for refund Table.
...
// extends- 
{
	...
	public void setRefundDao (RefundDao object){
		this.refundDao = object;
	}
	...
	*/
	public Refund create (Refund object,ActionUser user) throws Exception {
			...
			Refund result = refundDao.create (object);
			return result;
		}
	/*
	* Method update (Refund object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Refund update (Refund object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Refund trash (java.io.Serializable pkey) throws Exception {
		Refund object = refundDao.get (pkey);
		refundDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Refund delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Refund object = refundDao.get (pkey);
	...
	*/
	...
	public Refund delete (Refund object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Refund get (java.io.Serializable pkey) throws Exception{
		Refund object = null;
		object = refundDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Refund get (java.io.Serializable pkey, String[] required) throws Exception{
	    Refund object = null;
	    object = refundDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = refundDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Refund element = (Refund) iter.next();
...
// unique Result
	...
	public Refund searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = refundDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Refund obj = (Refund) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Refund searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = refundDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Refund obj = (Refund) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = refundDao.getDetachedCriteria();
		return dc;
	}
