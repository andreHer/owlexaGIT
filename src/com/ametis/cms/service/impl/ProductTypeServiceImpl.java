...
import com.ametis.cms.dao.ProductTypeDao;
...
/**
 * ProductType is a servlet controller for product_type Table.
...

{
	...
	public void setProductTypeDao (ProductTypeDao object){
		this.productTypeDao = object;
	}
	public ProductTypeDao getProductTypeDao (){
		return this.productTypeDao;
	}
	/*
	* Method create (ProductType object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProductType create (ProductType object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ProductType result = productTypeDao.create (object);
			return result;
		}
	/*
	* Method update (ProductType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProductType update (ProductType object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ProductType trash (java.io.Serializable pkey) throws Exception {
		ProductType object = productTypeDao.get (pkey);
		productTypeDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProductType object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProductType delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ProductType object = productTypeDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ProductType delete (ProductType object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProductType get (java.io.Serializable pkey) throws Exception{
		ProductType object = null;
		object = productTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProductType get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProductType object = null;
	    object = productTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductType element = (ProductType) iter.next();
...
// unique Result
	...
	public ProductType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = productTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductType obj = (ProductType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProductType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = productTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductType obj = (ProductType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productTypeDao.getDetachedCriteria();
		return dc;
	}
