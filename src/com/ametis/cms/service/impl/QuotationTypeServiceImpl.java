...
import com.ametis.cms.service.QuotationTypeService;
...
/**
 * QuotationType is a servlet controller for quotation_type Table.
...

{
	...
	private QuotationTypeDao  quotationTypeDao;

	public void setQuotationTypeDao (QuotationTypeDao object){
		this.quotationTypeDao = object;
	}
	public QuotationTypeDao getQuotationTypeDao (){
		return this.quotationTypeDao;
	}
	/*
	...
	*/
	public QuotationType create (QuotationType object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			QuotationType result = quotationTypeDao.create (object);
			return result;
		}
	/*
	* Method update (QuotationType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public QuotationType update (QuotationType object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		quotationTypeDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public QuotationType trash (java.io.Serializable pkey) throws Exception {
		QuotationType object = quotationTypeDao.get (pkey);
		quotationTypeDao.delete (object);
		return object;
	}
	...
	*/
	...
	public QuotationType delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		QuotationType object = quotationTypeDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public QuotationType delete (QuotationType object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public QuotationType get (java.io.Serializable pkey) throws Exception{
		QuotationType object = null;
		object = quotationTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public QuotationType get (java.io.Serializable pkey, String[] required) throws Exception{
	    QuotationType object = null;
	    object = quotationTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = quotationTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			QuotationType element = (QuotationType) iter.next();
...
// unique Result
	...
	public QuotationType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = quotationTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		QuotationType obj = (QuotationType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public QuotationType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = quotationTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		QuotationType obj = (QuotationType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = quotationTypeDao.getDetachedCriteria();
		return dc;
	}
