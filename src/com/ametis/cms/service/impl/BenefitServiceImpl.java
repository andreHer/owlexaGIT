...
/**
 * Benefit is a servlet controller for benefit Table.
...
private ActivityLogService activityLogService;
	...
	public void setBenefitDao (BenefitDao object){
		this.benefitDao = object;
	}
	public BenefitDao getBenefitDao (){
		return this.benefitDao;
	}
	/*
	* Method create (Benefit object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Benefit create (Benefit object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Benefit result = benefitDao.create (object);
			return result;
		}
	/*
	* Method update (Benefit object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Benefit update (Benefit object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Benefit trash (java.io.Serializable pkey) throws Exception {
		Benefit object = benefitDao.get (pkey);
		benefitDao.delete (object);
		return object;
	}

	/*
	* Method delete (Benefit object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Benefit delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		Benefit object = benefitDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Benefit delete (Benefit object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Benefit get (java.io.Serializable pkey) throws Exception{
		Benefit object = null;
		object = benefitDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Benefit get (java.io.Serializable pkey, String[] required) throws Exception{
	    Benefit object = null;
	    object = benefitDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = benefitDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Benefit element = (Benefit) iter.next();
...
// unique Result
	...
	public Benefit searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = benefitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Benefit obj = (Benefit) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Benefit searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = benefitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Benefit obj = (Benefit) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = benefitDao.getDetachedCriteria();
		return dc;
	}
