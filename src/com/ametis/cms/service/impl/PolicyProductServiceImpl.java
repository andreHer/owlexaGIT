...
import com.ametis.cms.dao.PolicyProductDao;
...
/**
 * PolicyProduct is a servlet controller for policy_product Table.
...
// extends- 
{
	...
	private PolicyProductDao  policyProductDao;

	public void setPolicyProductDao (PolicyProductDao object){
		this.policyProductDao = object;
	}
	public PolicyProductDao getPolicyProductDao (){
		return this.policyProductDao;
	}
	/*
	* Method create (PolicyProduct object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public PolicyProduct create (PolicyProduct object,ActionUser user) throws Exception {
			...
			PolicyProduct result = policyProductDao.create (object);
			return result;
		}
	/*
	* Method update (PolicyProduct object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PolicyProduct update (PolicyProduct object,ActionUser user) throws Exception{
		object.setModifiedTime(new java.sql.Timestamp(System.currentTimeMillis()));
		
		if (user != null && user.getUser() != null){
			object.setModifiedBy(user.getUser().getUsername());				
		}
		policyProductDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public PolicyProduct trash (java.io.Serializable pkey) throws Exception {
		PolicyProduct object = policyProductDao.get (pkey);
		policyProductDao.delete (object);
		return object;
	}

	/*
	* Method delete (PolicyProduct object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public PolicyProduct delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PolicyProduct object = policyProductDao.get (pkey);
	...
	*/
	...
	public PolicyProduct delete (PolicyProduct object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PolicyProduct get (java.io.Serializable pkey) throws Exception{
		PolicyProduct object = null;
		object = policyProductDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PolicyProduct get (java.io.Serializable pkey, String[] required) throws Exception{
	    PolicyProduct object = null;
	    object = policyProductDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = policyProductDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PolicyProduct element = (PolicyProduct) iter.next();
...
// unique Result
	...
	public PolicyProduct searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = policyProductDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyProduct obj = (PolicyProduct) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PolicyProduct searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = policyProductDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyProduct obj = (PolicyProduct) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = policyProductDao.getDetachedCriteria();
		return dc;
	}
