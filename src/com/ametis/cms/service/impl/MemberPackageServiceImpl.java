...
import com.ametis.cms.dao.MemberPackageDao;
...
/**
 * MemberPackage is a servlet controller for member_package Table.
...
private ActivityLogService activityLogService;
	...
	public void setMemberPackageDao (MemberPackageDao object){
		this.memberPackageDao = object;
	}
	public MemberPackageDao getMemberPackageDao (){
		return this.memberPackageDao;
	}
	/*
	* Method create (MemberPackage object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public MemberPackage create (MemberPackage object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			MemberPackage result = memberPackageDao.create (object);
			return result;
		}
	/*
	* Method update (MemberPackage object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MemberPackage update (MemberPackage object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		memberPackageDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MemberPackage trash (java.io.Serializable pkey) throws Exception {
		MemberPackage object = memberPackageDao.get (pkey);
		memberPackageDao.delete (object);
		return object;
	}

	/*
	* Method delete (MemberPackage object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public MemberPackage delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		MemberPackage object = memberPackageDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public MemberPackage delete (MemberPackage object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MemberPackage get (java.io.Serializable pkey) throws Exception{
		MemberPackage object = null;
		object = memberPackageDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MemberPackage get (java.io.Serializable pkey, String[] required) throws Exception{
	    MemberPackage object = null;
	    object = memberPackageDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberPackageDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberPackage element = (MemberPackage) iter.next();
...
// unique Result
	...
	public MemberPackage searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = memberPackageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberPackage obj = (MemberPackage) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MemberPackage searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = memberPackageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberPackage obj = (MemberPackage) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberPackageDao.getDetachedCriteria();
		return dc;
	}
