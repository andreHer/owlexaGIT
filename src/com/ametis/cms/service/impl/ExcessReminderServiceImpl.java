...
/**
 * ExcessReminder is a servlet controller for excess_reminder Table. All you
 * have to do is to convert necessary data field to the named parameter
 */
public class ExcessReminderServiceImpl implements ExcessReminderService
...
// extends-
{
	...
	private ExcessReminderDao excessReminderDao;
...
private ActivityLogService activityLogService;
	...
	public void setExcessReminderDao(ExcessReminderDao object) {
		this.excessReminderDao = object;
	}

	public ExcessReminderDao getExcessReminderDao() {
		return this.excessReminderDao;
	}

	/*
	 * Method create (ExcessReminder object) berfungsi untuk melakukan
	 ...
	 */
	public ExcessReminder create(ExcessReminder object, ActionUser actionUser)
			throws Exception {
		...
		ExcessReminder result = excessReminderDao.create(object);
		
		if (result != null){
			ExcessCharge excessCharge = excessChargeService.get(result.getExcessChargeId().getExcessChargeId());
			
			int counter = excessCharge.getReminderCounter() == null ? 0 : excessCharge.getReminderCounter();
			
			excessCharge.setReminderCounter(Integer.valueOf(counter+1));
			excessCharge.setNextReminderTime(result.getReminderDate());
	...
	/*
	 * Method update (ExcessReminder object) berfungsi untuk melakukan perubahan
	 ...
	 */
	public ExcessReminder update(ExcessReminder object, ActionUser actionUser)
			throws Exception {
		...
		excessReminderDao.update(object);
		return object;
	}
	 ...
	 * in any place
	 */
	public ExcessReminder trash(java.io.Serializable pkey) throws Exception {
		ExcessReminder object = excessReminderDao.get(pkey);
		excessReminderDao.delete(object);
		return object;
	}

	/*
	 * Method delete (ExcessReminder object) berfungsi untuk melakukan
	...
	public ExcessReminder delete(java.io.Serializable pkey, ActionUser actionUser)
			throws Exception {
		ExcessReminder object = excessReminderDao.get(pkey);
	...
	public ExcessReminder delete(ExcessReminder object, ActionUser actionUser)
			throws Exception {
	 ...
	 */
	public ExcessReminder get(java.io.Serializable pkey) throws Exception {
		ExcessReminder object = null;
		object = excessReminderDao.get(pkey);
		return object;
	}
	...
	public ExcessReminder get(java.io.Serializable pkey, String[] required)
			throws Exception {
		ExcessReminder object = null;
		object = excessReminderDao.get(pkey);
	...
	public Collection search(String[] likeColumns, Object[] likeParams,
		...
		Criteria c = excessReminderDao.getCriteria();
	...
	public Collection search(String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ExcessReminder element = (ExcessReminder) iter.next();
	...
	public ExcessReminder searchUnique(String eqColumns, Object eqParams,
			String[] required) throws Exception {
		Criteria c = excessReminderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
		ExcessReminder obj = (ExcessReminder) c.uniqueResult();
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = excessReminderDao.getDetachedCriteria();
		return dc;
	}
