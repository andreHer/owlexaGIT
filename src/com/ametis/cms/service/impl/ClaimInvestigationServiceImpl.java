...
/**
 * ClaimInvestigation is a servlet controller for claim_investigation Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ClaimInvestigationServiceImpl implements ClaimInvestigationService
...

{
	...
	private ClaimInvestigationDao  claimInvestigationDao;
private ActivityLogService activityLogService;
	...
	public void setClaimInvestigationDao (ClaimInvestigationDao object){
		this.claimInvestigationDao = object;
	}
	public ClaimInvestigationDao getClaimInvestigationDao (){
		return this.claimInvestigationDao;
	}
	/*
	...
	*/
	public ClaimInvestigation create (ClaimInvestigation object,ActionUser actionUser) throws Exception {
			...
			if (actionUser != null && actionUser.getUser() != null){
				object.setCreatedBy(actionUser.getUser().getUsername());
			}
			
			

			ClaimInvestigation result = claimInvestigationDao.create (object);
			return result;
		}
	/*
	* Method update (ClaimInvestigation object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClaimInvestigation update (ClaimInvestigation object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
		...
		if (actionUser != null && actionUser.getUser() != null){
			object.setModifiedBy(actionUser.getUser().getUsername());
		}
 		...
 		claimInvestigationDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClaimInvestigation trash (java.io.Serializable pkey) throws Exception {
		ClaimInvestigation object = claimInvestigationDao.get (pkey);
		claimInvestigationDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ClaimInvestigation delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ClaimInvestigation object = claimInvestigationDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
		...
		if (actionUser != null){
			if (actionUser.getUser() != null){
				object.setDeletedBy(actionUser.getUser().getUsername());
			}
		}
	...
	*/
	...
	public ClaimInvestigation delete (ClaimInvestigation object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClaimInvestigation get (java.io.Serializable pkey) throws Exception{
		ClaimInvestigation object = null;
		object = claimInvestigationDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClaimInvestigation get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClaimInvestigation object = null;
	    object = claimInvestigationDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = claimInvestigationDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClaimInvestigation element = (ClaimInvestigation) iter.next();
...
// unique Result
	...
	public ClaimInvestigation searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = claimInvestigationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClaimInvestigation obj = (ClaimInvestigation) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClaimInvestigation searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = claimInvestigationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClaimInvestigation obj = (ClaimInvestigation) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = claimInvestigationDao.getDetachedCriteria();
		return dc;
	}

	public List<ClaimInvestigation> getAllClaimInvestigationByClaimId(Integer claimId) throws Exception {
		List<ClaimInvestigation> listClaimInvestigation = new ArrayList<ClaimInvestigation>();
		...
		if (claimId != null) {
			...
			listClaimInvestigation = c.list();
		}

		return listClaimInvestigation;
	}
