...
// imports- 
/**
 * UserGroupAssignment is a servlet controller for user_group_assignment Table.
 * All you have to do is to convert necessary data field to the named parameter
 */
public class UserGroupAssignmentServiceImpl implements UserGroupAssignmentService // extends+ 
// extends- 
{

    private UserGroupAssignmentDao userGroupAssignmentDao;

    public void setUserGroupAssignmentDao(UserGroupAssignmentDao object) {
        this.userGroupAssignmentDao = object;
    }

    public UserGroupAssignmentDao getUserGroupAssignmentDao() {
        return this.userGroupAssignmentDao;
    }
    /*
     * Method create (UserGroupAssignment object) berfungsi untuk melakukan
    ...
    public UserGroupAssignment create(UserGroupAssignment object, ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
        ...
        UserGroupAssignment result = userGroupAssignmentDao.create(object);
        return result;
    }
    /*
     * Method update (UserGroupAssignment object) berfungsi untuk melakukan
    ...
    public UserGroupAssignment update(UserGroupAssignment object, ActionUser user) throws Exception {
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
        ...
        userGroupAssignmentDao.update(object);
        return object;
    }
     ...
     * in any place
     */
    public UserGroupAssignment trash(java.io.Serializable pkey) throws Exception {
        UserGroupAssignment object = userGroupAssignmentDao.get(pkey);
        userGroupAssignmentDao.delete(object);
        return object;
    }

    /*
     * Method delete (UserGroupAssignment object) berfungsi untuk melakukan
     ...
     * exception if failed
     */
    public UserGroupAssignment delete(java.io.Serializable pkey, ActionUser user) throws Exception {
        UserGroupAssignment object = userGroupAssignmentDao.get(pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
     ...
     * exception if failed
     */
    public UserGroupAssignment delete(UserGroupAssignment object, ActionUser user) throws Exception {
...
// -- get section - carefull !
     ...
     */
    public UserGroupAssignment get(java.io.Serializable pkey) throws Exception {
        UserGroupAssignment object = null;
        object = userGroupAssignmentDao.get(pkey);
        return object;
    }
    /*
     * Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
    ...
    public UserGroupAssignment get(java.io.Serializable pkey, String[] required) throws Exception {
        UserGroupAssignment object = null;
        object = userGroupAssignmentDao.get(pkey);
...
// -- 1
    public Collection search(String[] likeColumns, Object[] likeParams,
        ...
        Criteria c = userGroupAssignmentDao.getCriteria();
    ...
    public Collection search(String[] likeColumns, Object[] likeParams,
        ...
        for (Iterator iter = list.iterator(); iter.hasNext();) {
            UserGroupAssignment element = (UserGroupAssignment) iter.next();
...
// unique Result
    public UserGroupAssignment searchUnique(String eqColumns, Object eqParams, String[] required)
            throws Exception {
        Criteria c = userGroupAssignmentDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        UserGroupAssignment obj = (UserGroupAssignment) c.uniqueResult();
        DaoSupportUtil.lazyInit(required, obj);
        return obj;
    }

    public UserGroupAssignment searchUnique(String eqColumns, Object eqParams)
            throws Exception {
        Criteria c = userGroupAssignmentDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        UserGroupAssignment obj = (UserGroupAssignment) c.uniqueResult();
...
// -----------------------------------------------
    ...
    public DetachedCriteria getDetachedCriteria() throws Exception {
        DetachedCriteria dc = userGroupAssignmentDao.getDetachedCriteria();
        return dc;
    }
// class+ 
// class- 
