...
import com.ametis.cms.dao.MemberClausulDao;
...
*/
public class MemberClausulServiceImpl implements MemberClausulService
...

{
	...
	private MemberClausulDao  memberClausulDao;

	public void setMemberClausulDao (MemberClausulDao object){
		this.memberClausulDao = object;
	}
	public MemberClausulDao getMemberClausulDao (){
		return this.memberClausulDao;
	}
	/*
	* Method create (MemberClausul object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public MemberClausul create (MemberClausul object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			MemberClausul result = memberClausulDao.create (object);
			return result;
		}
	/*
	* Method update (MemberClausul object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MemberClausul update (MemberClausul object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		memberClausulDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MemberClausul trash (java.io.Serializable pkey) throws Exception {
		MemberClausul object = memberClausulDao.get (pkey);
		memberClausulDao.delete (object);
		return object;
	}

	/*
	* Method delete (MemberClausul object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public MemberClausul delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		MemberClausul object = memberClausulDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public MemberClausul delete (MemberClausul object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MemberClausul get (java.io.Serializable pkey) throws Exception{
		MemberClausul object = null;
		object = memberClausulDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MemberClausul get (java.io.Serializable pkey, String[] required) throws Exception{
	    MemberClausul object = null;
	    object = memberClausulDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = memberClausulDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MemberClausul element = (MemberClausul) iter.next();
...
// unique Result
	...
	public MemberClausul searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = memberClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberClausul obj = (MemberClausul) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MemberClausul searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = memberClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MemberClausul obj = (MemberClausul) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = memberClausulDao.getDetachedCriteria();
		return dc;
	}
	
	public Collection<MemberClausul> getMemberActiveClausul(Integer memberId)
			throws Exception {
		// TODO Auto-generated method stub
		Collection<MemberClausul> result = null;
		try {
	...
	public Collection<MemberClausul> getMemberActiveClausul(Integer memberId,
		...
		Collection<MemberClausul> result = null;
		try {
			String[] eqParam = {"memberId.memberId","deletedStatus","caseCategoryId.caseCategoryId"};
			Object[] eqValue = {memberId,Integer.valueOf(0),caseCategoryId};
