...
import com.ametis.cms.service.TpaService;
...
/**
 * Tpa is a servlet controller for tpa Table.
...
// extends- 
{
	...
	public void setTpaDao (TpaDao object){
		this.tpaDao = object;
	}
	public TpaDao getTpaDao (){
		return this.tpaDao;
	}
	/*
	...
	*/
	public Tpa create (Tpa object,ActionUser user) throws Exception {
			...
			Tpa result = tpaDao.create (object);
			return result;
		}
	/*
	* Method update (Tpa object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Tpa update (Tpa object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Tpa trash (java.io.Serializable pkey) throws Exception {
		Tpa object = tpaDao.get (pkey);
		tpaDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Tpa delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Tpa object = tpaDao.get (pkey);
	...
	*/
	...
	public Tpa delete (Tpa object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Tpa get (java.io.Serializable pkey) throws Exception{
		Tpa object = null;
		object = tpaDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Tpa get (java.io.Serializable pkey, String[] required) throws Exception{
	    Tpa object = null;
	    object = tpaDao.get(pkey);
...
// unique Result
	...
	public Tpa searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = tpaDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Tpa obj = (Tpa) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Tpa searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = tpaDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Tpa obj = (Tpa) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = tpaDao.getDetachedCriteria();
		return dc;
	}
