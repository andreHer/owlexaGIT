...
import com.ametis.cms.dao.MostFrequentItemDao;
...
/**
 * MostFrequentItem is a servlet controller for most_frequent_item Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class MostFrequentItemServiceImpl implements MostFrequentItemService
...
// extends- 
{
	...
	private MostFrequentItemDao  mostFrequentItemDao;

	public void setMostFrequentItemDao (MostFrequentItemDao object){
		this.mostFrequentItemDao = object;
	}
	public MostFrequentItemDao getMostFrequentItemDao (){
		return this.mostFrequentItemDao;
	}
	/*
	* Method create (MostFrequentItem object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public MostFrequentItem create (MostFrequentItem object,User user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			MostFrequentItem result = mostFrequentItemDao.create (object);
			return result;
		}
	/*
	* Method update (MostFrequentItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MostFrequentItem update (MostFrequentItem object,User user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		mostFrequentItemDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MostFrequentItem trash (java.io.Serializable pkey) throws Exception {
		MostFrequentItem object = mostFrequentItemDao.get (pkey);
		mostFrequentItemDao.delete (object);
		return object;
	}

	/*
	* Method delete (MostFrequentItem object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public MostFrequentItem delete (java.io.Serializable pkey,User user) throws Exception{
		MostFrequentItem object = mostFrequentItemDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public MostFrequentItem delete (MostFrequentItem object,User user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MostFrequentItem get (java.io.Serializable pkey) throws Exception{
		MostFrequentItem object = null;
		object = mostFrequentItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MostFrequentItem get (java.io.Serializable pkey, String[] required) throws Exception{
	    MostFrequentItem object = null;
	    object = mostFrequentItemDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = mostFrequentItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MostFrequentItem element = (MostFrequentItem) iter.next();
...
// unique Result
	...
	public MostFrequentItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = mostFrequentItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MostFrequentItem obj = (MostFrequentItem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MostFrequentItem searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = mostFrequentItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MostFrequentItem obj = (MostFrequentItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = mostFrequentItemDao.getDetachedCriteria();
		return dc;
	}
