...
*/
public class RefCityServiceImpl implements RefCityService
...
// extends- 
{
	...
	public void setRefCityDao (RefCityDao object){
		this.refCityDao = object;
	}
	public RefCityDao getRefCityDao (){
		return this.refCityDao;
	}
	/*
	...
	*/
	public RefCity create (RefCity object,ActionUser user) throws Exception {
			...
			RefCity result = refCityDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public RefCity trash (java.io.Serializable pkey) throws Exception {
		RefCity object = refCityDao.get (pkey);
		refCityDao.delete (object);
		return object;
	}
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = refCityDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			RefCity element = (RefCity) iter.next();
...
// unique Result
	...
	public RefCity searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = refCityDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RefCity obj = (RefCity) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = refCityDao.getDetachedCriteria();
		return dc;
	}
	public Collection searchCity(String q, Integer provinceId)
			throws Exception {
		// TODO Auto-generated method stub
		Collection<RefCity> result = new Vector<RefCity>();
        try {
            Session session = refCityDao.getCitySession();
            
            System.out.println("filter city by LIKE(cityName) and provinceId");

            String sqlQuery = "SELECT c FROM "
                    + "RefCity c WHERE lower(c.cityName) LIKE :keyword AND c.provinceId.id = :pid AND c.deletedStatus = 0 ORDER BY c.cityName ASC";
            ...
            query.setInteger("pid", provinceId);
	...
	public Collection searchCity(String q) throws Exception {
		// TODO Auto-generated method stub
		Collection<RefCity> result = new Vector<RefCity>();
        try {
            Session session = refCityDao.getCitySession();
            
            System.out.println("filter city by LIKE(cityName)");

            String sqlQuery = "SELECT c FROM "
                    + "RefCity c WHERE lower(c.cityName) LIKE :keyword  AND c.deletedStatus = 0 ORDER BY c.cityName ASC";
	...
	public Collection searchCity(String q, String provinceName)
			throws Exception {
        ...
        try {
            ...
            System.out.println("filter city by LIKE(cityName) and provinceName");

            String sqlQuery = "SELECT c FROM "
                    + "RefCity c WHERE lower(c.cityName) LIKE :keyword AND lower(c.provinceName) = :pid AND c.deletedStatus = 0 ORDER BY c.cityName ASC";
            ...
            query.setString("keyword", "%" + q + "%");
            query.setString("pid", provinceName);
            query.setMaxResults(10);
