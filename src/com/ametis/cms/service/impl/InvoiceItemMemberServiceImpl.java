...
import com.ametis.cms.dao.InvoiceItemMemberDao;
...
/**
 * InvoiceItemMember is a servlet controller for invoice_item_member Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class InvoiceItemMemberServiceImpl implements InvoiceItemMemberService
...
// extends- 
{
	...
	private InvoiceItemMemberDao  invoiceItemMemberDao;

	public void setInvoiceItemMemberDao (InvoiceItemMemberDao object){
		this.invoiceItemMemberDao = object;
	}
	public InvoiceItemMemberDao getInvoiceItemMemberDao (){
		return this.invoiceItemMemberDao;
	}
	/*
	* Method create (InvoiceItemMember object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public InvoiceItemMember create (InvoiceItemMember object,ActionUser user) throws Exception {
			...
			InvoiceItemMember result = invoiceItemMemberDao.create (object);
			return result;
		}
	/*
	* Method update (InvoiceItemMember object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public InvoiceItemMember update (InvoiceItemMember object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		invoiceItemMemberDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public InvoiceItemMember trash (java.io.Serializable pkey) throws Exception {
		InvoiceItemMember object = invoiceItemMemberDao.get (pkey);
		invoiceItemMemberDao.delete (object);
		return object;
	}

	/*
	* Method delete (InvoiceItemMember object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public InvoiceItemMember delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		InvoiceItemMember object = invoiceItemMemberDao.get (pkey);
	...
	*/
	...
	public InvoiceItemMember delete (InvoiceItemMember object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public InvoiceItemMember get (java.io.Serializable pkey) throws Exception{
		InvoiceItemMember object = null;
		object = invoiceItemMemberDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public InvoiceItemMember get (java.io.Serializable pkey, String[] required) throws Exception{
	    InvoiceItemMember object = null;
	    object = invoiceItemMemberDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = invoiceItemMemberDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			InvoiceItemMember element = (InvoiceItemMember) iter.next();
...
// unique Result
	...
	public InvoiceItemMember searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = invoiceItemMemberDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		InvoiceItemMember obj = (InvoiceItemMember) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public InvoiceItemMember searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = invoiceItemMemberDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		InvoiceItemMember obj = (InvoiceItemMember) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = invoiceItemMemberDao.getDetachedCriteria();
		return dc;
	}
