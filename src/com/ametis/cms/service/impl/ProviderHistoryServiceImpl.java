...
import com.ametis.cms.dao.ProviderHistoryDao;
...
/**
 * ProviderHistory is a servlet controller for provider_history Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderHistoryServiceImpl implements ProviderHistoryService
...
// extends- 
{
	...
	public void setProviderHistoryDao (ProviderHistoryDao object){
		this.providerHistoryDao = object;
	}
	public ProviderHistoryDao getProviderHistoryDao (){
		return this.providerHistoryDao;
	}
	/*
	* Method create (ProviderHistory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProviderHistory create (ProviderHistory object,ActionUser user) throws Exception {
			...
			ProviderHistory result = providerHistoryDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderHistory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderHistory update (ProviderHistory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerHistoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderHistory trash (java.io.Serializable pkey) throws Exception {
		ProviderHistory object = providerHistoryDao.get (pkey);
		providerHistoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProviderHistory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProviderHistory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderHistory object = providerHistoryDao.get (pkey);
	...
	*/
	...
	public ProviderHistory delete (ProviderHistory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderHistory get (java.io.Serializable pkey) throws Exception{
		ProviderHistory object = null;
		object = providerHistoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderHistory get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderHistory object = null;
	    object = providerHistoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerHistoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderHistory element = (ProviderHistory) iter.next();
...
// unique Result
	...
	public ProviderHistory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderHistory obj = (ProviderHistory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderHistory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderHistory obj = (ProviderHistory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerHistoryDao.getDetachedCriteria();
		return dc;
	}
