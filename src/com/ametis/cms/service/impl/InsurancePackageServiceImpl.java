...
/**
 * InsurancePackage is a servlet controller for insurance_package Table.
...

{
	...
	private InsurancePackageDao  insurancePackageDao;
private ActivityLogService activityLogService;
	...
	public void setInsurancePackageDao (InsurancePackageDao object){
		this.insurancePackageDao = object;
	}
	public InsurancePackageDao getInsurancePackageDao (){
		return this.insurancePackageDao;
	}
	/*
	...
	*/
	public InsurancePackage create (InsurancePackage object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			InsurancePackage result = insurancePackageDao.create (object);
			return result;
		}
	/*
	* Method update (InsurancePackage object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public InsurancePackage update (InsurancePackage object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		insurancePackageDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public InsurancePackage trash (java.io.Serializable pkey) throws Exception {
		InsurancePackage object = insurancePackageDao.get (pkey);
		insurancePackageDao.delete (object);
		return object;
	}
	...
	*/
	...
	public InsurancePackage delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		InsurancePackage object = insurancePackageDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public InsurancePackage delete (InsurancePackage object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public InsurancePackage get (java.io.Serializable pkey) throws Exception{
		InsurancePackage object = null;
		object = insurancePackageDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public InsurancePackage get (java.io.Serializable pkey, String[] required) throws Exception{
	    InsurancePackage object = null;
	    object = insurancePackageDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = insurancePackageDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			InsurancePackage element = (InsurancePackage) iter.next();
...
// unique Result
	...
	public InsurancePackage searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = insurancePackageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		InsurancePackage obj = (InsurancePackage) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public InsurancePackage searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = insurancePackageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		InsurancePackage obj = (InsurancePackage) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = insurancePackageDao.getDetachedCriteria();
		return dc;
	}
