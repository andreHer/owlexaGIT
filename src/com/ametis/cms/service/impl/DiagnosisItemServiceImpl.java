...
/**
 * DiagnosisItem is a servlet controller for diagnosis_item Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class DiagnosisItemServiceImpl implements DiagnosisItemService
...

{
	...
	private DiagnosisItemDao  diagnosisItemDao;
private ActivityLogService activityLogService;
	...
	public void setDiagnosisItemDao (DiagnosisItemDao object){
		this.diagnosisItemDao = object;
	}
	public DiagnosisItemDao getDiagnosisItemDao (){
		return this.diagnosisItemDao;
	}
	/*
	...
	*/
	public DiagnosisItem create (DiagnosisItem object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			DiagnosisItem result = diagnosisItemDao.create (object);
			return result;
		}
	/*
	* Method update (DiagnosisItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public DiagnosisItem update (DiagnosisItem object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		diagnosisItemDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public DiagnosisItem trash (java.io.Serializable pkey) throws Exception {
		DiagnosisItem object = diagnosisItemDao.get (pkey);
		diagnosisItemDao.delete (object);
		return object;
	}
	...
	*/
	...
	public DiagnosisItem delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		DiagnosisItem object = diagnosisItemDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public DiagnosisItem delete (DiagnosisItem object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public DiagnosisItem get (java.io.Serializable pkey) throws Exception{
		DiagnosisItem object = null;
		object = diagnosisItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public DiagnosisItem get (java.io.Serializable pkey, String[] required) throws Exception{
	    DiagnosisItem object = null;
	    object = diagnosisItemDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = diagnosisItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DiagnosisItem element = (DiagnosisItem) iter.next();
...
// unique Result
	...
	public DiagnosisItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = diagnosisItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisItem obj = (DiagnosisItem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public DiagnosisItem searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = diagnosisItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisItem obj = (DiagnosisItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = diagnosisItemDao.getDetachedCriteria();
		return dc;
	}
