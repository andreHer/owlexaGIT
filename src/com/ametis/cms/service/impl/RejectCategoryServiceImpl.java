...
/**
 * RejectCategory is a servlet controller for reject_category Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class RejectCategoryServiceImpl implements RejectCategoryService
...
// extends- 
{
	...
	private RejectCategoryDao  rejectCategoryDao;
private ActivityLogService activityLogService;
	...
	public void setRejectCategoryDao (RejectCategoryDao object){
		this.rejectCategoryDao = object;
	}
	public RejectCategoryDao getRejectCategoryDao (){
		return this.rejectCategoryDao;
	}
	/*
	...
	*/
	public RejectCategory create (RejectCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			RejectCategory result = rejectCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (RejectCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public RejectCategory update (RejectCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		rejectCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public RejectCategory trash (java.io.Serializable pkey) throws Exception {
		RejectCategory object = rejectCategoryDao.get (pkey);
		rejectCategoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public RejectCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		RejectCategory object = rejectCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public RejectCategory delete (RejectCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public RejectCategory get (java.io.Serializable pkey) throws Exception{
		RejectCategory object = null;
		object = rejectCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public RejectCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    RejectCategory object = null;
	    object = rejectCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = rejectCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			RejectCategory element = (RejectCategory) iter.next();
...
// unique Result
	...
	public RejectCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = rejectCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RejectCategory obj = (RejectCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public RejectCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = rejectCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RejectCategory obj = (RejectCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = rejectCategoryDao.getDetachedCriteria();
		return dc;
	}
