...
import com.ametis.cms.service.PolicyDocumentService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.PolicyDocument;
import com.ametis.cms.dao.PolicyDocumentDao;
...
/**
 * PolicyDocument is a servlet controller for policy_document Table.
...

{
	...
	public void setPolicyDocumentDao (PolicyDocumentDao object){
		this.policyDocumentDao = object;
	}
	public PolicyDocumentDao getPolicyDocumentDao (){
		return this.policyDocumentDao;
	}
	/*
	* Method create (PolicyDocument object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public PolicyDocument create (PolicyDocument object,ActionUser user) throws Exception {
			...
			PolicyDocument result = policyDocumentDao.create (object);
			return result;
		}
	/*
	* Method update (PolicyDocument object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PolicyDocument update (PolicyDocument object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		policyDocumentDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public PolicyDocument trash (java.io.Serializable pkey) throws Exception {
		PolicyDocument object = policyDocumentDao.get (pkey);
		policyDocumentDao.delete (object);
		return object;
	}

	/*
	* Method delete (PolicyDocument object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public PolicyDocument delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PolicyDocument object = policyDocumentDao.get (pkey);
	...
	*/
	...
	public PolicyDocument delete (PolicyDocument object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PolicyDocument get (java.io.Serializable pkey) throws Exception{
		PolicyDocument object = null;
		object = policyDocumentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PolicyDocument get (java.io.Serializable pkey, String[] required) throws Exception{
	    PolicyDocument object = null;
	    object = policyDocumentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = policyDocumentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PolicyDocument element = (PolicyDocument) iter.next();
...
// unique Result
	...
	public PolicyDocument searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = policyDocumentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyDocument obj = (PolicyDocument) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PolicyDocument searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = policyDocumentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyDocument obj = (PolicyDocument) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = policyDocumentDao.getDetachedCriteria();
		return dc;
	}
