...
import com.ametis.cms.dao.ServiceDiagnosisDao;
...
/**
 * ServiceDiagnosis is a servlet controller for service_diagnosis Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ServiceDiagnosisServiceImpl implements ServiceDiagnosisService
...

{
	...
	private ServiceDiagnosisDao  serviceDiagnosisDao;
private ActivityLogService activityLogService;
	...
	public void setServiceDiagnosisDao (ServiceDiagnosisDao object){
		this.serviceDiagnosisDao = object;
	}
	public ServiceDiagnosisDao getServiceDiagnosisDao (){
		return this.serviceDiagnosisDao;
	}
	/*
	* Method create (ServiceDiagnosis object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ServiceDiagnosis create (ServiceDiagnosis object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ServiceDiagnosis result = serviceDiagnosisDao.create (object);
			return result;
		}
	/*
	* Method update (ServiceDiagnosis object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ServiceDiagnosis update (ServiceDiagnosis object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		serviceDiagnosisDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ServiceDiagnosis trash (java.io.Serializable pkey) throws Exception {
		ServiceDiagnosis object = serviceDiagnosisDao.get (pkey);
		serviceDiagnosisDao.delete (object);
		return object;
	}

	/*
	* Method delete (ServiceDiagnosis object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ServiceDiagnosis delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ServiceDiagnosis object = serviceDiagnosisDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ServiceDiagnosis delete (ServiceDiagnosis object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ServiceDiagnosis get (java.io.Serializable pkey) throws Exception{
		ServiceDiagnosis object = null;
		object = serviceDiagnosisDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ServiceDiagnosis get (java.io.Serializable pkey, String[] required) throws Exception{
	    ServiceDiagnosis object = null;
	    object = serviceDiagnosisDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = serviceDiagnosisDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ServiceDiagnosis element = (ServiceDiagnosis) iter.next();
...
// unique Result
	...
	public ServiceDiagnosis searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = serviceDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ServiceDiagnosis obj = (ServiceDiagnosis) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ServiceDiagnosis searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = serviceDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ServiceDiagnosis obj = (ServiceDiagnosis) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = serviceDiagnosisDao.getDetachedCriteria();
		return dc;
	}
