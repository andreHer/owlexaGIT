...
*/
public class ItemMeasurementUnitServiceImpl implements ItemMeasurementUnitService
...

{
	...
	private ItemMeasurementUnitDao  itemMeasurementUnitDao;
private ActivityLogService activityLogService;
	...
	public void setItemMeasurementUnitDao (ItemMeasurementUnitDao object){
		this.itemMeasurementUnitDao = object;
	}
	public ItemMeasurementUnitDao getItemMeasurementUnitDao (){
		return this.itemMeasurementUnitDao;
	}
	/*
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ItemMeasurementUnit result = itemMeasurementUnitDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		itemMeasurementUnitDao.update (object);
      	return object;
	}
	...
	*/
	public ItemMeasurementUnit trash (java.io.Serializable pkey) throws Exception {
		ItemMeasurementUnit object = itemMeasurementUnitDao.get (pkey);
		itemMeasurementUnitDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public ItemMeasurementUnit get (java.io.Serializable pkey) throws Exception{
		ItemMeasurementUnit object = null;
		object = itemMeasurementUnitDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = itemMeasurementUnitDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ItemMeasurementUnit element = (ItemMeasurementUnit) iter.next();
...
// unique Result
	...
	public ItemMeasurementUnit searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = itemMeasurementUnitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ItemMeasurementUnit obj = (ItemMeasurementUnit) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = itemMeasurementUnitDao.getDetachedCriteria();
		return dc;
	}
