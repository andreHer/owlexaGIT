...
import com.ametis.cms.service.ProcedureDiagnosisService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.ProcedureDiagnosis;
import com.ametis.cms.dao.ProcedureDiagnosisDao;
...
/**
 * ProcedureDiagnosis is a servlet controller for procedure_diagnosis Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProcedureDiagnosisServiceImpl implements ProcedureDiagnosisService
...
// extends- 
{
	...
	private ProcedureDiagnosisDao  procedureDiagnosisDao;

	public void setProcedureDiagnosisDao (ProcedureDiagnosisDao object){
		this.procedureDiagnosisDao = object;
	}
	public ProcedureDiagnosisDao getProcedureDiagnosisDao (){
		return this.procedureDiagnosisDao;
	}
	/*
	* Method create (ProcedureDiagnosis object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProcedureDiagnosis create (ProcedureDiagnosis object,ActionUser user) throws Exception {
			...
			ProcedureDiagnosis result = procedureDiagnosisDao.create (object);
			return result;
		}
	/*
	* Method update (ProcedureDiagnosis object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProcedureDiagnosis update (ProcedureDiagnosis object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		procedureDiagnosisDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProcedureDiagnosis trash (java.io.Serializable pkey) throws Exception {
		ProcedureDiagnosis object = procedureDiagnosisDao.get (pkey);
		procedureDiagnosisDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProcedureDiagnosis object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProcedureDiagnosis delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProcedureDiagnosis object = procedureDiagnosisDao.get (pkey);
	...
	*/
	...
	public ProcedureDiagnosis delete (ProcedureDiagnosis object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProcedureDiagnosis get (java.io.Serializable pkey) throws Exception{
		ProcedureDiagnosis object = null;
		object = procedureDiagnosisDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProcedureDiagnosis get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProcedureDiagnosis object = null;
	    object = procedureDiagnosisDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = procedureDiagnosisDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProcedureDiagnosis element = (ProcedureDiagnosis) iter.next();
...
// unique Result
	...
	public ProcedureDiagnosis searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = procedureDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProcedureDiagnosis obj = (ProcedureDiagnosis) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProcedureDiagnosis searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = procedureDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProcedureDiagnosis obj = (ProcedureDiagnosis) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = procedureDiagnosisDao.getDetachedCriteria();
		return dc;
	}
