...
import com.ametis.cms.dao.PoliklinikDao;
...
/**
 * Poliklinik is a servlet controller for poliklinik Table.
...
// extends- 
{
	...
	private PoliklinikDao  poliklinikDao;

	public void setPoliklinikDao (PoliklinikDao object){
		this.poliklinikDao = object;
	}
	public PoliklinikDao getPoliklinikDao (){
		return this.poliklinikDao;
	}
	/*
	* Method create (Poliklinik object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Poliklinik create (Poliklinik object,ActionUser user) throws Exception {
			...
			Poliklinik result = poliklinikDao.create (object);
			return result;
		}
	/*
	* Method update (Poliklinik object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Poliklinik update (Poliklinik object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Poliklinik trash (java.io.Serializable pkey) throws Exception {
		Poliklinik object = poliklinikDao.get (pkey);
		poliklinikDao.delete (object);
		return object;
	}

	/*
	* Method delete (Poliklinik object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Poliklinik delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Poliklinik object = poliklinikDao.get (pkey);
	...
	*/
	...
	public Poliklinik delete (Poliklinik object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Poliklinik get (java.io.Serializable pkey) throws Exception{
		Poliklinik object = null;
		object = poliklinikDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Poliklinik get (java.io.Serializable pkey, String[] required) throws Exception{
	    Poliklinik object = null;
	    object = poliklinikDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = poliklinikDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Poliklinik element = (Poliklinik) iter.next();
...
// unique Result
	...
	public Poliklinik searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = poliklinikDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Poliklinik obj = (Poliklinik) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Poliklinik searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = poliklinikDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Poliklinik obj = (Poliklinik) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = poliklinikDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public Poliklinik getPoliByEdcCode(String edcCode) throws Exception {
		// TODO Auto-generated method stub
		Poliklinik result = null;
		
		if (edcCode != null){
			String[] eqParam = {"deletedStatus","poliklinikEdcCode"};
			Object[] eqValue = {Integer.valueOf(0),edcCode};
			
			Collection<Poliklinik> poliList = search(null,null,eqParam,eqValue,0,1);
			
			if (poliList != null){
				Iterator<Poliklinik> iterator = poliList.iterator();
