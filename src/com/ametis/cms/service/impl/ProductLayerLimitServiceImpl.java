...
*/
public class ProductLayerLimitServiceImpl implements ProductLayerLimitService
...

{
	...
	private ProductLayerLimitDao  productLayerLimitDao;

	public void setProductLayerLimitDao (ProductLayerLimitDao object){
		this.productLayerLimitDao = object;
	}
	public ProductLayerLimitDao getProductLayerLimitDao (){
		return this.productLayerLimitDao;
	}
	/*
	...
	*/
	public ProductLayerLimit create (ProductLayerLimit object,ActionUser user) throws Exception {
			...
			ProductLayerLimit result = productLayerLimitDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		productLayerLimitDao.update (object);
      	return object;
	}
	...
	*/
	public ProductLayerLimit trash (java.io.Serializable pkey) throws Exception {
		ProductLayerLimit object = productLayerLimitDao.get (pkey);
		productLayerLimitDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public ProductLayerLimit get (java.io.Serializable pkey) throws Exception{
		ProductLayerLimit object = null;
		object = productLayerLimitDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productLayerLimitDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductLayerLimit element = (ProductLayerLimit) iter.next();
...
// unique Result
	...
	public ProductLayerLimit searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = productLayerLimitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductLayerLimit obj = (ProductLayerLimit) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productLayerLimitDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public ProductLayerLimit getProductLayer(Integer productId, Integer layerCounter) throws Exception {
		// TODO Auto-generated method stub
		ProductLayerLimit result = null;
		
		String[] eqParam = {"productId.productId","deletedStatus","layerLevel"};
		Object[] eqValue = {productId,0,layerCounter};
		
		Collection<ProductLayerLimit> collection = search(null,null,eqParam,eqValue,0,1);
		
		if (collection != null && !collection.isEmpty()){
			Iterator<ProductLayerLimit> iterator = collection.iterator();
	...
	public Collection<ProductLayerLimit> getProductLayerList(Integer productId) throws Exception {
		// TODO Auto-generated method stub
		Collection<ProductLayerLimit> result = null;
		
		String[] eqParam = {"productId.productId","deletedStatus"};
		Object[] eqValue = {productId,0};
