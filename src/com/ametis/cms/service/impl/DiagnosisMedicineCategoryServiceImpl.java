...
import com.ametis.cms.service.DiagnosisMedicineCategoryService;
...
/**
 * DiagnosisMedicineCategory is a servlet controller for diagnosis_medicine_category Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class DiagnosisMedicineCategoryServiceImpl implements DiagnosisMedicineCategoryService
...

{
	...
	private DiagnosisMedicineCategoryDao  diagnosisMedicineCategoryDao;

	public void setDiagnosisMedicineCategoryDao (DiagnosisMedicineCategoryDao object){
		this.diagnosisMedicineCategoryDao = object;
	}
	public DiagnosisMedicineCategoryDao getDiagnosisMedicineCategoryDao (){
		return this.diagnosisMedicineCategoryDao;
	}
	/*
	...
	*/
	public DiagnosisMedicineCategory create (DiagnosisMedicineCategory object,ActionUser user) throws Exception {
			...
			DiagnosisMedicineCategory result = diagnosisMedicineCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (DiagnosisMedicineCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public DiagnosisMedicineCategory update (DiagnosisMedicineCategory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		diagnosisMedicineCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public DiagnosisMedicineCategory trash (java.io.Serializable pkey) throws Exception {
		DiagnosisMedicineCategory object = diagnosisMedicineCategoryDao.get (pkey);
		diagnosisMedicineCategoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public DiagnosisMedicineCategory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		DiagnosisMedicineCategory object = diagnosisMedicineCategoryDao.get (pkey);
	...
	*/
	...
	public DiagnosisMedicineCategory delete (DiagnosisMedicineCategory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public DiagnosisMedicineCategory get (java.io.Serializable pkey) throws Exception{
		DiagnosisMedicineCategory object = null;
		object = diagnosisMedicineCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public DiagnosisMedicineCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    DiagnosisMedicineCategory object = null;
	    object = diagnosisMedicineCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = diagnosisMedicineCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DiagnosisMedicineCategory element = (DiagnosisMedicineCategory) iter.next();
...
// unique Result
	...
	public DiagnosisMedicineCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = diagnosisMedicineCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisMedicineCategory obj = (DiagnosisMedicineCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public DiagnosisMedicineCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = diagnosisMedicineCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisMedicineCategory obj = (DiagnosisMedicineCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = diagnosisMedicineCategoryDao.getDetachedCriteria();
		return dc;
	}
