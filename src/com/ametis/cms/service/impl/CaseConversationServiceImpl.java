...
import com.ametis.cms.dao.CaseConversationDao;
...
/**
 * CaseConversation is a servlet controller for case_conversation Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class CaseConversationServiceImpl implements CaseConversationService
...

{
	...
	private CaseConversationDao  caseConversationDao;
private ActivityLogService activityLogService;
	...
	public void setCaseConversationDao (CaseConversationDao object){
		this.caseConversationDao = object;
	}
	public CaseConversationDao getCaseConversationDao (){
		return this.caseConversationDao;
	}
	/*
	* Method create (CaseConversation object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public CaseConversation create (CaseConversation object,ActionUser actionUser) throws Exception {
			...
			CaseConversation result = caseConversationDao.create (object);
			return result;
		}
	/*
	* Method update (CaseConversation object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CaseConversation update (CaseConversation object,ActionUser actionUser) throws Exception{
		...
		if (actionUser != null){
 		...
 		caseConversationDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public CaseConversation trash (java.io.Serializable pkey) throws Exception {
		CaseConversation object = caseConversationDao.get (pkey);
		caseConversationDao.delete (object);
		return object;
	}

	/*
	* Method delete (CaseConversation object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public CaseConversation delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		CaseConversation object = caseConversationDao.get (pkey);
	...
	*/
	...
	public CaseConversation delete (CaseConversation object,ActionUser actionUser) throws Exception{
	...
	*/
	public CaseConversation get (java.io.Serializable pkey) throws Exception{
		CaseConversation object = null;
		object = caseConversationDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CaseConversation get (java.io.Serializable pkey, String[] required) throws Exception{
	    CaseConversation object = null;
	    object = caseConversationDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseConversationDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CaseConversation element = (CaseConversation) iter.next();
...
// unique Result
	...
	public CaseConversation searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = caseConversationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseConversation obj = (CaseConversation) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CaseConversation searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = caseConversationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseConversation obj = (CaseConversation) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseConversationDao.getDetachedCriteria();
		return dc;
	}
