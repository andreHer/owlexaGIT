...
import com.ametis.cms.dao.ProviderGroupDao;
...
/**
 * ProviderGroup is a servlet controller for provider_group Table.
...
// extends- 
{
	...
	public void setProviderGroupDao (ProviderGroupDao object){
		this.providerGroupDao = object;
	}
	public ProviderGroupDao getProviderGroupDao (){
		return this.providerGroupDao;
	}
	/*
	* Method create (ProviderGroup object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProviderGroup create (ProviderGroup object,ActionUser user) throws Exception {
			...
			ProviderGroup result = providerGroupDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderGroup object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderGroup update (ProviderGroup object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerGroupDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderGroup trash (java.io.Serializable pkey) throws Exception {
		ProviderGroup object = providerGroupDao.get (pkey);
		providerGroupDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProviderGroup object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProviderGroup delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderGroup object = providerGroupDao.get (pkey);
	...
	*/
	...
	public ProviderGroup delete (ProviderGroup object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderGroup get (java.io.Serializable pkey) throws Exception{
		ProviderGroup object = null;
		object = providerGroupDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderGroup get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderGroup object = null;
	    object = providerGroupDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerGroupDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderGroup element = (ProviderGroup) iter.next();
...
// unique Result
	...
	public ProviderGroup searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerGroupDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderGroup obj = (ProviderGroup) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderGroup searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerGroupDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderGroup obj = (ProviderGroup) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerGroupDao.getDetachedCriteria();
		return dc;
	}
