...
import com.ametis.cms.dao.ClausulCategoryDao;
...
/**
 * ClausulCategory is a servlet controller for clausul_category Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ClausulCategoryServiceImpl implements ClausulCategoryService
...

{
	...
	private ClausulCategoryDao  clausulCategoryDao;
private ActivityLogService activityLogService;
	...
	public void setClausulCategoryDao (ClausulCategoryDao object){
		this.clausulCategoryDao = object;
	}
	public ClausulCategoryDao getClausulCategoryDao (){
		return this.clausulCategoryDao;
	}
	/*
	* Method create (ClausulCategory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ClausulCategory create (ClausulCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ClausulCategory result = clausulCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (ClausulCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClausulCategory update (ClausulCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		clausulCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClausulCategory trash (java.io.Serializable pkey) throws Exception {
		ClausulCategory object = clausulCategoryDao.get (pkey);
		clausulCategoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (ClausulCategory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ClausulCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ClausulCategory object = clausulCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ClausulCategory delete (ClausulCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClausulCategory get (java.io.Serializable pkey) throws Exception{
		ClausulCategory object = null;
		object = clausulCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClausulCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClausulCategory object = null;
	    object = clausulCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clausulCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClausulCategory element = (ClausulCategory) iter.next();
...
// unique Result
	...
	public ClausulCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clausulCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClausulCategory obj = (ClausulCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClausulCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clausulCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClausulCategory obj = (ClausulCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clausulCategoryDao.getDetachedCriteria();
		return dc;
	}
