...
import com.ametis.cms.dao.EventCategoryDao;
...
/**
 * EventCategory is a servlet controller for event_category Table.
...
private ActivityLogService activityLogService;
	...
	public void setEventCategoryDao (EventCategoryDao object){
		this.eventCategoryDao = object;
	}
	public EventCategoryDao getEventCategoryDao (){
		return this.eventCategoryDao;
	}
	/*
	* Method create (EventCategory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public EventCategory create (EventCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			EventCategory result = eventCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (EventCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public EventCategory update (EventCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		eventCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public EventCategory trash (java.io.Serializable pkey) throws Exception {
		EventCategory object = eventCategoryDao.get (pkey);
		eventCategoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (EventCategory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public EventCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		EventCategory object = eventCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public EventCategory delete (EventCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public EventCategory get (java.io.Serializable pkey) throws Exception{
		EventCategory object = null;
		object = eventCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public EventCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    EventCategory object = null;
	    object = eventCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = eventCategoryDao.getCriteria();
...
// unique Result
	...
	public EventCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = eventCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		EventCategory obj = (EventCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public EventCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = eventCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		EventCategory obj = (EventCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = eventCategoryDao.getDetachedCriteria();
		return dc;
	}
