...
import com.ametis.cms.service.ClientProviderDiagnosisService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.ClientProviderDiagnosis;
import com.ametis.cms.dao.ClientProviderDiagnosisDao;
...
/**
 * ClientProviderDiagnosis is a servlet controller for client_provider_diagnosis Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ClientProviderDiagnosisServiceImpl implements ClientProviderDiagnosisService
...

{
	...
	private ClientProviderDiagnosisDao  clientProviderDiagnosisDao;

	public void setClientProviderDiagnosisDao (ClientProviderDiagnosisDao object){
		this.clientProviderDiagnosisDao = object;
	}
	public ClientProviderDiagnosisDao getClientProviderDiagnosisDao (){
		return this.clientProviderDiagnosisDao;
	}
	/*
	* Method create (ClientProviderDiagnosis object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ClientProviderDiagnosis create (ClientProviderDiagnosis object,ActionUser user) throws Exception {
			...
			ClientProviderDiagnosis result = clientProviderDiagnosisDao.create (object);
			return result;
		}
	/*
	* Method update (ClientProviderDiagnosis object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClientProviderDiagnosis update (ClientProviderDiagnosis object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		clientProviderDiagnosisDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClientProviderDiagnosis trash (java.io.Serializable pkey) throws Exception {
		ClientProviderDiagnosis object = clientProviderDiagnosisDao.get (pkey);
		clientProviderDiagnosisDao.delete (object);
		return object;
	}

	/*
	* Method delete (ClientProviderDiagnosis object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ClientProviderDiagnosis delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ClientProviderDiagnosis object = clientProviderDiagnosisDao.get (pkey);
	...
	*/
	...
	public ClientProviderDiagnosis delete (ClientProviderDiagnosis object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClientProviderDiagnosis get (java.io.Serializable pkey) throws Exception{
		ClientProviderDiagnosis object = null;
		object = clientProviderDiagnosisDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClientProviderDiagnosis get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClientProviderDiagnosis object = null;
	    object = clientProviderDiagnosisDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clientProviderDiagnosisDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClientProviderDiagnosis element = (ClientProviderDiagnosis) iter.next();
...
// unique Result
	...
	public ClientProviderDiagnosis searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clientProviderDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientProviderDiagnosis obj = (ClientProviderDiagnosis) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClientProviderDiagnosis searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clientProviderDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientProviderDiagnosis obj = (ClientProviderDiagnosis) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clientProviderDiagnosisDao.getDetachedCriteria();
		return dc;
	}
