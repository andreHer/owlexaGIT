...
import com.ametis.cms.dao.QuotationProductDao;
...
/**
 * QuotationProduct is a servlet controller for quotation_product Table.
...
// extends- 
{
	...
	public void setQuotationProductDao (QuotationProductDao object){
		this.quotationProductDao = object;
	}
	public QuotationProductDao getQuotationProductDao (){
		return this.quotationProductDao;
	}
	/*
	* Method create (QuotationProduct object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public QuotationProduct create (QuotationProduct object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			QuotationProduct result = quotationProductDao.create (object);
			return result;
		}
	/*
	* Method update (QuotationProduct object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public QuotationProduct update (QuotationProduct object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		quotationProductDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public QuotationProduct trash (java.io.Serializable pkey) throws Exception {
		QuotationProduct object = quotationProductDao.get (pkey);
		quotationProductDao.delete (object);
		return object;
	}

	/*
	* Method delete (QuotationProduct object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public QuotationProduct delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		QuotationProduct object = quotationProductDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public QuotationProduct delete (QuotationProduct object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public QuotationProduct get (java.io.Serializable pkey) throws Exception{
		QuotationProduct object = null;
		object = quotationProductDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public QuotationProduct get (java.io.Serializable pkey, String[] required) throws Exception{
	    QuotationProduct object = null;
	    object = quotationProductDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = quotationProductDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			QuotationProduct element = (QuotationProduct) iter.next();
...
// unique Result
	...
	public QuotationProduct searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = quotationProductDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		QuotationProduct obj = (QuotationProduct) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public QuotationProduct searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = quotationProductDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		QuotationProduct obj = (QuotationProduct) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = quotationProductDao.getDetachedCriteria();
		return dc;
	}
