...
/**
 * BenefitUsageType is a servlet controller for benefit_usage_type Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class BenefitUsageTypeServiceImpl implements BenefitUsageTypeService
...

{
	...
	private BenefitUsageTypeDao  benefitUsageTypeDao;

	public void setBenefitUsageTypeDao (BenefitUsageTypeDao object){
		this.benefitUsageTypeDao = object;
	}
	public BenefitUsageTypeDao getBenefitUsageTypeDao (){
		return this.benefitUsageTypeDao;
	}
	/*
	...
	*/
	public BenefitUsageType create (BenefitUsageType object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			BenefitUsageType result = benefitUsageTypeDao.create (object);
			return result;
		}
	/*
	* Method update (BenefitUsageType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public BenefitUsageType update (BenefitUsageType object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		benefitUsageTypeDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public BenefitUsageType trash (java.io.Serializable pkey) throws Exception {
		BenefitUsageType object = benefitUsageTypeDao.get (pkey);
		benefitUsageTypeDao.delete (object);
		return object;
	}
	...
	*/
	...
	public BenefitUsageType delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		BenefitUsageType object = benefitUsageTypeDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public BenefitUsageType delete (BenefitUsageType object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public BenefitUsageType get (java.io.Serializable pkey) throws Exception{
		BenefitUsageType object = null;
		object = benefitUsageTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public BenefitUsageType get (java.io.Serializable pkey, String[] required) throws Exception{
	    BenefitUsageType object = null;
	    object = benefitUsageTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = benefitUsageTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			BenefitUsageType element = (BenefitUsageType) iter.next();
...
// unique Result
	...
	public BenefitUsageType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = benefitUsageTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		BenefitUsageType obj = (BenefitUsageType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public BenefitUsageType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = benefitUsageTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		BenefitUsageType obj = (BenefitUsageType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = benefitUsageTypeDao.getDetachedCriteria();
		return dc;
	}
