...
import com.ametis.cms.service.HolidayService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.Holiday;
import com.ametis.cms.dao.HolidayDao;
...
/**
 * Holiday is a servlet controller for holiday Table.
...
// extends- 
{
	...
	public void setHolidayDao (HolidayDao object){
		this.holidayDao = object;
	}
	public HolidayDao getHolidayDao (){
		return this.holidayDao;
	}
	/*
	* Method create (Holiday object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Holiday create (Holiday object,ActionUser user) throws Exception {
			...
			Holiday result = holidayDao.create (object);
			return result;
		}
	/*
	* Method update (Holiday object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Holiday update (Holiday object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Holiday trash (java.io.Serializable pkey) throws Exception {
		Holiday object = holidayDao.get (pkey);
		holidayDao.delete (object);
		return object;
	}

	/*
	* Method delete (Holiday object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Holiday delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Holiday object = holidayDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Holiday delete (Holiday object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Holiday get (java.io.Serializable pkey) throws Exception{
		Holiday object = null;
		object = holidayDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Holiday get (java.io.Serializable pkey, String[] required) throws Exception{
	    Holiday object = null;
	    object = holidayDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = holidayDao.getCriteria();
...
// unique Result
	...
	public Holiday searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = holidayDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Holiday obj = (Holiday) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Holiday searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = holidayDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Holiday obj = (Holiday) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = holidayDao.getDetachedCriteria();
		return dc;
	}

	public Integer getHolidaySLA(Date start, Date end) throws Exception{
				
		int result = 0;
		
		Session holidaySession = holidayDao.getHolidaySession();
		
		String query= "SELECT count(h.tglHoliday) FROM Holiday h " +
				" where h.tglHoliday between :start and :end ";
		
		
		Query q = holidaySession.createQuery(query);
