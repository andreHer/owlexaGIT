...
import com.ametis.cms.dao.ProviderDiagnosisTreatmentDao;
...
/**
 * ProviderDiagnosisTreatment is a servlet controller for provider_diagnosis_treatment Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderDiagnosisTreatmentServiceImpl implements ProviderDiagnosisTreatmentService
...
// extends- 
{
	...
	private ProviderDiagnosisTreatmentDao  providerDiagnosisTreatmentDao;

	public void setProviderDiagnosisTreatmentDao (ProviderDiagnosisTreatmentDao object){
		this.providerDiagnosisTreatmentDao = object;
	}
	public ProviderDiagnosisTreatmentDao getProviderDiagnosisTreatmentDao (){
		return this.providerDiagnosisTreatmentDao;
	}
	/*
	* Method create (ProviderDiagnosisTreatment object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProviderDiagnosisTreatment create (ProviderDiagnosisTreatment object,ActionUser user) throws Exception {
			...
			ProviderDiagnosisTreatment result = providerDiagnosisTreatmentDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderDiagnosisTreatment object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderDiagnosisTreatment update (ProviderDiagnosisTreatment object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerDiagnosisTreatmentDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderDiagnosisTreatment trash (java.io.Serializable pkey) throws Exception {
		ProviderDiagnosisTreatment object = providerDiagnosisTreatmentDao.get (pkey);
		providerDiagnosisTreatmentDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProviderDiagnosisTreatment object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProviderDiagnosisTreatment delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderDiagnosisTreatment object = providerDiagnosisTreatmentDao.get (pkey);
	...
	*/
	...
	public ProviderDiagnosisTreatment delete (ProviderDiagnosisTreatment object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderDiagnosisTreatment get (java.io.Serializable pkey) throws Exception{
		ProviderDiagnosisTreatment object = null;
		object = providerDiagnosisTreatmentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderDiagnosisTreatment get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderDiagnosisTreatment object = null;
	    object = providerDiagnosisTreatmentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerDiagnosisTreatmentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderDiagnosisTreatment element = (ProviderDiagnosisTreatment) iter.next();
...
// unique Result
	...
	public ProviderDiagnosisTreatment searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerDiagnosisTreatmentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderDiagnosisTreatment obj = (ProviderDiagnosisTreatment) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderDiagnosisTreatment searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerDiagnosisTreatmentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderDiagnosisTreatment obj = (ProviderDiagnosisTreatment) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerDiagnosisTreatmentDao.getDetachedCriteria();
		return dc;
	}
