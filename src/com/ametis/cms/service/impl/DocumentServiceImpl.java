...
import com.ametis.cms.dao.DocumentDao;
...
/**
 * Document is a servlet controller for document Table.
...
// extends- 
{
	...
	public void setDocumentDao (DocumentDao object){
		this.documentDao = object;
	}
	public DocumentDao getDocumentDao (){
		return this.documentDao;
	}
	/*
	* Method create (Document object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ActionResult create (Collection<Document> documentList, Collection<byte[]> contentList, ActionUser user) throws Exception {
		ActionResult result = new ActionResult();
		
		
		try {
			if (documentList != null && contentList != null){
				Iterator<Document> iterator = documentList.iterator();
				Iterator<byte[] > contentIterator = contentList.iterator();
				while (iterator.hasNext()){
					Document document = iterator.next();
					byte[] content = contentIterator.next();
					Document res = create (document,content,user);
	...
	public byte[] getDocumentContent (Document document) throws Exception {
		byte[] result = null;
		...
		try {
			...
			File file = new File(config.getReportPath()+separator+document.getDocumentUrl());
	...
	private Document create (Document object, byte[] content, ActionUser user) throws Exception{
		Document result = null;
		try {
			Configuration config = configurationService.getSystemConfiguration();
			
			if (config != null){
				String directory = config.getReportPath();
				String separator = System.getProperty("file.separator");
				
				FileOutputStream outstream = new FileOutputStream(directory+separator+object.getDocumentUrl());
	...
	public Document create (Document object,ActionUser user) throws Exception {
			object.setCreatedTime (new java.sql.Timestamp (System.currentTimeMillis()));			
			...
			Document result = documentDao.create (object);
			return result;
		}
	/*
	* Method update (Document object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Document update (Document object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Document trash (java.io.Serializable pkey) throws Exception {
		Document object = documentDao.get (pkey);
		documentDao.delete (object);
		return object;
	}

	/*
	* Method delete (Document object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Document delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Document object = documentDao.get (pkey);
	...
	*/
	...
	public Document delete (Document object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Document get (java.io.Serializable pkey) throws Exception{
		Document object = null;
		object = documentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Document get (java.io.Serializable pkey, String[] required) throws Exception{
	    Document object = null;
	    object = documentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = documentDao.getCriteria();
...
// unique Result
	...
	public Document searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = documentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Document obj = (Document) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Document searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = documentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Document obj = (Document) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = documentDao.getDetachedCriteria();
		return dc;
	}
