...
// extends- 
{
	...
	public void setCardTypeDao (CardTypeDao object){
		this.cardTypeDao = object;
	}
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			CardType result = cardTypeDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public CardType trash (java.io.Serializable pkey) throws Exception {
		CardType object = cardTypeDao.get (pkey);
		cardTypeDao.delete (object);
		return object;
	}
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = cardTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CardType element = (CardType) iter.next();
...
// unique Result
	...
	public CardType searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = cardTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CardType obj = (CardType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = cardTypeDao.getDetachedCriteria();
		return dc;
	}
