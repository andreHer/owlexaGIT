...
import com.ametis.cms.dao.PolicyBenefitDao;
...
// imports- 
/**
 * PolicyBenefit is a servlet controller for policy_benefit Table. All you have
 * to do is to convert necessary data field to the named parameter
 */
public class PolicyBenefitServiceImpl implements PolicyBenefitService // extends+ 
// extends- 
{

    private PolicyBenefitDao policyBenefitDao;

    public void setPolicyBenefitDao(PolicyBenefitDao object) {
        this.policyBenefitDao = object;
    }

    public PolicyBenefitDao getPolicyBenefitDao() {
        return this.policyBenefitDao;
    }
    /*
     * Method create (PolicyBenefit object) berfungsi untuk melakukan penambahan
    ...
    public PolicyBenefit create(PolicyBenefit object, ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
        ...
        PolicyBenefit result = policyBenefitDao.create(object);
        return result;
    }
    /*
     * Method update (PolicyBenefit object) berfungsi untuk melakukan perubahan
    ...
    public PolicyBenefit update(PolicyBenefit object, ActionUser user) throws Exception {
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
        ...
        policyBenefitDao.update(object);
        return object;
    }
     ...
     * in any place
     */
    public PolicyBenefit trash(java.io.Serializable pkey) throws Exception {
        PolicyBenefit object = policyBenefitDao.get(pkey);
        policyBenefitDao.delete(object);
        return object;
    }

    /*
     * Method delete (PolicyBenefit object) berfungsi untuk melakukan
     ...
     * exception if failed
     */
    public PolicyBenefit delete(java.io.Serializable pkey, ActionUser user) throws Exception {
        PolicyBenefit object = policyBenefitDao.get(pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
     ...
     * exception if failed
     */
    public PolicyBenefit delete(PolicyBenefit object, ActionUser user) throws Exception {
...
// -- get section - carefull !
     ...
     */
    public PolicyBenefit get(java.io.Serializable pkey) throws Exception {
        PolicyBenefit object = null;
        object = policyBenefitDao.get(pkey);
        return object;
    }
    /*
     * Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
    ...
    public PolicyBenefit get(java.io.Serializable pkey, String[] required) throws Exception {
        PolicyBenefit object = null;
        object = policyBenefitDao.get(pkey);
...
// -- 1
    public Collection search(String[] likeColumns, Object[] likeParams,
        ...
        Criteria c = policyBenefitDao.getCriteria();
    ...
    public Collection search(String[] likeColumns, Object[] likeParams,
        ...
        for (Iterator iter = list.iterator(); iter.hasNext();) {
            PolicyBenefit element = (PolicyBenefit) iter.next();
...
// unique Result
    public PolicyBenefit searchUnique(String eqColumns, Object eqParams, String[] required)
            throws Exception {
        Criteria c = policyBenefitDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        PolicyBenefit obj = (PolicyBenefit) c.uniqueResult();
        DaoSupportUtil.lazyInit(required, obj);
        return obj;
    }

    public PolicyBenefit searchUnique(String eqColumns, Object eqParams)
            throws Exception {
        Criteria c = policyBenefitDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        PolicyBenefit obj = (PolicyBenefit) c.uniqueResult();
...
// -----------------------------------------------
    ...
    public DetachedCriteria getDetachedCriteria() throws Exception {
        DetachedCriteria dc = policyBenefitDao.getDetachedCriteria();
        return dc;
    }
// class+ 
// class- 
