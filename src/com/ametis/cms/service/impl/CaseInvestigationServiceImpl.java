...
/**
 * CaseInvestigation is a servlet controller for case_investigation Table.
...

{
	...
	private CaseInvestigationDao  caseInvestigationDao;
private ActivityLogService activityLogService;
	...
	public void setCaseInvestigationDao (CaseInvestigationDao object){
		this.caseInvestigationDao = object;
	}
	public CaseInvestigationDao getCaseInvestigationDao (){
		return this.caseInvestigationDao;
	}
	/*
	...
	*/
	public CaseInvestigation create (CaseInvestigation object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			CaseInvestigation result = caseInvestigationDao.create (object);
			return result;
		}
	/*
	* Method update (CaseInvestigation object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CaseInvestigation update (CaseInvestigation object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
		...
		if (actionUser != null){
 		...
 		caseInvestigationDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public CaseInvestigation trash (java.io.Serializable pkey) throws Exception {
		CaseInvestigation object = caseInvestigationDao.get (pkey);
		caseInvestigationDao.delete (object);
		return object;
	}
	...
	*/
	...
	public CaseInvestigation delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		CaseInvestigation object = caseInvestigationDao.get (pkey);
	...
	*/
	...
	public CaseInvestigation delete (CaseInvestigation object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CaseInvestigation get (java.io.Serializable pkey) throws Exception{
		CaseInvestigation object = null;
		object = caseInvestigationDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CaseInvestigation get (java.io.Serializable pkey, String[] required) throws Exception{
	    CaseInvestigation object = null;
	    object = caseInvestigationDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseInvestigationDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CaseInvestigation element = (CaseInvestigation) iter.next();
...
// unique Result
	...
	public CaseInvestigation searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = caseInvestigationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseInvestigation obj = (CaseInvestigation) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CaseInvestigation searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = caseInvestigationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseInvestigation obj = (CaseInvestigation) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseInvestigationDao.getDetachedCriteria();
		return dc;
	}
...
// class- 
	...
	public Collection getTotalCaseId() throws Exception{
	   	 Collection result = null;
	   	 
	   	 Session session = caseInvestigationDao.getCaseInvestigationSession();
	        if (session != null) {
	       	 Query query = 	session.createQuery("SELECT DISTINCT ci.caseId.caseId FROM CaseInvestigation ci INNER JOIN ci.caseId WHERE ci.deletedStatus = 0");
