...
import com.ametis.cms.dao.ExternalPaymentDataDao;
...
/**
 * ExternalPaymentData is a servlet controller for external_payment_data Table.
...
// extends- 
{
	...
	private ExternalPaymentDataDao  externalPaymentDataDao;

	public void setExternalPaymentDataDao (ExternalPaymentDataDao object){
		this.externalPaymentDataDao = object;
	}
	public ExternalPaymentDataDao getExternalPaymentDataDao (){
		return this.externalPaymentDataDao;
	}
	/*
	* Method create (ExternalPaymentData object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ExternalPaymentData create (ExternalPaymentData object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ExternalPaymentData result = externalPaymentDataDao.create (object);
			return result;
		}
	/*
	* Method update (ExternalPaymentData object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ExternalPaymentData update (ExternalPaymentData object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		externalPaymentDataDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ExternalPaymentData trash (java.io.Serializable pkey) throws Exception {
		ExternalPaymentData object = externalPaymentDataDao.get (pkey);
		externalPaymentDataDao.delete (object);
		return object;
	}

	/*
	* Method delete (ExternalPaymentData object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ExternalPaymentData delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ExternalPaymentData object = externalPaymentDataDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ExternalPaymentData delete (ExternalPaymentData object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ExternalPaymentData get (java.io.Serializable pkey) throws Exception{
		ExternalPaymentData object = null;
		object = externalPaymentDataDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ExternalPaymentData get (java.io.Serializable pkey, String[] required) throws Exception{
	    ExternalPaymentData object = null;
	    object = externalPaymentDataDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = externalPaymentDataDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ExternalPaymentData element = (ExternalPaymentData) iter.next();
...
// unique Result
	...
	public ExternalPaymentData searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = externalPaymentDataDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExternalPaymentData obj = (ExternalPaymentData) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ExternalPaymentData searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = externalPaymentDataDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExternalPaymentData obj = (ExternalPaymentData) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = externalPaymentDataDao.getDetachedCriteria();
		return dc;
	}
