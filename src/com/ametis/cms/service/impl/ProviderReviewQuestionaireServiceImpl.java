...
import com.ametis.cms.dao.ProviderReviewQuestionaireDao;
...
/**
 * ProviderReviewQuestionaire is a servlet controller for provider_review_questionaire Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderReviewQuestionaireServiceImpl implements ProviderReviewQuestionaireService
...

{
	...
	private ProviderReviewQuestionaireDao  providerReviewQuestionaireDao;

	public void setProviderReviewQuestionaireDao (ProviderReviewQuestionaireDao object){
		this.providerReviewQuestionaireDao = object;
	}
	public ProviderReviewQuestionaireDao getProviderReviewQuestionaireDao (){
		return this.providerReviewQuestionaireDao;
	}
	/*
	...
	*/
	public ProviderReviewQuestionaire create (ProviderReviewQuestionaire object,ActionUser user) throws Exception {
			...
			ProviderReviewQuestionaire result = providerReviewQuestionaireDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderReviewQuestionaire object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderReviewQuestionaire update (ProviderReviewQuestionaire object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerReviewQuestionaireDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderReviewQuestionaire trash (java.io.Serializable pkey) throws Exception {
		ProviderReviewQuestionaire object = providerReviewQuestionaireDao.get (pkey);
		providerReviewQuestionaireDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderReviewQuestionaire delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderReviewQuestionaire object = providerReviewQuestionaireDao.get (pkey);
	...
	*/
	...
	public ProviderReviewQuestionaire delete (ProviderReviewQuestionaire object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderReviewQuestionaire get (java.io.Serializable pkey) throws Exception{
		ProviderReviewQuestionaire object = null;
		object = providerReviewQuestionaireDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderReviewQuestionaire get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderReviewQuestionaire object = null;
	    object = providerReviewQuestionaireDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerReviewQuestionaireDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderReviewQuestionaire element = (ProviderReviewQuestionaire) iter.next();
...
// unique Result
	...
	public ProviderReviewQuestionaire searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerReviewQuestionaireDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderReviewQuestionaire obj = (ProviderReviewQuestionaire) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderReviewQuestionaire searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerReviewQuestionaireDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderReviewQuestionaire obj = (ProviderReviewQuestionaire) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerReviewQuestionaireDao.getDetachedCriteria();
		return dc;
	}
