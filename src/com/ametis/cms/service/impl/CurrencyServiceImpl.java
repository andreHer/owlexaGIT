...
private ActivityLogService activityLogService;
	...
	public void setCurrencyDao (CurrencyDao object){
		this.currencyDao = object;
	}
	...
	*/
	public Currency create (Currency object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Currency result = currencyDao.create (object);
			return result;
		}
	/*
	* Method update (Currency object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Currency update (Currency object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Currency trash (java.io.Serializable pkey) throws Exception {
		Currency object = currencyDao.get (pkey);
	...
	*/
	...
	public Currency delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		Currency object = currencyDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Currency delete (Currency object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Currency get (java.io.Serializable pkey) throws Exception{
		Currency object = null;
		object = currencyDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Currency get (java.io.Serializable pkey, String[] required) throws Exception{
	    Currency object = null;
	    object = currencyDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = currencyDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Currency element = (Currency) iter.next();
...
// unique Result
	...
	public Currency searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = currencyDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Currency obj = (Currency) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Currency searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = currencyDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Currency obj = (Currency) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = currencyDao.getDetachedCriteria();
		return dc;
	}
