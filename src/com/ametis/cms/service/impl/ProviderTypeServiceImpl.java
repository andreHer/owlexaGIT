...
import com.ametis.cms.dao.ProviderTypeDao;
...
/**
 * ProviderType is a servlet controller for provider_type Table.
...
// extends- 
{
	...
	public void setProviderTypeDao (ProviderTypeDao object){
		this.providerTypeDao = object;
	}
	public ProviderTypeDao getProviderTypeDao (){
		return this.providerTypeDao;
	}
	/*
	...
	*/
	public ProviderType create (ProviderType object,ActionUser user) throws Exception {
			...
			ProviderType result = providerTypeDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderType update (ProviderType object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ProviderType trash (java.io.Serializable pkey) throws Exception {
		ProviderType object = providerTypeDao.get (pkey);
		providerTypeDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderType delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderType object = providerTypeDao.get (pkey);
	...
	*/
	...
	public ProviderType delete (ProviderType object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderType get (java.io.Serializable pkey) throws Exception{
		ProviderType object = null;
		object = providerTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderType get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderType object = null;
	    object = providerTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderType element = (ProviderType) iter.next();
...
// unique Result
	...
	public ProviderType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderType obj = (ProviderType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderType obj = (ProviderType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerTypeDao.getDetachedCriteria();
		return dc;
	}
