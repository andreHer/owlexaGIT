...
/**
 * QuestionaireItem is a servlet controller for questionaire_item Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class QuestionaireItemServiceImpl implements QuestionaireItemService
...

{
	...
	private QuestionaireItemDao  questionaireItemDao;

	public void setQuestionaireItemDao (QuestionaireItemDao object){
		this.questionaireItemDao = object;
	}
	public QuestionaireItemDao getQuestionaireItemDao (){
		return this.questionaireItemDao;
	}
	/*
	...
	*/
	public QuestionaireItem create (QuestionaireItem object,ActionUser user) throws Exception {
			...
			QuestionaireItem result = questionaireItemDao.create (object);
			return result;
		}
	/*
	* Method update (QuestionaireItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public QuestionaireItem update (QuestionaireItem object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		questionaireItemDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public QuestionaireItem trash (java.io.Serializable pkey) throws Exception {
		QuestionaireItem object = questionaireItemDao.get (pkey);
		questionaireItemDao.delete (object);
		return object;
	}
	...
	*/
	...
	public QuestionaireItem delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		QuestionaireItem object = questionaireItemDao.get (pkey);
	...
	*/
	...
	public QuestionaireItem delete (QuestionaireItem object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public QuestionaireItem get (java.io.Serializable pkey) throws Exception{
		QuestionaireItem object = null;
		object = questionaireItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public QuestionaireItem get (java.io.Serializable pkey, String[] required) throws Exception{
	    QuestionaireItem object = null;
	    object = questionaireItemDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = questionaireItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			QuestionaireItem element = (QuestionaireItem) iter.next();
...
// unique Result
	...
	public QuestionaireItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = questionaireItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		QuestionaireItem obj = (QuestionaireItem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public QuestionaireItem searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = questionaireItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		QuestionaireItem obj = (QuestionaireItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = questionaireItemDao.getDetachedCriteria();
		return dc;
	}
