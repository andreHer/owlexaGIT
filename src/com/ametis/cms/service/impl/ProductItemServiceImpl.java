...
private ActivityLogService activityLogService;
	...
	public void setProductItemDao (ProductItemDao object){
		this.productItemDao = object;
	}
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ProductItem result = productItemDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public ProductItem trash (java.io.Serializable pkey) throws Exception {
		ProductItem object = productItemDao.get (pkey);
		productItemDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public ProductItem get (java.io.Serializable pkey) throws Exception{
		ProductItem object = null;
		object = productItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductItem element = (ProductItem) iter.next();
...
// unique Result
	...
	public ProductItem searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = productItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductItem obj = (ProductItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productItemDao.getDetachedCriteria();
		return dc;
	}
