...
import com.ametis.cms.dao.InvestigationCategoryDao;
...
/**
 * InvestigationCategory is a servlet controller for investigation_category Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class InvestigationCategoryServiceImpl implements InvestigationCategoryService
...
// extends- 
{
	...
	private InvestigationCategoryDao  investigationCategoryDao;
	...
	public void setInvestigationCategoryDao (InvestigationCategoryDao object){
		this.investigationCategoryDao = object;
	}
	public InvestigationCategoryDao getInvestigationCategoryDao (){
		return this.investigationCategoryDao;
	}
	/*
	* Method create (InvestigationCategory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public InvestigationCategory create (InvestigationCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			InvestigationCategory result = investigationCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (InvestigationCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public InvestigationCategory update (InvestigationCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		investigationCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public InvestigationCategory trash (java.io.Serializable pkey) throws Exception {
		InvestigationCategory object = investigationCategoryDao.get (pkey);
		investigationCategoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (InvestigationCategory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public InvestigationCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		InvestigationCategory object = investigationCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public InvestigationCategory delete (InvestigationCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public InvestigationCategory get (java.io.Serializable pkey) throws Exception{
		InvestigationCategory object = null;
		object = investigationCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public InvestigationCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    InvestigationCategory object = null;
	    object = investigationCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = investigationCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			InvestigationCategory element = (InvestigationCategory) iter.next();
...
// unique Result
	...
	public InvestigationCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = investigationCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		InvestigationCategory obj = (InvestigationCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public InvestigationCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = investigationCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		InvestigationCategory obj = (InvestigationCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = investigationCategoryDao.getDetachedCriteria();
		return dc;
	}
