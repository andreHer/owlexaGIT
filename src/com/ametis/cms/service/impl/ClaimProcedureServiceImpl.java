...
import com.ametis.cms.service.ClaimProcedureService;
...
// extends- 
{
	...
	private ClaimProcedureDao  claimProcedureDao;

	public void setClaimProcedureDao (ClaimProcedureDao object){
		this.claimProcedureDao = object;
	}
	public ClaimProcedureDao getClaimProcedureDao (){
		return this.claimProcedureDao;
	}
	...
	*/
	public ClaimProcedure create (ClaimProcedure object,ActionUser user) throws Exception {
			...
			ClaimProcedure result = claimProcedureDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		claimProcedureDao.update (object);
      	return object;
	}
	...
	*/
	public ClaimProcedure trash (java.io.Serializable pkey) throws Exception {
		ClaimProcedure object = claimProcedureDao.get (pkey);
		claimProcedureDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public ClaimProcedure get (java.io.Serializable pkey) throws Exception{
		ClaimProcedure object = null;
		object = claimProcedureDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = claimProcedureDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClaimProcedure element = (ClaimProcedure) iter.next();
...
// unique Result
	...
	public ClaimProcedure searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = claimProcedureDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClaimProcedure obj = (ClaimProcedure) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = claimProcedureDao.getDetachedCriteria();
		return dc;
	}
	...
	public boolean addProcedure(/*Integer claimId*/ Claim claim,
		...
		try {
//			System.out.println("claimId service = " + claimId);
			...
			if (claim != null){			
				for (Iterator iterator = procedureList.iterator(); iterator.hasNext();) {
					...
					ClaimProcedure claimProcedure = (ClaimProcedure) iterator.next();
					claimProcedure.setClaimId(claim);
					
					create(claimProcedure,user);
					
					
					
				}
			/*	String[] eqParamProd = {"claimId.claimId","deletedStatus"};
				Object[] eqValueProd = {claim.getClaimId(),0};
				int totalProd = getTotal(null,null,eqParamProd,eqValueProd);
				Collection<ClaimProcedure> claimProdList = search(null,null,eqParamProd,eqValueProd,0,totalProd);
				
				for (Iterator iterator = claimProdList.iterator(); iterator
						.hasNext();) {
					
					ClaimProcedure claimProcedure = (ClaimProcedure) iterator
							.next();
					
					if (claimProcedure != null){
						totalDrugs += claimProcedure.getTotalCharge();
					}
...
//						item.setItemId(Item.DRUGS_OP);
						...
						claimItem.setItemName("Tindakan");
