...
/**
 * MedicineCategory is a servlet controller for medicine_category Table.
...

{
	...
	public void setMedicineCategoryDao (MedicineCategoryDao object){
		this.medicineCategoryDao = object;
	}
	public MedicineCategoryDao getMedicineCategoryDao (){
		return this.medicineCategoryDao;
	}
	/*
	...
	*/
	public MedicineCategory create (MedicineCategory object,ActionUser user) throws Exception {
			...
			MedicineCategory result = medicineCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (MedicineCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MedicineCategory update (MedicineCategory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		medicineCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MedicineCategory trash (java.io.Serializable pkey) throws Exception {
		MedicineCategory object = medicineCategoryDao.get (pkey);
		medicineCategoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public MedicineCategory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		MedicineCategory object = medicineCategoryDao.get (pkey);
	...
	*/
	...
	public MedicineCategory delete (MedicineCategory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MedicineCategory get (java.io.Serializable pkey) throws Exception{
		MedicineCategory object = null;
		object = medicineCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MedicineCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    MedicineCategory object = null;
	    object = medicineCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = medicineCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MedicineCategory element = (MedicineCategory) iter.next();
...
// unique Result
	...
	public MedicineCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = medicineCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MedicineCategory obj = (MedicineCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MedicineCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = medicineCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MedicineCategory obj = (MedicineCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = medicineCategoryDao.getDetachedCriteria();
		return dc;
	}
