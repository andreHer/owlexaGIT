...

{
	...
	public void setInvoiceItemDao(InvoiceItemDao object) {
		this.invoiceItemDao = object;
	}
	 ...
	 */
	public InvoiceItem create(InvoiceItem object, ActionUser actionUser) throws Exception {
		...
		InvoiceItem result = invoiceItemDao.create(object);
		return result;
	}

	/*
	 * Method update (InvoiceItem object) berfungsi untuk melakukan perubahan
	 ...
	 */
	public InvoiceItem update(InvoiceItem object, ActionUser actionUser) throws Exception {
	 ...
	 */
	public InvoiceItem trash(java.io.Serializable pkey) throws Exception {
		InvoiceItem object = invoiceItemDao.get(pkey);
		invoiceItemDao.delete(object);
		return object;
	}

	/*
	 * Method delete (InvoiceItem object) berfungsi untuk melakukan penghapusan
	 * terhadap sebuah object yang terdapat didalam database
	 * 
	...
	public InvoiceItem delete(java.io.Serializable pkey, ActionUser actionUser) throws Exception {
		InvoiceItem object = invoiceItemDao.get(pkey);
	...
	public InvoiceItem delete(InvoiceItem object, ActionUser actionUser) throws Exception {
	 ...
	 */
	public InvoiceItem get(java.io.Serializable pkey) throws Exception {
		InvoiceItem object = null;
		object = invoiceItemDao.get(pkey);
		return object;
	}
	/*
	 * Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	public InvoiceItem get(java.io.Serializable pkey, String[] required) throws Exception {
		InvoiceItem object = null;
		object = invoiceItemDao.get(pkey);
	...
	public Collection search(String[] likeColumns, Object[] likeParams, String[] eqColumns, Object[] eqParams,
		...
		Criteria c = invoiceItemDao.getCriteria();
	...
	public Collection search(String[] likeColumns, Object[] likeParams, String[] eqColumns, Object[] eqParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			InvoiceItem element = (InvoiceItem) iter.next();
	...
	public InvoiceItem searchUnique(String eqColumns, Object eqParams, String[] required) throws Exception {
		Criteria c = invoiceItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
		InvoiceItem obj = (InvoiceItem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required, obj);
		return obj;
	}

	public InvoiceItem searchUnique(String eqColumns, Object eqParams) throws Exception {
		Criteria c = invoiceItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
		InvoiceItem obj = (InvoiceItem) c.uniqueResult();
		return obj;
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = invoiceItemDao.getDetachedCriteria();
		return dc;
	}

	@Override
	public Collection<InvoiceItem> getItemList(Integer invoiceId) throws Exception {
		// TODO Auto-generated method stub
		Collection<InvoiceItem> result = null;

		String[] eqParam = { "invoiceId.invoiceId", "deletedStatus" };
		Object[] eqValue = { invoiceId, Integer.valueOf(0) };
	...
	public synchronized byte[] getAttachmentFile(Integer invoiceItemId) throws Exception {
		// TODO Auto-generated method stub
		byte[] result = null;
		
		InvoiceItem invoiceItem = get(invoiceItemId);
		
		if (invoiceItem != null && invoiceItem.getInvoiceItemAttachmentURL() != null){
			File file = new File(invoiceItem.getInvoiceItemAttachmentURL());
