...
// extends- 
{
	...
	public void setMessageTemplateDao (MessageTemplateDao object){
		this.messageTemplateDao = object;
	}
	...
	*/
	public MessageTemplate create (MessageTemplate object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			MessageTemplate result = messageTemplateDao.create (object);
			return result;
		}
	/*
	* Method update (MessageTemplate object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MessageTemplate update (MessageTemplate object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		messageTemplateDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MessageTemplate trash (java.io.Serializable pkey) throws Exception {
		MessageTemplate object = messageTemplateDao.get (pkey);
		messageTemplateDao.delete (object);
		return object;
	}
	...
	*/
	...
	public MessageTemplate delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		MessageTemplate object = messageTemplateDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public MessageTemplate delete (MessageTemplate object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MessageTemplate get (java.io.Serializable pkey) throws Exception{
		MessageTemplate object = null;
		object = messageTemplateDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MessageTemplate get (java.io.Serializable pkey, String[] required) throws Exception{
	    MessageTemplate object = null;
	    object = messageTemplateDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = messageTemplateDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MessageTemplate element = (MessageTemplate) iter.next();
...
// unique Result
	...
	public MessageTemplate searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = messageTemplateDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MessageTemplate obj = (MessageTemplate) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MessageTemplate searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = messageTemplateDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MessageTemplate obj = (MessageTemplate) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = messageTemplateDao.getDetachedCriteria();
		return dc;
	}
