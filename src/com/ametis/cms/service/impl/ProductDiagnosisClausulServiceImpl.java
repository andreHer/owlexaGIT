...
import com.ametis.cms.dao.ProductDiagnosisClausulDao;
...
/**
 * ProductDiagnosisClausul is a servlet controller for product_diagnosis_clausul Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProductDiagnosisClausulServiceImpl implements ProductDiagnosisClausulService
...

{
	...
	private ProductDiagnosisClausulDao  productDiagnosisClausulDao;

	public void setProductDiagnosisClausulDao (ProductDiagnosisClausulDao object){
		this.productDiagnosisClausulDao = object;
	}
	public ProductDiagnosisClausulDao getProductDiagnosisClausulDao (){
		return this.productDiagnosisClausulDao;
	}
	/*
	* Method create (ProductDiagnosisClausul object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProductDiagnosisClausul create (ProductDiagnosisClausul object,ActionUser user) throws Exception {
			...
			ProductDiagnosisClausul result = productDiagnosisClausulDao.create (object);
			return result;
		}
	/*
	* Method update (ProductDiagnosisClausul object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProductDiagnosisClausul update (ProductDiagnosisClausul object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		productDiagnosisClausulDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProductDiagnosisClausul trash (java.io.Serializable pkey) throws Exception {
		ProductDiagnosisClausul object = productDiagnosisClausulDao.get (pkey);
		productDiagnosisClausulDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProductDiagnosisClausul object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProductDiagnosisClausul delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProductDiagnosisClausul object = productDiagnosisClausulDao.get (pkey);
	...
	*/
	...
	public ProductDiagnosisClausul delete (ProductDiagnosisClausul object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProductDiagnosisClausul get (java.io.Serializable pkey) throws Exception{
		ProductDiagnosisClausul object = null;
		object = productDiagnosisClausulDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProductDiagnosisClausul get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProductDiagnosisClausul object = null;
	    object = productDiagnosisClausulDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productDiagnosisClausulDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductDiagnosisClausul element = (ProductDiagnosisClausul) iter.next();
...
// unique Result
	...
	public ProductDiagnosisClausul searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = productDiagnosisClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductDiagnosisClausul obj = (ProductDiagnosisClausul) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProductDiagnosisClausul searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = productDiagnosisClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductDiagnosisClausul obj = (ProductDiagnosisClausul) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productDiagnosisClausulDao.getDetachedCriteria();
		return dc;
	}
