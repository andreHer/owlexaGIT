...
import com.ametis.cms.dao.ProviderSetDao;
...
/**
 * ProviderSet is a servlet controller for provider_set Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderSetServiceImpl implements ProviderSetService
...
// extends- 
{
	...
	private ProviderSetDao  providerSetDao;

	public void setProviderSetDao (ProviderSetDao object){
		this.providerSetDao = object;
	}
	public ProviderSetDao getProviderSetDao (){
		return this.providerSetDao;
	}
	/*
	* Method create (ProviderSet object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProviderSet create (ProviderSet object,ActionUser user) throws Exception {
			...
			ProviderSet result = providerSetDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderSet object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderSet update (ProviderSet object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ProviderSet trash (java.io.Serializable pkey) throws Exception {
		ProviderSet object = providerSetDao.get (pkey);
		providerSetDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProviderSet object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProviderSet delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderSet object = providerSetDao.get (pkey);
	...
	*/
	...
	public ProviderSet delete (ProviderSet object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderSet get (java.io.Serializable pkey) throws Exception{
		ProviderSet object = null;
		object = providerSetDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderSet get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderSet object = null;
	    object = providerSetDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerSetDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderSet element = (ProviderSet) iter.next();
...
// unique Result
	...
	public ProviderSet searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerSetDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderSet obj = (ProviderSet) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderSet searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerSetDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderSet obj = (ProviderSet) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerSetDao.getDetachedCriteria();
		return dc;
	}
