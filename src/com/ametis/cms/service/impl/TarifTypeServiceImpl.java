...
*/
public class TarifTypeServiceImpl implements TarifTypeService
...
// extends- 
{
	...
	private TarifTypeDao  tarifTypeDao;

	public void setTarifTypeDao (TarifTypeDao object){
		this.tarifTypeDao = object;
	}
	public TarifTypeDao getTarifTypeDao (){
		return this.tarifTypeDao;
	}
	/*
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			TarifType result = tarifTypeDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public TarifType trash (java.io.Serializable pkey) throws Exception {
		TarifType object = tarifTypeDao.get (pkey);
		tarifTypeDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public TarifType get (java.io.Serializable pkey) throws Exception{
		TarifType object = null;
		object = tarifTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = tarifTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			TarifType element = (TarifType) iter.next();
...
// unique Result
	...
	public TarifType searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = tarifTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TarifType obj = (TarifType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = tarifTypeDao.getDetachedCriteria();
		return dc;
	}
