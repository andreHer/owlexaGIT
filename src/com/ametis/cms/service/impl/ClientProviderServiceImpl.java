...
/**
 * ClientProvider is a servlet controller for client_provider Table.
...

{
	...
	private ClientProviderDao  clientProviderDao;
...
public void setConfigurationService(ConfigurationService configurationService) {
	...
	public void setClientProviderDao (ClientProviderDao object){
		this.clientProviderDao = object;
	}
	public ClientProviderDao getClientProviderDao (){
		return this.clientProviderDao;
	}
	/*
	...
	*/
	public ClientProvider create (ClientProvider object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ClientProvider result = clientProviderDao.create (object);
			return result;
		}
	
	
	/*
	* Method update (ClientProvider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClientProvider update (ClientProvider object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		clientProviderDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClientProvider trash (java.io.Serializable pkey) throws Exception {
		ClientProvider object = clientProviderDao.get (pkey);
		clientProviderDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ClientProvider delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ClientProvider object = clientProviderDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ClientProvider delete (ClientProvider object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClientProvider get (java.io.Serializable pkey) throws Exception{
		ClientProvider object = null;
		object = clientProviderDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClientProvider get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClientProvider object = null;
	    object = clientProviderDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clientProviderDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClientProvider element = (ClientProvider) iter.next();
...
// unique Result
	...
	public ClientProvider searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clientProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientProvider obj = (ClientProvider) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClientProvider searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clientProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientProvider obj = (ClientProvider) c.uniqueResult();
	...
	public ClientProvider searchUnique (String[] eqColumns, Object[] eqParams, int index, int offset)
			throws Exception{
			Criteria c = clientProviderDao.getCriteria();
			DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
			DaoSupportUtil.setLimit(index, offset, c);
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clientProviderDao.getDetachedCriteria();
		return dc;
	}
	public boolean saveClientProviders(String[] providersId, Integer clientId,
		...
		if (providersId != null){
			...
			for (int i = 0; i < providersId.length; i++){
				
				if (NumberUtils.isNumber(providersId[i])){
					provider = new Provider();
					provider.setProviderId(Integer.valueOf(providersId[i]));
					
					cp = new ClientProvider();
					cp.setClientId(client);
					cp.setProviderId(provider);
					
					cp.setDeletedStatus(Integer.valueOf(0));
					
					if (actionUser != null){
						if (actionUser.getUser() != null){
							cp.setCreatedBy(actionUser.getUser().getUsername());
						}
					}
					cp.setCreatedTime(new Timestamp(System.currentTimeMillis()));
					
					clientProviderDao.create(cp);
				}
	...
	public boolean deleteClientProviders(String[] clientProviders,
			ActionUser actionUser) throws Exception {
		// TODO Auto-generated method stub
		...
		if (clientProviders != null){
			for (int i = 0; i < clientProviders.length ; i++){
				
				delete(Integer.valueOf(clientProviders[i]), actionUser);
			}
			result = true;
		}
	...
	@Override
	public ClientProvider createUpload(ClientProvider object,
			MultipartFile file, ActionUser user) throws Exception {
		// TODO Auto-generated method stub
