...
*/
public class FormulariumServiceImpl implements FormulariumService
...

{
	...
	private FormulariumDao  formulariumDao;

	public void setFormulariumDao (FormulariumDao object){
		this.formulariumDao = object;
	}
	public FormulariumDao getFormulariumDao (){
		return this.formulariumDao;
	}
	/*
	...
	*/
	public Formularium create (Formularium object,ActionUser user) throws Exception {
			...
			Formularium result = formulariumDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public Formularium trash (java.io.Serializable pkey) throws Exception {
		Formularium object = formulariumDao.get (pkey);
		formulariumDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public Formularium get (java.io.Serializable pkey) throws Exception{
		Formularium object = null;
		object = formulariumDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = formulariumDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Formularium element = (Formularium) iter.next();
...
// unique Result
	...
	public Formularium searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = formulariumDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Formularium obj = (Formularium) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = formulariumDao.getDetachedCriteria();
		return dc;
	}
