...

{
	...
	public void setContactPersonDao (ContactPersonDao object){
		this.contactPersonDao = object;
	}
	...
	*/
	public ContactPerson create (ContactPerson object,ActionUser user) throws Exception {
		...
		object.setCreatedTime(new java.sql.Timestamp(System.currentTimeMillis()));
			...
			ContactPerson result = contactPersonDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		contactPersonDao.update (object);
      	return object;
	}
	...
	*/
	public ContactPerson trash (java.io.Serializable pkey) throws Exception {
		ContactPerson object = contactPersonDao.get (pkey);
		contactPersonDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public ContactPerson get (java.io.Serializable pkey) throws Exception{
		...
		object = contactPersonDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// *b -> with columnOrder
	...
	public Collection searchContactPersonByName (String[] likeColumns, Object[] likeParams, String[] Name, Object[] oName, String[] required) throws Exception{

		
		Criteria c = contactPersonDao.getCriteria();
//		Criteria c2 = providerDao.getCriteria();

//		DaoSupportUtil.setEqParam(likeColumns, likeParams, cr2);
		DaoSupportUtil.setEqParam(likeColumns, likeParams, c);
//		DaoSupportUtil.setLikeParam(Name, oName, cr2);
		DaoSupportUtil.setLikeParam(Name, oName, c);

		
//		DaoSupportUtil.setEqParam(likeColumns, likeParams, c2);
//		DaoSupportUtil.setLikeParam(Name, oName, c2);
		
		List list = c.list();
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ContactPerson element = (ContactPerson) iter.next();
...
// unique Result
	...
	public ContactPerson searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = contactPersonDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ContactPerson obj = (ContactPerson) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = contactPersonDao.getDetachedCriteria();
		return dc;
	}
