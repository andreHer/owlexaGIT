...
import com.ametis.cms.dao.CallCategoryDao;
...
/**
 * CallCategory is a servlet controller for call_category Table.
...
private ActivityLogService activityLogService;
	...
	public void setCallCategoryDao (CallCategoryDao object){
		this.callCategoryDao = object;
	}
	public CallCategoryDao getCallCategoryDao (){
		return this.callCategoryDao;
	}
	/*
	* Method create (CallCategory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public CallCategory create (CallCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			CallCategory result = callCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (CallCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CallCategory update (CallCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public CallCategory trash (java.io.Serializable pkey) throws Exception {
		CallCategory object = callCategoryDao.get (pkey);
		callCategoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (CallCategory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public CallCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		CallCategory object = callCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public CallCategory delete (CallCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CallCategory get (java.io.Serializable pkey) throws Exception{
		CallCategory object = null;
		object = callCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CallCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    CallCategory object = null;
	    object = callCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = callCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CallCategory element = (CallCategory) iter.next();
...
// unique Result
	...
	public CallCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = callCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CallCategory obj = (CallCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CallCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = callCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CallCategory obj = (CallCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = callCategoryDao.getDetachedCriteria();
		return dc;
	}
