...
/**
 * ProductTreatmentClausul is a servlet controller for product_treatment_clausul Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProductTreatmentClausulServiceImpl implements ProductTreatmentClausulService
...

{
	...
	private ProductTreatmentClausulDao  productTreatmentClausulDao;

	public void setProductTreatmentClausulDao (ProductTreatmentClausulDao object){
		this.productTreatmentClausulDao = object;
	}
	public ProductTreatmentClausulDao getProductTreatmentClausulDao (){
		return this.productTreatmentClausulDao;
	}
	/*
	...
	*/
	public ProductTreatmentClausul create (ProductTreatmentClausul object,ActionUser user) throws Exception {
			...
			ProductTreatmentClausul result = productTreatmentClausulDao.create (object);
			return result;
		}
	/*
	* Method update (ProductTreatmentClausul object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProductTreatmentClausul update (ProductTreatmentClausul object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		productTreatmentClausulDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProductTreatmentClausul trash (java.io.Serializable pkey) throws Exception {
		ProductTreatmentClausul object = productTreatmentClausulDao.get (pkey);
		productTreatmentClausulDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProductTreatmentClausul delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProductTreatmentClausul object = productTreatmentClausulDao.get (pkey);
	...
	*/
	...
	public ProductTreatmentClausul delete (ProductTreatmentClausul object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProductTreatmentClausul get (java.io.Serializable pkey) throws Exception{
		ProductTreatmentClausul object = null;
		object = productTreatmentClausulDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProductTreatmentClausul get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProductTreatmentClausul object = null;
	    object = productTreatmentClausulDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productTreatmentClausulDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductTreatmentClausul element = (ProductTreatmentClausul) iter.next();
...
// unique Result
	...
	public ProductTreatmentClausul searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = productTreatmentClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductTreatmentClausul obj = (ProductTreatmentClausul) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProductTreatmentClausul searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = productTreatmentClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductTreatmentClausul obj = (ProductTreatmentClausul) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productTreatmentClausulDao.getDetachedCriteria();
		return dc;
	}
