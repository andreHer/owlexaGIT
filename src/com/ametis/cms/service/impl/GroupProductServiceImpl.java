...
private ActivityLogService activityLogService;
	...
	public void setGroupProductDao (GroupProductDao object){
		this.groupProductDao = object;
	}
	public GroupProductDao getGroupProductDao (){
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			GroupProduct result = groupProductDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public GroupProduct trash (java.io.Serializable pkey) throws Exception {
		GroupProduct object = groupProductDao.get (pkey);
		groupProductDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public GroupProduct get (java.io.Serializable pkey) throws Exception{
		GroupProduct object = null;
		object = groupProductDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = groupProductDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			GroupProduct element = (GroupProduct) iter.next();
...
// unique Result
	...
	public GroupProduct searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = groupProductDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		GroupProduct obj = (GroupProduct) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = groupProductDao.getDetachedCriteria();
		return dc;
	}
