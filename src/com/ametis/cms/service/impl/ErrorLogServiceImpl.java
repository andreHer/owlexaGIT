...
// extends- 
{
	...
	public void setErrorLogDao (ErrorLogDao object){
		this.errorLogDao = object;
	}
	...
	*/
	public ErrorLog create (ErrorLog object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ErrorLog result = errorLogDao.create (object);
			return result;
		}
	/*
	* Method update (ErrorLog object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ErrorLog update (ErrorLog object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ErrorLog trash (java.io.Serializable pkey) throws Exception {
		ErrorLog object = errorLogDao.get (pkey);
		errorLogDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ErrorLog delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ErrorLog object = errorLogDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ErrorLog delete (ErrorLog object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ErrorLog get (java.io.Serializable pkey) throws Exception{
		ErrorLog object = null;
		object = errorLogDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ErrorLog get (java.io.Serializable pkey, String[] required) throws Exception{
	    ErrorLog object = null;
	    object = errorLogDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = errorLogDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ErrorLog element = (ErrorLog) iter.next();
...
// unique Result
	...
	public ErrorLog searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = errorLogDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ErrorLog obj = (ErrorLog) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ErrorLog searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = errorLogDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ErrorLog obj = (ErrorLog) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = errorLogDao.getDetachedCriteria();
		return dc;
	}
