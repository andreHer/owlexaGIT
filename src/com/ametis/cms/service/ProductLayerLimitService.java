...
/**
 * ProductLayerLimit is a servlet controller for product_layer_limit Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface ProductLayerLimitService 
...
{	
/*
	* Method create (ProductLayerLimit object) berfungsi untuk melakukan penambahan
	...
	*/
	public ProductLayerLimit create (ProductLayerLimit object,ActionUser user) throws Exception;
	public ProductLayerLimit getProductLayer (Integer productId, Integer layerCounter) throws Exception;
	public Collection<ProductLayerLimit> getProductLayerList (Integer productId) throws Exception;

	/*
	* Method update (ProductLayerLimit object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public ProductLayerLimit update (ProductLayerLimit object,ActionUser user) throws Exception;	
	...
	* place
	*/
	public ProductLayerLimit trash (java.io.Serializable pkey) throws Exception;
	
	/*
	* Method delete (ProductLayerLimit object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	* @param pkey adalah sebuah object yang merepresentasikan primary key dari 
	...
	*/
	...
	public ProductLayerLimit delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public ProductLayerLimit delete (ProductLayerLimit object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public ProductLayerLimit get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public ProductLayerLimit get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public ProductLayerLimit searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public ProductLayerLimit searchUnique (String eqColumns, Object eqParams)
		throws Exception;
