...
/**
 * ClaimCompletion is a servlet controller for claim_completion Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface ClaimCompletionService 
...
/*
	...
	*/
	public ClaimCompletion create (ClaimCompletion object,ActionUser actionUser) throws Exception;

	/*
	* Method update (ClaimCompletion object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public ClaimCompletion update (ClaimCompletion object,ActionUser actionUser) throws Exception;	
	...
	*/
	...
	public ClaimCompletion delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
	...
	*/
	...
	public ClaimCompletion delete (ClaimCompletion object,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public ClaimCompletion get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public ClaimCompletion searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
