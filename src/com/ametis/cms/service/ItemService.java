...
*/
	...
	public Collection<Item> getClaimableItem (Integer memberId, Integer caseCategoryId) throws Exception;
	public Collection<Item> getClaimableItem (Integer memberId, Integer caseCategoryId, Date admissionDate, Date dischargeDate) throws Exception;
	
	public Item getItemByCode(String code) throws Exception ;
	public Item getItemByEdcCode(String code) throws Exception;
	public Item getMemberItemByEdcCode (String code, Integer memberId) throws Exception;
	public Collection<Item> searchItem (String q) throws Exception;
	public boolean updateItemBulk (Collection<Item> itemList, ActionUser user) throws Exception;
