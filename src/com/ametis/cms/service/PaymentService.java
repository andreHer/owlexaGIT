...
/**
 * Payment is a servlet controller for payment Table.
...
{	
	...
	*/
	...
	/*
	* Method update (Payment object) berfungsi untuk melakukan perubahan terhadap
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public Payment searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public Payment searchUnique (String eqColumns, Object eqParams)
		throws Exception;
