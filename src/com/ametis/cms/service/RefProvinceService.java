...
*/
public interface RefProvinceService 
...
*/
	...
	public Collection searchProvince (String query, Integer countryId) throws Exception;
	public Collection searchProvince (String query) throws Exception;

	public Collection searchProvince(String q, String country)	throws Exception ;
