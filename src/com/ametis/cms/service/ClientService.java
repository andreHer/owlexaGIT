...
/**
 * Client is a servlet controller for client Table.
...
{	
/*
	* Method create (Client object) berfungsi untuk melakukan penambahan
	...
	*/
	...
	/*
	* Method update (Client object) berfungsi untuk melakukan perubahan terhadap
	...
	*/
	...
	/*
	* Method renew (Object pkey) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database - benar2 HAPUS !!!
	* @param pkey adalah sebuah object yang merepresentasikan primary key dari 
	*	     tabel yang bersangkutan. Object tersebut dapat dalam bentuk single ID maupun composite ID
	* @return no return value karena objeknya sendiri sudah dihapus - just for consistency. Again, 
	...
	* place
	*/
	public Client activate (java.io.Serializable pkey, ActionUser actionUser) throws Exception;
	
	
	public Client renewal (Serializable pkey, java.sql.Date contractStart, java.sql.Date contractEnd, ActionUser actionUser) throws Exception;
	/*
	* Method terminate (Object pkey) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database - benar2 HAPUS !!!
	* @param pkey adalah sebuah object yang merepresentasikan primary key dari 
	*	     tabel yang bersangkutan. Object tersebut dapat dalam bentuk single ID maupun composite ID
	* @return no return value karena objeknya sendiri sudah dihapus - just for consistency. Again, 
	...
	* place
	*/
	public Client terminate (java.io.Serializable pkey, ActionUser actionUser) throws Exception;
	
	/*
	* Method delete (Client object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	* @param pkey adalah sebuah object yang merepresentasikan primary key dari 
	...
	*/
	...
	public Client delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public Client get (java.io.Serializable pkey, String[] required) throws Exception;
...
//---------------------------------------------------
	...
	*/
	...
	/*
	getting all object with where clause
	*/
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public Client searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
...
*/
	...
	public Collection<Client> searchClient (String query) throws Exception;
