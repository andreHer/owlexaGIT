...
/**
 * MemberElectronicCard is a servlet controller for member_electronic_card Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface MemberElectronicCardService 
...
/*
	...
	*/
	public MemberElectronicCard create (MemberElectronicCard object,ActionUser user) throws Exception;

	/*
	* Method update (MemberElectronicCard object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public MemberElectronicCard update (MemberElectronicCard object,ActionUser user) throws Exception;	
	...
	* place
	*/
	public MemberElectronicCard trash (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public MemberElectronicCard delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public MemberElectronicCard delete (MemberElectronicCard object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public MemberElectronicCard get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public MemberElectronicCard searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
...
*/
	...
	public Collection<MemberElectronicCard> getCardNumberByMember(Integer memberId) throws Exception;
