...
*/
public interface OutstandingClaimService 
...
/*
	...
	*/
	...
	public OutstandingClaim create (OutstandingClaim object, Collection<OutstandingClaimItem> items, ActionUser user) throws Exception;
	...
	*/
	...
	public ActionResult calculateExcess (OutstandingClaim object, Collection<OutstandingClaimItem> items) throws Exception ;
	/*
...
// -- get section - carefull !
	...
	*/
	...
	public Collection<OutstandingClaim> getMemberSubmittedOutstandingClaim (Integer memberId) throws Exception;
	public Collection<OutstandingClaim> getProviderSubmittedOutstandingClaim (Integer providerId) throws Exception;
