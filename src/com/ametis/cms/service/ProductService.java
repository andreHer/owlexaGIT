...
/*
	...
	*/
	...
	public boolean activate (Integer productId, ActionUser actionUser) throws Exception;
	
	public Collection<CaseCategory> getProductCaseCategoryList (Integer policyId) throws Exception;
	public Collection<CaseCategory> getGroupProductCaseCategoryList (Integer clientId,Integer groupId) throws Exception;
