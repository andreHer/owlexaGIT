...
/*
	...
	*/
	...
	public boolean blockProvider (Integer providerId, String reason, ActionUser actionUser) throws Exception;
	public boolean unBlockProvider (Integer providerId, String reason, ActionUser actionUser) throws Exception;
	...
	*/
	...
	/*
	* Method terminate (Provider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	...
	*/
	...
	/*
	* Method activate (Provider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
...
/* Method searching objects from database
	...
	*/	
	...
	public int getTotalProviderEdcTerminalAlert(java.util.Date alertDate) throws Exception;
...
//-------------------------------------------------
	...
	//Add by aju on 20150820, for getting all provider list fufufu
...
*/
	...
	public Collection searchUnassignedProvider (String[] likeColumns, Object[] likeParams,
			String[] eqColumns, Object[] eqParams,String[] required, Integer clientId, int index, int offset) 
			throws Exception;
	
	public int getTotalUnassignedProvider (String[] likeColumns, Object[] likeParams,
			String[] eqColumns, Object[] eqParams, Integer clientId) 
			throws Exception;
	...
	public int getTotalMemberProvider(String[] likeParam, Object[] likeValue,String[] eqParam, Object[] eqValue,
	...
	public Collection<Provider> searchProvider( String[] eqProvider,  Object[] oProvider, String[] sStatus,  Object[] oStatus, String[] required) throws Exception;
//	public Collection<Provider> searchProviderName(String providerName) throws Exception;
	...
	//Add 20150821 by FVO, to get Provider ID for EDC Alert
	...
	public int getTotalProviderEdcTerminalAlertCustom(java.util.Date alertDate) throws Exception;
	public Collection getProviderIdsEdcTerminalAlertCustom(java.util.Date alertDate) throws Exception;
	//Add 20150901 by FVO, to get Provider ID for Roll Paper Alert
	...
	public int getTotalProviderRollPaperAlertDefault(Integer rollPaperAmount) throws Exception;
	public int getTotalProviderRollPaperAlertCustom() throws Exception;
	
	//Add by aju on 20151028, nirbai nirbai fufufu
