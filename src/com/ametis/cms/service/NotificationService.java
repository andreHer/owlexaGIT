...
/**
 * Notification is a servlet controller for notification Table.
...
/*
	...
	*/
	public Notification create (Notification object,ActionUser user) throws Exception;
	...
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Notification createCDV (Notification object,ActionUser user,BatchClaim data,Collection<Claim> claimList ) throws Exception;
	
	public Notification createPAID (Notification object,ActionUser user,BatchClaim data,Collection<Claim> claimList,Payment payment ) throws Exception;
	...
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Notification createReject (Notification object,ActionUser user,RejectedClaim data, Claim claim,BatchClaim bc) throws Exception;

	/*
	* Method update (Notification object) berfungsi untuk melakukan perubahan terhadap
	...
	*/
	...
	public Notification createPending (Notification object,ActionUser user,PendingClaim data,Claim claim,BatchClaim bc) throws Exception;
	...
	*/
	...
	public Notification update (Notification object,ActionUser user) throws Exception;	
	...
	*/
	...
	/*
	* Method delete (Notification object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	* @param pkey adalah sebuah object yang merepresentasikan primary key dari 
	...
	*/
	...
	public Notification delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public Notification delete (Notification object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public Notification get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public Notification searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
