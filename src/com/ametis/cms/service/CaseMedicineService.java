...
/**
 * CaseMedicine is a servlet controller for case_medicine Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface CaseMedicineService 
...
{	
/*
	* Method create (CaseMedicine object) berfungsi untuk melakukan penambahan
	...
	*/
	public CaseMedicine create (CaseMedicine object,ActionUser user) throws Exception;
	public boolean addMedicine(Integer claimId, Collection<CaseMedicine> medicineList, ActionUser user) throws Exception;

	/*
	* Method update (CaseMedicine object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public CaseMedicine update (CaseMedicine object,ActionUser user) throws Exception;	
	...
	* place
	*/
	public CaseMedicine trash (java.io.Serializable pkey) throws Exception;
	
	/*
	* Method delete (CaseMedicine object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	* @param pkey adalah sebuah object yang merepresentasikan primary key dari 
	...
	*/
	...
	public CaseMedicine delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public CaseMedicine delete (CaseMedicine object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public CaseMedicine get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public CaseMedicine get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public CaseMedicine searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public CaseMedicine searchUnique (String eqColumns, Object eqParams)
		throws Exception;
