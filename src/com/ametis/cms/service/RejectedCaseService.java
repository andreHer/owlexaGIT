...
/**
 * RejectedCase is a servlet controller for rejected_case Table.
...
/*
	...
	*/
	...
	/*
	* Method update (RejectedCase object) berfungsi untuk melakukan perubahan terhadap
	...
	*/
	...
	public RejectedCase delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public RejectedCase get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public RejectedCase searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
