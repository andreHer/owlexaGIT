...
<input type="hidden" name="navigation" value="gosearchissued">
					...
					<td class="dataLabel" nowrap="nowrap">Status:
		                ...
		                <%
						   ...
						   if(statusSearch.length > 1){ 
						   	String panjangStatus[] = new String[19];
...
function cari (){
	document.form1.navigation.value = "gosearchissued";
	document.form1.action = "case";
	document.form1.method = "POST";
	document.form1.submit();
}
function downloadExcel (){
	document.form1.navigation.value = "downloadissued";
	document.form1.action = "case";
	document.form1.method = "POST";
	document.form1.submit();
}
...
function carisort(param){
	document.form1.navigation.value = "gosearchissuedbysort";
