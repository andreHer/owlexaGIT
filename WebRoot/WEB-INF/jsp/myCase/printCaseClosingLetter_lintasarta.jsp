...
<table class="tabDetailView"  border="0" cellpadding="0" cellspacing="0" width="90%" >
  <tbody>
	...
	<tr style="border-left: 1px solid;border-right: 1px solid; border-color: #000; color: #000; solid #000; ">
		...
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;">&nbsp;</td>
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;"><font color="#000"><c:out value="${benefit}" /></font></td>
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;">&nbsp;</td>
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;">&nbsp;</td>
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;">&nbsp;</td>
	</tr>
...
<tr style="border-left: 1px solid;border-right: 1px solid; border-color: #000; color: #000; solid #000; ">
		...
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;" colspan=11>&nbsp; Rp. <fmt:formatNumber><c:out value="${myCase.caseClaimValue}" /></fmt:formatNumber></td>
...
<tr style="border-left: 1px solid;border-right: 1px solid; border-color: #000; color: #000; solid #000; ">
		...
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;" colspan=11>&nbsp; Rp. <fmt:formatNumber><c:out value="${myCase.caseApprovedValue}" /></fmt:formatNumber></td>
...
<tr style="border-left: 1px solid;border-right: 1px solid; border-color: #000; color: #000; solid #000; ">
		...
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;" colspan=11>&nbsp; Rp. <fmt:formatNumber><c:out value="${myCase.caseExcessValue}" /></fmt:formatNumber></td>
	...
	<tr style="border-left: 1px solid;border-right: 1px solid; border-color: #000; color: #000; solid #000; ">
		...
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;" colspan=11>&nbsp; 
			<div style="padding-left: 20px;">
				<ul >
					<li>Alasan biaya tidak dijamin :</li>
					<li>Ekses ditagih ditempat (sesuai dengan ketentuan polis)</li>
					<li>Non medis, food suplement ditagih di tempat</li>
					<li>Biaya tersebut merupakan estimasi dan dapat terjadi perubahan sesuai dengan tagihan Rumah Sakit</li>
				</ul>
			</div>
