...
<form name="form1" method="GET" action="itemmeasurementunit" >
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   			<td width="30" align="center"><c:out value="${itemMeasurementUnit.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${itemMeasurementUnit.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${itemMeasurementUnit.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${itemMeasurementUnit.itemMeasurementUnitId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setItemMeasurementUnit (idx);
	window.close();
}
function goleft(){
