...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Quotation No </td>	   		   		   		   		   		   		   			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Request Date </td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Group Name</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Branch</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Broker</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Effective Date</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="6%">Status</td>
	</tr>
	...
	%>
	 <tr  height="20">
      	...
      	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
      		<a class="linkDetail" href="quotation?navigation=detail&quotationId=<c:out value="${quotation.quotationId}" />"><c:out value="${quotation.quotationNo}" /></a>			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<c:out value="${quotation.requestDate}" />
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<c:out value="${quotation.memberGroupId.groupName}" />
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<c:out value="${quotation.branchId.branchName}" />
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<c:out value="${quotation.brokerId.brokerName}" />
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<c:out value="${quotation.effectiveDate}" />
		</td>
		
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<c:out value="${quotation.status.status}" />
		</td>
