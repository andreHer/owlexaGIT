...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		<td width="6%" nowrap="nowrap" class="listViewThS1" scope="col">
			<img src="images/blank.gif" alt="asd" height="1" width="5%">No.</td>		

<!-- ini default generated table from database -->
		   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="20%">
				<a href="client?navigation=search&sortby=client_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Client Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">
				<a href="client?navigation=search&sortby=address&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Cost Containment Type &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">
				<a href="client?navigation=search&sortby=city&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Date &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
