...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%" >
  <tbody>    
		<tr>
	      <td class="tabDetailViewDF" valign="top" width="10%" style="text-align: left; color: #000; font-size: 10px;"><img height="70" src="images/logo/<c:out value="${configuration.companyCode}" />.png"></td>
