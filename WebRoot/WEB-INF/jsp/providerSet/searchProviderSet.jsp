...
<form name="form1" action="providerset" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Provider Set Profile</h3></td>
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
 		   			...
 		   			<option value="providerSetName" <c:if test="${searchby eq \"providerSetName\"}">selected="true"</c:if> >Provider Set Name</option>
			   			<option value="providerSetCode" <c:if test="${searchby eq \"providerSetCode\"}">selected="true"</c:if> >Provider Set Code</option>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Provider Set Name</td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Provider Set Code</td>
	...
	<c:forEach items="${ProviderSets}" var="providerSet" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<a href="providerset?navigation=detail&index=<c:out value="${index}" />&providerSetId=<c:out value="${providerSet.providerSetId}" />" class="linkDetail"><c:out value="${providerSet.providerSetName}" /></a>
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${providerSet.providerSetCode}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${providerSet.description}" />
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.providerSetId.value = idx;
