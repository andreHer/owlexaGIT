...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Product</h3></td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Product Name&nbsp;
			<input type="hidden" name="sortByOrderProductName" value="<c:out value="${sortProductName?'true':'false'}" />">
			<a href="javascript:carisort('productname')" class="listViewThLinkS1">
			<img src="images/arrow_<c:out value="${sortProductName?'up':'down'}" />.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
		</td>	
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Product Code&nbsp;
			<input type="hidden" name="sortByOrderProductCode" value="<c:out value="${sortProductCode?'true':'false'}" />">
			<a href="javascript:carisort('productcode')" class="listViewThLinkS1">
			<img src="images/arrow_<c:out value="${sortProductCode?'up':'down'}" />.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
		</td>		
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Policy Number&nbsp;
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Product Type&nbsp;
			<input type="hidden" name="sortByOrderProduct" value="<c:out value="${sortProductType?'true':'false'}" />">
			<a href="javascript:carisort('producttype')" class="listViewThLinkS1">
			<img src="images/arrow_<c:out value="${sortProductType?'up':'down'}" />.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
		</td>	 		   	 
	</tr>
	 ...
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<a href="product?navigation=detail&productId=<c:out value="${product.productId}" />" class="linkDetail"><c:out value="${product.productName}" /></a>			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
			<c:out value="${product.productCode}" />			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
			<c:out value="${product.policyId.clientId.clientName}" />			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
			<c:out value="${product.policyId.policyNumber}" />			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
			<c:out value="${product.productType.productTypeName}" />			
		</td>			   		   		   		   		   		   		   		   		
