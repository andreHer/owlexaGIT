...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${externalPaymentData.id}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setExternalPaymentData (idx);
	window.close();
}
function goleft(){
