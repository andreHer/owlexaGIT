...
<form action="externalpaymentdata-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="externalPaymentDataForm.id">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Policy Holder : </td>				
			

			<td class="dataField">
			<spring:bind path="externalPaymentDataForm.policyHolder">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="externalPaymentDataForm.cdvNumber">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Claim Paid Date : </td>				
			

						<td class="dataField">
			<spring:bind path="externalPaymentDataForm.claimPaidDate">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Is Synchronized : </td>				
			

						<td class="dataField">
			<spring:bind path="externalPaymentDataForm.isSynchronized">
