...
<form name="form1" method="GET" action="insurancepackage" >

 search By :
 <select name="searchby">

 		   			<option name="packageName" <c:if test="${searchby eq \"packageName\"}">selected="true"</c:if> >packageName</option>
			   			<option name="packageCode" <c:if test="${searchby eq \"packageCode\"}">selected="true"</c:if> >packageCode</option>
			   		   			<option name="packageDescription" <c:if test="${searchby eq \"packageDescription\"}">selected="true"</c:if> >packageDescription</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Package Name</td>
			   			<td width="30" align="center">Package Code</td>
			   		   			<td width="30" align="center">Package Description</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${insurancePackage.packageName}" /></td>
			   			<td width="30" align="center"><c:out value="${insurancePackage.packageCode}" /></td>
			   		   			<td width="30" align="center"><c:out value="${insurancePackage.packageDescription}" /></td>
			   		   		   		   		   			<td width="30" align="center"><c:out value="${insurancePackage.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${insurancePackage.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${insurancePackage.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${insurancePackage.packageId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setInsurancePackage (idx);
	window.close();
}
function goleft(){
