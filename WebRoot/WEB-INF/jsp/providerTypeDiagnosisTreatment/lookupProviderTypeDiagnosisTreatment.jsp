...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${providerTypeDiagnosisTreatment.providerTypeDiagnosisTreamentId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProviderTypeDiagnosisTreatment (idx);
	window.close();
}
function goleft(){
