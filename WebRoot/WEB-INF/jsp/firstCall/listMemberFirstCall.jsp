		...
		<tbody>
				...
				<td colspan="20" align="right">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody>
							<tr>
								<td  align="left">
									<a target="_blank" href="firstcall?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;
								</td>
			...
			<tr height="20">
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					...
					<a href="firstcall?navigation=search&sortby=caller_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Caller Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
					
				</td>

				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					
					<a href="firstcall?navigation=search&sortby=location&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Call Category &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
					
				</td>
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					
					<a href="firstcall?navigation=search&sortby=location&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Location &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
					
				</td>
								<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					
					<a href="firstcall?navigation=search&sortby=location&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Call Status &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
