...
<form name="form1" method="GET" action="fund" >

 search By :
 <select name="searchby">

 		   		   		   		   			<option name="fundCode" <c:if test="${searchby eq \"fundCode\"}">selected="true"</c:if> >fundCode</option>
			   			<option name="description" <c:if test="${searchby eq \"description\"}">selected="true"</c:if> >description</option>
			   		   			...
			   		   			<option name="approvedBy" <c:if test="${searchby eq \"approvedBy\"}">selected="true"</c:if> >approvedBy</option>
			   </select>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   			<td width="30" align="center">Fund Code</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   			<td width="30" align="center"><c:out value="${fund.fundCode}" /></td>
			   			<td width="30" align="center"><c:out value="${fund.description}" /></td>
			   		   		   			<td width="30" align="center"><c:out value="${fund.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${fund.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${fund.modifiedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${fund.approvedBy}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${fund.fundId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
