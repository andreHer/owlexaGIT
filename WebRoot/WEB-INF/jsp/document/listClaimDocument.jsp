...
<ul id="maintab" class="shadetabs">
	...
	<li >
		<a href="batchclaim?navigation=detail&batchClaimId=<c:out value="${batchClaimId}" />" rel="tcontent1">Detail Batch Claim</a>
	</li>
	<li>
		<a href="claim?navigation=list&batchClaimId=<c:out value="${batchClaimId}" />" rel="tcontent2">Claim</a>
	</li>	
	<li class="selected">
		<a href="document?navigation=list&batchClaimId=<c:out value="${batchClaimId }" />" rel="tcontent3">Attachment</a>
	</li>
	<li>
		<a href="pendingclaim?navigation=list&batchClaimId=<c:out value="${batchClaimId}" />" rel="tcontent4">Pending Claim</a>
	</li>
	<li>
		<a href="rejectedclaim?navigation=list&batchClaimId=<c:out value="${batchClaimId}" />" rel="tcontent5">Rejected Claim</a>
	</li>	
	 
	<li>
		<a href="excesscharge?navigation=listbatch&batchClaimId=<c:out value="${batchClaimId}" />" rel="tcontent5">Excess Charge</a>
	</li>
	 	
	  
	<li>
		<a href="payment?navigation=listbatch&batchClaimId=<c:out value="${batchClaimId}" />" rel="tcontent5">Claim Payment</a>
	</li>
	 ...
	 <tr  height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${document.documentId}" />')">
			...
			<a href="javascript:ubah('<c:out value="${document.documentId}" />')">
