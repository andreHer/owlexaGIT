...
<form name="form1" method="GET" action="benefitcategory" >

 search By :
 <select name="searchby">

 		   			<option name="benefitCategoryName" <c:if test="${searchby eq \"benefitCategoryName\"}">selected="true"</c:if> >benefitCategoryName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Benefit Category Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${benefitCategory.benefitCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${benefitCategory.description}" /></td>
			   		   			<td width="30" align="center"><c:out value="${benefitCategory.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${benefitCategory.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${benefitCategory.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${benefitCategory.benefitCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setBenefitCategory (idx);
	window.close();
}
function goleft(){
