...
<form action="benefitcategory-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="benefitCategoryForm.benefitCategoryId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Benefit Category Name : </td>				
			

			<td class="dataField">
			<spring:bind path="benefitCategoryForm.benefitCategoryName">
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="benefitCategoryForm.description">
