...
<form name="form1" method="GET" action="currency" >

 search By :
 <select name="searchby">

 		   			<option name="currencyCode" <c:if test="${searchby eq \"currencyCode\"}">selected="true"</c:if> >currencyCode</option>
			   			<option name="currencyName" <c:if test="${searchby eq \"currencyName\"}">selected="true"</c:if> >currencyName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Currency Code</td>
			   			<td width="30" align="center">Currency Name</td>
	...
	<c:forEach items="${Currencys}" var="currency" varStatus="status" >
	<tr>

		<td width="30" align="center"><c:out value="${status.count}" /></td>
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${currency.currencyCode}" /></td>
			   			<td width="30" align="center"><c:out value="${currency.currencyName}" /></td>
			   			<td width="30" align="center"><c:out value="${currency.description}" /></td>
			   		   			<td width="30" align="center"><c:out value="${currency.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${currency.updatedBy}" /></td>
			   			<td width="30" align="center"><c:out value="${currency.deletedBy}" /></td>
			   		   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${currency.currencyId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function cari (){
	document.form1.navigation.value = "golookup";
	document.form1.action = "currency";
	document.form1.method = "GET";
	document.form1.submit();
}
</script>
