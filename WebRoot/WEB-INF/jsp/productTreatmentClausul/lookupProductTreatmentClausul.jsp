...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${productTreatmentClausul.productTreatmentClausulId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProductTreatmentClausul (idx);
	window.close();
}
function goleft(){
