...
<html>
	...
	<body>
		<form action="mobile" name="form1" method="POST">
			<input type="hidden" name="navigation" value="saveitem" />
	            ...
	            <div class="span6">             
	                ...
	                <div class="block">                                   
	                    <div class="data-fluid">
	                        ...
	                        <div class="row-form">
	                            <div class="span3">Cost Factor :</div>
	                            <div class="span5">
	                            	<input type="hidden" name="caseItemId" id="caseItemId" value="" /> 
	        ...
	        <div class="row-fluid">
	            ...
	            <div class="span6">                
					<div class="row-form">
	                	<button class="btn btn-primary" type="button" onclick="javascript:addCaseItem();">Save</button>
...
$(document).ready(function(){   
    ...
    $("#itemName").autocomplete("item?navigation=lookupjson", {
        ...
        $("#caseItemId").val (value.id);
    });
    
 });
 function addCaseItem(){
 	document.form1.action = "mobile";
 	document.form1.navigation.value = "saveitem";
