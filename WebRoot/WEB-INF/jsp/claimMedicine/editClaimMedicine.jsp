...
<form action="claimmedicine-form" method="POST"  name="form1" id="form_layout">

<input type="hidden" name="navigation" value="">
<spring:bind path="claimMedicineForm.claimId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<spring:bind path="claimMedicineForm.claimMedicineId">
		<input type="hidden" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" >
			<div id="fredcaption">
			...
			<spring:bind path="claimMedicineForm.medicineId">
	<input type="hidden" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}"/>">
			...
			<tr>
				<td class="dataLabel"> Medicine  : </td>				
						...
						<td class="dataField">
			<spring:bind path="claimMedicineForm.medicineName">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="claimMedicineForm.totalUsage">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="claimMedicineForm.totalCharge">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" maxlength="22">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="claimMedicineForm.referencePrice">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" maxlength="22" readonly="readonly">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
			</spring:bind>
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="claimMedicineForm.description">
