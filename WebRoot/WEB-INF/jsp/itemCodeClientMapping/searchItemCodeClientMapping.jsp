...
<form name="form1" action="itemcodeclientmapping" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Benefit Code Mapping</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
								 ...
								 <select name="searchby" class="inputbox">
 		   		   			...
 		   		   			<option value="clientItemCode" <c:if test="${searchby eq \"clientItemCode\"}">selected="true"</c:if> >Client Item Code</option>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
			...
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Client Item Code</td>
	...
	<c:forEach items="${ItemCodeClientMappings}" var="itemCodeClientMapping" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${itemCodeClientMapping.clientId.clientName}" />
			
		</td>
      		   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${itemCodeClientMapping.clientItemCode}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${itemCodeClientMapping.itemCategoryId.itemCategoryName}" />
			
		</td>
			
					   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
			<c:out value="${itemCodeClientMapping.itemCategoryId.itemCategoryCode}" />
				
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<c:out value="${itemCodeClientMapping.description}" />
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.itemCodeClientMappingId.value = idx;
