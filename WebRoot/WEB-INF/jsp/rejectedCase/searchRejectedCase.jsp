...
<form name="form1" action="rejectedcase" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Rejected Case</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
								 ...
								 <select name="searchby" class="inputbox">
 		   		   		   			...
 		   		   		   			<option value="rejectionDescription" <c:if test="${searchby eq \"rejectionDescription\"}">selected="true"</c:if> >Rejection Description</option>
...
<!-- ini default generated table from database -->
				...
				<a href="rejectedcase?navigation=search&sortby=rejection_description&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Rejection Description &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	<c:forEach items="${RejectedCases}" var="rejectedCase" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${rejectedCase.rejectionDescription}" />
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.rejectedCaseId.value = idx;
		document.form1.action = "rejectedcase";
