...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${providerTypeProcedure.providerTypeProcedureId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProviderTypeProcedure (idx);
	window.close();
}
function goleft(){
