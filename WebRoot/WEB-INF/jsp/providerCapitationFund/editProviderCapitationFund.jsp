...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="providercapitationfund-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="providerCapitationFundForm.providerCapitationFundId">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Provider Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerCapitationFundForm.providerId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Client Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerCapitationFundForm.clientId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Current Capitation Fund : </td>				
			
			<td class="dataField">
			<spring:bind path="providerCapitationFundForm.currentCapitationFund">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Total Capitation Fund : </td>				
			
			<td class="dataField">
			<spring:bind path="providerCapitationFundForm.totalCapitationFund">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="22">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Capitation Fund Usage : </td>				
			
			<td class="dataField">
			<spring:bind path="providerCapitationFundForm.capitationFundUsage">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="22">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Last Addition Date : </td>				
			

						<td class="dataField">
			<spring:bind path="providerCapitationFundForm.lastAdditionDate">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Last Usage Date : </td>				
			

						<td class="dataField">
			<spring:bind path="providerCapitationFundForm.lastUsageDate">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" maxlength="10">
					<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
...
<script language="javascript">
	...
	function kembali (){
		...
		document.form1.action = "providercapitationfund";
		document.form1.submit();
	}
	// forreign affairs
