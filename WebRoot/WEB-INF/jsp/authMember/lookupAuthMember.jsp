...
<form name="form1" method="GET" action="authmember" >
 ...
 <select name="searchby">
			   			...
			   			<option name="createdBy" <c:if test="${searchby eq \"createdBy\"}">selected="true"</c:if> >createdBy</option>
			   		   			<option name="modifiedBy" <c:if test="${searchby eq \"modifiedBy\"}">selected="true"</c:if> >modifiedBy</option>
			   		   		   			...
			   		   		   			<option name="activationCode" <c:if test="${searchby eq \"activationCode\"}">selected="true"</c:if> >activationCode</option>
			   </select>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<!-- ini default generated table from database -->
			   			...
			   			<td width="30" align="center">Created By</td>
			   		   			<td width="30" align="center">Modified By</td>
			   		   		   			...
			   		   		   			<td width="30" align="center">Activation Code</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   			<td width="30" align="center"><c:out value="${authMember.username}" /></td>
			   			<td width="30" align="center"><c:out value="${authMember.password}" /></td>
			   			<td width="30" align="center"><c:out value="${authMember.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${authMember.modifiedBy}" /></td>
			   		   		   			<td width="30" align="center"><c:out value="${authMember.deletedBy}" /></td>
			   		   		   			<td width="30" align="center"><c:out value="${authMember.activationCode}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${authMember.authMemberId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setAuthMember (idx);
	window.close();
}
function goleft(){
