...
<form name="form1" action="authmember" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="authMemberId" value="<c:out value="${authMember.authMemberId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Auth Member</h3></td>
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
			   			...
			   			<option value="password" <c:if test="${searchby eq \"password\"}">selected="true"</c:if> >Password</option>
			   			<option value="createdBy" <c:if test="${searchby eq \"createdBy\"}">selected="true"</c:if> >Created By</option>
			   		   			<option value="modifiedBy" <c:if test="${searchby eq \"modifiedBy\"}">selected="true"</c:if> >Modified By</option>
			   		   		   			...
			   		   		   			<option value="activationCode" <c:if test="${searchby eq \"activationCode\"}">selected="true"</c:if> >Activation Code</option>
			   </select>
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="authmember?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="authmember?navigation=search&sortby=username&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Username &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="authmember?navigation=search&sortby=password&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Password &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="authmember?navigation=search&sortby=activation_code&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Activation Code &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	<c:forEach items="${AuthMembers}" var="authMember" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${authMember.username}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${authMember.password}" />
...
<tr>
            <td  align="left"><a target="_blank" href="authmember?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function tambahi (){
	...
	document.form1.action = "authmember-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.authMemberId.value = idx;
		document.form1.action = "authmember";
