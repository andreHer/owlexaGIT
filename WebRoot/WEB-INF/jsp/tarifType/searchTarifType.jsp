...
<form name="form1" action="tariftype" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="tarifTypeId" value="<c:out value="${tarifType.tarifTypeId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Tarif Type</h3></td>
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap"><slot>Search Category:</slot>
              ...
              <slot>
 		   			...
 		   			<option value="tarifTypeName" <c:if test="${searchby eq \"tarifTypeName\"}">selected="true"</c:if> >Tarif Type Name</option>
			   </select>
...
<!-- ini default generated table from database -->
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Tarif Type Name</td>
	...
	<c:forEach items="${TarifTypes}" var="tarifType" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
...
function tambahi (){
	...
	document.form1.action = "tariftype-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.tarifTypeId.value = idx;
		document.form1.action = "tariftype";
