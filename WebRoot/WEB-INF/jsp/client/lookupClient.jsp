...
<form name="form1" action="client" method="GET">
              ...
              &nbsp;&nbsp;
				 ...
				 <select name="searchby" class="inputbox">
 		   			...
 		   			<option value="clientName" <c:if test="${searchby eq \"clientName\"}">selected="true"</c:if> >Client Name</option>
			   			<option value="clientCode" <c:if test="${searchby eq \"clientCode\"}">selected="true"</c:if> >Client Code</option>
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="client?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
			...
			<tr height="20">
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					...
					<a href="client?navigation=search&sortby=client_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Client Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
					
				</td>

				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					
					<a href="client?navigation=search&sortby=address&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Client Category &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
					
				</td>
				
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					
					<a href="client?navigation=search&sortby=city&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">City &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
					
				</td>
				
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					
					<a href="client?navigation=search&sortby=province&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Province &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
					
				</td>

				<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
					
					<a href="client?navigation=search&sortby=country&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Country &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
			...
			%>
				<tr onMouseOver="'" onMouseOut=""
					...
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
						...
						<input type="button" name="pilihButton" value="choose" align="center" onclick="javascript:pilih('<c:out value="${client.clientId}" />','<c:out value="${client.clientName}" />')" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus">
...
<tr>
            <td  align="left"><a target="_blank" href="client?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function pilih (idx,cname){
	
	window.opener.setClient (idx,cname);
	window.close();
}
function goleft(){
