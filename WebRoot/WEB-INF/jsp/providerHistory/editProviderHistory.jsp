...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="providerhistory-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="providerHistoryForm.providerHistoryId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Provider Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerHistoryForm.providerId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerHistoryForm.status">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="2">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Action Type : </td>				
			
	
						<td class="dataField">
				<spring:bind path="providerHistoryForm.actionType">
			...
			<tr>
				<td class="dataLabel"> Action Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerHistoryForm.actionTime">
