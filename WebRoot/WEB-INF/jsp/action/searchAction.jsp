          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
 		   			...
 		   			<option value="actionName" <c:if test="${searchby eq \"actionName\"}">selected="true"</c:if> >Action Name</option>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="action?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Action Name</td>	   			
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Action Code</td>
	</tr>
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<a href="action?navigation=detail&actionId=<c:out value="${action.actionId}" />" class="linkDetail"><c:out value="${action.actionName}" /></a>
