...
<form name="form1" method="GET" action="action" >
 ...
 <select name="searchby">
 		   			...
 		   			<option name="actionName" <c:if test="${searchby eq \"actionName\"}">selected="true"</c:if> >actionName</option>
			   			<option name="description" <c:if test="${searchby eq \"description\"}">selected="true"</c:if> >description</option>
			   			<option name="actionUrl" <c:if test="${searchby eq \"actionUrl\"}">selected="true"</c:if> >actionUrl</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Action Name</td>
			   			<td width="30" align="center">Description</td>
			   			<td width="30" align="center">Action Url</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${action.actionName}" /></td>
			   			<td width="30" align="center"><c:out value="${action.description}" /></td>
			   			<td width="30" align="center"><c:out value="${action.actionUrl}" /></td>
			   		   			<td width="30" align="center"><c:out value="${action.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${action.modifiedBy}" /></td>
			   			<td width="30" align="center"><c:out value="${action.deletedBy}" /></td>
			   		   		   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${action.actionId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
