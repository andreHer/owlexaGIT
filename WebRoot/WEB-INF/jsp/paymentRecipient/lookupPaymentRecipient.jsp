...
<form name="form1" method="GET" action="paymentrecipient" >

 search By :
 <select name="searchby">

 		   			<option name="paymentRecipientName" <c:if test="${searchby eq \"paymentRecipientName\"}">selected="true"</c:if> >paymentRecipientName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Payment Recipient Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${paymentRecipient.paymentRecipientName}" /></td>
			   			<td width="30" align="center"><c:out value="${paymentRecipient.description}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${paymentRecipient.paymentRecipientId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setPaymentRecipient (idx);
	window.close();
}
function goleft(){
