...
<form name="form1" action="groupclaimreport" method="POST">
<input type="hidden" name="navigation" value="gosearchtop10">
...
<div align="left"> <font style="text-align: left; font-family: Verdana; font-size: 11px; font-weight: bold;" >Group : <c:out value="${groupName}" /> </font></div>
...
<br />
<div align="left"> <font style="text-align: left; font-family: Verdana; font-size: 14px; font-weight: bold;" >Most Benefit Usage </font></div><br />
...
<!-- ini default generated table from database -->
	...
	<br />
<div align="left"> <font style="text-align: left; font-family: Verdana; font-size: 14px; font-weight: bold;" >Most Common Diagnosis </font></div><br />
...
<!-- ini default generated table from database -->
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%" >
				Diagnosis/Procedure &nbsp;</td>

				<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">
				No of Participant &nbsp;</td>
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">
				Average Cost / Diagnosis  &nbsp;</td>
			
			
	</tr>


	<c:forEach items="${Diagnosis}" var="report" varStatus="status" >
	<%	if (j % 2 == 0) {
			rowclass = "col1";
		} else if (j % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=j%></td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right" style="border-left: 1px solid #000000;">
				...
				<c:out value="${report.noParticipant}" />
			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" align="right" nowrap="nowrap" valign="top" style="border-left: 1px solid #000000;">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" align="right" nowrap="nowrap" valign="top" style="border-left: 1px solid #000000;">
		   ...
		   <td class="oddListRowS1" bgcolor="#e7f0fe" align="right" nowrap="nowrap" valign="top" style="border-left: 1px solid #000000;">
				...
				<fmt:formatNumber><c:out value="${report.benefitPaid}" /></fmt:formatNumber>
			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right" style="border-left: 1px solid #000000;">
			
				<fmt:formatNumber pattern="#,##.##"><c:out value="${report.percentageTotal}" /></fmt:formatNumber> %
			
		</td>
					   		   		   		   		   		
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right" style="border-left: 1px solid #000000;"> 
			
				<fmt:formatNumber><c:out value="${report.averageCharge}" /></fmt:formatNumber>
...
<br />
<div align="left"> <font style="text-align: left; font-family: Verdana; font-size: 14px; font-weight: bold;" >Most Commonly Used Hospital </font></div><br />
...
<!-- ini default generated table from database -->
	...
	<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%" >
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">
				Average Cost / Hosp &nbsp;</td>
			
			
	</tr>


	<c:forEach items="${Providers}" var="report" varStatus="status" >
	<%	if (k % 2 == 0) {
			rowclass = "col1";
		} else if (k % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=k%></td>
		
		  <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" style="border-left: 1px solid #000000;">
			
				<c:out value="${report.providerName}" />
		...
		<td class="oddListRowS1" align="right" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" style="border-left: 1px solid #000000;">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right" style="border-left: 1px solid #000000;"> 
				...
				<fmt:formatNumber><c:out value="${report.averageClaim}" /></fmt:formatNumber>
