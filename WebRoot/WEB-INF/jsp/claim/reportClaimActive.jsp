...
<input type="hidden" name="navigation" value="gosearchclaimactive">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Report Claim Active</h3></td>
        ...
        <tbody>
          ...
          <tr>
                ...
                <select name="status" id="status"  multiple="multiple">
					...
					<c:set var="paidStatus" value="<%= paidStatus%>"> </c:set> 
					<c:set var="verifiedStatus" value="<%= verifiedStatus%>"> </c:set> 
					<c:set var="closeStatus" value="<%= closeStatus%>"> </c:set> 
...
<!-- 					<option value="">--- All Status ---</option> -->
					...
					<option value="6" <c:if test="${paidStatus eq 6 }">selected</c:if>>PAID</option>
					<option value="3" <c:if test="${verifiedStatus eq 3 }">selected</c:if>>VERIFIED</option>
					<option value="5" <c:if test="${closeStatus eq 5 }">selected</c:if>>CLOSED</option>
					<% }else{ %>
<!-- 						<option value="">--- All Status ---</option> -->
						<option value="1" <c:if test="${openStatus eq 1 }">selected</c:if> >OPEN</option>	
						<option value="13" <c:if test="${cdvStatus eq 13 }">selected</c:if>>CDV ISSUED</option>					
...
<%
String nav="";
if(request.getAttribute("navigation").equals("gosearchclaimactive") || request.getAttribute("navigation").equals("activeclaimreport")){
...
function exportData(){
	...
	document.form1.navigation.value = "downloadclaimactivereport";
...
function cari (){
	document.form1.navigation.value = "gosearchclaimactive";
	document.form1.action = "claimreport";
