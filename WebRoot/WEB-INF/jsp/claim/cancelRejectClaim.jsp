    ...
    <tr>
      <td colspan="20"  style="padding: 0px;">
	   ...
	   <tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Cancel Rejection Notes :&nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="33%" colspan="3">	      	
	      	<textarea rows="8" cols="60" name="cancelRejectNote" style="border: 1px #000 solid;"><c:out value="${cancelRejectNote}" /></textarea>
  ...
  <tbody>
    <tr>
      <td style="padding-top: 2px;">
        ...
        <input title="Save [Alt+Shift+S]" accesskey="S" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:cancelRejectClaim()" name="Save" value=" Cancel Reject " type="submit">
...
<script language="javascript">
	...
	function cancelRejectClaim (){
	
		document.form1.action = "claim";
		document.form1.navigation.value = "cancelreject";	
