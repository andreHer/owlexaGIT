...
function bulkReport(){
	...
	window.open ("groupclaimreport?navigation=downloadoutstandingedc&url=groupclaimreport"+urlAdd,"Search","width=1024, height=768, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes");
