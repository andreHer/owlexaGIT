...
<!-- ini default generated table from database -->
	...
	<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Pre Paid Excess &nbsp;</td>
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Paid To Provider &nbsp;</td>
				...
				Status &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Diagnosis &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Claim Remarks &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Officer &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Modified Time &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Employee Name &nbsp;</td>	   		   		   		   		   		   		   		   		   		   		   		   		   		   			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Number Batch &nbsp;</td>		
		
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Receive Date &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Submission Date &nbsp;</td>
	 ...
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=i%></td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
         	<c:out value="${claim.batchClaimId.invoiceNumber}" />
	    </td>
...
<!-- ini default generated table from database -->
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%" style="text-align: right;" align="right">
							...
							<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">
				</td><td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">
