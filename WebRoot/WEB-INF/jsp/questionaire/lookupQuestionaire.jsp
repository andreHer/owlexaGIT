...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${questionaire.questionaireId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setQuestionaire (idx);
	window.close();
}
function goleft(){
