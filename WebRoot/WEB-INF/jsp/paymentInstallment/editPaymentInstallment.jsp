...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="paymentinstallment-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="paymentInstallmentForm.paymentInstallmentId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Payment Id : </td>				
			

						<td class="dataField">
			<spring:bind path="paymentInstallmentForm.paymentId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Installment Number : </td>				
			
	
						<td class="dataField">
				<spring:bind path="paymentInstallmentForm.installmentNumber">
			...
			<tr>
				<td class="dataLabel"> Description : </td>				
						...
						<td class="dataField">
				<spring:bind path="paymentInstallmentForm.description">
			...
			<td class="dataField">
			<spring:bind path="paymentInstallmentForm.totalValue">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Total Claim : </td>				
						...
						<td class="dataField">
			<spring:bind path="paymentInstallmentForm.totalClaim">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="paymentInstallmentForm.status">
