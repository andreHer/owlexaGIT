...
<form name="form1" method="GET" action="dependent" >

 search By :
 <select name="searchby">

 		   		   			<option name="dependantName" <c:if test="${searchby eq \"dependantName\"}">selected="true"</c:if> >dependantName</option>
			   			<option name="dependantNumber" <c:if test="${searchby eq \"dependantNumber\"}">selected="true"</c:if> >dependantNumber</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   			<td width="30" align="center">Dependant Name</td>
			   			<td width="30" align="center">Dependant Number</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   			<td width="30" align="center"><c:out value="${dependent.dependantName}" /></td>
			   			<td width="30" align="center"><c:out value="${dependent.dependantNumber}" /></td>
			   		   		   		   		   			<td width="30" align="center"><c:out value="${dependent.createdBy}" /></td>
			   			<td width="30" align="center"><c:out value="${dependent.modifiedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${dependent.deletedBy}" /></td>
			   		   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${dependent.dependentId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setDependent (idx);
	window.close();
}
function goleft(){
