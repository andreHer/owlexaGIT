...
<form action="bank" method="GET" name="form1" id="form_layout">
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="bank?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="bankId" value="<c:out value="${bank.bankId}" />">
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bank.bankName}"/></td>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
			...
			<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Swift Code :&nbsp;</td>
		  
			 
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bank.swiftCode}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bank.description}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
			...
			<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Bank Code :&nbsp;</td>
		  
			 
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bank.bankCode}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
