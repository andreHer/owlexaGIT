...
<form name="form1" action="benefit" method="POST">
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="benefit?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="benefit?navigation=search&sortby=benefit_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Benefit Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="benefit?navigation=search&sortby=benefit_description&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Benefit Description &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   		   		   		   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="benefit?navigation=search&sortby=benefit_measurement_unit&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Benefit Measurement Unit &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   		   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="benefit?navigation=search&sortby=benefit_occurance_unit&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Benefit Occurance Unit &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${benefit.benefitName}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${benefit.benefitDescription}" />
			
		</td>
					   		   		   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${benefit.benefitMeasurementUnit}" />
			
		</td>
					   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${benefit.benefitOccuranceUnit}" />
...
<tr>
            <td  align="left"><a target="_blank" href="benefit?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.benefitId.value = idx;
