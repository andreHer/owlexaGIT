...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="diagnosissetdetail-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="diagnosisSetDetailForm.diagnosisSetDetailId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Diagnosis Code : </td>				
						...
						<td class="dataField">
				<spring:bind path="diagnosisSetDetailForm.diagnosisCode">
			...
			<tr>
				<td class="dataLabel"> Diagnosis Name : </td>				
						...
						<td class="dataField">
				<spring:bind path="diagnosisSetDetailForm.diagnosisName">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Description : </td>				
						...
						<td class="dataField">
				<spring:bind path="diagnosisSetDetailForm.description">
			...
			<tr>
				<td class="dataLabel"> Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="diagnosisSetDetailForm.status">
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="diagnosisSetDetailForm.diagnosisId">
	...
	<tr>
		<td class="dataLabel">Diagnosis Set Id : </td>		
		<td class="dataField">
		<spring:bind path="diagnosisSetDetailForm.diagnosisSetId">
		<input type="hidden" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" >
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
		</spring:bind>	
			<input type="text" name="diagnosisSetIdText" id="diagnosisSetIdId" value="" size=35>
