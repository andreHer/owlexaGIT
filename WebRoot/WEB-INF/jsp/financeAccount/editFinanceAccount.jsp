...
<form action="financeaccount-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="financeAccountForm.id">
...
<input type="hidden" name="navigation" value="">
			...
			<td class="dataField">
			<spring:bind path="financeAccountForm.accountName">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="financeAccountForm.accountCode">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="financeAccountForm.description">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Account Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="financeAccountForm.accountId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Created Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="financeAccountForm.createdTime">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="financeAccountForm.createdBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Modified Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="financeAccountForm.modifiedTime">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
					<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="financeAccountForm.modifiedBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Deleted Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="financeAccountForm.deletedTime">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
					<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="financeAccountForm.deletedBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Tipe : </td>				
						...
						<td class="dataField">
			<spring:bind path="financeAccountForm.tipe">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Coa Id : </td>				
			

						<td class="dataField">
			<spring:bind path="financeAccountForm.coaId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
