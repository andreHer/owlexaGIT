...
<form name="form1" action="item" method="GET">
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="item?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="item?navigation=search&sortby=item_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Item Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="item?navigation=search&sortby=item_code&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Item Code &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="item?navigation=search&sortby=item_description&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Item Description &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<input type="button" name="pilihButton" value="choose" align="center" onclick="javascript:pilih('<c:out value="${item.itemId}" />','<c:out value="${item.itemCode}" />','<c:out value="${item.itemName}" />')" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus">
...
<tr>
            <td  align="left"><a target="_blank" href="item?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
%>
function pilih (idx,cname,itemCode){
	var parentElem = document.form1.parentElem.value;	
	window.opener.setItem(parentElem,idx,itemCode,cname);
	window.close();
}
function goleft(){
