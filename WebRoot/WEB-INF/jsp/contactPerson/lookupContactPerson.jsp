...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Contact Person</h3></td>
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="contactperson?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="contactperson?navigation=search&sortby=name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="contactperson?navigation=search&sortby=telephone&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Telephone &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="contactperson?navigation=search&sortby=handphone&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Handphone &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="contactperson?navigation=search&sortby=email&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Email &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="contactperson?navigation=search&sortby=department&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Department &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="contactperson?navigation=search&sortby=job_position&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Job Position &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="pilihsaya" onClick="javascript:pilih('<c:out value="${contactPerson.contactPersonId}" />','')" value="Pilih">
...
<tr>
            <td  align="left"><a target="_blank" href="contactperson?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function pilih (idx){
	window.opener.setContactPerson (idx);
	window.close();
}
function goleft(){
