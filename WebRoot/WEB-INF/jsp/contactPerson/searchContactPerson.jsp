...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Telephone</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Handphone</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Email</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Department</td>			   			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Job Position</td>		
	...
	%>
	 <tr  height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${contactPerson.contactPersonId}" />')">
