...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Product Clausul</h3></td>
...
<form name="form1" action="productclausul" method="POST">
...
<input type="hidden" name="productClausulId" value="">

<br/>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Product Clausul</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<c:forEach items="${ProductClausuls}" var="clausul" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe"  valign="top">			
			<c:out value="${clausul.diagnosisCode}" /> - <c:out value="${clausul.diagnosisId.diagnosisName}" />
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe"  valign="top">			
			<c:out value="${clausul.procedureId.procedureName}" />
		</td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			...
			<a href="javascript:ubah('<c:out value="${clausul.productClausulId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${clausul.productClausulId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.productClausulId.value = idx;
