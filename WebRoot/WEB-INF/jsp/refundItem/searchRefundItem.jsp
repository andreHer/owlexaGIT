...
<form name="form1" action="refunditem" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Refund Item</h3></td>
...
<!-- ini default generated table from database -->
	...
	<c:forEach items="${RefundItems}" var="refundItem" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.refundItemId.value = idx;
