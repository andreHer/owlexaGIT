...
<form name="form1" method="GET" action="excesschargeitem" >
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   		   			<td width="30" align="center"><c:out value="${excessChargeItem.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${excessChargeItem.modifiedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${excessChargeItem.deletedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${excessChargeItem.excessChargeItemId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setExcessChargeItem (idx);
	window.close();
}
function goleft(){
