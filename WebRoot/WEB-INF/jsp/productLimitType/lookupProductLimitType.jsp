...
<form name="form1" method="GET" action="productlimittype" >

 search By :
 <select name="searchby">

 		   			<option name="productLimit" <c:if test="${searchby eq \"productLimit\"}">selected="true"</c:if> >productLimit</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Product Limit</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${productLimitType.productLimit}" /></td>
			   			<td width="30" align="center"><c:out value="${productLimitType.description}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${productLimitType.productLimitTypeId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setProductLimitType (idx);
	window.close();
}
function goleft(){
