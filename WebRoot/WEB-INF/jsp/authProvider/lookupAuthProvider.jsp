...
<form name="form1" method="GET" action="authprovider" >
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   			<td width="30" align="center"><c:out value="${authProvider.username}" /></td>
			   			<td width="30" align="center"><c:out value="${authProvider.password}" /></td>
			   			<td width="30" align="center"><c:out value="${authProvider.activationCode}" /></td>
			   		   		   			<td width="30" align="center"><c:out value="${authProvider.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${authProvider.modifiedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${authProvider.deletedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${authProvider.authProviderId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setAuthProvider (idx);
	window.close();
}
function goleft(){
