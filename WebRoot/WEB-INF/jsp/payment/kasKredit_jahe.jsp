...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%" >
  <tbody>
		...
		<tr>
		  ...
		  <td class="tabDetailViewDF" valign="top" width="15%" style="border: 0px solid #000; font-size: 10px;" colspan="2"><input type="text" value="" size="63" style="border: 1px solid #000; color: #000;"></td>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%" >
  <tbody>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDL" valign="top" width="10%" style="text-align: left; color: #000; font-size: 10px;">&nbsp;&nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="45%" style="border: 0px solid #000; font-size: 10px;"><input type="text" value="Ir. M. Khoirun, MM, AAAIK" size="30" style="border: 0px solid #000; color: #000;"></td>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="45%" style="border: 0px solid #000; font-size: 10px;"><input type="text" value="Ka. Div Non KBM" size="25" style="border: 1px solid #000; color: #000;"></td>
