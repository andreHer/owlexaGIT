...
<!-- ini default generated table from database -->
				...
				<td scope="col" colspan="9" class="listViewThS1" nowrap="nowrap" width="70%">
				&nbsp;</td>
  ...
  <tbody>
	...
	<tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber><c:out value="${claimChargeValue - claimApprovedValue -pembulatan - pembayaranDimuka}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
  ...
  <tbody>
	...
	<tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDL" valign="top" width="15%" style="text-align: left; color: #000; font-size: 10px;">&nbsp;Jumlah Diajukan &nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber ><c:out value="${claimChargeValue  - pembayaranDimuka}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
