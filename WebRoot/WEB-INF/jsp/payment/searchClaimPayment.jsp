          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Keyword:
              &nbsp;&nbsp;
				...
				<input size="30" name="memberGroupName" class="dataField" value="<c:out value="${searchtext}"/>" type="text"> &nbsp;&nbsp;
				<input title="Clear [Alt+Shift+C]" accesskey="C" onClick="javascrip:lookupGroup()" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="clear" value=" Cari Group " type="button">
              </td>
