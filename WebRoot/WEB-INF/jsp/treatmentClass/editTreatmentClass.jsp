...
<form action="treatmentclass-form" method="POST"  name="form1" id="form_layout">


	<spring:bind path="treatmentClassForm.treatmentClassId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Treatment Class Name : </td>				
			

			<td class="dataField">
			<spring:bind path="treatmentClassForm.treatmentClassName">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Treatment Class Code : </td>				
			

			<td class="dataField">
			<spring:bind path="treatmentClassForm.treatmentClassCode">
			<input type="text" size=35 name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" />
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="treatmentClassForm.classIndex">
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="treatmentClassForm.description">
