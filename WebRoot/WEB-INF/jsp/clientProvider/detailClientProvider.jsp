...
<h1>Client Provider</h1>

<form action="clientprovider" method="GET" name="form1" id="form_layout">
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="clientprovider?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&rowset=<c:out value="${rowser}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="clientProviderId" value="<c:out value="${clientProvider.clientProviderId}" />">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Client Id :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.clientId}"/></td>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Provider Id :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.providerId}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Created Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.createdTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.createdBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.deletedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.deletedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Modified Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.modifiedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.modifiedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Status :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${clientProvider.deletedStatus}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
