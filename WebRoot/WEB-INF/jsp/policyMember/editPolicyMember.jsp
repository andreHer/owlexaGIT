...
<form action="policymember-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="policyMemberForm.policyMemberId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Join Date : </td>				
						...
						<td class="dataField">
			<spring:bind path="policyMemberForm.joinDate">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Effective Date : </td>				
						...
						<td class="dataField">
			<spring:bind path="policyMemberForm.effectiveDate">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" maxlength="10">
					<img src="/WEB-INF/images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Expire Date : </td>				
						...
						<td class="dataField">
			<spring:bind path="policyMemberForm.expireDate">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" maxlength="10">
					<img src="/WEB-INF/images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Resigned Date : </td>				
						...
						<td class="dataField">
			<spring:bind path="policyMemberForm.resignedDate">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" maxlength="10">
					<img src="/WEB-INF/images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="policyMemberForm.status">
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="policyMemberForm.policyId">
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="policyMemberForm.memberId">
		<input type="text" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" maxlength="11">
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
...
<script language="javascript">
	...
	function kembali (){
		...
		document.form1.action = "policymember";
		document.form1.submit();
	}
	// forreign affairs
		function lookupPolicy (){
		window.open ("policy?navigation=lookup&url=policymember-form","Search","width=700, height=550, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes,screenX=200,screenY=100");
	}
	function setPolicy (idx){
		document.form1.method = "POST";
		document.form1.notyet.value="true";
		document.form1.action = "policymember-form";
		//document.form1.policyMemberForm.policyId.value=idx;
		document.getElementById("policyId").value = idx;
		document.form1.submit();
		}
			function lookupMember (){
		window.open ("member?navigation=lookup&url=policymember-form","Search","width=700, height=550, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes,screenX=200,screenY=100");
	}
	function setMember (idx){
		document.form1.method = "POST";
		document.form1.notyet.value="true";
		document.form1.action = "policymember-form";
		//document.form1.policyMemberForm.memberId.value=idx;
