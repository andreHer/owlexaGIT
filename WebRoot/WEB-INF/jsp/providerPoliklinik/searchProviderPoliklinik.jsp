...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Provider Poliklinik</h3></td>
...
<input type="hidden" name="providerId" value="<c:out value="${providerId}" />" />
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Provider Poliklinik</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
             ...
             <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
				 ...
				 <select name="searchby" class="inputbox">
	 		   			...
	 		   			<option value="poliklinikName" <c:if test="${searchby eq \"poliklinikName\"}">selected="true"</c:if> >Poliklinik Name</option>
			   			<option value="poliklinikCode" <c:if test="${searchby eq \"poliklinikCode\"}">selected="true"</c:if> >Poliklinik Code</option>
...
<br />
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:tambahi()" value=" Add Poliklinik ">
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:upload()" value=" Upload Poliklinik ">
...
<table class="listView" cellspacing="0" cellpadding="0">
	...
	<c:forEach items="${ProviderPolikliniks}" var="providerPoliklinik" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
      		...
      		<c:if test="${theUser.userType eq 2}">
				<c:if test="${theUser.roleId.roleId eq 0 or theUser.roleId.roleId eq 6}">
			         	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
							<a href="javascript:detil('<c:out value="${providerPoliklinik.providerPoliklinikId}" />')">
							<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>
			
						<!-- ini default edit table for each data -->
						<a href="javascript:ubah('<c:out value="${providerPoliklinik.providerPoliklinikId}" />')">
							<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>
			
						<!-- ini default delete table for each data -->
						<a href="javascript:hapus('<c:out value="${providerPoliklinik.providerPoliklinikId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.providerPoliklinikId.value = idx;
		document.form1.action = "providerpoliklinik";
