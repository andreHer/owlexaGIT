...
<form name="form1" action="invoiceitemmember" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="invoiceItemMemberId" value="<c:out value="${invoiceItemMember.invoiceItemMemberId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Invoice Item Member</h3></td>
...
<!-- ini default generated table from database -->
	...
	<c:forEach items="${InvoiceItemMembers}" var="invoiceItemMember" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${invoiceItemMember.invoiceItemMemberId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${invoiceItemMember.invoiceItemMemberId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${invoiceItemMember.invoiceItemMemberId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.invoiceItemMemberId.value = idx;
