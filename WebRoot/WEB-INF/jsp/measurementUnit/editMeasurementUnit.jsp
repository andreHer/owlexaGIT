...
<form action="measurementunit-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="measurementUnitForm.measurementUnitId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Measurement Unit Name : </td>				
			

			<td class="dataField">
			<spring:bind path="measurementUnitForm.measurementUnitName">
	    ...
	    <td class="dataField"></td>
			...
			<spring:bind path="measurementUnitForm.description">
