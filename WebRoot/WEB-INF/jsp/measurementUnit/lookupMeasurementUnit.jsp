...
<form name="form1" method="GET" action="measurementunit" >

 search By :
 <select name="searchby">

 		   			<option name="measurementUnitName" <c:if test="${searchby eq \"measurementUnitName\"}">selected="true"</c:if> >measurementUnitName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Measurement Unit Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${measurementUnit.measurementUnitName}" /></td>
			   			<td width="30" align="center"><c:out value="${measurementUnit.description}" /></td>
			   		   			<td width="30" align="center"><c:out value="${measurementUnit.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${measurementUnit.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${measurementUnit.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${measurementUnit.measurementUnitId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setMeasurementUnit (idx);
	window.close();
}
function goleft(){
