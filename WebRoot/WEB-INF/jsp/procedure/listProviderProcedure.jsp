...
<!-- ini default generated table from database -->
				...
				<a href="procedure?navigation=search&sortby=procedure_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Procedure Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="procedure?navigation=search&sortby=procedure_code&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Procedure Code &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
