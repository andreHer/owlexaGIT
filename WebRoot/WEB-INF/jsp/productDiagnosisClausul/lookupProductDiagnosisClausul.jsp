...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${productDiagnosisClausul.productDiagnosisClausulId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProductDiagnosisClausul (idx);
	window.close();
}
function goleft(){
