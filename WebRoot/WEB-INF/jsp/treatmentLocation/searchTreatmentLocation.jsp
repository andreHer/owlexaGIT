...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif" alt="Call Search" border="0">&nbsp;Search Treatment Location</h3></td>
...
<div class="table_container">
	<!-- Table Toolbar Start -->
		...
		<div id="search_float"<%=nampak%>>
			<h4>
				<c:out value="${SEARCH}" /> Data treatmentLocation
			</h4>
...
<BR/>
				...
				<input type="hidden" name="arah" value="">
								<input type="hidden" name="locationId" value="<c:out value="${treatmentLocation.locationId}" />">
							</form>
		</div>
	</div>
	<!-- Table Toolbar Stop -->
...
<LABEL><c:out value="${LIST_OF}" />  Treatment Location</LABEL>
...
%>
	<c:forEach items="${TreatmentLocations}" var="treatmentLocation" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
...
function tambahi (){
	...
	document.form1.action = "treatmentlocation-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.locationId.value = idx;
		document.form1.action = "treatmentlocation";
