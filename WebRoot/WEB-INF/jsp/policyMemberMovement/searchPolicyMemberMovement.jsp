...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Policy Member Movement</h3></td>
...
<form name="form1" action="policymembermovement" method="POST">
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Movement Number &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Movement Date &nbsp;</td>	   		   		   		   			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Total Member &nbsp;</td>			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">&nbsp;</td>
	</tr>


	<c:forEach items="${PolicyMemberMovements}" var="policyMemberMovement" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr  height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				 ...
				 <a class="linkDetail" href="policymembermovement?navigation=detail&id=<c:out value="${policyMemberMovement.id }" />">
				 <c:out value="${policyMemberMovement.movementNumber}" /></a>
			
		</td>
					   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${policyMemberMovement.movementDate}" />
			
		</td>
					   		   		   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${policyMemberMovement.totalMember}" />
