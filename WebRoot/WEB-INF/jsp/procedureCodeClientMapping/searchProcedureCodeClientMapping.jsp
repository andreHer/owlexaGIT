...
<form name="form1" action="procedurecodeclientmapping" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Procedure Code Client Mapping</h3></td>
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
 		   			...
 		   			<option value="procedureClientCode" <c:if test="${searchby eq \"procedureClientCode\"}">selected="true"</c:if> >Procedure Client Code</option>
...
<!-- ini default generated table from database -->
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Procedure Client Code</td>
			
		
			   		   		   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Procedure Code</td>
	...
	<c:forEach items="${ProcedureCodeClientMappings}" var="procedureCodeClientMapping" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${procedureCodeClientMapping.procedureClientCode}" />
			
		</td>
					   		   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${procedureCodeClientMapping.procedureCode}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${procedureCodeClientMapping.procedureName}" />
		...
		<a href="javascript:detil('<c:out value="${procedureCodeClientMapping.procedureCodeClientMappingId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${procedureCodeClientMapping.procedureCodeClientMappingId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${procedureCodeClientMapping.procedureCodeClientMappingId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.procedureCodeClientMappingId.value = idx;
