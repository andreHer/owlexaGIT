...
<form name="form1" action="outstandingclaim" method="POST">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Outstanding Claim</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
			   			...
			   			<option value="serviceCode" <c:if test="${searchby eq \"serviceCode\"}">selected="true"</c:if> >Service Code</option>
			   		   		   			<option value="covertedBy" <c:if test="${searchby eq \"covertedBy\"}">selected="true"</c:if> >Coverted By</option>
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="outstandingclaim?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
	...
	%>
	 <tr onMouseOver="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'over', '#e7f0fe', '#FFFFFF', '');" onMouseOut="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'out', '#e7f0fe', '#FFFFFF', '');" onMouseDown="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'click', '#e7f0fe', '#FFFFFF', '');" height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${outstandingClaim.memberNumber}" />
				...
				<c:out value="${outstandingClaim.memberName}" />
				...
				<c:out value="${outstandingClaim.providerId.providerName}" />
			
		</td>
			
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${outstandingClaim.serviceCode}" />
			
		</td>
			
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${outstandingClaim.diagnosis1Code}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${outstandingClaim.claimValue}" />
			
		</td>

			   		   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:if test="${outstandingClaim.isConverted eq 0}">
					SUBMITTED
				</c:if>
				<c:if test="${outstandingClaim.isConverted eq 1}">
					PROCESSED
				</c:if>
				...
				<c:out value="${outstandingClaim.description}" />
			
		</td>
					         <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
		<a href="javascript:detil('<c:out value="${outstandingClaim.outstandingClaimId}" />')">
...
<tr>
            <td  align="left"><a target="_blank" href="outstandingclaim?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.outstandingClaimId.value = idx;
