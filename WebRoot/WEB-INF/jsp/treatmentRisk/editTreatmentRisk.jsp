...
<form action="treatmentrisk-form" method="POST"  name="form1" id="form_layout">

	<spring:bind path="treatmentRiskForm.treatmentRiskId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Treatment Risk Name : </td>				
			

			<td class="dataField">
			<spring:bind path="treatmentRiskForm.treatmentRiskName">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Treatment Risk Code : </td>				
			

			<td class="dataField">
			<spring:bind path="treatmentRiskForm.treatmentRiskCode">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Risk Index : </td>				
			
			<td class="dataField">
			<spring:bind path="treatmentRiskForm.riskIndex">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="22">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="treatmentRiskForm.description">
