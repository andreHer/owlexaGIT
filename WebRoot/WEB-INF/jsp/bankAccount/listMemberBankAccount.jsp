...
<input type="hidden" name="refId" value="<c:out value="${memberId}" />" />
<input type="hidden" name="previousURL" value="bankaccount?navigation=listmember&memberId=<c:out value="${memberId}" />" />
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
 		   			...
 		   			<option value="bankAccount" <c:if test="${searchby eq \"bankAccount\"}">selected="true"</c:if> >Account Number</option>
