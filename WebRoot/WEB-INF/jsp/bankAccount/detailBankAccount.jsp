...
<form action="bankaccount" method="GET" name="form1" id="form_layout">
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="bankaccount?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="id" value="<c:out value="${bankAccount.id}" />">
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bankAccount.bankAccount}"/></td>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bankAccount.bank}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bankAccount.bankBranch}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${bankAccount.accountName}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
	...
	<h2>Foreign Affair</h2>
		...
		<label for="Bank Id">Bank Id</label>
			<div id="ffbox">
			<c:out value="${bankAccount.bankId.bankId}" />
			</div>
	
		<label for="Client Id">Client Id</label>
			<div id="ffbox">
			<c:out value="${bankAccount.clientId.clientId}" />
			</div>
	
		<label for="Member Group Id">Member Group Id</label>
			<div id="ffbox">
			<c:out value="${bankAccount.memberGroupId.memberGroupId}" />
			</div>
	
		<label for="Member Id">Member Id</label>
			<div id="ffbox">
			<c:out value="${bankAccount.memberId.memberId}" />
			</div>
	
		<label for="Provider Id">Provider Id</label>
			<div id="ffbox">
			<c:out value="${bankAccount.providerId.providerId}" />
			</div>
