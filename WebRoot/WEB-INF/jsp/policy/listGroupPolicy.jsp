...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Group Policy</h3></td>
...
<input type="hidden" name="memberGroupId" value="<c:out value="${memberGroupId}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Group Policy</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="8%">Group Code </td>
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="6%">Effective Date </td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="6%">Expire Date</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="6%">Status</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Renewal Date </td>
	...
	%>
	 <tr height="20">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
			...
			<c:if test="${policy.policyStatus.statusId eq 5}">INITIALIZED</c:if></td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
...
function cari (){
	document.form1.navigation.value = "golistgroup";
	document.form1.action = "policy";
	document.form1.method = "POST";
	document.form1.submit();
}
