...
<form name="form1" method="GET" action="policy" >

 search By :
 <select name="searchby">

 		   			<option name="policyNumber" <c:if test="${searchby eq \"policyNumber\"}">selected="true"</c:if> >policyNumber</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Policy Number</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${policy.policyNumber}" /></td>
			   		   		   		   		   		   		   			<td width="30" align="center"><c:out value="${policy.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${policy.modifiedBy}" /></td>
			   		   		   			<td width="30" align="center"><c:out value="${policy.deletedBy}" /></td>
			   		   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${policy.policyId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
