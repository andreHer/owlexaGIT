...
<form name="form1" action="diagnosisgroup" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="diagnosisGroupId" value="<c:out value="${diagnosisGroup.diagnosisGroupId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Diagnosis Group</h3></td>
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap"><slot>Search Category:</slot>
              ...
              <slot>
 		   			...
 		   			<option value="diagnosisGroupCode" <c:if test="${searchby eq \"diagnosisGroupCode\"}">selected="true"</c:if> >Diagnosis Group Code</option>
			   			<option value="diagnosisGroupCategory" <c:if test="${searchby eq \"diagnosisGroupCategory\"}">selected="true"</c:if> >Diagnosis Group Category</option>
			   </select>
...
<!-- ini default generated table from database -->
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Diagnosis Group Code</td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Diagnosis Group Category</td>
	...
	<c:forEach items="${DiagnosisGroups}" var="diagnosisGroup" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
			...
			<slot>
				<c:out value="${diagnosisGroup.diagnosisGroupCode}" />
			</slot>
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<slot>
				<c:out value="${diagnosisGroup.diagnosisGroupCategory}" />
			</slot>
		</td>
					         <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
		<a href="javascript:detil('<c:out value="${diagnosisGroup.diagnosisGroupId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${diagnosisGroup.diagnosisGroupId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${diagnosisGroup.diagnosisGroupId}" />')">
...
function tambahi (){
	...
	document.form1.action = "diagnosisgroup-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.diagnosisGroupId.value = idx;
		document.form1.action = "diagnosisgroup";
