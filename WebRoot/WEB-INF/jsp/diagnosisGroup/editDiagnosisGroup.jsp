...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="diagnosisgroup-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="diagnosisGroupForm.diagnosisGroupId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Diagnosis Group Code : </td>				
			
	
						<td class="dataField">
				<spring:bind path="diagnosisGroupForm.diagnosisGroupCode">
			...
			<tr>
				<td class="dataLabel"> Diagnosis Group Category : </td>				
			
	
						<td class="dataField">
				<spring:bind path="diagnosisGroupForm.diagnosisGroupCategory">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
