...
<!-- ini default generated table from database -->
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Card Type Name</td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Card Type Code</td>
...
function tambahi (){
	...
	document.form1.action = "cardtype-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.cardTypeId.value = idx;
