...
<form name="form1" action="provider" method="GET">
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
			...
			<input type="button" name="pilihButton" value="choose" align="center" onclick="javascript:pilih('<c:out value="${provider.providerId}" />','<c:out value="${provider.providerName}" />')" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus">
	  </td>
    </tr>
