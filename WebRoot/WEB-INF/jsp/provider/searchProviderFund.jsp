...
<input type="hidden" name="navigation" value="gosearchcapitation">
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Capitation Fund&nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="20%">&nbsp;</td>
	</tr>
	...
	%>
	 <tr height="20">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<fmt:formatNumber><c:out value="${provider.currentCapitationFund}" /></fmt:formatNumber>
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
...
<%
String nav="";
if(request.getAttribute("navigation").equals("gosearchcapitation")||request.getAttribute("navigation").equals("golookup")){
...
function cari (){
	document.form1.navigation.value = "gosearchcapitation";
