...
<form action="provider" method="POST" name="form1" id="form_layout">
	...
	<input type="hidden" name="navigation" value="confirmunblock">
  ...
  <tbody>
    <tr>
      <td colspan="20"  style="padding: 0px;">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">UnBlock Reason :&nbsp;</td>
...
<script language="javascript">
	...
	function blockProvider (){
		...
		if (delConfirm){
			document.form1.navigation.value = "confirmunblock";
