...
<form name="form1" method="GET" action="productitem" >
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   			<td width="30" align="center"><c:out value="${productItem.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${productItem.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${productItem.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${productItem.productItemId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setProductItem (idx);
	window.close();
}
function goleft(){
