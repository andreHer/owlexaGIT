...
<form name="form1" action="outstanding" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Outstanding</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
								 ...
								 <select name="searchby" class="inputbox">
			   		   			...
			   		   			<option value="outstandingValue" <c:if test="${searchby eq \"outstandingValue\"}">selected="true"</c:if> >Outstanding Value</option>
			   		   		   </select>
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="outstanding?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
		   ...
		   <td scope="col" class="listViewThS1" nowrap="nowrap" width="20%">Outstanding Number&nbsp;
	   	   <td scope="col" class="listViewThS1" nowrap="nowrap" width="20%">Batch Number&nbsp;
   	   	   <td scope="col" class="listViewThS1" nowrap="nowrap" width="20%">Client Name&nbsp;
	   	   <td scope="col" class="listViewThS1" nowrap="nowrap" width="20%">Outstanding Value&nbsp;   	   	   
	...
	<c:forEach items="${Outstandings}" var="outstanding" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	 ...
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
				...
				<c:out value="${outstanding.batchClaimId.batchClaimNumber}" />
			
		</td>
        <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<a href="batchclaim?navigation=detail&batchClaimId=<c:out value="${outstanding.batchClaimId.batchClaimId}" />" class="linkDetail"><c:out value="${outstanding.batchClaimId.batchClaimNumber}" /></a>
			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" > 
			
				<c:out value="${outstanding.clientId.clientName}" />
			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<fmt:formatNumber>
				<c:out value="${outstanding.outstandingValue}" />
				</fmt:formatNumber>
			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${outstanding.outstandingStatus.paymentStatusName}" />

			
		</td>			   		   		
					   		   		
					   		   		         <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
		<a href="javascript:detil('<c:out value="${outstanding.outstandingId}" />')">
...
<tr>
            <td  align="left"><a target="_blank" href="outstanding?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function detil (idx){
	document.form1.method = "POST";
	document.form1.outstandingId.value = idx;
	document.form1.action = "outstanding";
