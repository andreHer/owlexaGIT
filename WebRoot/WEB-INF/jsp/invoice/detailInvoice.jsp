...
<ul id="maintab" class="shadetabs">
	...
	<c:if test="${invoice.invoiceType eq 1}">
		<li>
  ...
  <tbody>
    <tr> 
      <td style="padding-bottom: 2px;">        
        ...
        <input title="Hapus [Alt+Shift+H]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:cetak1()" name="print1" value=" Print Cover Note " type="button">       		
		<input title="Hapus [Alt+Shift+H]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:cetak2()" name="print2" value=" Print Rekapitulasi " type="button">                		
        <input title="Hapus [Alt+Shift+H]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:cetakReceipt()" name="print3" value=" Print Receipt " type="button">
		</td>
      <td align="right"></td>
    </tr>
  </tbody>
...
<script language="javascript">
	...
	function cetak2(){
		window.open ("invoice?navigation=printrecap&url=member-form&invoiceId=<c:out value="${invoice.invoiceId}" />","Search","width=1024, height=768, menubar=yes, status=no, toolbar=no, scrollbars=yes, resizable=yes");
	...
	function cetakReceipt(){
		window.open ("invoice?navigation=printReceipt&url=member-form&invoiceId=<c:out value="${invoice.invoiceId}" />","Search","width=1024, height=768, menubar=yes, status=no, toolbar=no, scrollbars=yes, resizable=yes");
