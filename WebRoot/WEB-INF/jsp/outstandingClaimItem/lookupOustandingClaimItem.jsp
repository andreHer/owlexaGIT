...
<form name="form1" method="GET" action="oustandingclaimitem" >

 search By :
 <select name="searchby">

 		   			<option name="itemCode" <c:if test="${searchby eq \"itemCode\"}">selected="true"</c:if> >itemCode</option>
			   			<option name="itemName" <c:if test="${searchby eq \"itemName\"}">selected="true"</c:if> >itemName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Item Code</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${oustandingClaimItem.itemCode}" /></td>
			   			<td width="30" align="center"><c:out value="${oustandingClaimItem.itemName}" /></td>
			   			<td width="30" align="center"><c:out value="${oustandingClaimItem.description}" /></td>
			   		   		   		   		   			<td width="30" align="center"><c:out value="${oustandingClaimItem.createdBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${oustandingClaimItem.outstandingClaimItemId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setOustandingClaimItem (idx);
	window.close();
}
function goleft(){
