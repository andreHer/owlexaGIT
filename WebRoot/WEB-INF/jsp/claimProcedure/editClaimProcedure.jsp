...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="claimprocedure-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="claimProcedureForm.claimProcedureId">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Claim Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="claimProcedureForm.claimId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Procedure Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="claimProcedureForm.procedureId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="claimProcedureForm.totalUsage">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="claimProcedureForm.totalCharge">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="17">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="claimProcedureForm.referencePrice">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="17">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Description : </td>				
						...
						<td class="dataField">
				<spring:bind path="claimProcedureForm.description">
			...
			<td class="dataField">
			<spring:bind path="claimProcedureForm.approvedValue">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="17">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="claimProcedureForm.status">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
