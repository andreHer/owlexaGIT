...
Vector prodIdVector  = (Vector)request.getAttribute ("prodIdVector") == null ? new Vector() : (Vector)request.getAttribute ("prodIdVector");


Vector prodNameVector  = (Vector)request.getAttribute ("nameVector") == null ? new Vector() : (Vector)request.getAttribute ("nameVector");
...
Vector prodPriceVector = (Vector) request.getAttribute("prodPriceVector") == null ? new Vector() : (Vector)request.getAttribute ("prodPriceVector");

Vector claimDescVector = (Vector)request.getAttribute ("descVector") == null ? new Vector() : (Vector)request.getAttribute ("descVector");


System.out.println ("CLAIM ITEM : " + prodIdVector.size() );
...
<table class="tabForm" cellspacing="0" cellpadding="0">
	<thead>
		<tr height="20">
			...
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Procedure Name&nbsp;</td>	
	...
	%>
	 ...
	 <tr height="20">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<input type="text" class="input2" size="30" id="prod<%=i%>Name" name="procedureName" value="<%=(String)prodNameVector.get(i-1) %>"  > 
		</td>      	
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<input class="input2" type="text" id="idItemPrice<%=i%>" style="text-align: right;" name="itemPrice" value="<%=(String)prodPriceVector.get(i-1)%>">
		</td>   		   	
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
...
<script language="JavaScript">
	...
	$(document).ready(function(){
		...
		<%	
			for ( i = 1 ; i <= 10; i++){
		%>    
		    	$("#prod<%=i%>Name").autocomplete("procedure?navigation=lookupjson", {
			        max: 7,
			        dataType: "json",
			        parse: function(data) {
	...
	function cancel(){
		document.form1.navigation.value = "listclaimProcedure";
		document.form1.action = "claimprocedure";
		document.form1.submit();
	}
