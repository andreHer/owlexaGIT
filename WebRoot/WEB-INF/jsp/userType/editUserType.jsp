...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="usertype-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="userTypeForm.userTypeId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> User Type Name : </td>				
			
	
						<td class="dataField">
				<spring:bind path="userTypeForm.userTypeName">
			...
			<tr>
				<td class="dataLabel"> Description : </td>				
						...
						<td class="dataField">
				<spring:bind path="userTypeForm.description">
			...
			<td class="dataField">
			<spring:bind path="userTypeForm.createdTime">
