...
<form name="form1" action="usertype" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search User Type</h3></td>
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap"><slot>Search Category:</slot>
              ...
              <slot>
 		   			...
 		   			<option value="userTypeName" <c:if test="${searchby eq \"userTypeName\"}">selected="true"</c:if> >User Type Name</option>
...
<!-- ini default generated table from database -->
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">User Type Name</td>
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
			...
			<slot>
				<c:out value="${userType.userTypeName}" />
			</slot>
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<slot>
				<c:out value="${userType.description}" />
			</slot>
		</td>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.userTypeId.value = idx;
		document.form1.action = "usertype";
