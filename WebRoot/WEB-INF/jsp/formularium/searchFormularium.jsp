...
<form name="form1" action="formularium" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Master Formularium</h3></td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Formularium Name</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Formularium Code</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Periode</td>
	...
	<c:forEach items="${Formulariums}" var="formularium" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      	...
      	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><c:out value="${formularium.formulariumName}" /></td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><c:out value="${formularium.formulariumCode}" /></td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><c:out value="${formularium.periode}" /></td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><c:out value="${formularium.description}" /></td>
		
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
			<a href="javascript:detil('<c:out value="${formularium.formulariumId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>
			<a href="javascript:ubah('<c:out value="${formularium.formulariumId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>
			<a href="javascript:hapus('<c:out value="${formularium.formulariumId}" />')">
