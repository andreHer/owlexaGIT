...
<form action="policypayment" method="GET" name="form1" id="form_layout">
  ...
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="policypayment?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<h2>Foreign Affair</h2>
		...
		<label for="Policy Id">Policy Id</label>
			<div id="ffbox">
			<c:out value="${policyPayment.policyId.policyId}" />
			</div>
