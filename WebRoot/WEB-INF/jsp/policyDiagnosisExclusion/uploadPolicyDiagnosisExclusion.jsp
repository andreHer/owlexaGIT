...
<form action="policydiagnosisexclusion-upload" enctype="multipart/form-data" method="POST"  name="form1" id="form_layout">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<td class="dataField">
			<spring:bind path="policyDiagnosisExclusionForm.multipartFile">
