...
<form action="pendingcategory-form" method="POST"  name="form1" id="form_layout">
	<spring:bind path="pendingCategoryForm.pendingCategoryId">
...
<tr>
			...
			<tr>
				<td class="dataLabel"> Pending Category Name : </td>				
			

			<td class="dataField">
			<spring:bind path="pendingCategoryForm.pendingCategoryName">
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="pendingCategoryForm.description">
