...
<form action="groupbenefit" method="GET" name="form1" id="form_layout">
  ...
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="groupbenefit?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&rowset=<c:out value="${rowser}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="groupBenefitId" value="<c:out value="${groupBenefit.groupBenefitId}" />">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Benefit Limit :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.benefitLimit}"/></td>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Created Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.createdTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.createdBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.deletedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.deletedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Modified Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.modifiedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.modifiedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Status :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.deletedStatus}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Benefit Type :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${groupBenefit.benefitType}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
	...
	<h2>Foreign Affair</h2>
		...
		<label for="Member Group Id">Member Group Id</label>
			<div id="ffbox">
			<c:out value="${groupBenefit.memberGroupId.memberGroupId}" />
			</div>
	
		<label for="Item Category Id">Item Category Id</label>
			<div id="ffbox">
			<c:out value="${groupBenefit.itemCategoryId.itemCategoryId}" />
			</div>
		<center>
