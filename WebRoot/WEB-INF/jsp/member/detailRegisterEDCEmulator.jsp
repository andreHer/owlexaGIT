  ...
  <tbody>
      ...
      <td colspan="20"  style="padding: 0px;">
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="member-edc-emulator" class="tabDetailViewDFLink" style="font-weight: normal;">Return to Registration&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	    ...
	    <tr>
		  ...
		  <td class="tabDetailViewDF" valign="top" width="33%"><a href="member?navigation=detail&memberId=<c:out value="${member.memberId}" />" class="listViewTdLinkS1"><c:out value="${member.firstName}"/> <c:out value="${member.lastName}"/></a></td>
