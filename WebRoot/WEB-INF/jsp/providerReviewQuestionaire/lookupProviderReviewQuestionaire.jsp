...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${providerReviewQuestionaire.providerReviewQuestionaireId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProviderReviewQuestionaire (idx);
	window.close();
}
function goleft(){
