...
<!-- ini default generated table from database -->
	...
	<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="pilihsaya" onClick="javascript:pilih('<c:out value="${userGroupAssignment.id}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setUserGroupAssignment (idx);
	window.close();
}
function goleft(){
