...
<form name="form1" action="excessreminder" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Excess Reminder</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
								 ...
								 <select name="searchby" class="inputbox">
 		   		   		   			...
 		   		   		   			<option value="reminderRemarks" <c:if test="${searchby eq \"reminderRemarks\"}">selected="true"</c:if> >Reminder Remarks</option>
			   		   			...
			   		   			<option value="reminderBy" <c:if test="${searchby eq \"reminderBy\"}">selected="true"</c:if> >Reminder By</option>
			   </select>
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="excessreminder?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="excessreminder?navigation=search&sortby=reminder_remarks&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Reminder Remarks &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="excessreminder?navigation=search&sortby=reminder_by&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Reminder By &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	<c:forEach items="${ExcessReminders}" var="excessReminder" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${excessReminder.reminderRemarks}" />
		...
		<a href="javascript:detil('<c:out value="${excessReminder.excessReminderId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${excessReminder.excessReminderId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${excessReminder.excessReminderId}" />')">
...
<tr>
            <td  align="left"><a target="_blank" href="excessreminder?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.excessReminderId.value = idx;
		document.form1.action = "excessreminder";
