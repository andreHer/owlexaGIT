...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="90%" >
  <tbody>
		...
		<tr>
		  ...
		  <td class="tabDetailViewDF" valign="top" width="15%" style="border: 0px solid #000; font-size: 12px;"></td>
	      <td class="tabDetailViewDF" valign="top" width="15%" style="border: 0px solid #000; font-size: 12px;">No: <c:out value="${pendingClaim.pendingNumber}" /></td>	
	    </tr>		
		<tr>
...
<table class="listView" cellspacing="0" cellpadding="0" width="90%" border="0" style="border: 0px;">
	<tbody>
		...
		<!-- begin afwan 13/04/2016 -->
		<tr>
			<td class="tabDetailViewDF" align="justify" valign="top" width="15%" style="border: 0px solid #000; color: #000; font-size: 12px;">
			Mohon kiranya kelengkapan klaim tersebut dapat dikirimkan sebelum tanggal <font color="#000"><c:out value="${pendingClaim.pendingDueDate}" /></font>
			</td>			
		</tr>
		<!-- end afwan -->
