...
<!-- ini default generated table from database -->
				...
				<a href="pendingclaim?navigation=search&sortby=pending_subject&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Pending Subject &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="pendingclaim?navigation=search&sortby=remarks&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Remarks &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
