...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Client Medicine Formularium</h3></td>
...
<form name="form1" action="clientmedicine" method="POST">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Client Medicine Formularium</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
...
<table class="listView" cellspacing="0" cellpadding="0">
	...
	<c:forEach items="${ClientMedicines}" var="medicine" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.clientMedicineId.value = idx;
		document.form1.action = "clientmedicine";
