...
<form name="form1" method="GET" action="discountusagetype" >

 search By :
 <select name="searchby">

 		   			<option name="discountUsageTypeName" <c:if test="${searchby eq \"discountUsageTypeName\"}">selected="true"</c:if> >discountUsageTypeName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Discount Usage Type Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${discountUsageType.discountUsageTypeName}" /></td>
			   			<td width="30" align="center"><c:out value="${discountUsageType.description}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${discountUsageType.discountUsageTypeId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setDiscountUsageType (idx);
	window.close();
}
function goleft(){
