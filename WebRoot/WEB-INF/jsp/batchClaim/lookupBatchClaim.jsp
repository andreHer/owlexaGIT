...
<form name="form1" action="batchclaim" method="GET">
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
					   ...
					   <select name="searchby" class="inputbox">
 		   					...
 		   					<option value="batchClaimNumber" <c:if test="${searchby eq \"batchClaimNumber\"}">selected="true"</c:if> >Batch Number</option>
			   				<option value="providerName" <c:if test="${searchby eq \"providerName\"}">selected="true"</c:if> >Provider Name</option>
			   				<option value="memberGroupName" <c:if test="${searchby eq \"memberGroupName\"}">selected="true"</c:if> >Group Name</option>
			   		   </select>
			...
			%>
				<tr onMouseOver="'" onMouseOut=""
					...
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
						<input type="button" name="pilihButton" value="choose" align="center" onclick="javascript:pilih('<c:out value="${batchclaim.batchClaimId}" />','<c:out value="${batchclaim.batchClaimNumber}" />')" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus">
					</td>
...
function pilih (batchId,batchNumber){
	window.opener.setBatchClaim (batchId,batchNumber);
	window.close();
}
function goleft(){
