...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%" >
  <tbody>
		...
		<tr>
	      <td class="tabDetailViewDF" valign="top" width="15%" style="border: 0px solid #000; font-size: 12px;"><img src="images/jasindo.png" width="120" height="80"> &nbsp;</td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%" border="0" style="border: 0px;">
	<tbody>
		...
		<tr>
			...
			Mengacu pada surat nomor <c:out value="${excessCharge.excessChargeNumber}" /> tertanggal <c:out value="${excessCharge.excessChargeNumber}" /> kami bermaksud untuk mengingatkan kembali 
			tentang tagihan berikut:
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%" border="0" style="border: 0px;">
	<tbody>
		<tr>
			<td class="tabDetailViewDF" align="justify" valign="top" width="15%" style="border: 0px; color: #000; solid #000; font-size: 12px;">
			Pembayaran melalui bank harap ditransfer selambat-lambatnya dalam waktu 7 hari dari tanggal tagihan ini.</td>
		...
		<tr>
			...
			PT. ASURANSI JASA INDONESIA (PERSERO),</td>
		...
		<tr>
			...
			Bank Mandiri - JKT Pancoran</td>
			
		</tr>	
		<tr>
			<td class="tabDetailViewDF" align="justify" valign="top" width="15%" style="border: 0px solid #000; color: #000; font-weight: bold; font-size: 14px;">
			No. Rek. 070-0006027630</td>
		...
		<tr>
			<td class="tabDetailViewDF" align="justify" valign="top" width="15%" style="border: 0px; color: #000; solid #000; font-size: 12px;">
			Apabila ada pertanyaan sehubungan dengan tagihan ini, mohon hubungi Jasindo Healthcare di (021) 2670.0022
			atau (021) 2670.0033</td>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%" >
  <tbody>
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td align="left" style="font-size: 13px; text-align: left;"><font color="#000"> FENNY EFRIANI, S.E </font></td>
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td  align="left" style="font-size: 13px;"><font color="#000"> FINANCE </font></td>
	</tr>		
