		        ...
		        <div id="cssmenu">
		            <ul>               
						 <li >				 
					   	...
					   	<li>
		                    <a href="case">Case Monitoring</a>
		               	</li>
		               	<li>
		                    <a href="case?navigation=mycase">My Assigned Case</a>
		               	</li>
						<li class="has-sub" >
		                    <a href="#">Membership</a>
		                    <ul>
		                ...
		                <li class="has-sub" >
		                    ...
		                    <ul>
		                        <li class="current">
		                            <a href="member-rki-form">Register Manual</a>
		                        </li>
		                        <li>
		                            <a href="case?navigation=searchfinalized">Rujukan Manual</a>
		                        </li>
		                        <li>
		                            <a href="claim?navigation=searchadjustment">Claim Adjustment</a>
		                        </li>
		                        <li>
		                            <a href="case?navigation=searchopen">Payment Manual</a>
		                        </li>
		                    </ul>
		                </li>                 
