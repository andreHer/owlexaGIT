...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		<tr>
			<td valign="top">
				<div id="handle-sidebar"
					class="handle-container-sidebar vertical-text-sidebar">
					<div id="openCloseButton-sidebar"
						class="handle-button-item-sidebar">
				...
				<div id="sidebar-container">
					...
					<div class="sidebar" style="margin-left:-50px;">
						...
						<ul class="pendinglist">
							<li><a href="batchclaim?status=1&navigation=gosearch"
								title="">Unpaid Invoice</a> <span class="pendinglist-notif"
								id="openBatchNotifyId">0</span>
							</li>
						</ul>
					</div>
...
<script type="text/javascript">
	...
	function refreshOpenBatch() {
		$.get("batchclaim?navigation=jsontotalopen", function(data) {
