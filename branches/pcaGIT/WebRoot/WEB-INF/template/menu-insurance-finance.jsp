			...
			<div id="menu-container">
		        ...
		        <div id="cssmenu">
		            <ul >
		                ...
		                <li >
		                    <a href="dashboard?navigation=dashboard&tipe=claimgrowth">Dashboard</a>
		                </li>
		                ...
		                <li class="has-sub" >
		                    ...
		                    <ul>
		                        <li >
		                            <a href="dataimportstage-form?tipe=1">Upload Claim Data</a>
		                        </li>
		                        <li>
		                        ...
		                        <li>
		                            <a href="dataimportstage">Import Session</a>
		                        </li>                       
		                        <li>
		                            <a href="externalclaim">List Uploaded Claim Header</a>
		                        </li>
		                        
		                        
		                        <li >
		                            <a href="externalclaimdetail">List Uploaded Claim Detail</a>
		                        </li>
		                    </ul>
		                </li>
		                 -->
