...
<form action="eventcategory-form" method="POST"  name="form1" id="form_layout">
...
<tr>
	...
	<spring:bind path="eventCategoryForm.eventCategoryId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Event Category Name : </td>				
			

			<td class="dataField">
			<spring:bind path="eventCategoryForm.eventCategoryName">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="eventCategoryForm.description">
