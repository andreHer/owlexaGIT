...
<form name="form1" method="GET" action="eventcategory" >

 search By :
 <select name="searchby">

 		   			<option name="eventCategoryName" <c:if test="${searchby eq \"eventCategoryName\"}">selected="true"</c:if> >eventCategoryName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Event Category Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${eventCategory.eventCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${eventCategory.description}" /></td>
			   		   			<td width="30" align="center"><c:out value="${eventCategory.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${eventCategory.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${eventCategory.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${eventCategory.eventCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setEventCategory (idx);
	window.close();
}
function goleft(){
