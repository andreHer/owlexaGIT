...
<form action="eventcategory" method="GET" name="form1" id="form_layout">
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="eventcategory?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&rowset=<c:out value="${rowser}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="eventCategoryId" value="<c:out value="${eventCategory.eventCategoryId}" />">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Event Category Name :&nbsp;</td>
		  
			 
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${eventCategory.eventCategoryName}"/></td>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${eventCategory.description}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Created Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${eventCategory.createdTime}"/>  -  <c:out value="${eventCategory.createdBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Modified Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${eventCategory.modifiedTime}"/> - <c:out value="${eventCategory.modifiedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
