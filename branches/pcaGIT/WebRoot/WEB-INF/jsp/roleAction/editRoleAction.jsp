...
<form action="roleaction-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="roleActionForm.roleActionId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Hapus : </td>				
			

						<td class="dataField">
			<spring:bind path="roleActionForm.hapus">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="1">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
			</spring:bind>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Baca : </td>				
			

						<td class="dataField">
			<spring:bind path="roleActionForm.baca">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="1">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Ubah : </td>				
			

						<td class="dataField">
			<spring:bind path="roleActionForm.ubah">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="1">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Tambah : </td>				
			

						<td class="dataField">
			<spring:bind path="roleActionForm.tambah">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="1">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="roleActionForm.createdBy">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Created Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="roleActionForm.createdTime">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="roleActionForm.modifiedBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Modified Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="roleActionForm.modifiedTime">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
					<img src="/WEB-INF/images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	...
	<tr>
		<td class="dataLabel">Action Id : </td>		
		<td class="dataField">
		<spring:bind path="roleActionForm.actionId">
		...
		<input type="button" name="PILIH" class="btn" value="pilih" onClick="javascript:lookupAction()">
		</td>
	    <td class="dataLabel"></td>
	    <td class="dataField"></td>
	</tr>
	...
	<tr>
		<td class="dataLabel">Role Id : </td>		
		<td class="dataField">
		<spring:bind path="roleActionForm.roleId">
		<input type="text" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" maxlength="11">
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
		</spring:bind>	
		<input type="button" name="PILIH" class="btn" value="pilih" onClick="javascript:lookupRole()">
		</td>
	    <td class="dataLabel"></td>
	    <td class="dataField"></td>
	</tr>
...
<script language="javascript">
	function simpan (){
		...
		document.form1.action = "roleaction-form";
		document.form1.submit();
	}
	function kembali (){
		document.form1.navigation.value = "back";
		document.form1.action = "roleaction";
		document.form1.submit();
	}
	// forreign affairs
		function lookupAction (){
		window.open ("action?navigation=lookup&url=roleaction-form","Search","width=700, height=550, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes,screenX=200,screenY=100");
	}
	function setAction (idx){
		document.form1.method = "POST";
		document.form1.notyet.value="true";
		document.form1.action = "roleaction-form";
		//document.form1.roleActionForm.actionId.value=idx;
		document.getElementById("actionId").value = idx;
		document.form1.submit();
		}
			function lookupRole (){
		window.open ("role?navigation=lookup&url=roleaction-form","Search","width=700, height=550, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes,screenX=200,screenY=100");
	}
	function setRole (idx){
		document.form1.method = "POST";
		document.form1.notyet.value="true";
		document.form1.action = "roleaction-form";
		//document.form1.roleActionForm.roleId.value=idx;
		document.getElementById("roleId").value = idx;
		document.form1.submit();
		}
