...
<form name="form1" method="GET" action="roleaction" >
...
<input type="hidden" name="arah" value="">
	<input type="hidden" name="roleActionId" value="<c:out value="${roleAction.roleActionId}" />">
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<c:forEach items="${RoleActions}" var="roleAction" varStatus="status" >
	<tr>

		<td width="30" align="center"><c:out value="${status.count}" /></td>
		<!-- ini default generated table from database -->
		   		   		   		   		   		   		   			<td width="30" align="center"><c:out value="${roleAction.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${roleAction.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${roleAction.roleActionId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setRoleAction (idx);
	window.close();
}
function goleft(){
