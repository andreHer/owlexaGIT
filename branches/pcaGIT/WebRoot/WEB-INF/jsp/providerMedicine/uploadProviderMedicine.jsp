...
<form action="providermedicine-upload" method="POST" enctype="multipart/form-data"   name="form1" id="form_layout">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<td class="dataField">
				<spring:bind path="providerMedicineForm.medicineFile">				
