...
<form action="refprovince-form" method="POST"  name="form1" id="form_layout">
	<spring:bind path="refProvinceForm.id">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
			<tr>
				<td class="dataLabel"> Country Id : </td>				
			

						<td class="dataField">
			<spring:bind path="refProvinceForm.countryId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Province Name : </td>				
			

			<td class="dataField">
			<spring:bind path="refProvinceForm.provinceName">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Province Code : </td>				
			

			<td class="dataField">
			<spring:bind path="refProvinceForm.provinceCode">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="refProvinceForm.description">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="refProvinceForm.longitude">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="refProvinceForm.latitude">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
