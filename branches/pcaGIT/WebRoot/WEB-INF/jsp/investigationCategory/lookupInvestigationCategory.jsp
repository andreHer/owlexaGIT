...
<form name="form1" method="GET" action="investigationcategory" >

 search By :
 <select name="searchby">

 		   			<option name="investigationCategoryName" <c:if test="${searchby eq \"investigationCategoryName\"}">selected="true"</c:if> >investigationCategoryName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Investigation Category Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${investigationCategory.investigationCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${investigationCategory.description}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${investigationCategory.investigationCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setInvestigationCategory (idx);
	window.close();
}
function goleft(){
