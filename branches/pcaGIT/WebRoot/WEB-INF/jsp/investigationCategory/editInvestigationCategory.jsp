...
<form action="investigationcategory-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="investigationCategoryForm.investigationCategoryId">
...
<input type="hidden" name="navigation" value="">
			...
			<td class="dataField">
			<spring:bind path="investigationCategoryForm.investigationCategoryName">
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="investigationCategoryForm.description">
