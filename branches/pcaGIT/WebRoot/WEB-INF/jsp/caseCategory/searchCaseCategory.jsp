...
<form name="form1" action="casecategory" method="POST">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Service Coverage</h3></td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Case Category Name &nbsp;
			<input type="hidden" name="sortByOrderCategoryName" value="<c:out value="${sortCaseCatName?'true':'false'}" />">
			<a href="javascript:carisort('categoryname')" class="listViewThLinkS1">
			<img src="images/arrow_<c:out value="${sortCaseCatName?'up':'down'}" />.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
		</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Case Category Code &nbsp;
			<input type="hidden" name="sortByOrderCategoryCode" value="<c:out value="${sortCaseCatCode?'true':'false'}" />">
			<a href="javascript:carisort('categorycode')" class="listViewThLinkS1">
			<img src="images/arrow_<c:out value="${sortCaseCatCode?'up':'down'}" />.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a>
		</td>   			
	...
	%>
	 <tr height="20">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
			<c:out value="${caseCategory.description}" />			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
			<a href="javascript:detil('<c:out value="${caseCategory.caseCategoryId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>
			
			<c:if test="${theUser.roleId.roleId ne 6}">
			<a href="javascript:ubah('<c:out value="${caseCategory.caseCategoryId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<a href="javascript:hapus('<c:out value="${caseCategory.caseCategoryId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.caseCategoryId.value = idx;
