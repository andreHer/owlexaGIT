...
<form action="memberactivationlog-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="memberActivationLogForm.memberActivationLogId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Member Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="memberActivationLogForm.memberId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="memberActivationLogForm.memberNumber">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="memberActivationLogForm.memberName">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="memberActivationLogForm.productCode">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Product Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="memberActivationLogForm.productId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Activation Time : </td>				
			

						<td class="dataField">
			<spring:bind path="memberActivationLogForm.activationTime">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Total Benefit Populated : </td>				
			

						<td class="dataField">
			<spring:bind path="memberActivationLogForm.totalBenefitPopulated">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Total Clausul Populated : </td>				
			

						<td class="dataField">
			<spring:bind path="memberActivationLogForm.totalClausulPopulated">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
