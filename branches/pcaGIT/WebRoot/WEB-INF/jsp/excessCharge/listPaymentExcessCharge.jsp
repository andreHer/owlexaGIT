...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Excess Charge</h3></td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Nilai Excess &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Paid Excess &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Outstanding &nbsp;</td>	   		   		   							
	...
	%>
	 <tr height="20">
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<fmt:formatNumber>
				<c:out value="${excessCharge.claimId.pembayaranDimuka}" />
			</fmt:formatNumber>			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<fmt:formatNumber>
				<c:out value="${excessCharge.claimId.claimExcessValue - excessCharge.claimId.pembayaranDimuka}" />
			</fmt:formatNumber>			
		</td>		   		   		
	 	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">		
			<img src="images/view.gif" alt="Export" align="absmiddle" border="0" onclick="javascript:printExcess(<c:out value="${excessCharge.excessChargeId}" />)">
	  	</td>
    </tr>
