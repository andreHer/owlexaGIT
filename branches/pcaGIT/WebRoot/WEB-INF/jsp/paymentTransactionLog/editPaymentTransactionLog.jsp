...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="paymenttransactionlog-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="paymentTransactionLogForm.idProses">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Claim Number : </td>				
						...
						<td class="dataField">
				<spring:bind path="paymentTransactionLogForm.claimNumber">
			...
			<tr>
				<td class="dataLabel"> No Voucher Number : </td>				
			
	
						<td class="dataField">
				<spring:bind path="paymentTransactionLogForm.noVoucherNumber">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Payment Date : </td>				
						...
						<td class="dataField">
			<spring:bind path="paymentTransactionLogForm.paymentDate">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="29">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Currency : </td>				
						...
						<td class="dataField">
				<spring:bind path="paymentTransactionLogForm.currency">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Amount Paid : </td>				
			
			<td class="dataField">
			<spring:bind path="paymentTransactionLogForm.amountPaid">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="17">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
			</spring:bind>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Bank Name : </td>				
						...
						<td class="dataField">
				<spring:bind path="paymentTransactionLogForm.bankName">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Account Name : </td>				
						...
						<td class="dataField">
				<spring:bind path="paymentTransactionLogForm.accountName">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Bank Code : </td>				
			

						<td class="dataField">
			<spring:bind path="paymentTransactionLogForm.bankCode">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Account Number : </td>				
						...
						<td class="dataField">
			<spring:bind path="paymentTransactionLogForm.accountNumber">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
