...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Conversation</h3></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Conversation</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
        ...
        <tbody>
          <tr>
			...
			<select name="searchby" class="inputbox">
 		   		   		...
 		   		   		<option value="conversationCategory" <c:if test="${searchby eq \"conversationCategory\"}">selected="true"</c:if> >Conversation Category</option>
...
<c:if test="${theUser.roleId.roleId eq 1 or theUser.roleId.roleId eq 2 or theUser.roleId.roleId eq 5 or theUser.roleId.roleId eq 0}">
	<input title="Add Conversation [Alt+Shift+C]" accesskey="C" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:tambahi()" name="addConverse" value=" Add Conversation " type="button">
	<br />
	<br />
</c:if>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		<td width="5%" nowrap="nowrap" class="listViewThS1" scope="col">No.</td>
			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Conversation Time &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Case Number &nbsp;</td>	
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Conversation Subject &nbsp;</td>			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Conversation Category &nbsp;</td>		   			
		<td scope="col" class="listViewThS1"  width="20%">Conversation Description &nbsp;</td>
		<td scope="col" class="listViewThS1"  width="5%"> &nbsp;</td>
	</tr>
	 ...
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
			<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
				<a href="caseconversation?navigation=detail&index=<c:out value="${index}" />&rowset=<c:out value="${rowset}" />&caseId=<c:out value="${caseConversation.caseId.caseId}" />&conversationId=<c:out value="${caseConversation.conversationId}" />" class="linkDetail"><c:out value="${caseConversation.conversationTime}" /></a>			
			...
			<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
      		...
      		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
		   	...
		   	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
				<c:out value="${caseConversation.conversationCategory.conversationCategoryName}" />			
			</td>
