...
<form action="edctransactionlog-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="edcTransactionLogForm.id">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Terminal Code : </td>				
			

			<td class="dataField">
			<spring:bind path="edcTransactionLogForm.terminalCode">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Merchant Code : </td>				
			

			<td class="dataField">
			<spring:bind path="edcTransactionLogForm.merchantCode">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Activity Time : </td>				
			

						<td class="dataField">
			<spring:bind path="edcTransactionLogForm.activityTime">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Activity Log : </td>				
			

		    <td class="dataField">
			<spring:bind path="edcTransactionLogForm.activityLog">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="edcTransactionLogForm.actionCode">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="edcTransactionLogForm.cardNumber">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="edcTransactionLogForm.memberNumber">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Trace Number : </td>				
			

			<td class="dataField">
			<spring:bind path="edcTransactionLogForm.traceNumber">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
