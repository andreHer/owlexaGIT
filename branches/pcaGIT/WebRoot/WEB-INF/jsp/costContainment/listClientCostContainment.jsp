...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif" alt="Call Search" border="0">&nbsp;List Client Cost Containment</h3></td>
...
<br />
<form name="form1" action="costcontainment" method="POST" >
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif" alt="Call Search" border="0">&nbsp;Search Client Cost Containment</h3></td>
      <td width="100%"><img src="images/blank.gif" alt="asd" height="1" width="1"></td>
    </tr>
  </tbody>
</table>
