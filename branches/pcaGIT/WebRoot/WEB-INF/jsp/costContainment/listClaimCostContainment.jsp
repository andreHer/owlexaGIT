...
<ul id="maintab" class="shadetabs">
	...
	<li>
		<a href="claim?navigation=detail&claimId=<c:out value="${claimId}" />" rel="tcontent1">Detail Claim</a>
	</li>
	<li>
		<a href="claimitem?memberId=<c:out value="${memberId}" />&claimId=<c:out value="${claimId}" />" rel="tcontent2">Claim Item</a>
	</li>	
	<li>
		<a href="memberbenefit?memberId=<c:out value="${memberId}" />&navigation=listclaim&claimId=<c:out value="${claimId}" />" rel="tcontent3">Member Benefit</a>
	</li>
	<li>
		<a href="memberclausul?memberId=<c:out value="${memberId}" />&navigation=listclaim&claimId=<c:out value="${claimId}" />" rel="tcontent4">Member Clausul</a>
	</li>
	<li>
		<a href="case?navigation=list&memberId=<c:out value="${memberId}" />&claimId=<c:out value="${claimId}" />" rel="tcontent5">Case History</a>
	</li>	
	<li>
		<a href="claiminvestigation?memberId=<c:out value="${memberId}" />&claimId=<c:out value="${claimId}" />" rel="tcontent6">Claim Investigation </a>
	</li>
	<li class="selected">
		<a href="costcontainment?navigation=listclaim&memberId=<c:out value="${memberId}" />&claimId=<c:out value="${claimId}" />" rel="tcontent6">Cost Containment </a>
	</li>				
</ul>
<br />
<form action="costcontainment" method="POST" >
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
                ...
                <select name="search_category">
					<c:forEach items="${costContainmentType}" var="ctype">
						<option value="<c:out value="${ctype.costContainmentTypeId}" />"><c:out value="${ctype.costContainmentTypeName}" /></option>
					</c:forEach>
				</select>
              </td>
	            <td class="dataLabel">
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Cost Containment Type</td>   			
	 ...
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
				<c:out value="${client.clientId.clientName}" />			
		</td>     
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
				<c:out value="${client.costContainmentType.costContainmentTypeName}" />			
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">			
