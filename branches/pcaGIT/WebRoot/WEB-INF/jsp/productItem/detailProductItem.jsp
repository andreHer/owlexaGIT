...
<form action="productitem" method="GET" name="form1" id="form_layout">
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="productitem?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&rowset=<c:out value="${rowser}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="productItemId" value="<c:out value="${productItem.productItemId}" />">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Product Id :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.productId}"/></td>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Item Id :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.itemId}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Created Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.createdTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.createdBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.deletedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.deletedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Modified Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.modifiedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.modifiedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Status :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${productItem.deletedStatus}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
...
<script language="javascript">
	...
	function ubah (){
		...
		document.form1.action = "productitem-form";
