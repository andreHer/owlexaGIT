...
<form name="form1" method="GET" action="claimitem" >

 search By :
 <select name="searchby">

 		   		   		   			<option name="claimItemRemarks" <c:if test="${searchby eq \"claimItemRemarks\"}">selected="true"</c:if> >claimItemRemarks</option>
			   			<option name="claimItemDescription" <c:if test="${searchby eq \"claimItemDescription\"}">selected="true"</c:if> >claimItemDescription</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   			<td width="30" align="center">Claim Item Remarks</td>
			   			<td width="30" align="center">Claim Item Description</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   			<td width="30" align="center"><c:out value="${claimItem.claimItemRemarks}" /></td>
			   			<td width="30" align="center"><c:out value="${claimItem.claimItemDescription}" /></td>
			   		   		   		   		   		   		   		   		   			<td width="30" align="center"><c:out value="${claimItem.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${claimItem.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${claimItem.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${claimItem.claimItemId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setClaimItem (idx);
	window.close();
}
function goleft(){
