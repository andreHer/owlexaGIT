...
<form name="form1" method="GET" action="policypayment" >
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="30" align="center">
			...
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${policyPayment.policyPaymentId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setPolicyPayment (idx);
	window.close();
}
function goleft(){
