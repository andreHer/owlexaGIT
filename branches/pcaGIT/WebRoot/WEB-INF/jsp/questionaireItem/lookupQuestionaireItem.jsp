...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${questionaireItem.questionaireItemId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setQuestionaireItem (idx);
	window.close();
}
function goleft(){
