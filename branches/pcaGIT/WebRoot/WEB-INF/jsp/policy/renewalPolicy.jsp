...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Renew Policy</h3></td>
      ...
      <td colspan="20"  style="padding: 0px;">
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%" colspan="3">
	      		<input type="text" name="renewalDate" id="renewalDate" value="<c:out value="${renewalDate}" />" maxlength="10">
					<img src="images/jscalendar.gif" alt="Enter Date" id="renewalDate_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
        					inputField     :    "renewalDate",     // id of the input field
        					ifFormat       :    "%Y-%m-%d",      // format of the input field
        					button         :    "renewalDate_trigger",  // trigger for the calendar (button ID)
  ...
  <tbody>
    <tr> 
      <td style="padding-bottom: 2px;">        
			...
			<input title="Terminate [Alt+T]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:extend()" name="renewBtn" value=" Renew Policy " type="button">
...
<script language="javascript">
	function extend (){
		var delConfirm = window.confirm ("Are You Sure Want To Renew This Policy Periode ?");
		if (delConfirm){
			document.form1.navigation.value = "renewal";
