...
<form name="form1" method="GET" action="servicecategory" >

 search By :
 <select name="searchby">

 		   			<option name="serviceCategoryName" <c:if test="${searchby eq \"serviceCategoryName\"}">selected="true"</c:if> >serviceCategoryName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Service Category Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${serviceCategory.serviceCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${serviceCategory.description}" /></td>
			   			<td width="30" align="center"><c:out value="${serviceCategory.serviceCode}" /></td>
			   		   			<td width="30" align="center"><c:out value="${serviceCategory.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${serviceCategory.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${serviceCategory.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${serviceCategory.serviceCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setServiceCategory (idx);
	window.close();
}
function goleft(){
