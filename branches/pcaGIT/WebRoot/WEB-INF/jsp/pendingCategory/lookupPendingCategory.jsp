...
<form name="form1" method="GET" action="pendingcategory" >

 search By :
 <select name="searchby">

 		   			<option name="pendingCategoryName" <c:if test="${searchby eq \"pendingCategoryName\"}">selected="true"</c:if> >pendingCategoryName</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Pending Category Name</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${pendingCategory.pendingCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${pendingCategory.description}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${pendingCategory.pendingCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setPendingCategory (idx);
	window.close();
}
function goleft(){
