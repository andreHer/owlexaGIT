...
<table class="tabForm" cellspacing="0" cellpadding="0">
	<thead>
		<tr height="20">
			...
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Item Category Code &nbsp;</td>			
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Item Category EDC Code &nbsp;</td>
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Item Category EDC Name &nbsp;</td>
