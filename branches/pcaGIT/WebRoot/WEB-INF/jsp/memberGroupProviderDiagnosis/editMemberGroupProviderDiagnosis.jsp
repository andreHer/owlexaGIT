...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="membergroupproviderdiagnosis-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="memberGroupProviderDiagnosisForm.memberGroupProviderDiagnosisId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Exclusion Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="memberGroupProviderDiagnosisForm.exclusionStatus">
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="memberGroupProviderDiagnosisForm.diagnosisId">
	...
	<tr>
		<td class="dataLabel">Member Group Provider Id : </td>		
		<td class="dataField">
		<spring:bind path="memberGroupProviderDiagnosisForm.memberGroupProviderId">
		<input type="hidden" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" >
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
		</spring:bind>	
			<input type="text" name="memberGroupProviderIdText" id="memberGroupProviderIdId" value="" size=35>
