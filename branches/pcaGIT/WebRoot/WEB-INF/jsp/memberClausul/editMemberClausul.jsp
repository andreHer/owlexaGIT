...
<form action="memberclausul-form" method="POST" name="form1" id="form_layout">
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody>
							...
							<spring:bind path="memberClausulForm.memberClausulId">
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.memberId">
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.clausulId">
										<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
										<div id="fredcaption">
											<c:out value="${status.errorMessage}" />
										</div>
							...
							<!--<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.createdTime">
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.createdBy">
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.deletedTime">
										<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
										<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
										<script type="text/javascript">
    					Calendar.setup({
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.deletedBy">
										<textarea cols="60" rows="8" name="<c:out value="${status.expression}"/>">
											<c:out value="${status.value}" />
										</textarea>
										<div id="fredcaption">
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.modifiedTime">
										<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
										<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
										<script type="text/javascript">
    					Calendar.setup({
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="memberClausulForm.modifiedBy">
										<textarea cols="60" rows="8" name="<c:out value="${status.expression}"/>">
											<c:out value="${status.value}" />
										</textarea>
										<div id="fredcaption">
