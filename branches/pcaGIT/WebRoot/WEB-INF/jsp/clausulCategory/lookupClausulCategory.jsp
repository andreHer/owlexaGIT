...
<form name="form1" method="GET" action="clausulcategory" >

 search By :
 <select name="searchby">

 		   			<option name="clausulCategoryName" <c:if test="${searchby eq \"clausulCategoryName\"}">selected="true"</c:if> >clausulCategoryName</option>
			   			<option name="clausulCategoryCode" <c:if test="${searchby eq \"clausulCategoryCode\"}">selected="true"</c:if> >clausulCategoryCode</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Clausul Category Name</td>
			   			<td width="30" align="center">Clausul Category Code</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${clausulCategory.clausulCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${clausulCategory.clausulCategoryCode}" /></td>
			   			<td width="30" align="center"><c:out value="${clausulCategory.description}" /></td>
			   		   			<td width="30" align="center"><c:out value="${clausulCategory.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${clausulCategory.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${clausulCategory.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${clausulCategory.clausulCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setClausulCategory (idx);
	window.close();
}
function goleft(){
