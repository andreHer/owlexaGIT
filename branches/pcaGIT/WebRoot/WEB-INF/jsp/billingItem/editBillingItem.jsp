...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="billingitem-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="billingItemForm.billingItemId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Invoice Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="billingItemForm.invoiceId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Item Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="billingItemForm.itemId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Billing Value : </td>				
			
			<td class="dataField">
			<spring:bind path="billingItemForm.billingValue">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Billing Status : </td>				
			

						<td class="dataField">
			<spring:bind path="billingItemForm.billingStatus">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Claim Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="billingItemForm.claimStatus">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="11">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Member Name : </td>				
						...
						<td class="dataField">
				<spring:bind path="billingItemForm.memberName">
			...
			<tr>
				<td class="dataLabel"> Policy Number : </td>				
						...
						<td class="dataField">
				<spring:bind path="billingItemForm.policyNumber">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Member Number : </td>				
						...
						<td class="dataField">
				<spring:bind path="billingItemForm.memberNumber">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Claim Number : </td>				
						...
						<td class="dataField">
				<spring:bind path="billingItemForm.claimNumber">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="billingItemForm.memberImportId">
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="billingItemForm.claimId">
		<input type="hidden" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" >
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="billingItemForm.clientId">
		<input type="hidden" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" >
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
		</spring:bind>	
			<input type="text" name="clientIdText" id="clientIdId" value="" size=35>
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="billingItemForm.memberId">
		<input type="hidden" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" >
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="billingItemForm.policyId">
		<input type="hidden" name="<c:out value="${status.expression}"/>" id="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" >
			<div id="fredcaption">
				<c:out value="${status.errorMessage}" />
			</div>
		</spring:bind>	
			<input type="text" name="policyIdText" id="policyIdId" value="" size=35>
...
<script language="javascript">
	...
	function simpan (){
		...
		document.form1.action = "billingitem-form";
		document.form1.submit();
	}
	function kembali (){
		document.form1.navigation.value = "back";
		document.form1.action = "billingitem";
		document.form1.submit();
	}
	// forreign affairs
