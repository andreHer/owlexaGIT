...
<form name="form1" action="billingitem" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="billingItemId" value="<c:out value="${billingItem.billingItemId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Billing Item</h3></td>
...
<!-- ini default generated table from database -->
	...
	<c:forEach items="${BillingItems}" var="billingItem" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
			...
			<slot>
				<c:out value="${billingItem.memberName}" />
			</slot>
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<slot>
				<c:out value="${billingItem.policyNumber}" />
			</slot>
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<slot>
				<c:out value="${billingItem.memberNumber}" />
			</slot>
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<slot>
				<c:out value="${billingItem.claimNumber}" />
			</slot>
		</td>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.billingItemId.value = idx;
