...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${productTypePoliklinik.productTypePoliklinikId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProductTypePoliklinik (idx);
	window.close();
}
function goleft(){
