...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${scheduledPayment.id}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setScheduledPayment (idx);
	window.close();
}
function goleft(){
