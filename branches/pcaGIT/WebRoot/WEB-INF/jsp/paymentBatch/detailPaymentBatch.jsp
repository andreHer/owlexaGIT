  ...
  <tbody>
    <tr> 
      <td style="padding-bottom: 2px;">        
	        ...
	        <c:if test="${paymentBatch.batchStatus eq 0}">
		        ...
		        <input title="Hapus [Alt+H]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:exportBCA()" name="exBCA" value=" Export BCA Format " type="button">    
		            		
		        <input title="Hapus [Alt+H]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:exportMandiri()" name="exMandiri" value=" Export Mandiri Format " type="button">
				
				<input title="Export Disposition [Alt+H]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:exportDisposition()" name="exDispo" value=" Export Disposition " type="button">
				
				<input title="Export Excess [Alt+H]" accesskey="H" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:exportExcess()" name="exExcess" value=" Export Excess " type="button">
  ...
  <tbody>
	...
	<tr>
	      ...
	      <td class="tabDetailViewDL" valign="top" width="17%">Modified Time :&nbsp;</td>
			...
			<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Download Date :&nbsp;</td>
		  
			 
	      <td class="tabDetailViewDF" valign="top" width="33%">
	      	<input type="text" size="15" name="downloadDate" id="downloadDate" value="" maxlength="10" style="border-color:  #000 ; ">
...
<script language="javascript">
	...
	function confirmPayment (){
		document.form1.navigation.value = "preconfirm";
		document.form1.action = "paymentbatch";
		document.form1.method = "GET";
		document.form1.submit();
	}
	...
	function exportExcess (){
		document.form1.navigation.value = "exportrecap";
