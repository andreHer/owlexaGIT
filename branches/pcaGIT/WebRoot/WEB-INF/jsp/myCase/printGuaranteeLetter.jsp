...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="90%" >
  <tbody>
	...
	<tr style="border: 1px solid; border-color: #000; color: #000; solid #000; ">
		<td class="tabDetailViewDF" align=center  style="border-bottom: 1px; color: #000; solid #000; font-size: 11px; font-weight: bold;" colspan=12>Nomor : </td>
...
<table class="tabDetailView"  border="0" cellpadding="0" cellspacing="0" width="90%" >
  <tbody>
	...
	<tr style="border-left: 1px solid;border-right: 1px solid; border-color: #000; color: #000; solid #000; ">
		...
		<td class="tabDetailViewDF" style="border: 0px; color: #000; solid #000; font-size: 12px;" colspan=11></td>
...
<table class="tabDetailView"  border="0" cellpadding="0" cellspacing="0" width="90%" >
  <tbody>
	<tr >		
		...
		<font style="font-weight: bolder;">Catatan:</font>  
		</td>
