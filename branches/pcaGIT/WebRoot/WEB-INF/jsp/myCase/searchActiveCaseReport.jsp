...
<input type="hidden" name="navigation" value="gosearchactive">
					...
					<td class="dataLabel" nowrap="nowrap">				
						...
						<%
						   ...
						   if(caseCategory.length > 1){ 
						   	String panjang[] = new String[2];

						   	
							String caseCategoryString = caseCategory[0];							
							panjang[0] = caseCategoryString;
							panjang[1] = caseCategory[1];
						 ...
						 %>
						 	<c:set var="caseCategoryId2" value="<%= panjang%>"> </c:set> 
								<option value="1" <c:if test="${caseCategoryId2[0] eq \"1\"}">selected="true"</c:if>>
								 ...
								 <option value="3" <c:if test="${caseCategoryId2[1] eq \"3\"}">selected="true"</c:if>>
									MATERNITY
								</option>							
...
function cari (){
	document.form1.navigation.value = "gosearchactive";
	document.form1.action = "case";
	document.form1.method = "POST";
	document.form1.submit();
}
function downloadExcel (){
	document.form1.navigation.value = "downloadactive";
	document.form1.action = "case";
	document.form1.method = "POST";
	document.form1.submit();
}
...
function carisort(param){
	document.form1.navigation.value = "gosearchactivebysort";
