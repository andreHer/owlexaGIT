...
<input type="hidden" name="navigation" value="reversalrefer">
  ...
  <tbody>
    <tr>
      <td colspan="20"  style="padding: 0px;">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Assignment Notes :&nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="33%" colspan="3">
  ...
  <tbody>
    <tr>
      <td style="padding-top: 2px;">
        ...
        <input title="Save [Alt+Shift+S]" accesskey="S" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:assignCase()" name="Save" value=" Assign Case " type="submit">
...
<script language="javascript">
	...
	function assignCase (){
		...
		var stat = document.form1.assigneeId.value;
		var note = document.form1.note.value;
		var isError = 0;
		
		if (stat == ''){
			window.alert("Please Choose Assigned User");
			isError = 1;
		}
		if (note == ''){
		...
		if (isError == 0){
			var delConfirm = window.confirm ("Are You Sure Want To Assign This Case ?");
			if (delConfirm){
				document.form1.navigation.value = "assigncase";
				document.form1.action = "case";
