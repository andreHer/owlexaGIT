...
<input type="hidden" name="navigation" value="docanceldischarge">
      ...
      <td colspan="20"  style="padding: 0px;">
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%" colspan="3">	      	
	      		<textarea rows="8" cols="60" name="reason" style="border: 1px #000 solid;"><c:out value="${status.value}" /></textarea>	      		      
	      </td>	      
	    </tr>
  ...
  <tbody>
    <tr>
      <td style="padding-top: 2px;">
        ...
        <input title="Save [Alt+Shift+S]" accesskey="S" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:cancelDischarge()" name="Save" value=" Cancel Discharge " type="submit">
...
<script language="javascript">
	...
	function cancelDischarge (){
		...
		var delConfirm = window.confirm ("Are You Sure Want To Cancel Discharge This Case ?");
		if (delConfirm){
			document.form1.navigation.value = "docanceldischarge";
