  ...
  <tbody>
    <tr>
      <td colspan="20"  style="padding: 0px;">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Reversal Notes :&nbsp;</td>
  ...
  <tbody>
    <tr>
      <td style="padding-top: 2px;">
        ...
        <input title="Save [Alt+Shift+S]" accesskey="S" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:approveExGratia()" name="Save" value=" Submit Reversal " type="submit">
...
<script language="javascript">
	...
	function reversalRefer (){
	
		var delConfirm = window.confirm ("Are You Sure Want To Reverse This Refered Case ?");
		if (delConfirm){
			document.form1.navigation.value = "reversalrefer";
			document.form1.action = "case";
