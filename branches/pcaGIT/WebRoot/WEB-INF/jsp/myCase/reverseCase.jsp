...
<form action="exgratia-form" method="POST" enctype="multipart/form-data" name="form1" id="form_layout">

<input type="hidden" name="navigation" value="approveexgratia">
  ...
  <tbody>
    <tr>
      <td colspan="20"  style="padding: 0px;">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Approval Notes :&nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="33%" colspan="3">
	      	<spring:bind path="myCaseForm.approvalNote">
	      	<textarea rows="8" cols="60" name="<c:out value="${status.expression}" />" style="border: 1px #000 solid;"><c:out value="${status.value}" /></textarea>
	      	</spring:bind>	      
	      </td>	      
	    </tr>
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">ExGratia Document :&nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="33%" colspan="3">
	      		<spring:bind path="myCaseForm.multipartFile">
  ...
  <tbody>
    <tr>
      <td style="padding-top: 2px;">
        ...
        <input title="Save [Alt+Shift+S]" accesskey="S" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:approveExGratia()" name="Save" value=" Approve " type="submit">
...
<script language="javascript">
	...
	function approveExGratia (){
		...
		var delConfirm = window.confirm ("Are You Sure Want To Approve This Case ?");
		if (delConfirm){
