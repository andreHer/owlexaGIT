...
<ul id="maintab" class="shadetabs">
	...
	<li>
		<a href="edcterminal?navigation=listprovider&providerId=<c:out value="${providerId}" />" rel="tcontent6">EDC Terminal</a>                
	</li>	
	<li>
...
<input type="hidden" name="currentnavigation" value="listprovider" >
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;<c:out value="${name}" />'s Case</h3></td>
...
<!-- ini default generated table from database -->
				...
				<a href="case?navigation=listprovider&providerId=<c:out value="${providerId}" />&sortby=case_number&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">
				...
				<a href="case?navigation=listprovider&providerId=<c:out value="${providerId}" />&sortby=member_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">
				Member Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			   			
			   	<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">
				<a href="case?navigation=listprovider&providerId=<c:out value="${providerId}" />&sortby=provider&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">
				Case Date &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			   		
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">
				<a href="case?navigation=listprovider&providerId=<c:out value="${providerId}" />&sortby=physician&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">
				Category &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
				   		   		   			
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">
				<a href="case?navigation=listprovider&providerId=<c:out value="${providerId}" />&sortby=diagnosis1Id&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">
				Diagnosis &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
				   			
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">
				<a href="case?navigation=listprovider&providerId=<c:out value="${providerId}" />&sortby=status&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">
				Status &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${myCase.caseId}" />')">
