...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Provider Doctor</h3></td>
...
<form name="form1" action="providerdoctor" method="POST">
<input type="hidden" name="navigation" value="list">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
<input type="hidden" name="providerDoctor" value="<c:out value="${providerDoctor.providerDoctorId}" />">
<input type="hidden" name="providerId" value="<c:out value="${providerId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Provider Doctor</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
          ...
          <tr>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
 		   			...
 		   			<option value="doctorName" <c:if test="${searchby eq \"doctorName\"}">selected="true"</c:if> >Doctor Name</option>
			   			<option value="poliklinikName" <c:if test="${searchby eq \"poliklinikName\"}">selected="true"</c:if> >Poliklinik</option>
...
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:tambahi()" value=" Add Doctor ">
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:upload()" value=" Upload Doctor">
</c:if>
<br />
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		<td width="2%" nowrap="nowrap" class="listViewThS1" scope="col">No.</td>
			...
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Monday</td>
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Tuesday</td>
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Wednesday</td>
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Thursday</td>
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Friday</td>
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Saturday</td>
			<td scope="col" class="listViewThS1" nowrap="nowrap" width="7%">Sunday</td>
			<c:if test="${theUser.userType eq 2}">
				<c:if test="${theUser.roleId.roleId eq 0 or theUser.roleId.roleId eq 6}">			   			
					<td scope="col" class="listViewThS1"  style="text-align: center;" nowrap="nowrap" width="5%">&nbsp;</td>
				</c:if>
			</c:if>
	...
	<c:forEach items="${ProviderDoctors}" var="providerDoctor" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr  height="20">
		...
		<c:if test="${theUser.userType eq 2}">
			<c:if test="${theUser.roleId.roleId eq 0 or theUser.roleId.roleId eq 6}">
				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" style="text-align: center;" valign="top" >
					
					<!-- ini default edit table for each data -->
					<a href="javascript:ubah('<c:out value="${providerDoctor.providerDoctorId}" />')">
						<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>
		
					<!-- ini default delete table for each data -->
					<a href="javascript:hapus('<c:out value="${providerDoctor.providerDoctorId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.providerDoctor.value = idx;
		document.form1.action = "providerdoctor";
