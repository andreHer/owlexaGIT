...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%" >
  <tbody>
		...
		<tr>
		  ...
		  <td class="tabDetailViewDF" valign="top" width="15%" style="border: 0px solid #000; font-size: 12px; color: #000;"><c:if test="${batchClaim.paymentRecipient.paymentRecipientId eq 3}"><c:out value="${batchClaim.providerId.providerName}" /></c:if> 
		  <c:if test="${batchClaim.paymentRecipient.paymentRecipientId eq 2}"><c:out value="${batchClaim.memberId.memberGroupId.groupName}" /></c:if><c:if test="${batchClaim.paymentRecipient.paymentRecipientId eq 1}"><c:out value="${batchClaim.memberGroupId.groupName}" /></c:if> </td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" colspan="8" class="listViewThS1" nowrap="nowrap" width="70%">&nbsp;</td>
	</tr>
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Nilai Klaim &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Ditolak &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Disetujui &nbsp;</td>
		<td scope="col" class="listViewThS1" width="10%">Excess Sudah Dibayar &nbsp;</td>
		<td scope="col" class="listViewThS1" width="10%">Excess Belum Dibayar &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Refund &nbsp;</td>
	</tr>
	...
	<c:set var="claimRefundValue" value="0"  scope="request" />
	<c:set var="prePaidExcessValue" value="0"  scope="request" />
	...
	<c:forEach items="${reports}" var="claim" varStatus="status" >
		...
		<tr height="20">
			...
			<c:forEach items="${claimItem}" var="ci" varStatus="ciStatus">
				...
				<c:set var="prePaidExcessValue" value="${prePaidExcessValue+ci.prePaidExcess}"></c:set>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
				...
				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
						...
						<font style="font-size: 10px">
						<c:if test="${ci.claimId.claimTypeId.claimTypeId eq 2}">
						<fmt:formatNumber><c:out value="${ci.refund}" />
		   ...
		   <tr height="20">
		      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"></td>
				...
				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" colspan="10">
...
<!-- ini default generated table from database -->
				...
				<fmt:formatNumber ><c:out value="${claimChargeValue }" /></fmt:formatNumber></td>
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%" style="text-align: right;">
				<fmt:formatNumber ><c:out value="${ claimChargeValue - claimApprovedValue }" /></fmt:formatNumber></td>
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%"  style="text-align: right;">
				<fmt:formatNumber><c:out value="${prePaidExcessValue}" /></fmt:formatNumber>
				</td>
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%"  style="text-align: right;">
					<c:if test="${ci.claimId.claimTypeId.claimTypeId eq 2}">
  ...
  <tbody>
	...
	<tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber ><c:out value="${batchClaim.batchClaimInitialValue  - pembayaranDimuka}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber ><c:out value="${batchClaim.biayaMaterai}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
    	...
    	<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber><c:out value="${batchClaim.batchClaimFinalValue+payment.batchClaim.biayaMaterai}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber><c:out value="${batchClaim.batchClaimInitialValue - batchClaim.batchClaimFinalValue -pembulatan - pembayaranDimuka}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
...
<!-- ini default generated table from database -->
				...
				<td scope="col" class="listViewThS1" colspan="6" nowrap="nowrap" width="20%">
	...
	<tr height="20">
		<td width="6%" nowrap="nowrap" class="listViewThS1" scope="col">
			<img src="images/blank.gif" alt="asd" height="1" width="1">No.</td>		
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Nomor Peserta</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Nama Peserta&nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Nomor Klaim &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Nilai Klaim &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Ditolak &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Disetujui &nbsp;</td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
		   ...
		   <tr height="20">
		      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"></td>
				...
				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" colspan="12">
  ...
  <tbody>
	...
	<tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDL" valign="top" width="15%" style="text-align: left; color: #000; font-size: 10px;">&nbsp;Jumlah Diajukan &nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber ><c:out value="${batchClaim.batchClaimInitialValue}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDL" valign="top" width="15%" style="text-align: left; color: #000; font-size: 10px;">&nbsp;Jumlah Ditolak &nbsp;</td>
	      <td class="tabDetailViewDF" valign="top" width="20%" style="border: 0px solid #000; font-size: 10px;">Rp. <input type="text" value="<fmt:formatNumber><c:out value="${batchClaim.batchClaimInitialValue - batchClaim.batchClaimFinalValue -pembulatan}" /></fmt:formatNumber> " width="20"  style="border: 0px solid #000; color: #000; text-align: right;"></td>
