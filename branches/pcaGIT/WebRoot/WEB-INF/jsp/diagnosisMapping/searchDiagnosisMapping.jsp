...
<!-- ini default generated table from database -->
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Client Diagnosis Code</td>
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${diagnosisMapping.diagnosisMappingId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${diagnosisMapping.diagnosisMappingId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${diagnosisMapping.diagnosisMappingId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.diagnosisMappingId.value = idx;
