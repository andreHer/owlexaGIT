...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="diagnosismapping-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="diagnosisMappingForm.diagnosisMappingId">
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Client Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="diagnosisMappingForm.clientId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Diagnosis Code : </td>				
						...
						<td class="dataField">
				<spring:bind path="diagnosisMappingForm.diagnosisCode">
			...
			<tr>
				<td class="dataLabel"> Diagnosis Name : </td>				
						...
						<td class="dataField">
				<spring:bind path="diagnosisMappingForm.diagnosisName">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Description : </td>				
						...
						<td class="dataField">
				<spring:bind path="diagnosisMappingForm.description">
			...
			<tr>
				<td class="dataLabel"> Client Diagnosis Code : </td>				
			
	
						<td class="dataField">
				<spring:bind path="diagnosisMappingForm.clientDiagnosisCode">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Member Group Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="diagnosisMappingForm.memberGroupId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Diagnosis Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="diagnosisMappingForm.diagnosisId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
