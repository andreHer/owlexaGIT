...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="cardtype-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="cardTypeForm.cardTypeId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Card Type Name : </td>				
			
	
						<td class="dataField">
				<spring:bind path="cardTypeForm.cardTypeName">
			...
			<tr>
				<td class="dataLabel"> Card Type Code : </td>				
			
	
						<td class="dataField">
				<spring:bind path="cardTypeForm.cardTypeCode">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Description : </td>				
						...
						<td class="dataField">
				<spring:bind path="cardTypeForm.description">
