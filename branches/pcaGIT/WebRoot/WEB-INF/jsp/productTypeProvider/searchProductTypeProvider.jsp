...
<form name="form1" action="producttypeprovider" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">

<input type="hidden" name="index" value="<c:out value="${index}" />">
<input type="hidden" name="productTypeProviderId" value="<c:out value="${productTypeProvider.productTypeProviderId}" />">

<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Provider List</h3></td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<c:forEach items="${ProductTypeProviders}" var="productTypeProvider" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	 ...
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
				...
				<c:out value="${productTypeProvider.providerId.providerName}" />
			
		</td>
      	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${productTypeProvider.description}" />
		...
		<a href="javascript:detil('<c:out value="${productTypeProvider.productTypeProviderId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${productTypeProvider.productTypeProviderId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${productTypeProvider.productTypeProviderId}" />')">
...
function tambahi (){
	...
	document.form1.action = "producttypeprovider-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.productTypeProviderId.value = idx;
		document.form1.action = "producttypeprovider";
