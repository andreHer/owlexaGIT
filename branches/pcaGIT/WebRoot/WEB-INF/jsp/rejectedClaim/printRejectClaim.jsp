...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="90%" >
  <tbody>    
		<tr>
	      ...
	      <img src="images/logo/owlexa.png" width="160" height="80"> &nbsp;</td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="90%" border="0" style="border: 0px;">
	<tbody>
...
<table class="listView" cellspacing="0" cellpadding="0" width="90%" border="0" style="border: 0px;">
	<tbody>
		<tr>
			...
			Berdasarkan hasil verifikasi yang dilakukan terhadap permohonan klaim anda maka dengan sangat menyesal kami tidak dapat
			memenuhi penggantian klaim Bapak/Ibu ini. Adapun alasan dari penolakan klaim ini adalah sebagai berikut: <br />
			<br />
			<b>
			<c:out value="${rejectedClaim.description}" /></b>
			</td>
		...
		<tr>
			...
			Dan bersama surat ini kami kembalikan berkas klaim asli yang diajukan.
			</td>
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="90%" >
  <tbody>
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td align="left" style="font-size: 13px; text-align: left;"><font color="#000"> ................. </font></td>
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td  align="left" style="font-size: 13px;"><font color="#000"> Claim Department Manager </font></td>
	</tr>		
