...
<form name="form1" action="cardprinting" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="cardPrintingId" value="<c:out value="${cardPrinting.cardPrintingId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Card Printing</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap"><slot>Search Category:</slot>
              ...
              <slot>
								 ...
								 <select name="searchby" class="inputbox">
 		   		   		   			...
 		   		   		   			<option value="printingNumber" <c:if test="${searchby eq \"printingNumber\"}">selected="true"</c:if> >Printing Number</option>
...
<!-- ini default generated table from database -->
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Printing Number</td>
	...
	<c:forEach items="${CardPrintings}" var="cardPrinting" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
			...
			<slot>
				<c:out value="${cardPrinting.printingNumber}" />
			</slot>
		</td>
					   		   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<slot>
				<c:out value="${cardPrinting.description}" />
			</slot>
		</td>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.cardPrintingId.value = idx;
		document.form1.action = "cardprinting";
