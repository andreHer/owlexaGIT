...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="cardprinting-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="cardPrintingForm.cardPrintingId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Printing Date : </td>				
			

						<td class="dataField">
			<spring:bind path="cardPrintingForm.printingDate">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Printing Number : </td>				
			
	
						<td class="dataField">
				<spring:bind path="cardPrintingForm.printingNumber">
			...
			<tr>
				<td class="dataLabel"> Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="cardPrintingForm.status">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Description : </td>				
						...
						<td class="dataField">
				<spring:bind path="cardPrintingForm.description">
	...
	<tr>
		...
		<td class="dataField">
		<spring:bind path="cardPrintingForm.clientId">
