...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Diagnosis Set</h3></td>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%">Diagnosis Set Name</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Diagnosis Set Code</td>
	...
	%>
	 <tr  height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${diagnosisSet.diagnosisSetId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

  	        <c:if test="${theUser.roleId.roleId ne 6}">
				<a href="javascript:ubah('<c:out value="${diagnosisSet.diagnosisSetId}" />')">
					<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>
	
				<a href="javascript:hapus('<c:out value="${diagnosisSet.diagnosisSetId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.diagnosisSetId.value = idx;
