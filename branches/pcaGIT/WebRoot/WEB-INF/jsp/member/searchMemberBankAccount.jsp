...
<form name="form1" action="member" method="POST">
	<input type="hidden" name="navigation" value="gosearchaccount">
						...
						<tbody>
							<tr>
								...
								<td class="dataLabel">
									...
									<input title="Clear [Alt+Shift+C]" accesskey="C" onClick="javascrip:download();" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="clear" value=" Download " type="button">
								</td>
							</tr>
			...
			%>
				<tr onMouseOver="'" onMouseOut=""
					...
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
						...
						<c:out value="${member.bank}" />
						
					</td>
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
						
						<c:out value="${member.bankAccount}" />
						
					</td>		
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
						
						<c:out value="${member.bankAccountName}" />
					...
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
						...
						<c:if test="${member.status.statusId eq -1}">
...
<%
String nav="";
if(request.getAttribute("navigation").equals("gosearchaccount")||request.getAttribute("navigation").equals("golookup")){
...
function goleft(){
	document.form1.navigation.value = "gosearchaccount";
...
function download (){
	...
	document.form1.action = "member";
	document.form1.method = "POST";
	document.form1.navigation.value = "downloadaccount";
	document.form1.submit();
}
function detil (idx){
	document.form1.method = "POST";
