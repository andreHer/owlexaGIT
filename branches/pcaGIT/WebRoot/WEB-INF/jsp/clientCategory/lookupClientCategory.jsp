...
<form name="form1" method="GET" action="clientcategory" >

 search By :
 <select name="searchby">

 		   			<option name="clientCategoryName" <c:if test="${searchby eq \"clientCategoryName\"}">selected="true"</c:if> >clientCategoryName</option>
			   			<option name="clientCategoryCode" <c:if test="${searchby eq \"clientCategoryCode\"}">selected="true"</c:if> >clientCategoryCode</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Client Category Name</td>
			   			<td width="30" align="center">Client Category Code</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${clientCategory.clientCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${clientCategory.clientCategoryCode}" /></td>
			   			<td width="30" align="center"><c:out value="${clientCategory.description}" /></td>
			   		   			<td width="30" align="center"><c:out value="${clientCategory.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${clientCategory.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${clientCategory.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${clientCategory.clientCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setClientCategory (idx);
	window.close();
}
function goleft(){
