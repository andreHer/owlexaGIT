...
<form action="clientcategory-form" method="POST" name="form1" id="form_layout">
	...
	<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			...
			if (alert != null && !alert.trim().equals("")) {%>
							...
							<spring:bind path="clientCategoryForm.clientCategoryId">
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="clientCategoryForm.clientCategoryName">
							...
							<tr>
								...
								<td class="dataField">
									<spring:bind path="clientCategoryForm.clientCategoryCode">
							...
							<tr>
								...
								<td class="dataField" colspan="2">
									<spring:bind path="clientCategoryForm.description">
