...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif" alt="Call Search" border="0">&nbsp;Search Currency</h3></td>
...
<div class="table_container">
	<!-- Table Toolbar Start -->
		...
		<div id="search_float"<%=nampak%>>
			<h4>
				<c:out value="${SEARCH}" /> Data currency
			</h4>
			<form name=form1 onSubmit="cari()">
				...
				<label for="status">
				 ...
				 <select name="searchby" class="inputbox">
 		   			...
 		   			<option name="currencyCode" <c:if test="${searchby eq \"currencyCode\"}">selected="true"</c:if> >Currency Code</option>
			   			<option name="currencyName" <c:if test="${searchby eq \"currencyName\"}">selected="true"</c:if> >Currency Name</option>
			   			<option name="description" <c:if test="${searchby eq \"description\"}">selected="true"</c:if> >Description</option>
			   		   			...
			   		   			<option name="updatedBy" <c:if test="${searchby eq \"updatedBy\"}">selected="true"</c:if> >Updated By</option>
...
<LABEL><c:out value="${LIST_OF}" />  Currency</LABEL>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.currencyId.value = idx;
