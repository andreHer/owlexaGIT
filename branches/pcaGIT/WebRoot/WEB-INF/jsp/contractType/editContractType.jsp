...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="contracttype-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="contractTypeForm.contractTypeId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Contract Type Name : </td>				
			
	
						<td class="dataField">
				<spring:bind path="contractTypeForm.contractTypeName">
			...
			<tr>
				<td class="dataLabel"> Contract Type Code : </td>				
			
	
						<td class="dataField">
				<spring:bind path="contractTypeForm.contractTypeCode">
				<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" >
					<div id="fredcaption">
						<c:out value="${status.errorMessage}" />
					</div>
			...
			<tr>
				<td class="dataLabel"> Contract Charge Type : </td>				
			

						<td class="dataField">
			<spring:bind path="contractTypeForm.contractChargeType">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="2">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Contract Charge Per Member : </td>				
			
			<td class="dataField">
			<spring:bind path="contractTypeForm.contractChargePerMember">
