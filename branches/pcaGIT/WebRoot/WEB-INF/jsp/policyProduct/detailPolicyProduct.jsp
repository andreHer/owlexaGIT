...
<h1>Policy Product</h1>

<form action="policyproduct" method="GET" name="form1" id="form_layout">
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="policyproduct?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="policyProductId" value="<c:out value="${policyProduct.policyProductId}" />">
			...
			<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Total :&nbsp;</td>
		  
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${policyProduct.total}"/></td>
	...
	<h2>Foreign Affair</h2>
		...
		<label for="Policy Id">Policy Id</label>
			<div id="ffbox">
			<c:out value="${policyProduct.policyId.policyId}" />
			</div>
	
		<label for="Product Id">Product Id</label>
			<div id="ffbox">
			<c:out value="${policyProduct.productId.productId}" />
			</div>
