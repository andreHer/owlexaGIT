...
<input type="hidden" name="tipe" value="broker" />
<input type="hidden" name="refId" value="<c:out value="${brokerId}" />" />
<input type="hidden" name="previousURL" value="bankaccount?navigation=listbroker&brokerId=<c:out value="${brokerId}" />" />
