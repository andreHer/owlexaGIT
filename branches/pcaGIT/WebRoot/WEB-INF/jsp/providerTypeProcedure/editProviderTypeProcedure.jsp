...
<form action="providertypeprocedure-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="providerTypeProcedureForm.providerTypeProcedureId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Provider Type Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.providerTypeId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Procedure Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.procedureId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Treatment Class Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.treatmentClassId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Treatment Risk Id : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.treatmentRiskId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="3">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.alos">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.treatmentRate">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}" /></fmt:formatNumber>" maxlength="22">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="providerTypeProcedureForm.description">
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="providerTypeProcedureForm.referenceNote">
			<textarea class="inputbox" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Created Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.createdTime">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.createdBy">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Modified Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.modifiedTime">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
					<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.modifiedBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Deleted Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.deletedTime">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
					<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="providerTypeProcedureForm.deletedBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
