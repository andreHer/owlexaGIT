...
<form name="form1" action="providertypeprocedure" method="POST">
<input type="hidden" name="navigation" value="gosearch">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="providerTypeProcedureId" value="<c:out value="${providerTypeProcedure.providerTypeProcedureId}" />">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Provider Type Procedure</h3></td>
      ...
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
			...
			<a target="_blank" href="providertypeprocedure?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="providertypeprocedure?navigation=search&sortby=description&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Description &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="providertypeprocedure?navigation=search&sortby=reference_note&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Reference Note &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	<c:forEach items="${ProviderTypeProcedures}" var="providerTypeProcedure" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr onMouseOver="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'over', '#e7f0fe', '#FFFFFF', '');" onMouseOut="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'out', '#e7f0fe', '#FFFFFF', '');" onMouseDown="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'click', '#e7f0fe', '#FFFFFF', '');" height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${providerTypeProcedure.description}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${providerTypeProcedure.referenceNote}" />
		...
		<a href="javascript:detil('<c:out value="${providerTypeProcedure.providerTypeProcedureId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${providerTypeProcedure.providerTypeProcedureId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${providerTypeProcedure.providerTypeProcedureId}" />')">
...
<tr>
            <td class="listViewPaginationTdS1" align="left"><a target="_blank" href="providertypeprocedure?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function tambahi (){
	...
	document.form1.action = "providertypeprocedure-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.providerTypeProcedureId.value = idx;
		document.form1.action = "providertypeprocedure";
