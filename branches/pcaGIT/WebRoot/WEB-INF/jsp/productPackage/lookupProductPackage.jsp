...
<form name="form1" method="GET" action="productpackage" >
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   		   			<td width="30" align="center"><c:out value="${productPackage.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${productPackage.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${productPackage.modifiedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${productPackage.productPackageId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setProductPackage (idx);
	window.close();
}
function goleft(){
