...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="cardstockusage-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="cardStockUsageForm.id">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Card Print Batch Number : </td>				
			
	
						<td class="dataField">
				<spring:bind path="cardStockUsageForm.cardPrintBatchNumber">
			...
			<tr>
				<td class="dataLabel"> Card Print Batch Date : </td>				
			

						<td class="dataField">
			<spring:bind path="cardStockUsageForm.cardPrintBatchDate">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Card Stock Id : </td>				
			

						<td class="dataField">
			<spring:bind path="cardStockUsageForm.cardStockId">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Card Print Total : </td>				
			

						<td class="dataField">
			<spring:bind path="cardStockUsageForm.cardPrintTotal">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="10">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Status : </td>				
						...
						<td class="dataField">
			<spring:bind path="cardStockUsageForm.status">
