...
<form name="form1" action="membergroup" method="GET">
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
			<a target="_blank" href="membergroup?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="membergroup?navigation=search&sortby=group_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Group Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="membergroup?navigation=search&sortby=province&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Province &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="membergroup?navigation=search&sortby=policy_number&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Policy Number &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${memberGroup.groupName}" />
		 ...
		 <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
			<input type="button" name="pilihButton" value="choose" align="center" onclick="javascript:pilih('<c:out value="${memberGroup.memberGroupId}" />','<c:out value="${memberGroup.groupName}" />')" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus">
	  </td>
    </tr>
...
<tr>
            <td  align="left"><a target="_blank" href="membergroup?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function pilih (idx, nama){
	window.opener.setMemberGroup (idx,nama);
	window.close();
}
function goleft(){
