...
<div id="content">
	<table class="box">
		<tr>
			<th colspan="2">KONFIRMASI MEDIS MATERNITY (SECTIO CAESARIA)</th>
		</tr>
		<tr>
			<th colspan="2">
...
<tr>
		...
		<tr>
			<td colspan="2">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;a. Placenta Previa&nbsp;&nbsp;&nbsp;&nbsp;( Ya / Tidak )<br />
				&nbsp;&nbsp;&nbsp;&nbsp;b. Pre eklamsia / Hypertensi&nbsp;&nbsp;&nbsp;&nbsp;( Ya Tidak )<br />
				&nbsp;&nbsp;&nbsp;&nbsp;c. Malpresentasi / Gawat janin&nbsp;&nbsp;&nbsp;&nbsp;( Ya Tidak )<br />
				&nbsp;&nbsp;&nbsp;&nbsp;d. Disfungsi Uterus&nbsp;&nbsp;&nbsp;&nbsp;( Ya Tidak )<br />
				&nbsp;&nbsp;&nbsp;&nbsp;e. Ada Riwayat SC sebelumnya&nbsp;&nbsp;&nbsp;&nbsp;( Ya Tidak )<br />
		...
		<tr>
			<td colspan="2">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;a. Apakah ada perdarahan, bila YA berapa cc jumlahnya?<br />
				&nbsp;&nbsp;&nbsp;&nbsp;b. Apakah ditemukan penyulit?<br />
				&nbsp;&nbsp;&nbsp;&nbsp;c. Bagaimana dengan keadaan luka operasi?<br />
			</td>
		</tr>
		<tr>
			<td colspan="2">
