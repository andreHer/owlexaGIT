...
<form action="provideritem" method="GET" name="form1" id="form_layout">
  ...
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="provideritem?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&rowset=<c:out value="${rowser}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="providerItemId" value="<c:out value="${providerItem.providerItemId}" />">
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Item Id :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.itemId}"/></td>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Item Value :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.itemValue}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Created Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.createdTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.createdBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.deletedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.deletedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Modified Time :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.modifiedTime}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      ...
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.modifiedBy}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
		...
		<tr>
	      <td class="tabDetailViewDL" valign="top" width="17%">Deleted Status :&nbsp;</td>
			  ...
			  <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${providerItem.deletedStatus}"/></td>
	      <td class="tabDetailViewDL" valign="top" width="15%"></td>
	      <td class="tabDetailViewDF" valign="top" width="35%"></td>
	    </tr>
	...
	<h2>Foreign Affair</h2>
		...
		<label for="Provider Id">Provider Id</label>
			<div id="ffbox">
			<c:out value="${providerItem.providerId.providerId}" />
			</div>
		<center>
