...
<form name="form1" action="providerrollhistory" method="POST">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Provider Roll Paper</h3></td>
...
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:tambahi()" value="Add Roll Paper">
</c:if>
<br />
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Delivery Date
	   	</td>
	   	<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Roll Paper Amount
	   	</td>
	   	<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Created By
	   	</td>
	   	<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Created Time
	   	</td>
	   	<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Modified By
	   	</td>
...
<!-- ini default generated table from database -->
	...
	<c:forEach items="${ProviderRollHistorys}" var="providerRollHistory" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
	 	...
	 	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
	 		<c:out value="${providerRollHistory.deliveryDate }"/>
	 	</td>
	 	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
	 		<c:out value="${providerRollHistory.rollStockAmount }"/>
	 	</td>	 
	 	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
	 		<c:out value="${providerRollHistory.createdBy }"/>
	 	</td> 
	 	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
	 		<c:out value="${providerRollHistory.createdTime }"/>
	 	</td>
	 	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
	 		<c:out value="${providerRollHistory.modifiedBy }"/>
	 	</td> 
	 	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
	 		<c:out value="${providerRollHistory.modifiedTime }"/>
	 	</td> 
	 	<c:if test="${(theUser.roleId.roleId eq 0 )or(theUser.roleId.roleId eq 6 ) }">
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
<!-- 			<a href="javascript:detil('<c:out value="${providerRollHistory.providerRollHistoryId}" />')"> -->
<!-- 				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a> -->
			<!-- ini default edit table for each data -->
<!-- 			<a href="javascript:ubah('<c:out value="${providerRollHistory.providerRollHistoryId}" />')"> -->
<!-- 				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a> -->
			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${providerRollHistory.providerRollHistoryId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.providerRollHistoryId.value = idx;
