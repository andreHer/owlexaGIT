...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${providerDiagnosisTreatment.providerDiagnosisTreatmentId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProviderDiagnosisTreatment (idx);
	window.close();
}
function goleft(){
