...
<form action="producttreatmentclausul-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="productTreatmentClausulForm.productTreatmentClausulId">
...
<input type="hidden" name="navigation" value="">
			...
			<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.itemId">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Decision : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.decision">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Umur : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.umur">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Parameter Umur : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.parameterUmur">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="2">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.benefitAmount">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Benefit Amount Parameter : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.benefitAmountParameter">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="2">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Beban Benefit : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.bebanBenefit">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="2">
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Created Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.createdTime">
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.createdBy">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Modified Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.modifiedTime">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
					<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.modifiedBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Deleted Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.deletedTime">
					<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<c:out value="${status.value}" />" id="<c:out value="${status.value}"/>" maxlength="19">
					<img src="images/jscalendar.gif" alt="Enter Date" id="<c:out value="${status.expression}"/>_trigger" align="absmiddle" height="20" width="20">
					<script type="text/javascript">
    					Calendar.setup({
	    ...
	    <td class="dataField"></td>
			...
			<td class="dataField">
			<spring:bind path="productTreatmentClausulForm.deletedBy">
			<textarea  cols="60" rows="8" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
...
<script language="javascript">
	...
	function kembali (){
		...
		document.form1.action = "producttreatmentclausul";
		document.form1.submit();
	}
	// forreign affairs
