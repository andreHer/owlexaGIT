...
<form action="errorlog-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="errorLogForm.id">
...
<input type="hidden" name="navigation" value="">
			...
			<td class="dataField">
			<spring:bind path="errorLogForm.createdBy">
	    ...
	    <td class="dataField"></td>
		    ...
		    <td class="dataField">
			<spring:bind path="errorLogForm.description">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Current Url : </td>				
			

		    <td class="dataField">
			<spring:bind path="errorLogForm.currentUrl">
			<textarea class="inputbox" name="<c:out value="${status.expression}"/>"><c:out value="${status.value}" /></textarea>
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Created Time : </td>				
						...
						<td class="dataField">
			<spring:bind path="errorLogForm.createdTime">
