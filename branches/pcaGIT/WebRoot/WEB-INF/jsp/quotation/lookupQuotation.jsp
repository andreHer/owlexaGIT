...
<form name="form1" method="GET" action="quotation" >

 search By :
 <select name="searchby">

 		   			<option name="quotationNo" <c:if test="${searchby eq \"quotationNo\"}">selected="true"</c:if> >quotationNo</option>
			   		   		   		   		   		   		   			<option name="remarks" <c:if test="${searchby eq \"remarks\"}">selected="true"</c:if> >remarks</option>
			   		   		   		   		   		   		   		   		   		   		   		   		   		   		   		   			<option name="requestedBy" <c:if test="${searchby eq \"requestedBy\"}">selected="true"</c:if> >requestedBy</option>
			   		   		   		   		   		   		   		   		   		   		   </select>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Quotation No</td>
			   		   		   		   		   		   		   			<td width="30" align="center">Remarks</td>
			   		   		   		   		   		   		   		   		   		   		   		   		   		   		   		   			<td width="30" align="center">Requested By</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${quotation.quotationNo}" /></td>
			   		   		   		   		   		   		   			<td width="30" align="center"><c:out value="${quotation.remarks}" /></td>
			   		   		   		   		   		   		   		   		   		   		   		   		   		   		   		   			<td width="30" align="center"><c:out value="${quotation.requestedBy}" /></td>
			   		   		   		   		   		   		   		   		   		   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${quotation.quotationId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setQuotation (idx);
	window.close();
}
function goleft(){
