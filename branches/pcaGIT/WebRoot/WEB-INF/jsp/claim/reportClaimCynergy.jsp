...
<input type="hidden" name="navigation" value="docynergy">
          ...
          <td class="dataLabel" nowrap="nowrap">Format Value &nbsp;&nbsp;:
              ...
              <select name="reportFormat">					
					...
					<option value="2" <c:if test="${reportFormat eq 2 }">selected</c:if> >Text File - Header</option>
                                        ...
                                        <option value="4" <c:if test="${reportFormat eq 3 }">selected</c:if> >Excel</option>
...
function exportData(){
	...
	document.form1.navigation.value = "exportcynergy";
...
function cari (){
	document.form1.navigation.value = "docynergy";
	document.form1.action = "claimreport";
