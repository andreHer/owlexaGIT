        ...
        <tbody>
          <tr>
            ...
            <td >
              ...
              <input title="Search [Alt+Shift+Q]" accesskey="Q" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="button" value="Provider Report" type="button" onclick="javascript:providerPopup()">
             </td>
            </tr>
			<tr>
            ...
            <td >
              <input title="Search [Alt+Shift+Q]" accesskey="Q" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="button" value="Diagnosis Report" type="button" onclick="javascript:diagnosisPopup()">
              <input title="Search [Alt+Shift+Q]" accesskey="Q" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="button" value="Benefit Usage Report" type="button" onclick="javascript:benefitPopup()">
            </td>
          </tr>
          <tr>
              ...
              <input title="Search [Alt+Shift+Q]" accesskey="P" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" name="button" value="Payment Report" type="button" onclick="javascript:paymentReport()">
              </td>
          </tr>
        </tbody>
      </table></td>
