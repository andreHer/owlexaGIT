...
<form name="form1" method="GET" action="claim" >

 search By :
 <select name="searchby">

 		   			<option name="description" <c:if test="${searchby eq \"description\"}">selected="true"</c:if> >description</option>
			   		   		   			<option name="claimNumber" <c:if test="${searchby eq \"claimNumber\"}">selected="true"</c:if> >claimNumber</option>
			   		   		   		   		   		   			<option name="claimRemarks" <c:if test="${searchby eq \"claimRemarks\"}">selected="true"</c:if> >claimRemarks</option>
			   		   		   		   		   		   		   		   		   		   		   		   		   		   			<option name="providerName" <c:if test="${searchby eq \"providerName\"}">selected="true"</c:if> >providerName</option>
			   		   			...
			   		   			<option name="modifiedBy" <c:if test="${searchby eq \"modifiedBy\"}">selected="true"</c:if> >modifiedBy</option>
			   		   		   		   		   			<option name="iterative" <c:if test="${searchby eq \"iterative\"}">selected="true"</c:if> >iterative</option>
			   </select>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Description</td>
			   		   		   			<td width="30" align="center">Claim Number</td>
			   		   		   		   		   		   			<td width="30" align="center">Claim Remarks</td>
			   		   			...
			   		   			<td width="30" align="center">Modified By</td>
			   		   		   		   		   			<td width="30" align="center">Iterative</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${claim.description}" /></td>
			   		   		   			<td width="30" align="center"><c:out value="${claim.claimNumber}" /></td>
			   		   		   		   		   		   			<td width="30" align="center"><c:out value="${claim.claimRemarks}" /></td>
			   		   		   		   		   		   		   		   		   		   		   		   		   		   			<td width="30" align="center"><c:out value="${claim.providerName}" /></td>
			   		   		   		   		   			<td width="30" align="center"><c:out value="${claim.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${claim.deletedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${claim.modifiedBy}" /></td>
			   		   		   		   		   			<td width="30" align="center"><c:out value="${claim.iterative}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${claim.claimId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
