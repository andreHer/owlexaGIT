...
// String alert2 = (String) request.getAttribute("modifTime");
int index = 0;
int totalIndex = 0;
int count = 0;
int countSet = 0;
// String modifTime = (String) request.getAttribute("claim.getModifiedTime");
try {
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Member Claim</h3></td>
...
<input type="hidden" name="claimId" value="<c:out value="${claimId}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Member Claim</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
              	<select name="searchby" class="inputbox">
 	  		   		...
 	  		   		<option value="diagnosis1Code" <c:if test="${searchby eq \"diagnosis1Code\"}">selected="true"</c:if> >Diagnosis Code</option>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<select name="dateby" class="inputbox">
					...
					<option value="claimDate" <c:if test="${dateby eq \"claimDate\"}">selected="true"</c:if> >Received Date</option>
			   		...
			   		<option value="dischargeDate" <c:if test="${dateby eq \"dischargeDate\"}">selected="true"</c:if> >Discharge Date</option>
			   </select>
...
<!-- 				Member &nbsp;</td> -->
	...
	<c:set var="claimExcessPrepaidValue" value="${claimExcessPrepaidValue+claim.prePaidExcess}"></c:set>
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
...
<!-- 		</td> -->
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe"  valign="top">
			<c:out value="${claim.diagnosis1Code}" />	
		</td>				
...
<!-- ini default generated table from database -->
				...
				<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%" style="text-align: right;">
					<fmt:formatNumber><c:out value="${claimExcessPrepaidValue}" /></fmt:formatNumber> &nbsp;</td>
