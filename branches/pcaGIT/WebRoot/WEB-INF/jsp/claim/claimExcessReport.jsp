...
<input type="hidden" name="navigation" value="gosearchexcess">
              ...
              &nbsp;&nbsp;
 	   		   			...
 	   		   			<option value="claimNumber" <c:if test="${searchby eq \"claimNumber\"}">selected="true"</c:if> >Claim Number</option>
				 		   			<option value="description" <c:if test="${searchby eq \"description\"}">selected="true"</c:if> >Description</option>
			   	  		   			...
			   	  		   			<option value="claimRemarks" <c:if test="${searchby eq \"claimRemarks\"}">selected="true"</c:if> >Claim Remarks</option>
			   	  		   			<option value="description" <c:if test="${searchby eq \"description\"}">selected="true"</c:if> >Claim Description</option>			   	  		   			
	...
	<tr>
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td  align="left">
            <c:if test="${memberGroupId ne null}">
            <a target="_blank" href="report?navigation=groupExcessRecap&memberGroupId=<c:out value="${memberGroupId}"/>&minimumDate=<c:out value="${minimum_date}" />&maximumDate=<c:out value="${maximum_date}" />" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;
            </c:if>
            <c:if test="${memberGroupId eq null}" >
            <a target="_blank" href="report?navigation=excessReport&minimumDate=<c:out value="${minimum_date}" />&maximumDate=<c:out value="${maximum_date}" />" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;
            </c:if>
            </td>
