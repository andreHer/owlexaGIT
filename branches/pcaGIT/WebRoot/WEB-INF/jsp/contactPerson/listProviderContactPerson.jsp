...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Provider Contact Person</h3></td>
...
<input type="hidden" name="previousURL" value="contactperson?navigation=listprovider&providerId=<c:out value="${providerId}" />" />
...
<c:if test="${theUser.userType eq 2}">
	...
	<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:tambahi()" value="Add Contact Person">
	</c:if>
	<br />
	<br />
</c:if>
