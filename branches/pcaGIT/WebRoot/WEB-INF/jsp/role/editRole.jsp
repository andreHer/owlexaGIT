...
<form action="role-form" method="POST"  name="form1" id="form_layout">
<br />
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="roleForm.roleId">
...
<tr>
			...
			<tr>
				<td class="dataLabel"> Role Name : </td>				
			

			<td class="dataField">
			<spring:bind path="roleForm.roleName">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Menu Template URL : </td>				
			

			<td class="dataField">
			<spring:bind path="roleForm.menuTemplateURL">
		<input type="text" size="35" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" />	
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Sidebar Template URL : </td>				
			

			<td class="dataField">
			<spring:bind path="roleForm.sidebarTemplateURL">
		<input type="text" size="35" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" />" />	
				<div id="fredcaption">
					<c:out value="${status.errorMessage}" />
				</div>
