...
<ul id="maintab" class="shadetabs">
	<li>
		<a href="member?navigation=detail&memberId=<c:out value="${memberId}" />" rel="tcontent1">Current Benefit</a>
	</li>
	<li>
	...
	<li>
		<a href="memberelectroniccard?navigation=list&memberId=<c:out value="${memberId}" />" rel="tcontent8">Member Card</a>
	</li>	
</ul>
