...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Register Upload Client Provider</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>

<form action="clientprovider-upload" enctype="multipart/form-data" method="POST"  name="form1" id="form_layout">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<td class="dataField">
			<spring:bind path="clientProviderForm.multipartFile">
...
<script language="javascript">
	function simpan (){
		...
		document.form1.action = "clientprovider-upload";
