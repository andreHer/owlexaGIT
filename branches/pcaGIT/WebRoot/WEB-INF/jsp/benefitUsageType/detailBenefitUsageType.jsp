...
<h1>Benefit Usage Type</h1>

<form action="benefitusagetype" method="GET" name="form1" id="form_layout">
...
<table class="tabDetailView" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
			...
			<tbody>
				<tr>
					...
					<td class="tabDetailViewDL" align="right" nowrap="nowrap">
						<a href="benefitusagetype?navigation=search&searchtext=<c:out value="${searchtext}"/>&searchby=<c:out value="${searchby}" />&rowset=<c:out value="${rowser}" />&index=<c:out value="${index}"/>" class="tabDetailViewDFLink" style="font-weight: normal;">Return to List&nbsp;</a>					
					</td>
				</tr>
			</tbody>
		</table>
	...
	<input type="hidden" name="benefitUsageTypeId" value="<c:out value="${benefitUsageType.benefitUsageTypeId}" />">
		...
		<tr>
	      <td clabDetailViewDL" valign="top" width="17%">Benefit Usage :&nbsp;</td>
		  
			 
	      <td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${benefitUsageType.benefitUsage}"/></td>
	      <td clas="tabDetailViewDL" valign="top" width="15%"></td>
  	...
  	<td class="tabDetailViewDF" valign="top" width="33%"><c:out value="${benefitUsageType.description}"/></td>   
