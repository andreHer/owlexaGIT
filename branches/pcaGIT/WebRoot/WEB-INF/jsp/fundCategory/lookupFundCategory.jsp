...
<form name="form1" method="GET" action="fundcategory" >

 search By :
 <select name="searchby">

 		   			<option name="fundCategoryName" <c:if test="${searchby eq \"fundCategoryName\"}">selected="true"</c:if> >fundCategoryName</option>
			   			<option name="fundCategoryCode" <c:if test="${searchby eq \"fundCategoryCode\"}">selected="true"</c:if> >fundCategoryCode</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center">Fund Category Name</td>
			   			<td width="30" align="center">Fund Category Code</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   			<td width="30" align="center"><c:out value="${fundCategory.fundCategoryName}" /></td>
			   			<td width="30" align="center"><c:out value="${fundCategory.fundCategoryCode}" /></td>
			   			<td width="30" align="center"><c:out value="${fundCategory.description}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${fundCategory.fundCategoryId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setFundCategory (idx);
	window.close();
}
function goleft(){
