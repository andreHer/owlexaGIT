...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<%}%>
<form action="tariftype-form" method="POST"  name="form1" id="form_layout">
			<spring:bind path="tarifTypeForm.tarifTypeId">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<tr>
				<td class="dataLabel"> Tarif Type Name : </td>				
			
	
						<td class="dataField">
				<spring:bind path="tarifTypeForm.tarifTypeName">
