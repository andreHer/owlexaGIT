...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Claim Investigation</h3></td>
...
<c:if test="${ theUser.roleId.roleId eq 4 or theUser.roleId.roleId eq 3 or theUser.roleId.roleId eq 0 }">
	<c:if test="${claim.claimStatus.caseStatusId ne 19}">
		<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:tambahi()" value=" Add Claim Investigation ">
	</c:if>
</c:if>
<br />
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${claimInvestigation.investigationSubject}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${claimInvestigation.headDoctor}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${claimInvestigation.consultDoctor}" />
			
		</td>
					   				<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			
				<c:out value="${claimInvestigation.nurse}" />
		...
		<c:if test="${theUser.roleId.roleId ne 11 }">
			...
			<a href="javascript:ubah('<c:out value="${claimInvestigation.claimInvestigationId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${claimInvestigation.claimInvestigationId}" />')">
