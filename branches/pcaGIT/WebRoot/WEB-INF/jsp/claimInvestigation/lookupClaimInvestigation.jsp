...
<form name="form1" method="GET" action="claiminvestigation" >
 ...
 <select name="searchby">
			   			...
			   			<option name="investigationSubject" <c:if test="${searchby eq \"investigationSubject\"}">selected="true"</c:if> >investigationSubject</option>
			   			<option name="headDoctor" <c:if test="${searchby eq \"headDoctor\"}">selected="true"</c:if> >headDoctor</option>
			   			<option name="consultDoctor" <c:if test="${searchby eq \"consultDoctor\"}">selected="true"</c:if> >consultDoctor</option>
			   			<option name="nurse" <c:if test="${searchby eq \"nurse\"}">selected="true"</c:if> >nurse</option>
			   </select>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
			   			...
			   			<td width="30" align="center">Investigation Subject</td>
			   			<td width="30" align="center">Head Doctor</td>
			   			<td width="30" align="center">Consult Doctor</td>
			   			<td width="30" align="center">Nurse</td>
			   		<td width="30" align="center">Pilih</td>
	</tr>

	<c:forEach items="${ClaimInvestigations}" var="claimInvestigation" varStatus="status" >
	<tr>

		<td width="30" align="center"><c:out value="${status.count}" /></td>
		<!-- ini default generated table from database -->
		   		   		   		   		   		   			<td width="30" align="center"><c:out value="${claimInvestigation.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${claimInvestigation.modifiedBy}" /></td>
			   			<td width="30" align="center"><c:out value="${claimInvestigation.deletedBy}" /></td>
			   		   		   			<td width="30" align="center"><c:out value="${claimInvestigation.description}" /></td>
			   			<td width="30" align="center"><c:out value="${claimInvestigation.investigationSubject}" /></td>
			   			<td width="30" align="center"><c:out value="${claimInvestigation.headDoctor}" /></td>
			   			<td width="30" align="center"><c:out value="${claimInvestigation.consultDoctor}" /></td>
			   			<td width="30" align="center"><c:out value="${claimInvestigation.nurse}" /></td>
			   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${claimInvestigation.claimInvestigationId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setClaimInvestigation (idx);
	window.close();
}
function goleft(){
