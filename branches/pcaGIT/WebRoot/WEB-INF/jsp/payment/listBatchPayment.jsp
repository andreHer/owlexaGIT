...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Batch Payment</h3></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Batch Payment</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Payment Number &nbsp;</td>			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Batch Number &nbsp;</td>		   			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Bank Name &nbsp;</td>			   			
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Account Number &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">Payee Name &nbsp;</td>					
