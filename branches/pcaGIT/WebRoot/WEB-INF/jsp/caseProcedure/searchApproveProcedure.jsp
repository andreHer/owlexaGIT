...
<form name="form1" action="caseprocedure" method="POST">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Case Procedure</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
								 ...
								 <select name="searchby" class="inputbox">
			   		   		   			...
			   		   		   			<option value="approvalRemarks" <c:if test="${searchby eq \"approvalRemarks\"}">selected="true"</c:if> >Approval Remarks</option>
			   </select>
...
<table class="listView" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="20">
		...
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%" align="center">Case Number</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%" align="center">Biaya &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="15%" align="center">Description &nbsp;</td>
		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%" align="center">Status</td>		
   	   	<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%"></td>
	</tr>


	<c:forEach items="${CaseProcedures}" var="caseProcedure" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr  height="20">
      	...
      	<td class="oddListRowS1" bgcolor="#e7f0fe" valign="top"><c:out value="${caseProcedure.caseId.caseNumber}" /></td>
	    ...
	    <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><b>
	    	<c:if test="${caseProcedure.status eq 0}">PENDING</c:if>
	    	<c:if test="${caseProcedure.status eq -1}">REJECTED</c:if>
	    	<c:if test="${caseProcedure.status eq 1}">APPROVED</c:if></b>
	    </td>
        <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
        	<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus" onClick="javascript:approve(<c:out value="${caseProcedure.caseProcedureId}" />)" value=" Approval "></td>
    </tr>
...
function approve (idx){
	var delConfirm = window.confirm ("Are You Sure Want To Approve This Procedure ?");

	if (delConfirm){
		document.form1.method = "POST";
		document.form1.caseProcedureId.value = idx;
