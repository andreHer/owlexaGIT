...
<!-- ini default generated table from database -->
	...
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${providerReview.providerReviewId}" />','')" value="Pilih">
...
function pilih (idx){
	window.opener.setProviderReview (idx);
	window.close();
}
function goleft(){
