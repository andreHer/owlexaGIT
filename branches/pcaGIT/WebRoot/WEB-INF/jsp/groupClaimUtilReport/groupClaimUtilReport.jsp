...
<!-- ini default generated table from database -->		   		   			
					...
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Claim Charge</td>
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Claim Approve</td>
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="8%">Total Excess </td>
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="8%">Outstanding Excess </td>
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Paid Excess</td>
					...
					<c:if test="${(theUser.userType eq 2 )or (theUser.userType eq 3 ) }">
			   			<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Claim Ratio</td>   		 
			   		</c:if>  		   		  
			   		
			   		<td scope="col" class="listViewThS1" nowrap="nowrap" width="5%">Statistic</td>   		 
	 ...
	 <tr onMouseOver="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'over', '#e7f0fe', '#FFFFFF', '');" onMouseOut="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'out', '#e7f0fe', '#FFFFFF', '');" onMouseDown="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'click', '#e7f0fe', '#FFFFFF', '');" height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
      	...
      	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
			<a href="claim?navigation=gosearch&memberGroupId=<c:out value="${groupClaimUtilReport.groupId.memberGroupId}" />" class="linkDetail">
			<c:out value="${groupClaimUtilReport.groupName}" /></a>
		</td>
	
	  	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<fmt:formatNumber maxFractionDigits="0"><c:out value="${groupClaimUtilReport.claimChargeValue}" /></fmt:formatNumber>
		</td>
	  	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<fmt:formatNumber maxFractionDigits="0"><c:out value="${groupClaimUtilReport.claimApprovedValue}" /></fmt:formatNumber>
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<fmt:formatNumber maxFractionDigits="0"><c:out value="${groupClaimUtilReport.totalExcessCharge}" /></fmt:formatNumber>
		</td>
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<fmt:formatNumber maxFractionDigits="0"><c:out value="${groupClaimUtilReport.outstandingExcess}" /></fmt:formatNumber>
		</td>
	  	<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<fmt:formatNumber maxFractionDigits="0"><c:out value="${groupClaimUtilReport.paidExcess}" /></fmt:formatNumber>
		</td>
		...
		<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top" align="right">
			<input type="button" name="pilihButton" value="Statistik" align="center" onclick="javascript:lihatStat('<c:out value="${groupClaimUtilReport.groupId.memberGroupId}" />')" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus">
		</td>  
    </tr>
...
%>
function lihatStat(gid){
	window.open ("groupclaimreport?memberGroupId="+gid+"&navigation=top10report&url=claim-form","Search","width=1024, height=768, menubar=no, status=no, toolbar=no, scrollbars=yes, resizable=yes,screenX=200,screenY=100");
