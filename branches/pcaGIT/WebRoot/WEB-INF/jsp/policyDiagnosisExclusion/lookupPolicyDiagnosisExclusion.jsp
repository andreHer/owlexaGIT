...
<form name="form1" action="policydiagnosisexclusion" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Policy Diagnosis Exclusion</h3></td>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
			   			...
			   			<option value="deletedBy" <c:if test="${searchby eq \"deletedBy\"}">selected="true"</c:if> >Deleted By</option>
			   		   		   			...
			   		   		   			<option value="modificationInformation" <c:if test="${searchby eq \"modificationInformation\"}">selected="true"</c:if> >Modification Information</option>
			   </select>
      ...
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
			...
			<a target="_blank" href="policydiagnosisexclusion?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
<!-- ini default generated table from database -->
				...
				<a href="policydiagnosisexclusion?navigation=search&sortby=modification_information&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Modification Information &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	...
	<c:forEach items="${PolicyDiagnosisExclusions}" var="policyDiagnosisExclusion" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr onMouseOver="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'over', '#e7f0fe', '#FFFFFF', '');" onMouseOut="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'out', '#e7f0fe', '#FFFFFF', '');" onMouseDown="setPointer(this, '910cbdf4-ffae-5c1a-db84-4434fa305b0a', 'click', '#e7f0fe', '#FFFFFF', '');" height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
				...
				<c:out value="${policyDiagnosisExclusion.modificationInformation}" />
			
		</td>
					         <td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
	<input type="button" class="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${policyDiagnosisExclusion.id}" />','')" value="Pilih">
...
<tr>
            <td class="listViewPaginationTdS1" align="left"><a target="_blank" href="policydiagnosisexclusion?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function pilih (idx){
	window.opener.setPolicyDiagnosisExclusion (idx);
	window.close();
}
function goleft(){
...
function cari (){
	document.form1.navigation.value = "golookup";
	document.form1.action = "policydiagnosisexclusion";
	document.form1.method = "POST";
	document.form1.submit();
}
</script>
