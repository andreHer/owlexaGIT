...
<form action="relationship-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="relationshipForm.relationshipId">
...
<input type="hidden" name="navigation" value="">
			...
			<tr>
				<td class="dataLabel"> Relationship Name : </td>				
			

			<td class="dataField">
			<spring:bind path="relationshipForm.relationshipName">
	    ...
	    <td class="dataField"></td>
			...
			<spring:bind path="relationshipForm.description">
