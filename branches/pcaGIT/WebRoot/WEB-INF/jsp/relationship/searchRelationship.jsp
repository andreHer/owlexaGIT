...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif" alt="Call Search" border="0">&nbsp;Search Relationship</h3></td>
...
<div class="table_container">
	<!-- Table Toolbar Start -->
		...
		<div id="search_float"<%=nampak%>>
			<h4>
				<c:out value="${SEARCH}" /> Data relationship
			</h4>
			<form name=form1 onSubmit="cari()">
				...
				<label for="status">
				 ...
				 <select name="searchby" class="inputbox">
 		   			...
 		   			<option name="relationshipName" <c:if test="${searchby eq \"relationshipName\"}">selected="true"</c:if> >Relationship Name</option>
...
<LABEL><c:out value="${LIST_OF}" />  Relationship</LABEL>
...
function tambahi (){
	...
	document.form1.action = "relationship-form";
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.relationshipId.value = idx;
