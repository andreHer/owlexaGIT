...
<form action="externalrawdetaildata-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="externalRawDetailDataForm.id">
...
<input type="hidden" name="navigation" value="">
		    ...
		    <td class="dataField">
			<spring:bind path="externalRawDetailDataForm.data">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Is Migrated : </td>				
						...
						<td class="dataField">
			<spring:bind path="externalRawDetailDataForm.isMigrated">
	<input type="text" size="35" name="<c:out value="${status.expression}" />" value="<fmt:formatNumber><c:out value="${status.value}"/></fmt:formatNumber>" maxlength="2">
	    ...
	    <td class="dataField"></td>
			...
			<tr>
				<td class="dataLabel"> Template Id : </td>				
			

						<td class="dataField">
			<spring:bind path="externalRawDetailDataForm.templateId">
