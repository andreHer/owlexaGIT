...
<form action="treatmentlocation-form" method="POST"  name="form1" id="form_layout">
...
if (alert != null && !alert.trim().equals("")) {%>
	...
	<spring:bind path="treatmentLocationForm.locationId">
...
<input type="hidden" name="navigation" value="">
			...
			<td class="dataField">
			<spring:bind path="treatmentLocationForm.location">
	    ...
	    <td class="dataField"></td>
			...
			<spring:bind path="treatmentLocationForm.description">
