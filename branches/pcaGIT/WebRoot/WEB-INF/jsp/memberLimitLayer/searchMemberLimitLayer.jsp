...
<form name="form1" action="memberlimitlayer" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Member Limit Layer</h3></td>
...
<!-- ini default generated table from database -->
	...
	<c:forEach items="${MemberLimitLayers}" var="memberLimitLayer" varStatus="status" >
	<%	if (i % 2 == 0) {
			rowclass = "col1";
		} else if (i % 2 != 0) {
			rowclass= "col2";
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${memberLimitLayer.memberLimitLayerId}" />')">
				<img src="images/view.gif" class="action_icon" alt="View" title="View"></a>

			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${memberLimitLayer.memberLimitLayerId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${memberLimitLayer.memberLimitLayerId}" />')">
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.memberLimitLayerId.value = idx;
