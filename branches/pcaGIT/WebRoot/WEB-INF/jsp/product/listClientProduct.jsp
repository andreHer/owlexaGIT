...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;List Client Product</h3></td>
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Client Product</h3></td>
      <td width="100%"><img src="images/blank.gif"  height="1" width="1"></td>
    </tr>
  </tbody>
</table>
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              ...
              &nbsp;&nbsp;
                ...
                <select name="searchstatus">					
					...
					<option value="-1" <c:if test="${status eq -1 }">selected</c:if>>PENDING</option>
					<option value="1" <c:if test="${status eq 1 }">selected</c:if>>ACTIVE</option>
					<option value="2" <c:if test="${status eq 2 }">selected</c:if>>INACTIVE</option>
				</select>
...
<!-- ini default generated table from database -->
				...
				<a href="product?navigation=search&sortby=product_code&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Product Code &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="product?navigation=search&sortby=product_name&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Product Name &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
			
		
			   			
					<td scope="col" class="listViewThS1" nowrap="nowrap" width="19%">
				<a href="product?navigation=search&sortby=product_description&searchby=<c:out value="${searchby}" />" class="listViewThLinkS1">Product Description &nbsp;<img src="images/arrow.gif" alt="Sort" align="absmiddle" border="0" height="9" width="8"></a></td>
	 ...
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
		...
		<a href="javascript:detil('<c:out value="${product.productId}" />')">
			...
			<c:if test="${product.productStatus.statusId ne 1}">
			<!-- ini default edit table for each data -->
			<a href="javascript:ubah('<c:out value="${product.productId}" />')">
				<img src="images/edit.gif" class="action_icon" alt="Edit" title="Edit"></a>

			<!-- ini default delete table for each data -->
			<a href="javascript:hapus('<c:out value="${product.productId}" />')">
