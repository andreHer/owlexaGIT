...
<form name="form1" action="holiday" method="POST">
...
<input type="hidden" name="index" value="<c:out value="${index}" />">
  ...
  <tbody>
    <tr>
      <td nowrap="nowrap"><h3><img src="images/h3Arrow.gif"  border="0">&nbsp;Search Holiday</h3></td>
...
<!-- ini default generated table from database -->
		   		   	<td scope="col" class="listViewThS1" nowrap="nowrap" width="10%">Holiday Date</td>		
	...
	%>
	 <tr height="20">
      <td class="oddListRowS1" align="center" bgcolor="#e7f0fe" nowrap="nowrap" valign="top"><%=(i+((indexint-1)*countSet))%></td>
			...
			<slot>
				<c:out value="${holiday.tglHoliday}" />
			</slot>
...
function hapus (idx){
	...
	if (delConfirm){
		...
		document.form1.idHoliday.value = idx;
