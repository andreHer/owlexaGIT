...
<form name="form1" method="GET" action="pendingclaim" >

 search By :
 <select name="searchby">

 		   		   		   		   			<option name="pendingSubject" <c:if test="${searchby eq \"pendingSubject\"}">selected="true"</c:if> >pendingSubject</option>
...
<table width="95%" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   			<td width="30" align="center">Pending Subject</td>
	...
	<tr>
		...
		<!-- ini default generated table from database -->
		   		   		   		   			<td width="30" align="center"><c:out value="${pendingClaim.pendingSubject}" /></td>
			   			<td width="30" align="center"><c:out value="${pendingClaim.remarks}" /></td>
			   		   			<td width="30" align="center"><c:out value="${pendingClaim.createdBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${pendingClaim.updatedBy}" /></td>
			   		   			<td width="30" align="center"><c:out value="${pendingClaim.deletedBy}" /></td>
			   		   
		<td width="30" align="center">
			<!-- ini default edit table for each data -->
			<input type="button" name="pilihsaya" onClick="javascript:pilih('<c:out value="${pendingClaim.pendingClaimId}" />')" value="Pilih">
		</td>
	</tr>
	</c:forEach>
	</table>
...
function pilih (idx){
	window.opener.setPendingClaim (idx);
	window.close();
}
function goleft(){
