...
<form name="form1" action="broker" method="GET">
<input type="hidden" name="navigation" value="golookup">
<input type="hidden" name="arah" value="">
<input type="hidden" name="index" value="<c:out value="${index}" />">
				<input type="hidden" name="brokerId" value="<c:out value="${broker.brokerId}" />">
            ...
            <td class="dataLabel" nowrap="nowrap">Search Category:
              &nbsp;&nbsp;
				 ...
				 <select name="searchby" class="inputbox">
 		   			...
 		   			<option value="brokerName" <c:if test="${searchby eq \"brokerName\"}">selected="true"</c:if> >Broker Name</option>
			   			<option value="brokerCode" <c:if test="${searchby eq \"brokerCode\"}">selected="true"</c:if> >Broker Code</option>
      ...
      <td colspan="20" align="right"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
			...
			<c:forEach items="${Brokers}" var="broker" varStatus="status" >
	<%if (i % 2 == 0) {
				rowclass = "col1";
			} else if (i % 2 != 0) {
				rowclass = "col2";
			...
			%>
				<tr onMouseOver="" onMouseOut=""
					...
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
						...
						<c:out value="${broker.brokerName}" />
						
					</td>
				
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
						
						<c:out value="${broker.city}" />
						
					</td>
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
						
						<c:out value="${broker.province}" />
						
					</td>
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" valign="top">
						
						<c:out value="${broker.country}" />
					...
					<td class="oddListRowS1" bgcolor="#e7f0fe" nowrap="nowrap" align="center" valign="top">
						...
						<input type="button" name="pilihButton" value="choose" align="center" onclick="javascript:pilih('<c:out value="${broker.brokerId}" />','<c:out value="${broker.brokerName}" />')" class="ui-button ui-widget ui-state-default ui-corner-all ui-state-focus">
...
<tr>
            <td  align="left"><a target="_blank" href="broker?navigation=export&searchby=<c:out value="${searchby}"/>" class="listViewPaginationLinkS1"><img src="images/export.gif" alt="Export" align="absmiddle" border="0" height="7" width="8">&nbsp;Export</a>&nbsp;</td>
...
function pilih (idx,cname){
	...
	window.opener.setBroker (idx,cname);
	window.close();
}
function goleft(){
...
function detil (idx){
	document.form1.method = "GET";
	document.form1.brokerId.value = idx;
	document.form1.action = "broker";
