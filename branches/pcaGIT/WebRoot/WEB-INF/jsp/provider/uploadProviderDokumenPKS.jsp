...
<form action="dokumenpks-upload" enctype="multipart/form-data" method="POST"  name="form1" id="form_layout">
	<spring:bind path="dokumenPKSForm.id">
...
<table class="tabForm" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<td class="dataField">
			<spring:bind path="dokumenPKSForm.multipartFile">
...
<script language="javascript">
	function simpan (){
		...
		document.form1.action = "dokumenpks-upload";
