...
*/
public class PaymentInstallmentValidator implements Validator
// extends+ 
...

{
	public boolean supports(Class clazz) {
		return PaymentInstallmentForm.class.isAssignableFrom(clazz);
	}
	public void validate(Object obj, Errors errors) {
								ValidationUtils.rejectIfEmptyOrWhitespace
 (errors,"paymentInstallmentId","PAYMENT_INSTALLMENT_ID_REQUIRED","paymentInstallmentId is required");
																																																																																						ValidationUtils.rejectIfEmptyOrWhitespace
