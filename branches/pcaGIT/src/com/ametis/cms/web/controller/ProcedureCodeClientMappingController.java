...
/**
 * ProcedureCodeClientMapping is a servlet controller for procedure_code_client_mapping Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProcedureCodeClientMappingController implements Controller
...
// extends- 
{
	...
	private ProcedureCodeClientMappingService  procedureCodeClientMappingService;
	...
	public void setProcedureCodeClientMappingService	(ProcedureCodeClientMappingService procedureCodeClientMappingService){
	this.procedureCodeClientMappingService = procedureCodeClientMappingService;
	}
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProcedureCodeClientMapping res = procedureCodeClientMappingService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.procedurecodeclientmapping",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.procedurecodeclientmapping",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProcedureCodeClientMapping");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.procedurecodeclientmapping",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("procedureCodeClientMapping", object);
		...
		try {
		    ...
		    if (navigation.equals("gosearch") || navigation.equals("golookup")){
			    ...
			    */
			    							    								...
			    							    								if (searchby.equalsIgnoreCase("procedureClientCode")){
					vLikeP.add("procedureClientCode");
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = procedureCodeClientMappingService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = procedureCodeClientMappingService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProcedureCodeClientMappings",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProcedureCodeClientMapping" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProcedureCodeClientMapping" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProcedureCodeClientMapping" );
	    }
