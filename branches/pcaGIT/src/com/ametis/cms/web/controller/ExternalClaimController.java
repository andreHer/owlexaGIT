...
// imports- 
/**
 * ExternalClaim is a servlet controller for external_claim Table. All you have
 * to do is to convert necessary data field to the named parameter
 */
public class ExternalClaimController implements Controller // extends+ 
// extends- 
{
...
private ActivityLogService logService;
    ...
    public ExternalClaimService getExternalClaimService() {
        return this.externalClaimService;
    }
    ...
    public ModelAndView deletePerformed(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            ExternalClaim res = externalClaimService.delete(pkey, user);

            if (res != null) {
                request.setAttribute("alert", alertProperties.getMessage("success.delete.externalclaim", null, "success", Locale.getDefault()));
            } else {
                request.setAttribute("alert", alertProperties.getMessage("fail.delete.externalclaim", null, "fail", Locale.getDefault()));

            }
            result = searchPerformed(request, response, "searchExternalClaim");
        } catch (Exception e) {
    ...
    public ModelAndView detailPerformed(HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
        ...
        try {
            ...
            java.io.Serializable pkey = id;
            ExternalClaim object = externalClaimService.get(pkey);

            if (object == null) {
                request.setAttribute("alert", alertProperties.getMessage("not.found.externalclaim", null, "fail", Locale.getDefault()));
            }
            /*
            ...
            result.addObject("externalClaim", object);
    ...
    public ModelAndView searchPerformed(HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
        ...
        try {
            ...
            Integer sessionId = WebUtil.getParameterInteger(request, "sessionId");
            ...
            if (navigation.equals("gosearch") || navigation.equals("golookup")) {
                ...
                if (searchby != null) {
                    ...
                    if (searchby.equalsIgnoreCase("claimCategory")) {
                        vLikeP.add("claimCategory");
                        vLikeQ.add(searchtext);
                    }
                    if (searchby.equalsIgnoreCase("claimType")) {
                        vLikeP.add("claimType");
                        vLikeQ.add(searchtext);
                    }
                    if (searchby.equalsIgnoreCase("batchNumber")) {
                        vLikeP.add("batchNumber");
                        vLikeQ.add(searchtext);
                    }
                    ...
                    if (searchby.equalsIgnoreCase("claimStatus")) {
                        vLikeP.add("claimStatus");
                        vLikeQ.add(searchtext);
                    }
                    ...
                    if (searchby.equalsIgnoreCase("cdvNumber")) {
                        vLikeP.add("cdvNumber");
                        vLikeQ.add(searchtext);
                    }
                    ...
                    if (searchby.equalsIgnoreCase("payTo")) {
                        vLikeP.add("payTo");
                        vLikeQ.add(searchtext);
                    }
                    if (searchby.equalsIgnoreCase("accountNo")) {
                        vLikeP.add("accountNo");
                        vLikeQ.add(searchtext);
                    }
            ...
            count = externalClaimService.getTotal(sLikeP, sLikeQ, sEqP, sEqQ);
            ...
            collection = externalClaimService.search(sLikeP, sLikeQ, sEqP, sEqQ,
            ...
            result.addObject("ExternalClaims", collection);
    ...
    public ModelAndView handleRequest(
        ...
        try {
            if (navigation.equalsIgnoreCase("detail")) {
                 ...
                 */
                result = detailPerformed(request, response, "detailExternalClaim");
                ...
                result = searchPerformed(request, response, "lookupExternalClaim");
            } else if (navigation.equalsIgnoreCase("list") ) {
                Integer sessionId = WebUtil.getParameterInteger(request, "id");              
                
                
                result = searchPerformed(request, response, "listExternalClaim");
