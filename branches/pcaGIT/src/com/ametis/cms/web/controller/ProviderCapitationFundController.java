...
*/
public class ProviderCapitationFundController implements Controller
...
// extends- 
{
	...
	public void setProviderCapitationFundService	(ProviderCapitationFundService providerCapitationFundService){
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProviderCapitationFund res = providerCapitationFundService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.providercapitationfund",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.providercapitationfund",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProviderCapitationFund");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.providercapitationfund",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("providerCapitationFund", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = providerCapitationFundService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = providerCapitationFundService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProviderCapitationFunds",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProviderCapitationFund" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProviderCapitationFund" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProviderCapitationFund" );
	    }
