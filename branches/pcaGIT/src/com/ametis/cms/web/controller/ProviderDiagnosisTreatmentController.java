...
*/
public class ProviderDiagnosisTreatmentController implements Controller
...
// extends- 
{
	...
	public void setProviderDiagnosisTreatmentService	(ProviderDiagnosisTreatmentService providerDiagnosisTreatmentService){
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProviderDiagnosisTreatment res = providerDiagnosisTreatmentService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.providerdiagnosistreatment",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.providerdiagnosistreatment",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProviderDiagnosisTreatment");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.providerdiagnosistreatment",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("providerDiagnosisTreatment", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = providerDiagnosisTreatmentService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = providerDiagnosisTreatmentService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProviderDiagnosisTreatments",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProviderDiagnosisTreatment" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProviderDiagnosisTreatment" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProviderDiagnosisTreatment" );
	    }
