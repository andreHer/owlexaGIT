...
*/
public class DiagnosisMedicineController implements Controller
...
// extends- 
{
	...
	public void setDiagnosisMedicineService	(DiagnosisMedicineService diagnosisMedicineService){
	this.diagnosisMedicineService = diagnosisMedicineService;
	}
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			DiagnosisMedicine res = diagnosisMedicineService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.diagnosismedicine",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.diagnosismedicine",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchDiagnosisMedicine");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.diagnosismedicine",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("diagnosisMedicine", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = diagnosisMedicineService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
				"DiagnosisMedicine.MedicineId",
				"DiagnosisMedicine.DiagnosisId",
		// foreign affairs end
	};
		    collection = diagnosisMedicineService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("DiagnosisMedicines",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailDiagnosisMedicine" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupDiagnosisMedicine" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchDiagnosisMedicine" );
	    }
