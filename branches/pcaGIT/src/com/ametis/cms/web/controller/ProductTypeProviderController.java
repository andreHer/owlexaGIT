...
*/
public class ProductTypeProviderController implements Controller
...

{
	...
	private ProductTypeProviderService  productTypeProviderService;
	...
	public void setProductTypeProviderService	(ProductTypeProviderService productTypeProviderService){
	this.productTypeProviderService = productTypeProviderService;
	}
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProductTypeProvider res = productTypeProviderService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.producttypeprovider",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.producttypeprovider",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProductTypeProvider");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.producttypeprovider",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("productTypeProvider", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = productTypeProviderService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
				"ProductTypeProvider.ProductTypeId",
				"ProductTypeProvider.ProviderId",
		// foreign affairs end
	};
		    collection = productTypeProviderService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProductTypeProviders",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProductTypeProvider" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProductTypeProvider" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProductTypeProvider" );
	    }
