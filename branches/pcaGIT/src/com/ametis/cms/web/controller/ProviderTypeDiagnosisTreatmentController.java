...
*/
public class ProviderTypeDiagnosisTreatmentController implements Controller
...
// extends- 
{
	...
	public void setProviderTypeDiagnosisTreatmentService	(ProviderTypeDiagnosisTreatmentService providerTypeDiagnosisTreatmentService){
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProviderTypeDiagnosisTreatment res = providerTypeDiagnosisTreatmentService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.providertypediagnosistreatment",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.providertypediagnosistreatment",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProviderTypeDiagnosisTreatment");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.providertypediagnosistreatment",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("providerTypeDiagnosisTreatment", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		    ...
		    if (navigation.equals("gosearch") || navigation.equals("golookup")){
			    ...
			    */
					...
					vLikeQ.add(searchtext);
							    								...
							    								if (searchby.equalsIgnoreCase("referenceNote")){
					vLikeP.add("referenceNote");
					vLikeQ.add(searchtext);
				}
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = providerTypeDiagnosisTreatmentService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = providerTypeDiagnosisTreatmentService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProviderTypeDiagnosisTreatments",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProviderTypeDiagnosisTreatment" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProviderTypeDiagnosisTreatment" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProviderTypeDiagnosisTreatment" );
	    }
