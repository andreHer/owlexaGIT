...
*/
public class TherapyMedicineController implements Controller
...

{
	...
	private TherapyMedicineService  therapyMedicineService;
	...
	public void setTherapyMedicineService	(TherapyMedicineService therapyMedicineService){
	this.therapyMedicineService = therapyMedicineService;
	}
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			TherapyMedicine res = therapyMedicineService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.therapymedicine",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.therapymedicine",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchTherapyMedicine");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.therapymedicine",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("therapyMedicine", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = therapyMedicineService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = therapyMedicineService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("TherapyMedicines",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailTherapyMedicine" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupTherapyMedicine" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchTherapyMedicine" );
	    }
