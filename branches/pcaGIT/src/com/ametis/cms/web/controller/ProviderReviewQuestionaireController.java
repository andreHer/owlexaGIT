...
*/
public class ProviderReviewQuestionaireController implements Controller
...

{
	...
	public void setProviderReviewQuestionaireService	(ProviderReviewQuestionaireService providerReviewQuestionaireService){
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ProviderReviewQuestionaire res = providerReviewQuestionaireService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.providerreviewquestionaire",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.providerreviewquestionaire",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchProviderReviewQuestionaire");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.providerreviewquestionaire",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("providerReviewQuestionaire", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = providerReviewQuestionaireService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
		// foreign affairs end
		    ...
		    collection = providerReviewQuestionaireService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ProviderReviewQuestionaires",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailProviderReviewQuestionaire" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupProviderReviewQuestionaire" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchProviderReviewQuestionaire" );
	    }
