...
*/
public class ItemCategoryMapController implements Controller
...
// extends- 
{
	...
	private ItemCategoryMapService  itemCategoryMapService;
...
private ActivityLogService logService;
	...
	public void setItemCategoryMapService	(ItemCategoryMapService itemCategoryMapService){
	this.itemCategoryMapService = itemCategoryMapService;
	}
	    ...
	    ModelAndView result = null;
 	    ...
 	    try {
			...
			*/
			...
			ItemCategoryMap res = itemCategoryMapService.delete (pkey,user);

			if (res!=null){
				request.setAttribute ("alert", alertProperties.getMessage ("success.delete.itemcategorymap",null,"success",Locale.getDefault()));
			}
			else {
				request.setAttribute ("alert", alertProperties.getMessage ("fail.delete.itemcategorymap",null,"fail",Locale.getDefault()));

			}
			result = searchPerformed (request, response, "searchItemCategoryMap");
		}
		catch (Exception e){
	...
	public ModelAndView detailPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
	    ...
	    try {
			...
			*/
			...
			if (object == null){
				request.setAttribute ("alert", alertProperties.getMessage ("not.found.itemcategorymap",null,"fail",Locale.getDefault()));
			}
			/*
			...
			*/
		    ...
		    result.addObject ("itemCategoryMap", object);
	...
	public ModelAndView searchPerformed (HttpServletRequest request, HttpServletResponse response, String location) throws Exception {
		...
		try {
		  ...
		  //  vEqQ.add(new Integer(0));
			...
			count = itemCategoryMapService.getTotal (sLikeP,sLikeQ,sEqP,sEqQ);
	...
	// foreign affairs
				"ItemCategoryMap.CaseCategoryId",
				"ItemCategoryMap.ItemId",
				"ItemCategoryMap.ItemCategoryId",
		// foreign affairs end
	};
		    collection = itemCategoryMapService.search (sLikeP,sLikeQ,sEqP,sEqQ,
		    ...
		    */
		    ...
		    result.addObject("ItemCategoryMaps",collection);
...
*/
	try {
	    ...
	    */
	    	result = detailPerformed (request, response, "detailItemCategoryMap" );
	    }
	    	...
	    	result = searchPerformed (request, response, "lookupItemCategoryMap" );
	    }
	    else {
	    	result = searchPerformed (request, response, "searchItemCategoryMap" );
	    }
