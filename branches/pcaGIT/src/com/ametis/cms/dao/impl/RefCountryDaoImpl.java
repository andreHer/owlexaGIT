...
import com.ametis.cms.dao.RefCountryDao;
...
/**
 * RefCountryDao adalah bean implementation untuk DAO tabel ref_country.
*/
public class RefCountryDaoImpl extends DaoSupportUtil implements RefCountryDao
...
// extends- 
{
	...
	*/
	...
	public RefCountry get (java.io.Serializable pkey) throws DataAccessException {
		return (RefCountry) this.getHibernateTemplate().get (RefCountry.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(RefCountry.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(RefCountry.class);
		return dc;
	}
	@Override
...
/*	public Collection searchRefCountry (RefCountry object) throws Exception{
