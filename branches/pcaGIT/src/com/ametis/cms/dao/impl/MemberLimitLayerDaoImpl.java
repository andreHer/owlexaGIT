...
/**
 * MemberLimitLayerDao adalah bean implementation untuk DAO tabel member_limit_layer.
*/
public class MemberLimitLayerDaoImpl extends DaoSupportUtil implements MemberLimitLayerDao
...
// extends- 
{
	...
	*/
	...
	public MemberLimitLayer get (java.io.Serializable pkey) throws DataAccessException {
		return (MemberLimitLayer) this.getHibernateTemplate().get (MemberLimitLayer.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(MemberLimitLayer.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(MemberLimitLayer.class);
		return dc;
	}
	@Override
...
/*	public Collection searchMemberLimitLayer (MemberLimitLayer object) throws Exception{
