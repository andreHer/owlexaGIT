...
/**
 * FormulariumMedicineDao adalah bean implementation untuk DAO tabel formularium_medicine.
*/
public class FormulariumMedicineDaoImpl extends DaoSupportUtil implements FormulariumMedicineDao
...

{
	...
	*/
	...
	public FormulariumMedicine get (java.io.Serializable pkey) throws DataAccessException {
		return (FormulariumMedicine) this.getHibernateTemplate().get (FormulariumMedicine.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(FormulariumMedicine.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(FormulariumMedicine.class);
		return dc;
	}
...
/*	public Collection searchFormulariumMedicine (FormulariumMedicine object) throws Exception{
