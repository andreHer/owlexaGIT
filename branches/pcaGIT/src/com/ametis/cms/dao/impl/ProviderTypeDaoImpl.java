...
/**
 * ProviderTypeDao adalah bean implementation untuk DAO tabel provider_type.
*/
public class ProviderTypeDaoImpl extends DaoSupportUtil implements ProviderTypeDao
...
// extends- 
{
	...
	*/
	...
	public ProviderType get (java.io.Serializable pkey) throws DataAccessException {
		return (ProviderType) this.getHibernateTemplate().get (ProviderType.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(ProviderType.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(ProviderType.class);
		return dc;
	}
...
/*	public Collection searchProviderType (ProviderType object) throws Exception{
