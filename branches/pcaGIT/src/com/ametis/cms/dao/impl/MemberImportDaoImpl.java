...
import com.ametis.cms.dao.MemberImportDao;
...
/**
 * MemberImportDao adalah bean implementation untuk DAO tabel member_import.
*/
public class MemberImportDaoImpl extends DaoSupportUtil implements MemberImportDao
...
// extends- 
{
	...
	*/
	...
	public MemberImport get (java.io.Serializable pkey) throws DataAccessException {
		return (MemberImport) this.getHibernateTemplate().get (MemberImport.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(MemberImport.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(MemberImport.class);
		return dc;
	}
	@Override
...
/*	public Collection searchMemberImport (MemberImport object) throws Exception{
