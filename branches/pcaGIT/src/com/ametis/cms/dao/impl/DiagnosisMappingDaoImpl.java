...
/**
 * DiagnosisMappingDao adalah bean implementation untuk DAO tabel diagnosis_mapping.
*/
public class DiagnosisMappingDaoImpl extends DaoSupportUtil implements DiagnosisMappingDao
...
// extends- 
{
	...
	*/
	...
	public DiagnosisMapping get (java.io.Serializable pkey) throws DataAccessException {
		return (DiagnosisMapping) this.getHibernateTemplate().get (DiagnosisMapping.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(DiagnosisMapping.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(DiagnosisMapping.class);
		return dc;
	}
...
/*	public Collection searchDiagnosisMapping (DiagnosisMapping object) throws Exception{
