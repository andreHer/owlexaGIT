...
import com.ametis.cms.dao.ItemMeasurementUnitDao;
...
/**
 * ItemMeasurementUnitDao adalah bean implementation untuk DAO tabel item_measurement_unit.
*/
public class ItemMeasurementUnitDaoImpl extends DaoSupportUtil implements ItemMeasurementUnitDao
...
// extends- 
{
	...
	*/
	...
	public ItemMeasurementUnit get (java.io.Serializable pkey) throws DataAccessException {
		return (ItemMeasurementUnit) this.getHibernateTemplate().get (ItemMeasurementUnit.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(ItemMeasurementUnit.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(ItemMeasurementUnit.class);
		return dc;
	}
...
/*	public Collection searchItemMeasurementUnit (ItemMeasurementUnit object) throws Exception{
