...
/**
 * ScheduledPaymentItemDao adalah bean implementation untuk DAO tabel scheduled_payment_item.
*/
public class ScheduledPaymentItemDaoImpl extends DaoSupportUtil implements ScheduledPaymentItemDao
...

{
	...
	*/
	...
	public ScheduledPaymentItem get (java.io.Serializable pkey) throws DataAccessException {
		return (ScheduledPaymentItem) this.getHibernateTemplate().get (ScheduledPaymentItem.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(ScheduledPaymentItem.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(ScheduledPaymentItem.class);
		return dc;
	}
...
/*	public Collection searchScheduledPaymentItem (ScheduledPaymentItem object) throws Exception{
