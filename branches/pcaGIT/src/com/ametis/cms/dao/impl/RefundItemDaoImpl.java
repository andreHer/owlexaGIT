...
import com.ametis.cms.dao.RefundItemDao;
...
/**
 * RefundItemDao adalah bean implementation untuk DAO tabel refund_item.
*/
public class RefundItemDaoImpl extends DaoSupportUtil implements RefundItemDao
...
// extends- 
{
	...
	*/
	...
	public RefundItem get (java.io.Serializable pkey) throws DataAccessException {
		return (RefundItem) this.getHibernateTemplate().get (RefundItem.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(RefundItem.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(RefundItem.class);
		return dc;
	}
...
/*	public Collection searchRefundItem (RefundItem object) throws Exception{
