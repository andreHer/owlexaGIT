...
/**
 * MedicalProcedureMappingDao adalah bean implementation untuk DAO tabel medical_procedure_mapping.
*/
public class MedicalProcedureMappingDaoImpl extends DaoSupportUtil implements MedicalProcedureMappingDao
...
// extends- 
{
	...
	*/
	...
	public MedicalProcedureMapping get (java.io.Serializable pkey) throws DataAccessException {
		return (MedicalProcedureMapping) this.getHibernateTemplate().get (MedicalProcedureMapping.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(MedicalProcedureMapping.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(MedicalProcedureMapping.class);
		return dc;
	}
...
/*	public Collection searchMedicalProcedureMapping (MedicalProcedureMapping object) throws Exception{
