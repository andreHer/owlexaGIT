...
import com.ametis.cms.dao.PolicyDiagnosisExclusionDao;
...
/**
 * PolicyDiagnosisExclusionDao adalah bean implementation untuk DAO tabel policy_diagnosis_exclusion.
*/
public class PolicyDiagnosisExclusionDaoImpl extends DaoSupportUtil implements PolicyDiagnosisExclusionDao
...

{
	...
	*/
	...
	public PolicyDiagnosisExclusion get (java.io.Serializable pkey) throws DataAccessException {
		return (PolicyDiagnosisExclusion) this.getHibernateTemplate().get (PolicyDiagnosisExclusion.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(PolicyDiagnosisExclusion.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(PolicyDiagnosisExclusion.class);
		return dc;
	}
...
/*	public Collection searchPolicyDiagnosisExclusion (PolicyDiagnosisExclusion object) throws Exception{
