...
/**
 * FirstCallDao adalah bean implementation untuk DAO tabel first_call.
*/
public class FirstCallDaoImpl extends DaoSupportUtil implements FirstCallDao
...
// extends- 
{
	...
	*/
	...
	public FirstCall get (java.io.Serializable pkey) throws DataAccessException {
		return (FirstCall) this.getHibernateTemplate().get (FirstCall.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(FirstCall.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(FirstCall.class);
		return dc;
	}
...
/*	public Collection searchFirstCall (FirstCall object) throws Exception{
