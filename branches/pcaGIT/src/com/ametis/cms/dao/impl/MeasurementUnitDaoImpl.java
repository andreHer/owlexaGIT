...
/**
 * MeasurementUnitDao adalah bean implementation untuk DAO tabel measurement_unit.
*/
public class MeasurementUnitDaoImpl extends DaoSupportUtil implements MeasurementUnitDao
...
// extends- 
{
	...
	*/
	...
	public MeasurementUnit get (java.io.Serializable pkey) throws DataAccessException {
		return (MeasurementUnit) this.getHibernateTemplate().get (MeasurementUnit.class, pkey);
	}
...
*/
	public Criteria getCriteria() throws Exception {
		...
		Criteria criteria = session.createCriteria(MeasurementUnit.class);
		return criteria;
	}
...
*/
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = DetachedCriteria.forClass(MeasurementUnit.class);
		return dc;
	}
...
/*	public Collection searchMeasurementUnit (MeasurementUnit object) throws Exception{
