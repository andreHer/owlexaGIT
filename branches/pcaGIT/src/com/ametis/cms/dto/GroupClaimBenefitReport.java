...
public class GroupClaimBenefitReport implements Serializable{
	...
	private Vector<ClaimBenefitReport> reports = new Vector<ClaimBenefitReport>();
	
	public GroupClaimBenefitReport(){}
	...
	public Vector<ClaimBenefitReport> getReports() {
		return reports;
	}
	public void setReports(Vector<ClaimBenefitReport> reports) {
