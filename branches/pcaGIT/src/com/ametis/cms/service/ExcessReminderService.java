...
/**
 * ExcessReminder is a servlet controller for excess_reminder Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface ExcessReminderService 
...
/*
	...
	*/
	public ExcessReminder create (ExcessReminder object,ActionUser actionUser) throws Exception;

	/*
	* Method update (ExcessReminder object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public ExcessReminder update (ExcessReminder object,ActionUser actionUser) throws Exception;	
	...
	*/
	...
	public ExcessReminder delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
	...
	*/
	...
	public ExcessReminder delete (ExcessReminder object,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public ExcessReminder get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public ExcessReminder searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
