...
/**
 * PolicyProvider is a servlet controller for policy_provider Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface PolicyProviderService 
...
{	
/*
	* Method create (PolicyProvider object) berfungsi untuk melakukan penambahan
	...
	*/
	public PolicyProvider create (PolicyProvider object,ActionUser user) throws Exception;
	public PolicyProvider createUpload (PolicyProvider object,MultipartFile file,ActionUser user) throws Exception;

	/*
	* Method update (PolicyProvider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public PolicyProvider update (PolicyProvider object,ActionUser user) throws Exception;	
	
	public Collection<PolicyProvider> searchMemberProvider (String q, Integer policyId,Integer memberId) throws Exception;
	...
	* place
	*/
	public PolicyProvider trash (java.io.Serializable pkey) throws Exception;
	
	/*
	* Method delete (PolicyProvider object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	* @param pkey adalah sebuah object yang merepresentasikan primary key dari 
	...
	*/
	...
	public PolicyProvider delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public PolicyProvider delete (PolicyProvider object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public PolicyProvider get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public PolicyProvider get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public PolicyProvider searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public PolicyProvider searchUnique (String eqColumns, Object eqParams)
		throws Exception;
