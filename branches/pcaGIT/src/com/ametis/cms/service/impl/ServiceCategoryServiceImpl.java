...
/**
 * ServiceCategory is a servlet controller for service_category Table.
...
private ActivityLogService activityLogService;
	...
	public void setServiceCategoryDao (ServiceCategoryDao object){
		this.serviceCategoryDao = object;
	}
	...
	*/
	public ServiceCategory create (ServiceCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ServiceCategory result = serviceCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (ServiceCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ServiceCategory update (ServiceCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		serviceCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ServiceCategory trash (java.io.Serializable pkey) throws Exception {
		ServiceCategory object = serviceCategoryDao.get (pkey);
		serviceCategoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ServiceCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ServiceCategory object = serviceCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ServiceCategory delete (ServiceCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ServiceCategory get (java.io.Serializable pkey) throws Exception{
		ServiceCategory object = null;
		object = serviceCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ServiceCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    ServiceCategory object = null;
	    object = serviceCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = serviceCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ServiceCategory element = (ServiceCategory) iter.next();
...
// unique Result
	...
	public ServiceCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = serviceCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ServiceCategory obj = (ServiceCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ServiceCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = serviceCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ServiceCategory obj = (ServiceCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = serviceCategoryDao.getDetachedCriteria();
		return dc;
	}
