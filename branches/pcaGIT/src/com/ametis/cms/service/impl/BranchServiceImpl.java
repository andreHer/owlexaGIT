...
import com.ametis.cms.dao.BranchDao;
...
/**
 * Branch is a servlet controller for branch Table.
...
// extends- 
{
	...
	public void setBranchDao (BranchDao object){
		this.branchDao = object;
	}
	public BranchDao getBranchDao (){
		return this.branchDao;
	}
	/*
	* Method create (Branch object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Branch create (Branch object,ActionUser user) throws Exception {
			...
			Branch result = branchDao.create (object);
			return result;
		}
	/*
	* Method update (Branch object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Branch update (Branch object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Branch trash (java.io.Serializable pkey) throws Exception {
		Branch object = branchDao.get (pkey);
		branchDao.delete (object);
		return object;
	}

	/*
	* Method delete (Branch object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Branch delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Branch object = branchDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Branch delete (Branch object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Branch get (java.io.Serializable pkey) throws Exception{
		Branch object = null;
		object = branchDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Branch get (java.io.Serializable pkey, String[] required) throws Exception{
	    Branch object = null;
	    object = branchDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = branchDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Branch element = (Branch) iter.next();
...
// unique Result
	...
	public Branch searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = branchDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Branch obj = (Branch) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Branch searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = branchDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Branch obj = (Branch) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = branchDao.getDetachedCriteria();
		return dc;
	}
