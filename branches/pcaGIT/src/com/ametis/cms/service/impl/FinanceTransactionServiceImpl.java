...
import com.ametis.cms.dao.FinanceTransactionDao;
...
/**
 * FinanceTransaction is a servlet controller for finance_transaction Table.
...

{
	...
	public void setFinanceTransactionDao (FinanceTransactionDao object){
		this.financeTransactionDao = object;
	}
	public FinanceTransactionDao getFinanceTransactionDao (){
		return this.financeTransactionDao;
	}
	/*
	* Method create (FinanceTransaction object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public FinanceTransaction create (FinanceTransaction object,ActionUser user) throws Exception {
			...
			FinanceTransaction result = financeTransactionDao.create (object);
			return result;
		}
	/*
	* Method update (FinanceTransaction object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public FinanceTransaction update (FinanceTransaction object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		financeTransactionDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public FinanceTransaction trash (java.io.Serializable pkey) throws Exception {
		FinanceTransaction object = financeTransactionDao.get (pkey);
		financeTransactionDao.delete (object);
		return object;
	}

	/*
	* Method delete (FinanceTransaction object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public FinanceTransaction delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		FinanceTransaction object = financeTransactionDao.get (pkey);
	...
	*/
	...
	public FinanceTransaction delete (FinanceTransaction object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public FinanceTransaction get (java.io.Serializable pkey) throws Exception{
		FinanceTransaction object = null;
		object = financeTransactionDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public FinanceTransaction get (java.io.Serializable pkey, String[] required) throws Exception{
	    FinanceTransaction object = null;
	    object = financeTransactionDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = financeTransactionDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			FinanceTransaction element = (FinanceTransaction) iter.next();
...
// unique Result
	...
	public FinanceTransaction searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = financeTransactionDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FinanceTransaction obj = (FinanceTransaction) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public FinanceTransaction searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = financeTransactionDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FinanceTransaction obj = (FinanceTransaction) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = financeTransactionDao.getDetachedCriteria();
		return dc;
	}
