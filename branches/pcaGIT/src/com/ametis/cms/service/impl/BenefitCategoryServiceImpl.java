...
import com.ametis.cms.dao.BenefitCategoryDao;
...
/**
 * BenefitCategory is a servlet controller for benefit_category Table.
...
private ActivityLogService activityLogService;
	...
	public void setBenefitCategoryDao (BenefitCategoryDao object){
		this.benefitCategoryDao = object;
	}
	public BenefitCategoryDao getBenefitCategoryDao (){
		return this.benefitCategoryDao;
	}
	/*
	* Method create (BenefitCategory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public BenefitCategory create (BenefitCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			BenefitCategory result = benefitCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (BenefitCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public BenefitCategory update (BenefitCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		benefitCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public BenefitCategory trash (java.io.Serializable pkey) throws Exception {
		BenefitCategory object = benefitCategoryDao.get (pkey);
		benefitCategoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (BenefitCategory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public BenefitCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		BenefitCategory object = benefitCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public BenefitCategory delete (BenefitCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public BenefitCategory get (java.io.Serializable pkey) throws Exception{
		BenefitCategory object = null;
		object = benefitCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public BenefitCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    BenefitCategory object = null;
	    object = benefitCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = benefitCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			BenefitCategory element = (BenefitCategory) iter.next();
...
// unique Result
	...
	public BenefitCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = benefitCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		BenefitCategory obj = (BenefitCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public BenefitCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = benefitCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		BenefitCategory obj = (BenefitCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = benefitCategoryDao.getDetachedCriteria();
		return dc;
	}
