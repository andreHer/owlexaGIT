...
import com.ametis.cms.dao.MedicineDao;
...
/**
 * Medicine is a servlet controller for medicine Table.
...
// extends- 
{
	...
	public void setMedicineDao (MedicineDao object){
		this.medicineDao = object;
	}
	public MedicineDao getMedicineDao (){
		return this.medicineDao;
	}
	/*
	* Method create (Medicine object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Medicine create (Medicine object,ActionUser user) throws Exception {
			...
			Medicine result = medicineDao.create (object);
			return result;
		}
	/*
	* Method update (Medicine object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Medicine update (Medicine object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Medicine trash (java.io.Serializable pkey) throws Exception {
		Medicine object = medicineDao.get (pkey);
		medicineDao.delete (object);
		return object;
	}

	/*
	* Method delete (Medicine object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Medicine delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Medicine object = medicineDao.get (pkey);
	...
	*/
	...
	public Medicine delete (Medicine object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Medicine get (java.io.Serializable pkey) throws Exception{
		Medicine object = null;
		object = medicineDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Medicine get (java.io.Serializable pkey, String[] required) throws Exception{
	    Medicine object = null;
	    object = medicineDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = medicineDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Medicine element = (Medicine) iter.next();
...
// unique Result
	...
	public Medicine searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = medicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Medicine obj = (Medicine) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Medicine searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = medicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Medicine obj = (Medicine) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = medicineDao.getDetachedCriteria();
		return dc;
	}
