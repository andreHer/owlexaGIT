...
*/
public class ClientContractItemServiceImpl implements ClientContractItemService
...

{
	...
	private ClientContractItemDao  clientContractItemDao;
	...
	public void setClientContractItemDao (ClientContractItemDao object){
		this.clientContractItemDao = object;
	}
	public ClientContractItemDao getClientContractItemDao (){
		return this.clientContractItemDao;
	}
	/*
	...
	*/
	public ClientContractItem create (ClientContractItem object,ActionUser user) throws Exception {
			...
			ClientContractItem result = clientContractItemDao.create (object);
			return result;
		}
	/*
	* Method update (ClientContractItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClientContractItem update (ClientContractItem object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		clientContractItemDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClientContractItem trash (java.io.Serializable pkey) throws Exception {
		ClientContractItem object = clientContractItemDao.get (pkey);
		clientContractItemDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ClientContractItem delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ClientContractItem object = clientContractItemDao.get (pkey);
	...
	*/
	...
	public ClientContractItem delete (ClientContractItem object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClientContractItem get (java.io.Serializable pkey) throws Exception{
		ClientContractItem object = null;
		object = clientContractItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClientContractItem get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClientContractItem object = null;
	    object = clientContractItemDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clientContractItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClientContractItem element = (ClientContractItem) iter.next();
...
// unique Result
	...
	public ClientContractItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clientContractItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientContractItem obj = (ClientContractItem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClientContractItem searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clientContractItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientContractItem obj = (ClientContractItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clientContractItemDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public Collection<ClientContractItem> getContractItemList(Integer contractId)
			throws Exception {
		// TODO Auto-generated method stub
		
		Collection<ClientContractItem> result = null;
		
		try {
			String[] eqParam = {"deletedStatus","clientContractId.clientContractId"};
			Object[] eqValue = {0,contractId};
	...
	@Override
	public boolean createContractItem(Integer clientContract,
			Collection<ClientContractItem> itemList, ActionUser user)
			throws Exception {
		// TODO Auto-generated method stub
		boolean result = false;
		
		ClientContract contract = clientContractService.get(clientContract);
		...
		if (contract != null){
			...
			for (Iterator iterator = itemList.iterator(); iterator.hasNext();) {
				...
				if (clientContractItem != null){
					clientContractItem.setClientContractId(contract);
					
					create(clientContractItem,user);
				}
	...
	@Override
	public ClientContractItem getClientContractItemByType(Integer clientContractId, Integer type) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
