...
/**
 * TreatmentUpgradeType is a servlet controller for treatment_upgrade_type Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class TreatmentUpgradeTypeServiceImpl implements TreatmentUpgradeTypeService
...
// extends- 
{
	...
	private TreatmentUpgradeTypeDao  treatmentUpgradeTypeDao;

	public void setTreatmentUpgradeTypeDao (TreatmentUpgradeTypeDao object){
		this.treatmentUpgradeTypeDao = object;
	}
	public TreatmentUpgradeTypeDao getTreatmentUpgradeTypeDao (){
		return this.treatmentUpgradeTypeDao;
	}
	/*
	...
	*/
	public TreatmentUpgradeType create (TreatmentUpgradeType object,ActionUser user) throws Exception {
			...
			TreatmentUpgradeType result = treatmentUpgradeTypeDao.create (object);
			return result;
		}
	/*
	* Method update (TreatmentUpgradeType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public TreatmentUpgradeType update (TreatmentUpgradeType object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		treatmentUpgradeTypeDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public TreatmentUpgradeType trash (java.io.Serializable pkey) throws Exception {
		TreatmentUpgradeType object = treatmentUpgradeTypeDao.get (pkey);
		treatmentUpgradeTypeDao.delete (object);
		return object;
	}
	...
	*/
	...
	public TreatmentUpgradeType delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		TreatmentUpgradeType object = treatmentUpgradeTypeDao.get (pkey);
	...
	*/
	...
	public TreatmentUpgradeType delete (TreatmentUpgradeType object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public TreatmentUpgradeType get (java.io.Serializable pkey) throws Exception{
		TreatmentUpgradeType object = null;
		object = treatmentUpgradeTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public TreatmentUpgradeType get (java.io.Serializable pkey, String[] required) throws Exception{
	    TreatmentUpgradeType object = null;
	    object = treatmentUpgradeTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = treatmentUpgradeTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			TreatmentUpgradeType element = (TreatmentUpgradeType) iter.next();
...
// unique Result
	...
	public TreatmentUpgradeType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = treatmentUpgradeTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentUpgradeType obj = (TreatmentUpgradeType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public TreatmentUpgradeType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = treatmentUpgradeTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentUpgradeType obj = (TreatmentUpgradeType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = treatmentUpgradeTypeDao.getDetachedCriteria();
		return dc;
	}
