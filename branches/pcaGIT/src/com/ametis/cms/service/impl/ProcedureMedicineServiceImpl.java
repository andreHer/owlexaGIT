...
import com.ametis.cms.service.ProcedureMedicineService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.ProcedureMedicine;
import com.ametis.cms.dao.ProcedureMedicineDao;
...
/**
 * ProcedureMedicine is a servlet controller for procedure_medicine Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProcedureMedicineServiceImpl implements ProcedureMedicineService
...
// extends- 
{
	...
	private ProcedureMedicineDao  procedureMedicineDao;

	public void setProcedureMedicineDao (ProcedureMedicineDao object){
		this.procedureMedicineDao = object;
	}
	public ProcedureMedicineDao getProcedureMedicineDao (){
		return this.procedureMedicineDao;
	}
	/*
	* Method create (ProcedureMedicine object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProcedureMedicine create (ProcedureMedicine object,ActionUser user) throws Exception {
			...
			ProcedureMedicine result = procedureMedicineDao.create (object);
			return result;
		}
	/*
	* Method update (ProcedureMedicine object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProcedureMedicine update (ProcedureMedicine object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		procedureMedicineDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProcedureMedicine trash (java.io.Serializable pkey) throws Exception {
		ProcedureMedicine object = procedureMedicineDao.get (pkey);
		procedureMedicineDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProcedureMedicine object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProcedureMedicine delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProcedureMedicine object = procedureMedicineDao.get (pkey);
	...
	*/
	...
	public ProcedureMedicine delete (ProcedureMedicine object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProcedureMedicine get (java.io.Serializable pkey) throws Exception{
		ProcedureMedicine object = null;
		object = procedureMedicineDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProcedureMedicine get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProcedureMedicine object = null;
	    object = procedureMedicineDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = procedureMedicineDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProcedureMedicine element = (ProcedureMedicine) iter.next();
...
// unique Result
	...
	public ProcedureMedicine searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = procedureMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProcedureMedicine obj = (ProcedureMedicine) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProcedureMedicine searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = procedureMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProcedureMedicine obj = (ProcedureMedicine) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = procedureMedicineDao.getDetachedCriteria();
		return dc;
	}
