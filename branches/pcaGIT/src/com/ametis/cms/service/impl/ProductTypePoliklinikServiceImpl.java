...
import com.ametis.cms.dao.ProductTypePoliklinikDao;
...
/**
 * ProductTypePoliklinik is a servlet controller for product_type_poliklinik Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProductTypePoliklinikServiceImpl implements ProductTypePoliklinikService
...
// extends- 
{
	...
	private ProductTypePoliklinikDao  productTypePoliklinikDao;

	public void setProductTypePoliklinikDao (ProductTypePoliklinikDao object){
		this.productTypePoliklinikDao = object;
	}
	public ProductTypePoliklinikDao getProductTypePoliklinikDao (){
		return this.productTypePoliklinikDao;
	}
	/*
	* Method create (ProductTypePoliklinik object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProductTypePoliklinik create (ProductTypePoliklinik object,ActionUser user) throws Exception {
			...
			ProductTypePoliklinik result = productTypePoliklinikDao.create (object);
			return result;
		}
	/*
	* Method update (ProductTypePoliklinik object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProductTypePoliklinik update (ProductTypePoliklinik object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		productTypePoliklinikDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProductTypePoliklinik trash (java.io.Serializable pkey) throws Exception {
		ProductTypePoliklinik object = productTypePoliklinikDao.get (pkey);
		productTypePoliklinikDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProductTypePoliklinik object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProductTypePoliklinik delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProductTypePoliklinik object = productTypePoliklinikDao.get (pkey);
	...
	*/
	...
	public ProductTypePoliklinik delete (ProductTypePoliklinik object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProductTypePoliklinik get (java.io.Serializable pkey) throws Exception{
		ProductTypePoliklinik object = null;
		object = productTypePoliklinikDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProductTypePoliklinik get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProductTypePoliklinik object = null;
	    object = productTypePoliklinikDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productTypePoliklinikDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductTypePoliklinik element = (ProductTypePoliklinik) iter.next();
...
// unique Result
	...
	public ProductTypePoliklinik searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = productTypePoliklinikDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductTypePoliklinik obj = (ProductTypePoliklinik) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProductTypePoliklinik searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = productTypePoliklinikDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductTypePoliklinik obj = (ProductTypePoliklinik) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productTypePoliklinikDao.getDetachedCriteria();
		return dc;
	}
