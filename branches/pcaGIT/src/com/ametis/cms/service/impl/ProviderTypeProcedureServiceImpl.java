...
/**
 * ProviderTypeProcedure is a servlet controller for provider_type_procedure Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderTypeProcedureServiceImpl implements ProviderTypeProcedureService
...
// extends- 
{
	...
	private ProviderTypeProcedureDao  providerTypeProcedureDao;

	public void setProviderTypeProcedureDao (ProviderTypeProcedureDao object){
		this.providerTypeProcedureDao = object;
	}
	public ProviderTypeProcedureDao getProviderTypeProcedureDao (){
		return this.providerTypeProcedureDao;
	}
	/*
	...
	*/
	public ProviderTypeProcedure create (ProviderTypeProcedure object,ActionUser user) throws Exception {
			...
			ProviderTypeProcedure result = providerTypeProcedureDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderTypeProcedure object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderTypeProcedure update (ProviderTypeProcedure object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerTypeProcedureDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderTypeProcedure trash (java.io.Serializable pkey) throws Exception {
		ProviderTypeProcedure object = providerTypeProcedureDao.get (pkey);
		providerTypeProcedureDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderTypeProcedure delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderTypeProcedure object = providerTypeProcedureDao.get (pkey);
	...
	*/
	...
	public ProviderTypeProcedure delete (ProviderTypeProcedure object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderTypeProcedure get (java.io.Serializable pkey) throws Exception{
		ProviderTypeProcedure object = null;
		object = providerTypeProcedureDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderTypeProcedure get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderTypeProcedure object = null;
	    object = providerTypeProcedureDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerTypeProcedureDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderTypeProcedure element = (ProviderTypeProcedure) iter.next();
...
// unique Result
	...
	public ProviderTypeProcedure searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerTypeProcedureDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderTypeProcedure obj = (ProviderTypeProcedure) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderTypeProcedure searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerTypeProcedureDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderTypeProcedure obj = (ProviderTypeProcedure) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerTypeProcedureDao.getDetachedCriteria();
		return dc;
	}
