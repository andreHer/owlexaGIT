...
import com.ametis.cms.service.CardStockUsageService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.CardStockUsage;
import com.ametis.cms.dao.CardStockUsageDao;
...
/**
 * CardStockUsage is a servlet controller for card_stock_usage Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class CardStockUsageServiceImpl implements CardStockUsageService
...
// extends- 
{
	...
	private CardStockUsageDao  cardStockUsageDao;

	public void setCardStockUsageDao (CardStockUsageDao object){
		this.cardStockUsageDao = object;
	}
	public CardStockUsageDao getCardStockUsageDao (){
		return this.cardStockUsageDao;
	}
	/*
	* Method create (CardStockUsage object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public CardStockUsage create (CardStockUsage object,ActionUser user) throws Exception {
			...
			CardStockUsage result = cardStockUsageDao.create (object);
			return result;
		}
	/*
	* Method update (CardStockUsage object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CardStockUsage update (CardStockUsage object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		cardStockUsageDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public CardStockUsage trash (java.io.Serializable pkey) throws Exception {
		CardStockUsage object = cardStockUsageDao.get (pkey);
		cardStockUsageDao.delete (object);
		return object;
	}

	/*
	* Method delete (CardStockUsage object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public CardStockUsage delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		CardStockUsage object = cardStockUsageDao.get (pkey);
	...
	*/
	...
	public CardStockUsage delete (CardStockUsage object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CardStockUsage get (java.io.Serializable pkey) throws Exception{
		CardStockUsage object = null;
		object = cardStockUsageDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CardStockUsage get (java.io.Serializable pkey, String[] required) throws Exception{
	    CardStockUsage object = null;
	    object = cardStockUsageDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = cardStockUsageDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CardStockUsage element = (CardStockUsage) iter.next();
...
// unique Result
	...
	public CardStockUsage searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = cardStockUsageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CardStockUsage obj = (CardStockUsage) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CardStockUsage searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = cardStockUsageDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CardStockUsage obj = (CardStockUsage) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = cardStockUsageDao.getDetachedCriteria();
		return dc;
	}
