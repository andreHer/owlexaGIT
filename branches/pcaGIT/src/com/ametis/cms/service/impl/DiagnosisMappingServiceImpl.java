...
import com.ametis.cms.service.DiagnosisMappingService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.DiagnosisMapping;
import com.ametis.cms.dao.DiagnosisMappingDao;
...
/**
 * DiagnosisMapping is a servlet controller for diagnosis_mapping Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class DiagnosisMappingServiceImpl implements DiagnosisMappingService
...
// extends- 
{
	...
	private DiagnosisMappingDao  diagnosisMappingDao;

	public void setDiagnosisMappingDao (DiagnosisMappingDao object){
		this.diagnosisMappingDao = object;
	}
	public DiagnosisMappingDao getDiagnosisMappingDao (){
		return this.diagnosisMappingDao;
	}
	/*
	...
	*/
	public DiagnosisMapping create (DiagnosisMapping object,ActionUser user) throws Exception {
			...
			DiagnosisMapping result = diagnosisMappingDao.create (object);
			return result;
		}
	/*
	* Method update (DiagnosisMapping object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public DiagnosisMapping update (DiagnosisMapping object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		diagnosisMappingDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public DiagnosisMapping trash (java.io.Serializable pkey) throws Exception {
		DiagnosisMapping object = diagnosisMappingDao.get (pkey);
		diagnosisMappingDao.delete (object);
		return object;
	}
	...
	*/
	...
	public DiagnosisMapping delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		DiagnosisMapping object = diagnosisMappingDao.get (pkey);
	...
	*/
	...
	public DiagnosisMapping delete (DiagnosisMapping object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public DiagnosisMapping get (java.io.Serializable pkey) throws Exception{
		DiagnosisMapping object = null;
		object = diagnosisMappingDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public DiagnosisMapping get (java.io.Serializable pkey, String[] required) throws Exception{
	    DiagnosisMapping object = null;
	    object = diagnosisMappingDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = diagnosisMappingDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DiagnosisMapping element = (DiagnosisMapping) iter.next();
...
// unique Result
	...
	public DiagnosisMapping searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = diagnosisMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisMapping obj = (DiagnosisMapping) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public DiagnosisMapping searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = diagnosisMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisMapping obj = (DiagnosisMapping) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = diagnosisMappingDao.getDetachedCriteria();
		return dc;
	}
