...
/**
 * Problem is a servlet controller for problem Table.
...
// extends- 
{
	...
	public void setProblemDao (ProblemDao object){
		this.problemDao = object;
	}
	...
	*/
	public Problem create (Problem object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Problem result = problemDao.create (object);
			return result;
		}
	/*
	* Method update (Problem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Problem update (Problem object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Problem trash (java.io.Serializable pkey) throws Exception {
		Problem object = problemDao.get (pkey);
		problemDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Problem delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Problem object = problemDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Problem delete (Problem object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Problem get (java.io.Serializable pkey) throws Exception{
		Problem object = null;
		object = problemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Problem get (java.io.Serializable pkey, String[] required) throws Exception{
	    Problem object = null;
	    object = problemDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = problemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Problem element = (Problem) iter.next();
...
// unique Result
	...
	public Problem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = problemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Problem obj = (Problem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Problem searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = problemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Problem obj = (Problem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = problemDao.getDetachedCriteria();
		return dc;
	}
