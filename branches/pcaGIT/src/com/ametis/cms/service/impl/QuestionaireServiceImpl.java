...
/**
 * Questionaire is a servlet controller for questionaire Table.
...

{
	...
	public void setQuestionaireDao (QuestionaireDao object){
		this.questionaireDao = object;
	}
	public QuestionaireDao getQuestionaireDao (){
		return this.questionaireDao;
	}
	/*
	...
	*/
	public Questionaire create (Questionaire object,ActionUser user) throws Exception {
			...
			Questionaire result = questionaireDao.create (object);
			return result;
		}
	/*
	* Method update (Questionaire object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Questionaire update (Questionaire object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Questionaire trash (java.io.Serializable pkey) throws Exception {
		Questionaire object = questionaireDao.get (pkey);
		questionaireDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Questionaire delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Questionaire object = questionaireDao.get (pkey);
	...
	*/
	...
	public Questionaire delete (Questionaire object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Questionaire get (java.io.Serializable pkey) throws Exception{
		Questionaire object = null;
		object = questionaireDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Questionaire get (java.io.Serializable pkey, String[] required) throws Exception{
	    Questionaire object = null;
	    object = questionaireDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = questionaireDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Questionaire element = (Questionaire) iter.next();
...
// unique Result
	...
	public Questionaire searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = questionaireDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Questionaire obj = (Questionaire) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Questionaire searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = questionaireDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Questionaire obj = (Questionaire) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = questionaireDao.getDetachedCriteria();
		return dc;
	}
