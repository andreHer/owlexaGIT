...
/**
 * Configuration is a servlet controller for configuration Table.
...

{
	...
	public void setConfigurationDao (ConfigurationDao object){
		this.configurationDao = object;
	}
	...
	*/
	public Configuration create (Configuration object,ActionUser user) throws Exception {
			
		Configuration result = configurationDao.create (object);
		return result;
	}
	/*
	* Method update (Configuration object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Configuration update (Configuration object,ActionUser user) throws Exception{	
		
 		configurationDao.update (object);
      	return object;
	}

	public int generateClaimNumber(Integer configId) throws Exception {
		int result = 0;
		
		try {
			Session session = configurationDao.getConfigSession();
			
			
			String q = "SELECT claim_number FROM configuration WHERE configuration_id = :id";
			String qUpdate = "UPDATE configuration SET claim_number = :num WHERE configuration_id = :id";
			
			SQLQuery sqlQ = session.createSQLQuery(q);
			sqlQ.setInteger("id", configId);


			Number num = (Number) sqlQ.uniqueResult();
			result = num.intValue();	
			
			SQLQuery sqlQUpdate = session.createSQLQuery(qUpdate);
			sqlQUpdate.setInteger("num", result+1);
			sqlQUpdate.setInteger("id", configId);
			
			sqlQUpdate.executeUpdate();
	...
	* place
	*/
	public Configuration trash (java.io.Serializable pkey) throws Exception {
		Configuration object = configurationDao.get (pkey);
		configurationDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Configuration delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Configuration object = configurationDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Configuration delete (Configuration object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Configuration get (java.io.Serializable pkey) throws Exception{
		Configuration object = null;
		object = configurationDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Configuration get (java.io.Serializable pkey, String[] required) throws Exception{
	    Configuration object = null;
	    object = configurationDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = configurationDao.getCriteria();
...
// unique Result
	...
	public Configuration searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = configurationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Configuration obj = (Configuration) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Configuration searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = configurationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Configuration obj = (Configuration) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = configurationDao.getDetachedCriteria();
		return dc;
	}
	public Configuration getSystemConfiguration() throws Exception {
		// TODO Auto-generated method stub
		Configuration object = configurationDao.get (0);
		return object;
	}
	@Override
	public Configuration getClientConfiguration(Integer clientId)
			throws Exception {
		// TODO Auto-generated method stub
		Configuration result = null;
		String[] eqParam = {"clientId.clientId"};
		Object[] eqValue = {clientId};
		Collection<Configuration> configurations = search(null,null,eqParam,eqValue,0,1);
