...
/**
 * Priority is a servlet controller for priority Table.
...

{
	...
	public void setPriorityDao (PriorityDao object){
		this.priorityDao = object;
	}
	...
	*/
	public Priority create (Priority object,User user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Priority result = priorityDao.create (object);
			return result;
		}
	/*
	* Method update (Priority object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Priority update (Priority object,User user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Priority trash (java.io.Serializable pkey) throws Exception {
		Priority object = priorityDao.get (pkey);
		priorityDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Priority delete (java.io.Serializable pkey,User user) throws Exception{
		Priority object = priorityDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Priority delete (Priority object,User user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Priority get (java.io.Serializable pkey) throws Exception{
		Priority object = null;
		object = priorityDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Priority get (java.io.Serializable pkey, String[] required) throws Exception{
	    Priority object = null;
	    object = priorityDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = priorityDao.getCriteria();
...
// unique Result
	...
	public Priority searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = priorityDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Priority obj = (Priority) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Priority searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = priorityDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Priority obj = (Priority) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = priorityDao.getDetachedCriteria();
		return dc;
	}
