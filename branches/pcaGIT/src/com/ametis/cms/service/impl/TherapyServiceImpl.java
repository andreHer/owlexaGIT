...
import com.ametis.cms.service.TherapyService;
...
/**
 * Therapy is a servlet controller for therapy Table.
...

{
	...
	public void setTherapyDao (TherapyDao object){
		this.therapyDao = object;
	}
	...
	*/
	public Therapy create (Therapy object,ActionUser user) throws Exception {
			...
			Therapy result = therapyDao.create (object);
			return result;
		}
	/*
	* Method update (Therapy object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Therapy update (Therapy object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Therapy trash (java.io.Serializable pkey) throws Exception {
		Therapy object = therapyDao.get (pkey);
		therapyDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Therapy delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Therapy object = therapyDao.get (pkey);
	...
	*/
	...
	public Therapy delete (Therapy object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Therapy get (java.io.Serializable pkey) throws Exception{
		Therapy object = null;
		object = therapyDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Therapy get (java.io.Serializable pkey, String[] required) throws Exception{
	    Therapy object = null;
	    object = therapyDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = therapyDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Therapy element = (Therapy) iter.next();
...
// unique Result
	...
	public Therapy searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = therapyDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Therapy obj = (Therapy) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Therapy searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = therapyDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Therapy obj = (Therapy) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = therapyDao.getDetachedCriteria();
		return dc;
	}
