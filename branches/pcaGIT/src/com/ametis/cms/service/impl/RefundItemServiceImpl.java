...
import com.ametis.cms.service.RefundItemService;
...
*/
public class RefundItemServiceImpl implements RefundItemService
...
// extends- 
{
	...
	private RefundItemDao  refundItemDao;

	public void setRefundItemDao (RefundItemDao object){
		this.refundItemDao = object;
	}
	public RefundItemDao getRefundItemDao (){
		return this.refundItemDao;
	}
	/*
	...
	*/
	public RefundItem create (RefundItem object,ActionUser user) throws Exception {
			...
			RefundItem result = refundItemDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public RefundItem trash (java.io.Serializable pkey) throws Exception {
		RefundItem object = refundItemDao.get (pkey);
		refundItemDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public RefundItem get (java.io.Serializable pkey) throws Exception{
		RefundItem object = null;
		object = refundItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = refundItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			RefundItem element = (RefundItem) iter.next();
...
// unique Result
	...
	public RefundItem searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = refundItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RefundItem obj = (RefundItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = refundItemDao.getDetachedCriteria();
		return dc;
	}
