...
/**
 * ProviderCategory is a servlet controller for provider_category Table.
...

{
	...
	private ProviderCategoryDao  providerCategoryDao;
private ActivityLogService activityLogService;
	...
	public void setProviderCategoryDao (ProviderCategoryDao object){
		this.providerCategoryDao = object;
	}
	public ProviderCategoryDao getProviderCategoryDao (){
		return this.providerCategoryDao;
	}
	/*
	...
	*/
	public ProviderCategory create (ProviderCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			object.setDeletedTime(new Timestamp(System.currentTimeMillis()));
			...
			ProviderCategory result = providerCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderCategory update (ProviderCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderCategory trash (java.io.Serializable pkey) throws Exception {
		ProviderCategory object = providerCategoryDao.get (pkey);
		providerCategoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ProviderCategory object = providerCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ProviderCategory delete (ProviderCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderCategory get (java.io.Serializable pkey) throws Exception{
		ProviderCategory object = null;
		object = providerCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderCategory object = null;
	    object = providerCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderCategory element = (ProviderCategory) iter.next();
...
// unique Result
	...
	public ProviderCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderCategory obj = (ProviderCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderCategory obj = (ProviderCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerCategoryDao.getDetachedCriteria();
		return dc;
	}
