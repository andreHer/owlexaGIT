...
*/
public class PolicyClausulServiceImpl implements PolicyClausulService
...
// extends- 
{
	...
	private PolicyClausulDao  policyClausulDao;

	public void setPolicyClausulDao (PolicyClausulDao object){
		this.policyClausulDao = object;
	}
	public PolicyClausulDao getPolicyClausulDao (){
		return this.policyClausulDao;
	}
	/*
	...
	*/
	public PolicyClausul create (PolicyClausul object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			PolicyClausul result = policyClausulDao.create (object);
			return result;
		}
	/*
	* Method update (PolicyClausul object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PolicyClausul update (PolicyClausul object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		policyClausulDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public PolicyClausul trash (java.io.Serializable pkey) throws Exception {
		PolicyClausul object = policyClausulDao.get (pkey);
		policyClausulDao.delete (object);
		return object;
	}
	...
	*/
	...
	public PolicyClausul delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PolicyClausul object = policyClausulDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public PolicyClausul delete (PolicyClausul object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PolicyClausul get (java.io.Serializable pkey) throws Exception{
		PolicyClausul object = null;
		object = policyClausulDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PolicyClausul get (java.io.Serializable pkey, String[] required) throws Exception{
	    PolicyClausul object = null;
	    object = policyClausulDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = policyClausulDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PolicyClausul element = (PolicyClausul) iter.next();
...
// unique Result
	...
	public PolicyClausul searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = policyClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyClausul obj = (PolicyClausul) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PolicyClausul searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = policyClausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyClausul obj = (PolicyClausul) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = policyClausulDao.getDetachedCriteria();
		return dc;
	}
