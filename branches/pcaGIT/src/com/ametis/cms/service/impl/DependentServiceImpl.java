...
import com.ametis.cms.dao.DependentDao;
...
/**
 * Dependent is a servlet controller for dependent Table.
...
private ActivityLogService activityLogService;
	...
	public void setDependentDao (DependentDao object){
		this.dependentDao = object;
	}
	public DependentDao getDependentDao (){
		return this.dependentDao;
	}
	/*
	* Method create (Dependent object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Dependent create (Dependent object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Dependent result = dependentDao.create (object);
			return result;
		}
	/*
	* Method update (Dependent object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Dependent update (Dependent object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Dependent trash (java.io.Serializable pkey) throws Exception {
		Dependent object = dependentDao.get (pkey);
		dependentDao.delete (object);
		return object;
	}

	/*
	* Method delete (Dependent object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Dependent delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		Dependent object = dependentDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Dependent delete (Dependent object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Dependent get (java.io.Serializable pkey) throws Exception{
		Dependent object = null;
		object = dependentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Dependent get (java.io.Serializable pkey, String[] required) throws Exception{
	    Dependent object = null;
	    object = dependentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = dependentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Dependent element = (Dependent) iter.next();
...
// unique Result
	...
	public Dependent searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = dependentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Dependent obj = (Dependent) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Dependent searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = dependentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Dependent obj = (Dependent) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = dependentDao.getDetachedCriteria();
		return dc;
	}
