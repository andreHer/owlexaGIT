...
import com.ametis.cms.service.ClientMedicineService;
...
*/
public class ClientMedicineServiceImpl implements ClientMedicineService
...
// extends- 
{
	...
	private ClientMedicineDao  clientMedicineDao;
	...
	public void setClientMedicineDao (ClientMedicineDao object){
		this.clientMedicineDao = object;
	}
	public ClientMedicineDao getClientMedicineDao (){
		return this.clientMedicineDao;
	}
	/*
	...
	*/
	public ClientMedicine create (ClientMedicine object,ActionUser user) throws Exception {
			...
			ClientMedicine result = clientMedicineDao.create (object);
			return result;
		}
	/*
	* Method update (ClientMedicine object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClientMedicine update (ClientMedicine object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		clientMedicineDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClientMedicine trash (java.io.Serializable pkey) throws Exception {
		ClientMedicine object = clientMedicineDao.get (pkey);
		clientMedicineDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ClientMedicine delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ClientMedicine object = clientMedicineDao.get (pkey);
	...
	*/
	...
	public ClientMedicine delete (ClientMedicine object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClientMedicine get (java.io.Serializable pkey) throws Exception{
		ClientMedicine object = null;
		object = clientMedicineDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClientMedicine get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClientMedicine object = null;
	    object = clientMedicineDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clientMedicineDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClientMedicine element = (ClientMedicine) iter.next();
...
// unique Result
	...
	public ClientMedicine searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clientMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientMedicine obj = (ClientMedicine) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClientMedicine searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clientMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientMedicine obj = (ClientMedicine) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clientMedicineDao.getDetachedCriteria();
		return dc;
	}
	
	public boolean addMedicine(Integer clientId,
			Collection<ClientMedicine> medicineList, ActionUser user)
			throws Exception {
		// TODO Auto-generated method stub
		boolean result = false;
		
		try {
			if (clientId != null && medicineList != null){
				Client client = clientService.get(clientId);
				
				for (Iterator iterator = medicineList.iterator(); iterator
						.hasNext();) {
					
					ClientMedicine med = (ClientMedicine) iterator.next();
