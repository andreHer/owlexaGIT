...
// extends- 
{
	...
	public void setBillingItemDao (BillingItemDao object){
		this.billingItemDao = object;
	}
	public BillingItemDao getBillingItemDao (){
		return this.billingItemDao;
	}
	/*
	...
	*/
	public BillingItem create (BillingItem object,ActionUser user) throws Exception {
			...
			BillingItem result = billingItemDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public BillingItem trash (java.io.Serializable pkey) throws Exception {
		BillingItem object = billingItemDao.get (pkey);
		billingItemDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public BillingItem get (java.io.Serializable pkey) throws Exception{
		BillingItem object = null;
		object = billingItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = billingItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			BillingItem element = (BillingItem) iter.next();
...
// unique Result
	...
	public BillingItem searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = billingItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		BillingItem obj = (BillingItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = billingItemDao.getDetachedCriteria();
		return dc;
	}
