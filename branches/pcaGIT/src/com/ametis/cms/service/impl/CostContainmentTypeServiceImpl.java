...
import com.ametis.cms.dao.CostContainmentTypeDao;
...
/**
 * CostContainmentType is a servlet controller for cost_containment_type Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class CostContainmentTypeServiceImpl implements CostContainmentTypeService
...

{
	...
	private CostContainmentTypeDao  costContainmentTypeDao;

	public void setCostContainmentTypeDao (CostContainmentTypeDao object){
		this.costContainmentTypeDao = object;
	}
	public CostContainmentTypeDao getCostContainmentTypeDao (){
		return this.costContainmentTypeDao;
	}
	/*
	...
	*/
	public CostContainmentType create (CostContainmentType object,User user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			CostContainmentType result = costContainmentTypeDao.create (object);
			return result;
		}
	/*
	* Method update (CostContainmentType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CostContainmentType update (CostContainmentType object,User user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		costContainmentTypeDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public CostContainmentType trash (java.io.Serializable pkey) throws Exception {
		CostContainmentType object = costContainmentTypeDao.get (pkey);
		costContainmentTypeDao.delete (object);
		return object;
	}
	...
	*/
	...
	public CostContainmentType delete (java.io.Serializable pkey,User user) throws Exception{
		CostContainmentType object = costContainmentTypeDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public CostContainmentType delete (CostContainmentType object,User user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CostContainmentType get (java.io.Serializable pkey) throws Exception{
		CostContainmentType object = null;
		object = costContainmentTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CostContainmentType get (java.io.Serializable pkey, String[] required) throws Exception{
	    CostContainmentType object = null;
	    object = costContainmentTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = costContainmentTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CostContainmentType element = (CostContainmentType) iter.next();
...
// unique Result
	...
	public CostContainmentType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = costContainmentTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CostContainmentType obj = (CostContainmentType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CostContainmentType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = costContainmentTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CostContainmentType obj = (CostContainmentType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = costContainmentTypeDao.getDetachedCriteria();
		return dc;
	}
