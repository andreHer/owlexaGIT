...
import com.ametis.cms.dao.ClientCategoryDao;
...
/**
 * ClientCategory is a servlet controller for client_category Table.
...
private ActivityLogService activityLogService;
	...
	public void setClientCategoryDao (ClientCategoryDao object){
		this.clientCategoryDao = object;
	}
	public ClientCategoryDao getClientCategoryDao (){
		return this.clientCategoryDao;
	}
	/*
	* Method create (ClientCategory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ClientCategory create (ClientCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ClientCategory result = clientCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (ClientCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClientCategory update (ClientCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		clientCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClientCategory trash (java.io.Serializable pkey) throws Exception {
		ClientCategory object = clientCategoryDao.get (pkey);
		clientCategoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (ClientCategory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ClientCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ClientCategory object = clientCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ClientCategory delete (ClientCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClientCategory get (java.io.Serializable pkey) throws Exception{
		ClientCategory object = null;
		object = clientCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClientCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClientCategory object = null;
	    object = clientCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clientCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClientCategory element = (ClientCategory) iter.next();
...
// unique Result
	...
	public ClientCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clientCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientCategory obj = (ClientCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClientCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clientCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientCategory obj = (ClientCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clientCategoryDao.getDetachedCriteria();
		return dc;
	}
