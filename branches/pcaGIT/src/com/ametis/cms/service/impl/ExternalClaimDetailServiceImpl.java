...
// imports- 
/**
 * ExternalClaimDetail is a servlet controller for external_claim_detail Table.
 * All you have to do is to convert necessary data field to the named parameter
 */
public class ExternalClaimDetailServiceImpl implements ExternalClaimDetailService // extends+ 
// extends- 
{

    private ExternalClaimDetailDao externalClaimDetailDao;
	...
	public void setExternalClaimDetailDao(ExternalClaimDetailDao object) {
        this.externalClaimDetailDao = object;
    }

    public ExternalClaimDetailDao getExternalClaimDetailDao() {
        return this.externalClaimDetailDao;
    }
    /*
     * Method create (ExternalClaimDetail object) berfungsi untuk melakukan
    ...
    public ExternalClaimDetail create(ExternalClaimDetail object, ActionUser user) throws Exception {

        object.setCreatedTime(new java.sql.Date(System.currentTimeMillis()));
        ...
        ExternalClaimDetail result = null;
        
        if (total == 0){
        	result = externalClaimDetailDao.create(object);
        	...
        	if (result != null){
        		...
        		if (totalClaim == 0){
        			...
        			//claim.setAdmissionDate(Date.valueOf(object.))
        		}
    ...
    /*
     * Method update (ExternalClaimDetail object) berfungsi untuk melakukan
    ...
    public ExternalClaimDetail update(ExternalClaimDetail object, ActionUser user) throws Exception {
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
        ...
        externalClaimDetailDao.update(object);
        return object;
    }
     ...
     * in any place
     */
    public ExternalClaimDetail trash(java.io.Serializable pkey) throws Exception {
        ExternalClaimDetail object = externalClaimDetailDao.get(pkey);
        externalClaimDetailDao.delete(object);
        return object;
    }

    /*
     * Method delete (ExternalClaimDetail object) berfungsi untuk melakukan
     ...
     * exception if failed
     */
    public ExternalClaimDetail delete(java.io.Serializable pkey, ActionUser user) throws Exception {
        ExternalClaimDetail object = externalClaimDetailDao.get(pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
     ...
     * exception if failed
     */
    public ExternalClaimDetail delete(ExternalClaimDetail object, ActionUser user) throws Exception {
...
// -- get section - carefull !
     ...
     */
    public ExternalClaimDetail get(java.io.Serializable pkey) throws Exception {
        ExternalClaimDetail object = null;
        object = externalClaimDetailDao.get(pkey);
        return object;
    }
    /*
     * Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
    ...
    public ExternalClaimDetail get(java.io.Serializable pkey, String[] required) throws Exception {
        ExternalClaimDetail object = null;
        object = externalClaimDetailDao.get(pkey);
...
// -- 1
    public Collection search(String[] likeColumns, Object[] likeParams,
        ...
        Criteria c = externalClaimDetailDao.getCriteria();
    ...
    public Collection search(String[] likeColumns, Object[] likeParams,
        ...
        for (Iterator iter = list.iterator(); iter.hasNext();) {
            ExternalClaimDetail element = (ExternalClaimDetail) iter.next();
...
// unique Result
    public ExternalClaimDetail searchUnique(String eqColumns, Object eqParams, String[] required)
            throws Exception {
        Criteria c = externalClaimDetailDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        ExternalClaimDetail obj = (ExternalClaimDetail) c.uniqueResult();
        DaoSupportUtil.lazyInit(required, obj);
        return obj;
    }

    public ExternalClaimDetail searchUnique(String eqColumns, Object eqParams)
            throws Exception {
        Criteria c = externalClaimDetailDao.getCriteria();
        DaoSupportUtil.setEqParam(eqColumns, eqParams, c);
        ExternalClaimDetail obj = (ExternalClaimDetail) c.uniqueResult();
...
// -----------------------------------------------
    ...
    public DetachedCriteria getDetachedCriteria() throws Exception {
        DetachedCriteria dc = externalClaimDetailDao.getDetachedCriteria();
        return dc;
    }
// class+ 
// class- 
