...
import com.ametis.cms.dao.ActivityLogDao;
...
/**
 * ActivityLog is a servlet controller for activity_log Table.
...

{
	...
	public void setActivityLogDao (ActivityLogDao object){
		this.activityLogDao = object;
	}
	public ActivityLogDao getActivityLogDao (){
		return this.activityLogDao;
	}
	/*
	* Method create (ActivityLog object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ActivityLog create (ActivityLog object) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ActivityLog result = activityLogDao.create (object);
			return result;
		}
	/*
	* Method update (ActivityLog object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ActivityLog update (ActivityLog object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ActivityLog trash (java.io.Serializable pkey) throws Exception {
		ActivityLog object = activityLogDao.get (pkey);
		activityLogDao.delete (object);
		return object;
	}

	/*
	* Method delete (ActivityLog object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ActivityLog delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ActivityLog object = activityLogDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ActivityLog delete (ActivityLog object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ActivityLog get (java.io.Serializable pkey) throws Exception{
		ActivityLog object = null;
		object = activityLogDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ActivityLog get (java.io.Serializable pkey, String[] required) throws Exception{
	    ActivityLog object = null;
	    object = activityLogDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = activityLogDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ActivityLog element = (ActivityLog) iter.next();
...
// unique Result
	...
	public ActivityLog searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = activityLogDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ActivityLog obj = (ActivityLog) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ActivityLog searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = activityLogDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ActivityLog obj = (ActivityLog) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = activityLogDao.getDetachedCriteria();
		return dc;
	}
