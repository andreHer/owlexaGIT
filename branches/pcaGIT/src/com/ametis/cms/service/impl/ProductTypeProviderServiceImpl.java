...
import com.ametis.cms.service.ProductTypeProviderService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.ProductTypeProvider;
import com.ametis.cms.dao.ProductTypeProviderDao;
...
/**
 * ProductTypeProvider is a servlet controller for product_type_provider Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProductTypeProviderServiceImpl implements ProductTypeProviderService
...
// extends- 
{
	...
	private ProductTypeProviderDao  productTypeProviderDao;

	public void setProductTypeProviderDao (ProductTypeProviderDao object){
		this.productTypeProviderDao = object;
	}
	public ProductTypeProviderDao getProductTypeProviderDao (){
		return this.productTypeProviderDao;
	}
	/*
	* Method create (ProductTypeProvider object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProductTypeProvider create (ProductTypeProvider object,ActionUser user) throws Exception {
			...
			ProductTypeProvider result = productTypeProviderDao.create (object);
			return result;
		}
	/*
	* Method update (ProductTypeProvider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProductTypeProvider update (ProductTypeProvider object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		productTypeProviderDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProductTypeProvider trash (java.io.Serializable pkey) throws Exception {
		ProductTypeProvider object = productTypeProviderDao.get (pkey);
		productTypeProviderDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProductTypeProvider object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProductTypeProvider delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProductTypeProvider object = productTypeProviderDao.get (pkey);
	...
	*/
	...
	public ProductTypeProvider delete (ProductTypeProvider object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProductTypeProvider get (java.io.Serializable pkey) throws Exception{
		ProductTypeProvider object = null;
		object = productTypeProviderDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProductTypeProvider get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProductTypeProvider object = null;
	    object = productTypeProviderDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productTypeProviderDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductTypeProvider element = (ProductTypeProvider) iter.next();
...
// unique Result
	...
	public ProductTypeProvider searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = productTypeProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductTypeProvider obj = (ProductTypeProvider) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProductTypeProvider searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = productTypeProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductTypeProvider obj = (ProductTypeProvider) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productTypeProviderDao.getDetachedCriteria();
		return dc;
	}
