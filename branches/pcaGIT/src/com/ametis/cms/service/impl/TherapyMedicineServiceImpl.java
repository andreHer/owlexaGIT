...
import com.ametis.cms.service.TherapyMedicineService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.TherapyMedicine;
import com.ametis.cms.dao.TherapyMedicineDao;
...
/**
 * TherapyMedicine is a servlet controller for therapy_medicine Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class TherapyMedicineServiceImpl implements TherapyMedicineService
...

{
	...
	public void setTherapyMedicineDao (TherapyMedicineDao object){
		this.therapyMedicineDao = object;
	}
	public TherapyMedicineDao getTherapyMedicineDao (){
		return this.therapyMedicineDao;
	}
	/*
	* Method create (TherapyMedicine object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public TherapyMedicine create (TherapyMedicine object,ActionUser user) throws Exception {
			...
			TherapyMedicine result = therapyMedicineDao.create (object);
			return result;
		}
	/*
	* Method update (TherapyMedicine object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public TherapyMedicine update (TherapyMedicine object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		therapyMedicineDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public TherapyMedicine trash (java.io.Serializable pkey) throws Exception {
		TherapyMedicine object = therapyMedicineDao.get (pkey);
		therapyMedicineDao.delete (object);
		return object;
	}

	/*
	* Method delete (TherapyMedicine object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public TherapyMedicine delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		TherapyMedicine object = therapyMedicineDao.get (pkey);
	...
	*/
	...
	public TherapyMedicine delete (TherapyMedicine object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public TherapyMedicine get (java.io.Serializable pkey) throws Exception{
		TherapyMedicine object = null;
		object = therapyMedicineDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public TherapyMedicine get (java.io.Serializable pkey, String[] required) throws Exception{
	    TherapyMedicine object = null;
	    object = therapyMedicineDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = therapyMedicineDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			TherapyMedicine element = (TherapyMedicine) iter.next();
...
// unique Result
	...
	public TherapyMedicine searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = therapyMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TherapyMedicine obj = (TherapyMedicine) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public TherapyMedicine searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = therapyMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TherapyMedicine obj = (TherapyMedicine) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = therapyMedicineDao.getDetachedCriteria();
		return dc;
	}
