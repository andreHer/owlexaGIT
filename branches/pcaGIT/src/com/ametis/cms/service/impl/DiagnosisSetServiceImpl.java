...
/**
 * DiagnosisSet is a servlet controller for diagnosis_set Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class DiagnosisSetServiceImpl implements DiagnosisSetService
...
// extends- 
{
	...
	private DiagnosisSetDao  diagnosisSetDao;

	public void setDiagnosisSetDao (DiagnosisSetDao object){
		this.diagnosisSetDao = object;
	}
	public DiagnosisSetDao getDiagnosisSetDao (){
		return this.diagnosisSetDao;
	}
	/*
	...
	*/
	public DiagnosisSet create (DiagnosisSet object,ActionUser user) throws Exception {
			...
			DiagnosisSet result = diagnosisSetDao.create (object);
			return result;
		}
	/*
	* Method update (DiagnosisSet object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public DiagnosisSet update (DiagnosisSet object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public DiagnosisSet trash (java.io.Serializable pkey) throws Exception {
		DiagnosisSet object = diagnosisSetDao.get (pkey);
		diagnosisSetDao.delete (object);
		return object;
	}
	...
	*/
	...
	public DiagnosisSet delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		DiagnosisSet object = diagnosisSetDao.get (pkey);
	...
	*/
	...
	public DiagnosisSet delete (DiagnosisSet object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public DiagnosisSet get (java.io.Serializable pkey) throws Exception{
		DiagnosisSet object = null;
		object = diagnosisSetDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public DiagnosisSet get (java.io.Serializable pkey, String[] required) throws Exception{
	    DiagnosisSet object = null;
	    object = diagnosisSetDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = diagnosisSetDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DiagnosisSet element = (DiagnosisSet) iter.next();
...
// unique Result
	...
	public DiagnosisSet searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = diagnosisSetDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisSet obj = (DiagnosisSet) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public DiagnosisSet searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = diagnosisSetDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisSet obj = (DiagnosisSet) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = diagnosisSetDao.getDetachedCriteria();
		return dc;
	}
