...
/**
 * ItemCodeClientMapping is a servlet controller for item_code_client_mapping Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ItemCodeClientMappingServiceImpl implements ItemCodeClientMappingService
...
// extends- 
{
	...
	private ItemCodeClientMappingDao  itemCodeClientMappingDao;

	public void setItemCodeClientMappingDao (ItemCodeClientMappingDao object){
		this.itemCodeClientMappingDao = object;
	}
	public ItemCodeClientMappingDao getItemCodeClientMappingDao (){
		return this.itemCodeClientMappingDao;
	}
	/*
	...
	*/
	public ItemCodeClientMapping create (ItemCodeClientMapping object,ActionUser user) throws Exception {
			...
			ItemCodeClientMapping result = itemCodeClientMappingDao.create (object);
			return result;
		}
	/*
	* Method update (ItemCodeClientMapping object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ItemCodeClientMapping update (ItemCodeClientMapping object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		itemCodeClientMappingDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ItemCodeClientMapping trash (java.io.Serializable pkey) throws Exception {
		ItemCodeClientMapping object = itemCodeClientMappingDao.get (pkey);
		itemCodeClientMappingDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ItemCodeClientMapping delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ItemCodeClientMapping object = itemCodeClientMappingDao.get (pkey);
	...
	*/
	...
	public ItemCodeClientMapping delete (ItemCodeClientMapping object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ItemCodeClientMapping get (java.io.Serializable pkey) throws Exception{
		ItemCodeClientMapping object = null;
		object = itemCodeClientMappingDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ItemCodeClientMapping get (java.io.Serializable pkey, String[] required) throws Exception{
	    ItemCodeClientMapping object = null;
	    object = itemCodeClientMappingDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = itemCodeClientMappingDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ItemCodeClientMapping element = (ItemCodeClientMapping) iter.next();
...
// unique Result
	...
	public ItemCodeClientMapping searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = itemCodeClientMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ItemCodeClientMapping obj = (ItemCodeClientMapping) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ItemCodeClientMapping searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = itemCodeClientMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ItemCodeClientMapping obj = (ItemCodeClientMapping) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = itemCodeClientMappingDao.getDetachedCriteria();
		return dc;
	}
