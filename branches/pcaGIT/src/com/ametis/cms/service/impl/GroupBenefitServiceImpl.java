...
import com.ametis.cms.dao.GroupBenefitDao;
...
/**
 * GroupBenefit is a servlet controller for group_benefit Table.
...

{
	...
	private GroupBenefitDao  groupBenefitDao;
private ActivityLogService activityLogService;
	...
	public void setGroupBenefitDao (GroupBenefitDao object){
		this.groupBenefitDao = object;
	}
	public GroupBenefitDao getGroupBenefitDao (){
		return this.groupBenefitDao;
	}
	/*
	* Method create (GroupBenefit object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public GroupBenefit create (GroupBenefit object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			GroupBenefit result = groupBenefitDao.create (object);
			return result;
		}
	/*
	* Method update (GroupBenefit object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public GroupBenefit update (GroupBenefit object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public GroupBenefit trash (java.io.Serializable pkey) throws Exception {
		GroupBenefit object = groupBenefitDao.get (pkey);
		groupBenefitDao.delete (object);
		return object;
	}

	/*
	* Method delete (GroupBenefit object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public GroupBenefit delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		GroupBenefit object = groupBenefitDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public GroupBenefit delete (GroupBenefit object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public GroupBenefit get (java.io.Serializable pkey) throws Exception{
		GroupBenefit object = null;
		object = groupBenefitDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public GroupBenefit get (java.io.Serializable pkey, String[] required) throws Exception{
	    GroupBenefit object = null;
	    object = groupBenefitDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = groupBenefitDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			GroupBenefit element = (GroupBenefit) iter.next();
...
// unique Result
	...
	public GroupBenefit searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = groupBenefitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		GroupBenefit obj = (GroupBenefit) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public GroupBenefit searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = groupBenefitDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		GroupBenefit obj = (GroupBenefit) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = groupBenefitDao.getDetachedCriteria();
		return dc;
	}
