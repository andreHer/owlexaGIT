...
import com.ametis.cms.dao.ProviderTypeDiagnosisTreatmentDao;
...
/**
 * ProviderTypeDiagnosisTreatment is a servlet controller for provider_type_diagnosis_treatment Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderTypeDiagnosisTreatmentServiceImpl implements ProviderTypeDiagnosisTreatmentService
...
// extends- 
{
	...
	private ProviderTypeDiagnosisTreatmentDao  providerTypeDiagnosisTreatmentDao;

	public void setProviderTypeDiagnosisTreatmentDao (ProviderTypeDiagnosisTreatmentDao object){
		this.providerTypeDiagnosisTreatmentDao = object;
	}
	public ProviderTypeDiagnosisTreatmentDao getProviderTypeDiagnosisTreatmentDao (){
		return this.providerTypeDiagnosisTreatmentDao;
	}
	/*
	...
	*/
	public ProviderTypeDiagnosisTreatment create (ProviderTypeDiagnosisTreatment object,ActionUser user) throws Exception {
			...
			ProviderTypeDiagnosisTreatment result = providerTypeDiagnosisTreatmentDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderTypeDiagnosisTreatment object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderTypeDiagnosisTreatment update (ProviderTypeDiagnosisTreatment object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerTypeDiagnosisTreatmentDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderTypeDiagnosisTreatment trash (java.io.Serializable pkey) throws Exception {
		ProviderTypeDiagnosisTreatment object = providerTypeDiagnosisTreatmentDao.get (pkey);
		providerTypeDiagnosisTreatmentDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderTypeDiagnosisTreatment delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderTypeDiagnosisTreatment object = providerTypeDiagnosisTreatmentDao.get (pkey);
	...
	*/
	...
	public ProviderTypeDiagnosisTreatment delete (ProviderTypeDiagnosisTreatment object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderTypeDiagnosisTreatment get (java.io.Serializable pkey) throws Exception{
		ProviderTypeDiagnosisTreatment object = null;
		object = providerTypeDiagnosisTreatmentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderTypeDiagnosisTreatment get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderTypeDiagnosisTreatment object = null;
	    object = providerTypeDiagnosisTreatmentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerTypeDiagnosisTreatmentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderTypeDiagnosisTreatment element = (ProviderTypeDiagnosisTreatment) iter.next();
...
// unique Result
	...
	public ProviderTypeDiagnosisTreatment searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerTypeDiagnosisTreatmentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderTypeDiagnosisTreatment obj = (ProviderTypeDiagnosisTreatment) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderTypeDiagnosisTreatment searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerTypeDiagnosisTreatmentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderTypeDiagnosisTreatment obj = (ProviderTypeDiagnosisTreatment) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerTypeDiagnosisTreatmentDao.getDetachedCriteria();
		return dc;
	}
