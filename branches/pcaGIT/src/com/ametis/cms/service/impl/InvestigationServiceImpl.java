...
/**
 * Investigation is a servlet controller for investigation Table.
...

{
	...
	public void setInvestigationDao (InvestigationDao object){
		this.investigationDao = object;
	}
	public InvestigationDao getInvestigationDao (){
		return this.investigationDao;
	}
	/*
	* Method create (Investigation object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Investigation create (Investigation object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Investigation result = investigationDao.create (object);
			return result;
		}
	/*
	* Method update (Investigation object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Investigation update (Investigation object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
		...
		object.setUpdatedBy(user.getUsername());
 		...
 		investigationDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public Investigation trash (java.io.Serializable pkey) throws Exception {
		Investigation object = investigationDao.get (pkey);
		investigationDao.delete (object);
		return object;
	}

	/*
	* Method delete (Investigation object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Investigation delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		Investigation object = investigationDao.get (pkey);
...
if (actionUser != null){
	...
	*/
	...
	public Investigation delete (Investigation object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Investigation get (java.io.Serializable pkey) throws Exception{
		Investigation object = null;
		object = investigationDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Investigation get (java.io.Serializable pkey, String[] required) throws Exception{
	    Investigation object = null;
	    object = investigationDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = investigationDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Investigation element = (Investigation) iter.next();
...
// unique Result
	...
	public Investigation searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = investigationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Investigation obj = (Investigation) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Investigation searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = investigationDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Investigation obj = (Investigation) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = investigationDao.getDetachedCriteria();
		return dc;
	}
