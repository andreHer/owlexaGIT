...
/**
 * PolicyPayment is a servlet controller for policy_payment Table.
...
// extends- 
{
	...
	public void setPolicyPaymentDao (PolicyPaymentDao object){
		this.policyPaymentDao = object;
	}
	public PolicyPaymentDao getPolicyPaymentDao (){
		return this.policyPaymentDao;
	}
	/*
	...
	*/
	public PolicyPayment create (PolicyPayment object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			PolicyPayment result = policyPaymentDao.create (object);
			return result;
		}
	/*
	* Method update (PolicyPayment object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PolicyPayment update (PolicyPayment object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		policyPaymentDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public PolicyPayment trash (java.io.Serializable pkey) throws Exception {
		PolicyPayment object = policyPaymentDao.get (pkey);
		policyPaymentDao.delete (object);
		return object;
	}
	...
	*/
	...
	public PolicyPayment delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PolicyPayment object = policyPaymentDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public PolicyPayment delete (PolicyPayment object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PolicyPayment get (java.io.Serializable pkey) throws Exception{
		PolicyPayment object = null;
		object = policyPaymentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PolicyPayment get (java.io.Serializable pkey, String[] required) throws Exception{
	    PolicyPayment object = null;
	    object = policyPaymentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = policyPaymentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PolicyPayment element = (PolicyPayment) iter.next();
...
// unique Result
	...
	public PolicyPayment searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = policyPaymentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyPayment obj = (PolicyPayment) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PolicyPayment searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = policyPaymentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyPayment obj = (PolicyPayment) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = policyPaymentDao.getDetachedCriteria();
		return dc;
	}
