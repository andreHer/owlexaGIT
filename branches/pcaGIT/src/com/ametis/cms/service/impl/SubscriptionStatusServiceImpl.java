...
/**
 * SubscriptionStatus is a servlet controller for subscription_status Table.
...

{
	...
	public void setSubscriptionStatusDao (SubscriptionStatusDao object){
		this.subscriptionStatusDao = object;
	}
	public SubscriptionStatusDao getSubscriptionStatusDao (){
		return this.subscriptionStatusDao;
	}
	/*
	...
	*/
	public SubscriptionStatus create (SubscriptionStatus object,User user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			SubscriptionStatus result = subscriptionStatusDao.create (object);
			return result;
		}
	/*
	* Method update (SubscriptionStatus object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public SubscriptionStatus update (SubscriptionStatus object,User user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		subscriptionStatusDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public SubscriptionStatus trash (java.io.Serializable pkey) throws Exception {
		SubscriptionStatus object = subscriptionStatusDao.get (pkey);
		subscriptionStatusDao.delete (object);
		return object;
	}
	...
	*/
	...
	public SubscriptionStatus delete (java.io.Serializable pkey,User user) throws Exception{
		SubscriptionStatus object = subscriptionStatusDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public SubscriptionStatus delete (SubscriptionStatus object,User user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public SubscriptionStatus get (java.io.Serializable pkey) throws Exception{
		SubscriptionStatus object = null;
		object = subscriptionStatusDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public SubscriptionStatus get (java.io.Serializable pkey, String[] required) throws Exception{
	    SubscriptionStatus object = null;
	    object = subscriptionStatusDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = subscriptionStatusDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			SubscriptionStatus element = (SubscriptionStatus) iter.next();
...
// unique Result
	...
	public SubscriptionStatus searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = subscriptionStatusDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		SubscriptionStatus obj = (SubscriptionStatus) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public SubscriptionStatus searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = subscriptionStatusDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		SubscriptionStatus obj = (SubscriptionStatus) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = subscriptionStatusDao.getDetachedCriteria();
		return dc;
	}
