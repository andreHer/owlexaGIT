...
import com.ametis.cms.dao.DiscountUsageTypeDao;
...
/**
 * DiscountUsageType is a servlet controller for discount_usage_type Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class DiscountUsageTypeServiceImpl implements DiscountUsageTypeService
...

{
	...
	private DiscountUsageTypeDao  discountUsageTypeDao;

	public void setDiscountUsageTypeDao (DiscountUsageTypeDao object){
		this.discountUsageTypeDao = object;
	}
	public DiscountUsageTypeDao getDiscountUsageTypeDao (){
		return this.discountUsageTypeDao;
	}
	/*
	* Method create (DiscountUsageType object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public DiscountUsageType create (DiscountUsageType object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			DiscountUsageType result = discountUsageTypeDao.create (object);
			return result;
		}
	/*
	* Method update (DiscountUsageType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public DiscountUsageType update (DiscountUsageType object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		discountUsageTypeDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public DiscountUsageType trash (java.io.Serializable pkey) throws Exception {
		DiscountUsageType object = discountUsageTypeDao.get (pkey);
		discountUsageTypeDao.delete (object);
		return object;
	}

	/*
	* Method delete (DiscountUsageType object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public DiscountUsageType delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		DiscountUsageType object = discountUsageTypeDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public DiscountUsageType delete (DiscountUsageType object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public DiscountUsageType get (java.io.Serializable pkey) throws Exception{
		DiscountUsageType object = null;
		object = discountUsageTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public DiscountUsageType get (java.io.Serializable pkey, String[] required) throws Exception{
	    DiscountUsageType object = null;
	    object = discountUsageTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = discountUsageTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DiscountUsageType element = (DiscountUsageType) iter.next();
...
// unique Result
	...
	public DiscountUsageType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = discountUsageTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiscountUsageType obj = (DiscountUsageType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public DiscountUsageType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = discountUsageTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiscountUsageType obj = (DiscountUsageType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = discountUsageTypeDao.getDetachedCriteria();
		return dc;
	}
