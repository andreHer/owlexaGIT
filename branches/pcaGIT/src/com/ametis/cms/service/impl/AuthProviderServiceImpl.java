...
/**
 * AuthProvider is a servlet controller for auth_provider Table.
...
private ActivityLogService activityLogService;
	...
	public void setAuthProviderDao (AuthProviderDao object){
		this.authProviderDao = object;
	}
	public AuthProviderDao getAuthProviderDao (){
		return this.authProviderDao;
	}
	/*
	...
	*/
	public AuthProvider create (AuthProvider object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			AuthProvider result = authProviderDao.create (object);
			return result;
		}
	/*
	* Method update (AuthProvider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public AuthProvider update (AuthProvider object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public AuthProvider trash (java.io.Serializable pkey) throws Exception {
		AuthProvider object = authProviderDao.get (pkey);
		authProviderDao.delete (object);
		return object;
	}
	...
	*/
	...
	public AuthProvider delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		AuthProvider object = authProviderDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public AuthProvider delete (AuthProvider object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public AuthProvider get (java.io.Serializable pkey) throws Exception{
		AuthProvider object = null;
		object = authProviderDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public AuthProvider get (java.io.Serializable pkey, String[] required) throws Exception{
	    AuthProvider object = null;
	    object = authProviderDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = authProviderDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			AuthProvider element = (AuthProvider) iter.next();
...
// unique Result
	...
	public AuthProvider searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = authProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		AuthProvider obj = (AuthProvider) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public AuthProvider searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = authProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		AuthProvider obj = (AuthProvider) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = authProviderDao.getDetachedCriteria();
		return dc;
	}
