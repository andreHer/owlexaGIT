...
/**
 * CaseProvider is a servlet controller for case_provider Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class CaseProviderServiceImpl implements CaseProviderService
...

{
	...
	private CaseProviderDao  caseProviderDao;
private ActivityLogService activityLogService;
	...
	public void setCaseProviderDao (CaseProviderDao object){
		this.caseProviderDao = object;
	}
	public CaseProviderDao getCaseProviderDao (){
		return this.caseProviderDao;
	}
	/*
	...
	*/
	public CaseProvider create (CaseProvider object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			CaseProvider result = caseProviderDao.create (object);
			return result;
		}
	/*
	* Method update (CaseProvider object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CaseProvider update (CaseProvider object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public CaseProvider trash (java.io.Serializable pkey) throws Exception {
		CaseProvider object = caseProviderDao.get (pkey);
		caseProviderDao.delete (object);
		return object;
	}
	...
	*/
	...
	public CaseProvider delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		CaseProvider object = caseProviderDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public CaseProvider delete (CaseProvider object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CaseProvider get (java.io.Serializable pkey) throws Exception{
		CaseProvider object = null;
		object = caseProviderDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CaseProvider get (java.io.Serializable pkey, String[] required) throws Exception{
	    CaseProvider object = null;
	    object = caseProviderDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseProviderDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CaseProvider element = (CaseProvider) iter.next();
...
// unique Result
	...
	public CaseProvider searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = caseProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseProvider obj = (CaseProvider) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CaseProvider searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = caseProviderDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseProvider obj = (CaseProvider) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseProviderDao.getDetachedCriteria();
		return dc;
	}
