...
import com.ametis.cms.service.ProviderSetMappingService;
...
*/
public class ProviderSetMappingServiceImpl implements ProviderSetMappingService
...
// extends- 
{
	...
	private ProviderSetMappingDao  providerSetMappingDao;

	public void setProviderSetMappingDao (ProviderSetMappingDao object){
		this.providerSetMappingDao = object;
	}
	public ProviderSetMappingDao getProviderSetMappingDao (){
		return this.providerSetMappingDao;
	}
	/*
	...
	*/
	public ProviderSetMapping create (ProviderSetMapping object,ActionUser user) throws Exception {
			...
			ProviderSetMapping result = providerSetMappingDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderSetMapping object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderSetMapping update (ProviderSetMapping object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerSetMappingDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderSetMapping trash (java.io.Serializable pkey) throws Exception {
		ProviderSetMapping object = providerSetMappingDao.get (pkey);
		providerSetMappingDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderSetMapping delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderSetMapping object = providerSetMappingDao.get (pkey);
	...
	*/
	...
	public ProviderSetMapping delete (ProviderSetMapping object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderSetMapping get (java.io.Serializable pkey) throws Exception{
		ProviderSetMapping object = null;
		object = providerSetMappingDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderSetMapping get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderSetMapping object = null;
	    object = providerSetMappingDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerSetMappingDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderSetMapping element = (ProviderSetMapping) iter.next();
...
// unique Result
	...
	public ProviderSetMapping searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerSetMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderSetMapping obj = (ProviderSetMapping) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderSetMapping searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerSetMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderSetMapping obj = (ProviderSetMapping) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerSetMappingDao.getDetachedCriteria();
		return dc;
	}
