...
import com.ametis.cms.dao.SubstitutionItemDao;
...
/**
 * SubstitutionItem is a servlet controller for substitution_item Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class SubstitutionItemServiceImpl implements SubstitutionItemService
...

{
	...
	private SubstitutionItemDao  substitutionItemDao;
private ActivityLogService activityLogService;
	...
	public void setSubstitutionItemDao (SubstitutionItemDao object){
		this.substitutionItemDao = object;
	}
	public SubstitutionItemDao getSubstitutionItemDao (){
		return this.substitutionItemDao;
	}
	/*
	* Method create (SubstitutionItem object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public SubstitutionItem create (SubstitutionItem object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			SubstitutionItem result = substitutionItemDao.create (object);
			return result;
		}
	/*
	* Method update (SubstitutionItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public SubstitutionItem update (SubstitutionItem object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		substitutionItemDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public SubstitutionItem trash (java.io.Serializable pkey) throws Exception {
		SubstitutionItem object = substitutionItemDao.get (pkey);
		substitutionItemDao.delete (object);
		return object;
	}

	/*
	* Method delete (SubstitutionItem object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public SubstitutionItem delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		SubstitutionItem object = substitutionItemDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public SubstitutionItem delete (SubstitutionItem object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public SubstitutionItem get (java.io.Serializable pkey) throws Exception{
		SubstitutionItem object = null;
		object = substitutionItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public SubstitutionItem get (java.io.Serializable pkey, String[] required) throws Exception{
	    SubstitutionItem object = null;
	    object = substitutionItemDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = substitutionItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			SubstitutionItem element = (SubstitutionItem) iter.next();
...
// unique Result
	...
	public SubstitutionItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = substitutionItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		SubstitutionItem obj = (SubstitutionItem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public SubstitutionItem searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = substitutionItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		SubstitutionItem obj = (SubstitutionItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = substitutionItemDao.getDetachedCriteria();
		return dc;
	}
