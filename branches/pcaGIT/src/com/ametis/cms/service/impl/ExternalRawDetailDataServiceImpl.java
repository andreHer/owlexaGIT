...
/**
 * ExternalRawDetailData is a servlet controller for external_raw_detail_data Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ExternalRawDetailDataServiceImpl implements ExternalRawDetailDataService
...
// extends- 
{
	...
	private ExternalRawDetailDataDao  externalRawDetailDataDao;

	public void setExternalRawDetailDataDao (ExternalRawDetailDataDao object){
		this.externalRawDetailDataDao = object;
	}
	public ExternalRawDetailDataDao getExternalRawDetailDataDao (){
		return this.externalRawDetailDataDao;
	}
	/*
	...
	*/
	public ExternalRawDetailData create (ExternalRawDetailData object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ExternalRawDetailData result = externalRawDetailDataDao.create (object);
			return result;
		}
	/*
	* Method update (ExternalRawDetailData object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ExternalRawDetailData update (ExternalRawDetailData object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		externalRawDetailDataDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ExternalRawDetailData trash (java.io.Serializable pkey) throws Exception {
		ExternalRawDetailData object = externalRawDetailDataDao.get (pkey);
		externalRawDetailDataDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ExternalRawDetailData delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ExternalRawDetailData object = externalRawDetailDataDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ExternalRawDetailData delete (ExternalRawDetailData object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ExternalRawDetailData get (java.io.Serializable pkey) throws Exception{
		ExternalRawDetailData object = null;
		object = externalRawDetailDataDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ExternalRawDetailData get (java.io.Serializable pkey, String[] required) throws Exception{
	    ExternalRawDetailData object = null;
	    object = externalRawDetailDataDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = externalRawDetailDataDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ExternalRawDetailData element = (ExternalRawDetailData) iter.next();
...
// unique Result
	...
	public ExternalRawDetailData searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = externalRawDetailDataDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExternalRawDetailData obj = (ExternalRawDetailData) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ExternalRawDetailData searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = externalRawDetailDataDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExternalRawDetailData obj = (ExternalRawDetailData) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = externalRawDetailDataDao.getDetachedCriteria();
		return dc;
	}
