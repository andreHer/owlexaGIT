...
import com.ametis.cms.dao.DocumentCategoryDao;
...
// extends- 
{
	...
	public void setDocumentCategoryDao (DocumentCategoryDao object){
		this.documentCategoryDao = object;
	}
	public DocumentCategoryDao getDocumentCategoryDao (){
		return this.documentCategoryDao;
	}
	/*
	* Method create (DocumentCategory object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public DocumentCategory create (DocumentCategory object,ActionUser user) throws Exception {
			...
			DocumentCategory result = documentCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (DocumentCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public DocumentCategory update (DocumentCategory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		documentCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public DocumentCategory trash (java.io.Serializable pkey) throws Exception {
		DocumentCategory object = documentCategoryDao.get (pkey);
		documentCategoryDao.delete (object);
		return object;
	}

	/*
	* Method delete (DocumentCategory object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public DocumentCategory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		DocumentCategory object = documentCategoryDao.get (pkey);
	...
	*/
	...
	public DocumentCategory delete (DocumentCategory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public DocumentCategory get (java.io.Serializable pkey) throws Exception{
		DocumentCategory object = null;
		object = documentCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public DocumentCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    DocumentCategory object = null;
	    object = documentCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = documentCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DocumentCategory element = (DocumentCategory) iter.next();
...
// unique Result
	...
	public DocumentCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = documentCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DocumentCategory obj = (DocumentCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public DocumentCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = documentCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DocumentCategory obj = (DocumentCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = documentCategoryDao.getDetachedCriteria();
		return dc;
	}
