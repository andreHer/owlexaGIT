...
import com.ametis.cms.dao.FinanceCoaDao;
...
/**
 * FinanceCoa is a servlet controller for finance_coa Table.
...

{
	...
	private FinanceCoaDao  financeCoaDao;

	public void setFinanceCoaDao (FinanceCoaDao object){
		this.financeCoaDao = object;
	}
	public FinanceCoaDao getFinanceCoaDao (){
		return this.financeCoaDao;
	}
	/*
	* Method create (FinanceCoa object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public FinanceCoa create (FinanceCoa object,ActionUser user) throws Exception {
			...
			FinanceCoa result = financeCoaDao.create (object);
			return result;
		}
	/*
	* Method update (FinanceCoa object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public FinanceCoa update (FinanceCoa object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public FinanceCoa trash (java.io.Serializable pkey) throws Exception {
		FinanceCoa object = financeCoaDao.get (pkey);
		financeCoaDao.delete (object);
		return object;
	}

	/*
	* Method delete (FinanceCoa object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public FinanceCoa delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		FinanceCoa object = financeCoaDao.get (pkey);
	...
	*/
	...
	public FinanceCoa delete (FinanceCoa object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public FinanceCoa get (java.io.Serializable pkey) throws Exception{
		FinanceCoa object = null;
		object = financeCoaDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public FinanceCoa get (java.io.Serializable pkey, String[] required) throws Exception{
	    FinanceCoa object = null;
	    object = financeCoaDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = financeCoaDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			FinanceCoa element = (FinanceCoa) iter.next();
...
// unique Result
	...
	public FinanceCoa searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = financeCoaDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FinanceCoa obj = (FinanceCoa) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public FinanceCoa searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = financeCoaDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FinanceCoa obj = (FinanceCoa) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = financeCoaDao.getDetachedCriteria();
		return dc;
	}
