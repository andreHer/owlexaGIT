...
*/
public class DiagnosisSetDetailServiceImpl implements DiagnosisSetDetailService
...
// extends- 
{
	...
	private DiagnosisSetDetailDao  diagnosisSetDetailDao;

	public void setDiagnosisSetDetailDao (DiagnosisSetDetailDao object){
		this.diagnosisSetDetailDao = object;
	}
	public DiagnosisSetDetailDao getDiagnosisSetDetailDao (){
		return this.diagnosisSetDetailDao;
	}
	/*
	...
	*/
	public DiagnosisSetDetail create (DiagnosisSetDetail object,ActionUser user) throws Exception {
			...
			DiagnosisSetDetail result = diagnosisSetDetailDao.create (object);
			return result;
		}
	/*
	...
	*/
	public DiagnosisSetDetail update (DiagnosisSetDetail object,ActionUser user) throws Exception{
		...
		if (user != null && user.getUser() != null){
 		...
 		diagnosisSetDetailDao.update (object);
      	return object;
	}
	...
	*/
	public DiagnosisSetDetail trash (java.io.Serializable pkey) throws Exception {
		DiagnosisSetDetail object = diagnosisSetDetailDao.get (pkey);
		diagnosisSetDetailDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public DiagnosisSetDetail get (java.io.Serializable pkey) throws Exception{
		DiagnosisSetDetail object = null;
		object = diagnosisSetDetailDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = diagnosisSetDetailDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DiagnosisSetDetail element = (DiagnosisSetDetail) iter.next();
...
// unique Result
	...
	public DiagnosisSetDetail searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = diagnosisSetDetailDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisSetDetail obj = (DiagnosisSetDetail) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = diagnosisSetDetailDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public boolean createDetails(Integer diagnosisSetId,
			Collection<DiagnosisSetDetail> details, ActionUser user)
			throws Exception {
		...
		try {
			if (details != null){
				for (DiagnosisSetDetail diagnosisSetDetail : details) {
					if (diagnosisSetDetail != null){
						DiagnosisSet diagnosisSet = new DiagnosisSet();
						diagnosisSet.setDiagnosisSetId(diagnosisSetId);
						
						diagnosisSetDetail.setDiagnosisSetId(diagnosisSet);
						
						create(diagnosisSetDetail, user);
