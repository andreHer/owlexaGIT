...
/**
 * PaymentDocument is a servlet controller for payment_document Table.
...

{
	...
	public void setPaymentDocumentDao (PaymentDocumentDao object){
		this.paymentDocumentDao = object;
	}
	public PaymentDocumentDao getPaymentDocumentDao (){
		return this.paymentDocumentDao;
	}
	/*
	...
	*/
	public PaymentDocument create (PaymentDocument object,ActionUser user) throws Exception {
			...
			PaymentDocument result = paymentDocumentDao.create (object);
			return result;
		}
	/*
	* Method update (PaymentDocument object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PaymentDocument update (PaymentDocument object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		paymentDocumentDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public PaymentDocument trash (java.io.Serializable pkey) throws Exception {
		PaymentDocument object = paymentDocumentDao.get (pkey);
		paymentDocumentDao.delete (object);
		return object;
	}
	...
	*/
	...
	public PaymentDocument delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PaymentDocument object = paymentDocumentDao.get (pkey);
	...
	*/
	...
	public PaymentDocument delete (PaymentDocument object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PaymentDocument get (java.io.Serializable pkey) throws Exception{
		PaymentDocument object = null;
		object = paymentDocumentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PaymentDocument get (java.io.Serializable pkey, String[] required) throws Exception{
	    PaymentDocument object = null;
	    object = paymentDocumentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = paymentDocumentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PaymentDocument element = (PaymentDocument) iter.next();
...
// unique Result
	...
	public PaymentDocument searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = paymentDocumentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PaymentDocument obj = (PaymentDocument) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PaymentDocument searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = paymentDocumentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PaymentDocument obj = (PaymentDocument) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = paymentDocumentDao.getDetachedCriteria();
		return dc;
	}
