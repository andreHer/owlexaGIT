...
import com.ametis.cms.dao.TreatmentRiskDao;
...
/**
 * TreatmentRisk is a servlet controller for treatment_risk Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class TreatmentRiskServiceImpl implements TreatmentRiskService
...
// extends- 
{
	...
	private TreatmentRiskDao  treatmentRiskDao;

	public void setTreatmentRiskDao (TreatmentRiskDao object){
		this.treatmentRiskDao = object;
	}
	public TreatmentRiskDao getTreatmentRiskDao (){
		return this.treatmentRiskDao;
	}
	/*
	* Method create (TreatmentRisk object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public TreatmentRisk create (TreatmentRisk object,ActionUser user) throws Exception {
			...
			TreatmentRisk result = treatmentRiskDao.create (object);
			return result;
		}
	/*
	* Method update (TreatmentRisk object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public TreatmentRisk update (TreatmentRisk object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		treatmentRiskDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public TreatmentRisk trash (java.io.Serializable pkey) throws Exception {
		TreatmentRisk object = treatmentRiskDao.get (pkey);
		treatmentRiskDao.delete (object);
		return object;
	}

	/*
	* Method delete (TreatmentRisk object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public TreatmentRisk delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		TreatmentRisk object = treatmentRiskDao.get (pkey);
	...
	*/
	...
	public TreatmentRisk delete (TreatmentRisk object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public TreatmentRisk get (java.io.Serializable pkey) throws Exception{
		TreatmentRisk object = null;
		object = treatmentRiskDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public TreatmentRisk get (java.io.Serializable pkey, String[] required) throws Exception{
	    TreatmentRisk object = null;
	    object = treatmentRiskDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = treatmentRiskDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			TreatmentRisk element = (TreatmentRisk) iter.next();
...
// unique Result
	...
	public TreatmentRisk searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = treatmentRiskDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentRisk obj = (TreatmentRisk) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public TreatmentRisk searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = treatmentRiskDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		TreatmentRisk obj = (TreatmentRisk) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = treatmentRiskDao.getDetachedCriteria();
		return dc;
	}
