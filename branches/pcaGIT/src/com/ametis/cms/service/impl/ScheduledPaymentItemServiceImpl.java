...
import com.ametis.cms.dao.ScheduledPaymentItemDao;
...
/**
 * ScheduledPaymentItem is a servlet controller for scheduled_payment_item Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ScheduledPaymentItemServiceImpl implements ScheduledPaymentItemService
...

{
	...
	private ScheduledPaymentItemDao  scheduledPaymentItemDao;

	public void setScheduledPaymentItemDao (ScheduledPaymentItemDao object){
		this.scheduledPaymentItemDao = object;
	}
	public ScheduledPaymentItemDao getScheduledPaymentItemDao (){
		return this.scheduledPaymentItemDao;
	}
	/*
	...
	*/
	public ScheduledPaymentItem create (ScheduledPaymentItem object,ActionUser user) throws Exception {
			...
			ScheduledPaymentItem result = scheduledPaymentItemDao.create (object);
			return result;
		}
	/*
	* Method update (ScheduledPaymentItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ScheduledPaymentItem update (ScheduledPaymentItem object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		scheduledPaymentItemDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ScheduledPaymentItem trash (java.io.Serializable pkey) throws Exception {
		ScheduledPaymentItem object = scheduledPaymentItemDao.get (pkey);
		scheduledPaymentItemDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ScheduledPaymentItem delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ScheduledPaymentItem object = scheduledPaymentItemDao.get (pkey);
	...
	*/
	...
	public ScheduledPaymentItem delete (ScheduledPaymentItem object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ScheduledPaymentItem get (java.io.Serializable pkey) throws Exception{
		ScheduledPaymentItem object = null;
		object = scheduledPaymentItemDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ScheduledPaymentItem get (java.io.Serializable pkey, String[] required) throws Exception{
	    ScheduledPaymentItem object = null;
	    object = scheduledPaymentItemDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = scheduledPaymentItemDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ScheduledPaymentItem element = (ScheduledPaymentItem) iter.next();
...
// unique Result
	...
	public ScheduledPaymentItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = scheduledPaymentItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ScheduledPaymentItem obj = (ScheduledPaymentItem) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ScheduledPaymentItem searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = scheduledPaymentItemDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ScheduledPaymentItem obj = (ScheduledPaymentItem) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = scheduledPaymentItemDao.getDetachedCriteria();
		return dc;
	}
