...
import com.ametis.cms.dao.ProductDao;
...
/**
 * Product is a servlet controller for product Table.
...
private ActivityLogService activityLogService;
	...
	/*
	* Method create (Product object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Product create (Product object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			status.setStatusId(Integer.valueOf(Product.PRODUCT_PENDING));
			object.setProductStatus(status);
			

			Product result = productDao.create (object);
			return result;
		}
	/*
	...
	*/
	public Product update (Product object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Product trash (java.io.Serializable pkey) throws Exception {
		Product object = productDao.get (pkey);
	...
	*/
	...
	public Product delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		Product object = productDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Product delete (Product object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Product get (java.io.Serializable pkey) throws Exception{
		Product object = null;
		object = productDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Product get (java.io.Serializable pkey, String[] required) throws Exception{
	    Product object = null;
	    object = productDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productDao.getCriteria();
...
// unique Result
	...
	public Product searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = productDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Product obj = (Product) c.uniqueResult();
	...
	public Product searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = productDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Product obj = (Product) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productDao.getDetachedCriteria();
		return dc;
	}
	public Product getProduct(String productCode) throws Exception {
		// TODO Auto-generated method stub
		String[] required = {"Product.ProductBenefits","Product.ProductClausuls"};
		Product result = searchUnique("productCode", productCode, required);
			
		return result;
	}
	public boolean activate(Integer productId, ActionUser actionUser)
			throws Exception {
		// TODO Auto-generated method stub
		...
		if (productId != null){
			...
			if (product != null){
				SubscriptionStatus status = new SubscriptionStatus();
				status.setStatusId(Product.PRODUCT_ACTIVE);
				product.setProductStatus(status);
				update(product, actionUser);
				result = true;
			}
		}
		return result;
	...
	public boolean setAsProductTemplate (Integer productId, ActionUser actionUser) throws Exception {
		boolean result = false;
		if (productId != null){
			Product product = get(productId);
			
			if (product != null){
				product.setIsTemplate(Integer.valueOf(1));
				update(product, actionUser);
				result = true;
			}
		}
	...
	public Product getActiveProduct(String productCode) throws Exception {
		String[] required = {"Product.ProductBenefits","Product.ProductClausuls"};
		
		String[] param = {"productCode","deletedStatus"};
		Object[] value = {productCode, Integer.valueOf(0)};
		Product result = searchUnique(param,value, required);
			
		return result;
	}

	public Product getActiveProduct(String productCode,Integer policyId) throws Exception {
		String[] required = {"Product.ProductBenefits","Product.ProductClausuls"};
		
		String[] param = {"productCode","deletedStatus","policyId.policyId"};
		Object[] value = {productCode, Integer.valueOf(0),policyId};
		Product result = searchUnique(param,value, required);
			
		return result;
	}
	public Collection<Product> searchClientProduct(String q,Integer clientId) throws Exception {
		Collection<Product> result = new Vector<Product>();
		
		String[] eqParam = {"deletedStatus","clientId.clientId"};
		Object[] eqValue = {Integer.valueOf(0),clientId};
		String[] likeParam = {"productCode"};
		Object[] likeValue = {q};
	...
	@Override
	public Collection<CaseCategory> getProductCaseCategoryList(Integer policyId)
			throws Exception {
		Collection<CaseCategory> result = new Vector<CaseCategory>();
		try {
			Session session = productDao.getProductSession();
	        if (session != null) {


	            Query query = session.createQuery("SELECT DISTINCT p.caseCategory FROM Product p WHERE " +
	            		"p.policyId.policyId = :policyId ");
	...
	@Override
	public Collection<CaseCategory> getGroupProductCaseCategoryList(
		...
		try {
	        ...
	        if (session != null) {
	            ...
	            Query query = session.createQuery("SELECT DISTINCT p.caseCategory FROM Product p WHERE " +
	            		"p.policyId.policyId IN (SELECT pol.policyId " +
	            		" FROM Policy pol WHERE pol.clientId.clientId = :clientId " +
	            		" AND pol.memberGroupId.memberGroupId = :groupId)");
