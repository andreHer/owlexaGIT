...
import com.ametis.cms.service.CardPrintingService;
...
*/
public class CardPrintingServiceImpl implements CardPrintingService
...
// extends- 
{
	...
	private CardPrintingDao  cardPrintingDao;
	...
	public void setCardPrintingDao (CardPrintingDao object){
		this.cardPrintingDao = object;
	}
	public CardPrintingDao getCardPrintingDao (){
		return this.cardPrintingDao;
	}
	/*
	...
	*/
	public CardPrinting create (CardPrinting object,ActionUser user) throws Exception {
			...
			CardPrinting result = cardPrintingDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public CardPrinting trash (java.io.Serializable pkey) throws Exception {
		CardPrinting object = cardPrintingDao.get (pkey);
		cardPrintingDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public CardPrinting get (java.io.Serializable pkey) throws Exception{
		CardPrinting object = null;
		object = cardPrintingDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = cardPrintingDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CardPrinting element = (CardPrinting) iter.next();
...
// unique Result
	...
	public CardPrinting searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = cardPrintingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CardPrinting obj = (CardPrinting) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = cardPrintingDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public CardPrinting create(CardPrinting object,
			Collection<Integer> cardList, ActionUser user) throws Exception {
		// TODO Auto-generated method stub
		CardPrinting result = null;
		
		try {
			result = create(object,user);
			
			if (result != null){
				for (Iterator iterator = cardList.iterator(); iterator
						.hasNext();) {
					
					
					Integer importId = (Integer) iterator.next();
					
					MemberImport importMember = memberImportService.get(importId);
					
					if (importMember != null){
						importMember.setCardPrintingId(result);
						
						memberImportService.update(importMember, user);
					}
