...
import com.ametis.cms.service.FormulariumMedicineService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.FormulariumMedicine;
import com.ametis.cms.dao.FormulariumMedicineDao;
...
/**
 * FormulariumMedicine is a servlet controller for formularium_medicine Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class FormulariumMedicineServiceImpl implements FormulariumMedicineService
...

{
	...
	private FormulariumMedicineDao  formulariumMedicineDao;

	public void setFormulariumMedicineDao (FormulariumMedicineDao object){
		this.formulariumMedicineDao = object;
	}
	public FormulariumMedicineDao getFormulariumMedicineDao (){
		return this.formulariumMedicineDao;
	}
	/*
	...
	*/
	public FormulariumMedicine create (FormulariumMedicine object,ActionUser user) throws Exception {
			...
			FormulariumMedicine result = formulariumMedicineDao.create (object);
			return result;
		}
	/*
	* Method update (FormulariumMedicine object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public FormulariumMedicine update (FormulariumMedicine object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		formulariumMedicineDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public FormulariumMedicine trash (java.io.Serializable pkey) throws Exception {
		FormulariumMedicine object = formulariumMedicineDao.get (pkey);
		formulariumMedicineDao.delete (object);
		return object;
	}
	...
	*/
	...
	public FormulariumMedicine delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		FormulariumMedicine object = formulariumMedicineDao.get (pkey);
	...
	*/
	...
	public FormulariumMedicine delete (FormulariumMedicine object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public FormulariumMedicine get (java.io.Serializable pkey) throws Exception{
		FormulariumMedicine object = null;
		object = formulariumMedicineDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public FormulariumMedicine get (java.io.Serializable pkey, String[] required) throws Exception{
	    FormulariumMedicine object = null;
	    object = formulariumMedicineDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = formulariumMedicineDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			FormulariumMedicine element = (FormulariumMedicine) iter.next();
...
// unique Result
	...
	public FormulariumMedicine searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = formulariumMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FormulariumMedicine obj = (FormulariumMedicine) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public FormulariumMedicine searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = formulariumMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FormulariumMedicine obj = (FormulariumMedicine) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = formulariumMedicineDao.getDetachedCriteria();
		return dc;
	}
