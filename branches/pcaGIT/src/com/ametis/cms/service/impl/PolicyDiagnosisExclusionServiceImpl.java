...
*/
public class PolicyDiagnosisExclusionServiceImpl implements PolicyDiagnosisExclusionService
...

{
	...
	private PolicyDiagnosisExclusionDao  policyDiagnosisExclusionDao;

	public void setPolicyDiagnosisExclusionDao (PolicyDiagnosisExclusionDao object){
		this.policyDiagnosisExclusionDao = object;
	}
	public PolicyDiagnosisExclusionDao getPolicyDiagnosisExclusionDao (){
		return this.policyDiagnosisExclusionDao;
	}
	...
	*/
	public PolicyDiagnosisExclusion create (PolicyDiagnosisExclusion object,ActionUser user) throws Exception {
			...
			PolicyDiagnosisExclusion result = policyDiagnosisExclusionDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		policyDiagnosisExclusionDao.update (object);
      	return object;
	}
	...
	*/
	public PolicyDiagnosisExclusion trash (java.io.Serializable pkey) throws Exception {
		PolicyDiagnosisExclusion object = policyDiagnosisExclusionDao.get (pkey);
		policyDiagnosisExclusionDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public PolicyDiagnosisExclusion get (java.io.Serializable pkey) throws Exception{
		PolicyDiagnosisExclusion object = null;
		object = policyDiagnosisExclusionDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = policyDiagnosisExclusionDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PolicyDiagnosisExclusion element = (PolicyDiagnosisExclusion) iter.next();
...
// unique Result
	...
	public PolicyDiagnosisExclusion searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = policyDiagnosisExclusionDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyDiagnosisExclusion obj = (PolicyDiagnosisExclusion) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = policyDiagnosisExclusionDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public PolicyDiagnosisExclusion createUpload(
			PolicyDiagnosisExclusion object, MultipartFile file, ActionUser user)
			throws Exception {
