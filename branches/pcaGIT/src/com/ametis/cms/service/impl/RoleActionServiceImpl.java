...
private ActivityLogService activityLogService;
	...
	public void setRoleActionDao (RoleActionDao object){
		this.roleActionDao = object;
	}
...
if (actionUser != null){
			...
			RoleAction result = roleActionDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public RoleAction trash (java.io.Serializable pkey) throws Exception {
		RoleAction object = roleActionDao.get (pkey);
		roleActionDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public RoleAction get (java.io.Serializable pkey) throws Exception{
		RoleAction object = null;
		object = roleActionDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = roleActionDao.getCriteria();
...
// unique Result
	...
	public RoleAction searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = roleActionDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RoleAction obj = (RoleAction) c.uniqueResult();
