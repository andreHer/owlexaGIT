...
import com.ametis.cms.dao.AuthMemberDao;
...
/**
 * AuthMember is a servlet controller for auth_member Table.
...

{
	...
	public void setAuthMemberDao (AuthMemberDao object){
		this.authMemberDao = object;
	}
	public AuthMemberDao getAuthMemberDao (){
		return this.authMemberDao;
	}
	/*
	* Method create (AuthMember object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public AuthMember create (AuthMember object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			AuthMember result = authMemberDao.create (object);
			return result;
		}
	/*
	* Method update (AuthMember object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public AuthMember update (AuthMember object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public AuthMember trash (java.io.Serializable pkey) throws Exception {
		AuthMember object = authMemberDao.get (pkey);
		authMemberDao.delete (object);
		return object;
	}

	/*
	* Method delete (AuthMember object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public AuthMember delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		AuthMember object = authMemberDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public AuthMember delete (AuthMember object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public AuthMember get (java.io.Serializable pkey) throws Exception{
		AuthMember object = null;
		object = authMemberDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public AuthMember get (java.io.Serializable pkey, String[] required) throws Exception{
	    AuthMember object = null;
	    object = authMemberDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = authMemberDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			AuthMember element = (AuthMember) iter.next();
...
// unique Result
	...
	public AuthMember searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = authMemberDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		AuthMember obj = (AuthMember) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public AuthMember searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = authMemberDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		AuthMember obj = (AuthMember) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = authMemberDao.getDetachedCriteria();
		return dc;
	}
