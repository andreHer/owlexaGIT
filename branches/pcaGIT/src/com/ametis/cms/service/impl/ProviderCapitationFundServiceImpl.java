...
/**
 * ProviderCapitationFund is a servlet controller for provider_capitation_fund Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProviderCapitationFundServiceImpl implements ProviderCapitationFundService
...
// extends- 
{
	...
	private ProviderCapitationFundDao  providerCapitationFundDao;

	public void setProviderCapitationFundDao (ProviderCapitationFundDao object){
		this.providerCapitationFundDao = object;
	}
	public ProviderCapitationFundDao getProviderCapitationFundDao (){
		return this.providerCapitationFundDao;
	}
	/*
	...
	*/
	public ProviderCapitationFund create (ProviderCapitationFund object,ActionUser user) throws Exception {
			...
			ProviderCapitationFund result = providerCapitationFundDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderCapitationFund object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderCapitationFund update (ProviderCapitationFund object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerCapitationFundDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderCapitationFund trash (java.io.Serializable pkey) throws Exception {
		ProviderCapitationFund object = providerCapitationFundDao.get (pkey);
		providerCapitationFundDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ProviderCapitationFund delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderCapitationFund object = providerCapitationFundDao.get (pkey);
	...
	*/
	...
	public ProviderCapitationFund delete (ProviderCapitationFund object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderCapitationFund get (java.io.Serializable pkey) throws Exception{
		ProviderCapitationFund object = null;
		object = providerCapitationFundDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderCapitationFund get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderCapitationFund object = null;
	    object = providerCapitationFundDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerCapitationFundDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderCapitationFund element = (ProviderCapitationFund) iter.next();
...
// unique Result
	...
	public ProviderCapitationFund searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerCapitationFundDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderCapitationFund obj = (ProviderCapitationFund) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderCapitationFund searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerCapitationFundDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderCapitationFund obj = (ProviderCapitationFund) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerCapitationFundDao.getDetachedCriteria();
		return dc;
	}
