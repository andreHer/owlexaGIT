...
*/
public class RefRegionServiceImpl implements RefRegionService
...

{
	...
	public void setRefRegionDao (RefRegionDao object){
		this.refRegionDao = object;
	}
	public RefRegionDao getRefRegionDao (){
		return this.refRegionDao;
	}
	/*
	...
	*/
	public RefRegion create (RefRegion object,ActionUser user) throws Exception {
			...
			RefRegion result = refRegionDao.create (object);
			return result;
		}
	/*
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	public RefRegion trash (java.io.Serializable pkey) throws Exception {
		RefRegion object = refRegionDao.get (pkey);
		refRegionDao.delete (object);
		return object;
	}
...
// -- get section - carefull !
	...
	*/
	public RefRegion get (java.io.Serializable pkey) throws Exception{
		RefRegion object = null;
		object = refRegionDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = refRegionDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			RefRegion element = (RefRegion) iter.next();
...
// unique Result
	...
	public RefRegion searchUnique (String eqColumns, Object eqParams, String[] required)
		...
		Criteria c = refRegionDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		RefRegion obj = (RefRegion) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = refRegionDao.getDetachedCriteria();
		return dc;
	}
	...
	public Collection searchRegion(String q, String country) throws Exception {
        ...
        Collection<RefRegion> result = new Vector<RefRegion>();
        try {
            Session session = refRegionDao.getRegionSession();

            System.out.println("filter region by LIKE(regionName) and LIKE(regionName)");
            
            String sqlQuery = "SELECT c FROM "
                    + "RefRegion c WHERE lower(c.regionName) LIKE :keyword AND lower(c.regionName) LIKE :cword AND c.deletedStatus = 0 "
                    + "ORDER BY c.regionName ASC";
	...
	public Collection searchRegion(String q) throws Exception {

        Collection<RefRegion> result = new Vector<RefRegion>();
        try {
            Session session = refRegionDao.getRegionSession();

            System.out.println("filter region by LIKE(regionName)");
            String sqlQuery = "SELECT c FROM "
                    + "RefRegion c WHERE lower(c.regionName) LIKE :keyword AND c.deletedStatus = 0 ORDER BY c.regionName ASC";
	...
	public Collection searchRegion(String q, Integer countryId)
			throws Exception {
		 Collection<RefRegion> result = new Vector<RefRegion>();
	        try {
	            Session session = refRegionDao.getRegionSession();
	            
	            System.out.println("filter region by LIKE(regionName) and countryid");

	            String sqlQuery = "SELECT c FROM "
	                    + "RefRegion c WHERE lower(c.regionName) LIKE :keyword AND c.countryId.id = :cid AND c.deletedStatus = 0 ORDER BY c.regionName ASC";
