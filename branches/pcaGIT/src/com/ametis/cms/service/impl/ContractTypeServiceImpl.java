...
import com.ametis.cms.service.ContractTypeService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.ContractType;
import com.ametis.cms.dao.ContractTypeDao;
...
/**
 * ContractType is a servlet controller for contract_type Table.
...
// extends- 
{
	...
	public void setContractTypeDao (ContractTypeDao object){
		this.contractTypeDao = object;
	}
	public ContractTypeDao getContractTypeDao (){
		return this.contractTypeDao;
	}
	/*
	* Method create (ContractType object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ContractType create (ContractType object,ActionUser user) throws Exception {
			...
			ContractType result = contractTypeDao.create (object);
			return result;
		}
	/*
	* Method update (ContractType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ContractType update (ContractType object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ContractType trash (java.io.Serializable pkey) throws Exception {
		ContractType object = contractTypeDao.get (pkey);
		contractTypeDao.delete (object);
		return object;
	}

	/*
	* Method delete (ContractType object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ContractType delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ContractType object = contractTypeDao.get (pkey);
	...
	*/
	...
	public ContractType delete (ContractType object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ContractType get (java.io.Serializable pkey) throws Exception{
		ContractType object = null;
		object = contractTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ContractType get (java.io.Serializable pkey, String[] required) throws Exception{
	    ContractType object = null;
	    object = contractTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = contractTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ContractType element = (ContractType) iter.next();
...
// unique Result
	...
	public ContractType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = contractTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ContractType obj = (ContractType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ContractType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = contractTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ContractType obj = (ContractType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = contractTypeDao.getDetachedCriteria();
		return dc;
	}
