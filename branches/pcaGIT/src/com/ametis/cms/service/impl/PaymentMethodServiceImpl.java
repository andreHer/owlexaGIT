...
import com.ametis.cms.dao.PaymentMethodDao;
...
/**
 * PaymentMethod is a servlet controller for payment_method Table.
...

{
	...
	public void setPaymentMethodDao (PaymentMethodDao object){
		this.paymentMethodDao = object;
	}
	public PaymentMethodDao getPaymentMethodDao (){
		return this.paymentMethodDao;
	}
	/*
	* Method create (PaymentMethod object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public PaymentMethod create (PaymentMethod object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			PaymentMethod result = paymentMethodDao.create (object);
			return result;
		}
	/*
	* Method update (PaymentMethod object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PaymentMethod update (PaymentMethod object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		paymentMethodDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public PaymentMethod trash (java.io.Serializable pkey) throws Exception {
		PaymentMethod object = paymentMethodDao.get (pkey);
		paymentMethodDao.delete (object);
		return object;
	}

	/*
	* Method delete (PaymentMethod object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public PaymentMethod delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PaymentMethod object = paymentMethodDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public PaymentMethod delete (PaymentMethod object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PaymentMethod get (java.io.Serializable pkey) throws Exception{
		PaymentMethod object = null;
		object = paymentMethodDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PaymentMethod get (java.io.Serializable pkey, String[] required) throws Exception{
	    PaymentMethod object = null;
	    object = paymentMethodDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = paymentMethodDao.getCriteria();
...
// unique Result
	...
	public PaymentMethod searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = paymentMethodDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PaymentMethod obj = (PaymentMethod) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PaymentMethod searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = paymentMethodDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PaymentMethod obj = (PaymentMethod) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = paymentMethodDao.getDetachedCriteria();
		return dc;
	}
