...
/**
 * FundCategory is a servlet controller for fund_category Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class FundCategoryServiceImpl implements FundCategoryService
...
private ActivityLogService activityLogService;
	...
	public void setFundCategoryDao (FundCategoryDao object){
		this.fundCategoryDao = object;
	}
	public FundCategoryDao getFundCategoryDao (){
		return this.fundCategoryDao;
	}
	/*
	...
	*/
	public FundCategory create (FundCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			FundCategory result = fundCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (FundCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public FundCategory update (FundCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public FundCategory trash (java.io.Serializable pkey) throws Exception {
		FundCategory object = fundCategoryDao.get (pkey);
		fundCategoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public FundCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		FundCategory object = fundCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public FundCategory delete (FundCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public FundCategory get (java.io.Serializable pkey) throws Exception{
		FundCategory object = null;
		object = fundCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public FundCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    FundCategory object = null;
	    object = fundCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = fundCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			FundCategory element = (FundCategory) iter.next();
...
// unique Result
	...
	public FundCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = fundCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FundCategory obj = (FundCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public FundCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = fundCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		FundCategory obj = (FundCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = fundCategoryDao.getDetachedCriteria();
		return dc;
	}
