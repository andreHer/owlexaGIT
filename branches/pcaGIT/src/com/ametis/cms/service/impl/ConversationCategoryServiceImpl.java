...
/**
 * ConversationCategory is a servlet controller for conversation_category Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ConversationCategoryServiceImpl implements ConversationCategoryService
...

{
	...
	private ConversationCategoryDao  conversationCategoryDao;
private ActivityLogService activityLogService;
	...
	public void setConversationCategoryDao (ConversationCategoryDao object){
		this.conversationCategoryDao = object;
	}
	public ConversationCategoryDao getConversationCategoryDao (){
		return this.conversationCategoryDao;
	}
	/*
	...
	*/
	public ConversationCategory create (ConversationCategory object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ConversationCategory result = conversationCategoryDao.create (object);
			return result;
		}
	/*
	* Method update (ConversationCategory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ConversationCategory update (ConversationCategory object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
		...
		if (user != null){
 		...
 		conversationCategoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ConversationCategory trash (java.io.Serializable pkey) throws Exception {
		ConversationCategory object = conversationCategoryDao.get (pkey);
		conversationCategoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ConversationCategory delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		ConversationCategory object = conversationCategoryDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ConversationCategory delete (ConversationCategory object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ConversationCategory get (java.io.Serializable pkey) throws Exception{
		ConversationCategory object = null;
		object = conversationCategoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ConversationCategory get (java.io.Serializable pkey, String[] required) throws Exception{
	    ConversationCategory object = null;
	    object = conversationCategoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = conversationCategoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ConversationCategory element = (ConversationCategory) iter.next();
...
// unique Result
	...
	public ConversationCategory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = conversationCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ConversationCategory obj = (ConversationCategory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ConversationCategory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = conversationCategoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ConversationCategory obj = (ConversationCategory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = conversationCategoryDao.getDetachedCriteria();
		return dc;
	}
