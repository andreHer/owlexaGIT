...
import com.ametis.cms.service.MedicalProcedureMappingService;
import com.ametis.cms.datamodel.ActionUser;
import com.ametis.cms.datamodel.MedicalProcedureMapping;
import com.ametis.cms.dao.MedicalProcedureMappingDao;
...
/**
 * MedicalProcedureMapping is a servlet controller for medical_procedure_mapping Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class MedicalProcedureMappingServiceImpl implements MedicalProcedureMappingService
...
// extends- 
{
	...
	private MedicalProcedureMappingDao  medicalProcedureMappingDao;

	public void setMedicalProcedureMappingDao (MedicalProcedureMappingDao object){
		this.medicalProcedureMappingDao = object;
	}
	public MedicalProcedureMappingDao getMedicalProcedureMappingDao (){
		return this.medicalProcedureMappingDao;
	}
	/*
	...
	*/
	public MedicalProcedureMapping create (MedicalProcedureMapping object,ActionUser user) throws Exception {
			...
			MedicalProcedureMapping result = medicalProcedureMappingDao.create (object);
			return result;
		}
	/*
	* Method update (MedicalProcedureMapping object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MedicalProcedureMapping update (MedicalProcedureMapping object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		medicalProcedureMappingDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MedicalProcedureMapping trash (java.io.Serializable pkey) throws Exception {
		MedicalProcedureMapping object = medicalProcedureMappingDao.get (pkey);
		medicalProcedureMappingDao.delete (object);
		return object;
	}
	...
	*/
	...
	public MedicalProcedureMapping delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		MedicalProcedureMapping object = medicalProcedureMappingDao.get (pkey);
	...
	*/
	...
	public MedicalProcedureMapping delete (MedicalProcedureMapping object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MedicalProcedureMapping get (java.io.Serializable pkey) throws Exception{
		MedicalProcedureMapping object = null;
		object = medicalProcedureMappingDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MedicalProcedureMapping get (java.io.Serializable pkey, String[] required) throws Exception{
	    MedicalProcedureMapping object = null;
	    object = medicalProcedureMappingDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = medicalProcedureMappingDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MedicalProcedureMapping element = (MedicalProcedureMapping) iter.next();
...
// unique Result
	...
	public MedicalProcedureMapping searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = medicalProcedureMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MedicalProcedureMapping obj = (MedicalProcedureMapping) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MedicalProcedureMapping searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = medicalProcedureMappingDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MedicalProcedureMapping obj = (MedicalProcedureMapping) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = medicalProcedureMappingDao.getDetachedCriteria();
		return dc;
	}
