...
// extends- 
{
	...
	public void setBrokerDao (BrokerDao object){
		this.brokerDao = object;
	}
	...
	*/
	public Broker create (Broker object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Broker result = brokerDao.create (object);
			return result;
		}
	/*
	* Method update (Broker object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Broker update (Broker object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Broker trash (java.io.Serializable pkey) throws Exception {
		Broker object = brokerDao.get (pkey);
		brokerDao.delete (object);
		return object;
	}
	...
	*/
	...
	public Broker delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		Broker object = brokerDao.get (pkey);
	...
	*/
	...
	public Broker delete (Broker object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Broker get (java.io.Serializable pkey) throws Exception{
		Broker object = null;
		object = brokerDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Broker get (java.io.Serializable pkey, String[] required) throws Exception{
	    Broker object = null;
	    object = brokerDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = brokerDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Broker element = (Broker) iter.next();
...
// unique Result
	...
	public Broker searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = brokerDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Broker obj = (Broker) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Broker searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = brokerDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Broker obj = (Broker) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = brokerDao.getDetachedCriteria();
		return dc;
	}
