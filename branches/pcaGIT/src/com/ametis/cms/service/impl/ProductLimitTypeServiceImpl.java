...
import com.ametis.cms.dao.ProductLimitTypeDao;
...
/**
 * ProductLimitType is a servlet controller for product_limit_type Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ProductLimitTypeServiceImpl implements ProductLimitTypeService
...

{
	...
	private ProductLimitTypeDao  productLimitTypeDao;

	public void setProductLimitTypeDao (ProductLimitTypeDao object){
		this.productLimitTypeDao = object;
	}
	public ProductLimitTypeDao getProductLimitTypeDao (){
		return this.productLimitTypeDao;
	}
	/*
	* Method create (ProductLimitType object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProductLimitType create (ProductLimitType object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ProductLimitType result = productLimitTypeDao.create (object);
			return result;
		}
	/*
	* Method update (ProductLimitType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProductLimitType update (ProductLimitType object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		productLimitTypeDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProductLimitType trash (java.io.Serializable pkey) throws Exception {
		ProductLimitType object = productLimitTypeDao.get (pkey);
		productLimitTypeDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProductLimitType object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProductLimitType delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProductLimitType object = productLimitTypeDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ProductLimitType delete (ProductLimitType object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProductLimitType get (java.io.Serializable pkey) throws Exception{
		ProductLimitType object = null;
		object = productLimitTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProductLimitType get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProductLimitType object = null;
	    object = productLimitTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = productLimitTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProductLimitType element = (ProductLimitType) iter.next();
...
// unique Result
	...
	public ProductLimitType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = productLimitTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductLimitType obj = (ProductLimitType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProductLimitType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = productLimitTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProductLimitType obj = (ProductLimitType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = productLimitTypeDao.getDetachedCriteria();
		return dc;
	}
