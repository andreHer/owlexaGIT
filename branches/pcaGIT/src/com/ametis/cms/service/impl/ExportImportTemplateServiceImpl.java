...
/**
 * ExportImportTemplate is a servlet controller for export_import_template Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class ExportImportTemplateServiceImpl implements ExportImportTemplateService
...
// extends- 
{
	...
	private ExportImportTemplateDao  exportImportTemplateDao;

	public void setExportImportTemplateDao (ExportImportTemplateDao object){
		this.exportImportTemplateDao = object;
	}
	public ExportImportTemplateDao getExportImportTemplateDao (){
		return this.exportImportTemplateDao;
	}
	/*
	...
	*/
	public ExportImportTemplate create (ExportImportTemplate object,ActionUser user) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			ExportImportTemplate result = exportImportTemplateDao.create (object);
			return result;
		}
	/*
	* Method update (ExportImportTemplate object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ExportImportTemplate update (ExportImportTemplate object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		exportImportTemplateDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ExportImportTemplate trash (java.io.Serializable pkey) throws Exception {
		ExportImportTemplate object = exportImportTemplateDao.get (pkey);
		exportImportTemplateDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ExportImportTemplate delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ExportImportTemplate object = exportImportTemplateDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public ExportImportTemplate delete (ExportImportTemplate object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ExportImportTemplate get (java.io.Serializable pkey) throws Exception{
		ExportImportTemplate object = null;
		object = exportImportTemplateDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ExportImportTemplate get (java.io.Serializable pkey, String[] required) throws Exception{
	    ExportImportTemplate object = null;
	    object = exportImportTemplateDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = exportImportTemplateDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ExportImportTemplate element = (ExportImportTemplate) iter.next();
...
// unique Result
	...
	public ExportImportTemplate searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = exportImportTemplateDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExportImportTemplate obj = (ExportImportTemplate) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ExportImportTemplate searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = exportImportTemplateDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ExportImportTemplate obj = (ExportImportTemplate) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = exportImportTemplateDao.getDetachedCriteria();
		return dc;
	}
