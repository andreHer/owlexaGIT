...
/**
 * MedicineFactory is a servlet controller for medicine_factory Table.
...

{
	...
	public void setMedicineFactoryDao (MedicineFactoryDao object){
		this.medicineFactoryDao = object;
	}
	public MedicineFactoryDao getMedicineFactoryDao (){
		return this.medicineFactoryDao;
	}
	/*
	...
	*/
	public MedicineFactory create (MedicineFactory object,ActionUser user) throws Exception {
			...
			MedicineFactory result = medicineFactoryDao.create (object);
			return result;
		}
	/*
	* Method update (MedicineFactory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public MedicineFactory update (MedicineFactory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		medicineFactoryDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public MedicineFactory trash (java.io.Serializable pkey) throws Exception {
		MedicineFactory object = medicineFactoryDao.get (pkey);
		medicineFactoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public MedicineFactory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		MedicineFactory object = medicineFactoryDao.get (pkey);
	...
	*/
	...
	public MedicineFactory delete (MedicineFactory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public MedicineFactory get (java.io.Serializable pkey) throws Exception{
		MedicineFactory object = null;
		object = medicineFactoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public MedicineFactory get (java.io.Serializable pkey, String[] required) throws Exception{
	    MedicineFactory object = null;
	    object = medicineFactoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = medicineFactoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			MedicineFactory element = (MedicineFactory) iter.next();
...
// unique Result
	...
	public MedicineFactory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = medicineFactoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MedicineFactory obj = (MedicineFactory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public MedicineFactory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = medicineFactoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		MedicineFactory obj = (MedicineFactory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = medicineFactoryDao.getDetachedCriteria();
		return dc;
	}
