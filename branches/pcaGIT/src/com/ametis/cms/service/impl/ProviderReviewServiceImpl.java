...
import com.ametis.cms.datamodel.ProviderReview;
import com.ametis.cms.dao.ProviderReviewDao;
...
/**
 * ProviderReview is a servlet controller for provider_review Table.
...

{
	...
	private ProviderReviewDao  providerReviewDao;

	public void setProviderReviewDao (ProviderReviewDao object){
		this.providerReviewDao = object;
	}
	public ProviderReviewDao getProviderReviewDao (){
		return this.providerReviewDao;
	}
	/*
	* Method create (ProviderReview object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public ProviderReview create (ProviderReview object,ActionUser user) throws Exception {
			...
			ProviderReview result = providerReviewDao.create (object);
			return result;
		}
	/*
	* Method update (ProviderReview object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ProviderReview update (ProviderReview object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		providerReviewDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ProviderReview trash (java.io.Serializable pkey) throws Exception {
		ProviderReview object = providerReviewDao.get (pkey);
		providerReviewDao.delete (object);
		return object;
	}

	/*
	* Method delete (ProviderReview object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public ProviderReview delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ProviderReview object = providerReviewDao.get (pkey);
	...
	*/
	...
	public ProviderReview delete (ProviderReview object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ProviderReview get (java.io.Serializable pkey) throws Exception{
		ProviderReview object = null;
		object = providerReviewDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ProviderReview get (java.io.Serializable pkey, String[] required) throws Exception{
	    ProviderReview object = null;
	    object = providerReviewDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = providerReviewDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ProviderReview element = (ProviderReview) iter.next();
...
// unique Result
	...
	public ProviderReview searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = providerReviewDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderReview obj = (ProviderReview) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ProviderReview searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = providerReviewDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ProviderReview obj = (ProviderReview) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = providerReviewDao.getDetachedCriteria();
		return dc;
	}
