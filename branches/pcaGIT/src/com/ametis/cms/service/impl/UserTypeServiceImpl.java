...
import com.ametis.cms.dao.UserTypeDao;
...
/**
 * UserType is a servlet controller for user_type Table.
...
// extends- 
{
	...
	public void setUserTypeDao (UserTypeDao object){
		this.userTypeDao = object;
	}
	public UserTypeDao getUserTypeDao (){
		return this.userTypeDao;
	}
	/*
	* Method create (UserType object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public UserType create (UserType object,ActionUser user) throws Exception {
			
			
			
			object.setCreatedTime (new java.sql.Time (System.currentTimeMillis()));
			...
			UserType result = userTypeDao.create (object);
			return result;
		}
	/*
	* Method update (UserType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public UserType update (UserType object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public UserType trash (java.io.Serializable pkey) throws Exception {
		UserType object = userTypeDao.get (pkey);
		userTypeDao.delete (object);
		return object;
	}

	/*
	* Method delete (UserType object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public UserType delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		UserType object = userTypeDao.get (pkey);
	...
	*/
	...
	public UserType delete (UserType object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public UserType get (java.io.Serializable pkey) throws Exception{
		UserType object = null;
		object = userTypeDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public UserType get (java.io.Serializable pkey, String[] required) throws Exception{
	    UserType object = null;
	    object = userTypeDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = userTypeDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			UserType element = (UserType) iter.next();
...
// unique Result
	...
	public UserType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = userTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		UserType obj = (UserType) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public UserType searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = userTypeDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		UserType obj = (UserType) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = userTypeDao.getDetachedCriteria();
		return dc;
	}
