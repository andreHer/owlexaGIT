...
import com.ametis.cms.dao.CaseEventDao;
...
/**
 * CaseEvent is a servlet controller for case_event Table.
...
private ActivityLogService activityLogService;
	...
	public void setCaseEventDao (CaseEventDao object){
		this.caseEventDao = object;
	}
	public CaseEventDao getCaseEventDao (){
		return this.caseEventDao;
	}
	/*
	* Method create (CaseEvent object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public CaseEvent create (CaseEvent object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			CaseEvent result = caseEventDao.create (object);
			return result;
		}
	/*
	* Method update (CaseEvent object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public CaseEvent update (CaseEvent object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public CaseEvent trash (java.io.Serializable pkey) throws Exception {
		CaseEvent object = caseEventDao.get (pkey);
		caseEventDao.delete (object);
		return object;
	}

	/*
	* Method delete (CaseEvent object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public CaseEvent delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		CaseEvent object = caseEventDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public CaseEvent delete (CaseEvent object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public CaseEvent get (java.io.Serializable pkey) throws Exception{
		CaseEvent object = null;
		object = caseEventDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public CaseEvent get (java.io.Serializable pkey, String[] required) throws Exception{
	    CaseEvent object = null;
	    object = caseEventDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = caseEventDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			CaseEvent element = (CaseEvent) iter.next();
...
// unique Result
	...
	public CaseEvent searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = caseEventDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseEvent obj = (CaseEvent) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public CaseEvent searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = caseEventDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		CaseEvent obj = (CaseEvent) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = caseEventDao.getDetachedCriteria();
		return dc;
	}
