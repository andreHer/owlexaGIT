...
import com.ametis.cms.dao.BankAccountDao;
...
/**
 * BankAccount is a servlet controller for bank_account Table.
...
// extends- 
{
	...
	public void setBankAccountDao (BankAccountDao object){
		this.bankAccountDao = object;
	}
	public BankAccountDao getBankAccountDao (){
		return this.bankAccountDao;
	}
	/*
	* Method create (BankAccount object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public BankAccount create (BankAccount object,ActionUser user) throws Exception {
			...
			if (object != null){
				Integer bankId = object.getBankId().getBankId();
				Bank bank = bankService.get(bankId);
				
				if (bank != null){
					object.setBank(bank.getBankName());
				}
			...
			BankAccount result = bankAccountDao.create (object);
			return result;
		}
	/*
	* Method update (BankAccount object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public BankAccount update (BankAccount object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public BankAccount trash (java.io.Serializable pkey) throws Exception {
		BankAccount object = bankAccountDao.get (pkey);
		bankAccountDao.delete (object);
		return object;
	}

	/*
	* Method delete (BankAccount object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public BankAccount delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		BankAccount object = bankAccountDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
		...
		object.setDeletedTime(new java.sql.Timestamp(System.currentTimeMillis()));
			if (user.getUser() != null){
                        ...
                        object.setDeletedStatus(Integer.valueOf(1));
	...
	*/
	...
	public BankAccount delete (BankAccount object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public BankAccount get (java.io.Serializable pkey) throws Exception{
		BankAccount object = null;
		object = bankAccountDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public BankAccount get (java.io.Serializable pkey, String[] required) throws Exception{
	    BankAccount object = null;
	    object = bankAccountDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = bankAccountDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			BankAccount element = (BankAccount) iter.next();
...
// unique Result
	...
	public BankAccount searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = bankAccountDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		BankAccount obj = (BankAccount) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public BankAccount searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = bankAccountDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		BankAccount obj = (BankAccount) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = bankAccountDao.getDetachedCriteria();
		return dc;
	}

	public Collection<BankAccount> searchProvider( String[] eqProvider,  Object[] oProvider) throws Exception {
		Criteria c = bankAccountDao.getCriteria();
		DaoSupportUtil.setEqParam(eqProvider, oProvider, c);
		List list = c.list();
		return list;

	}
	
	public BankAccount getBankAccountName (Integer providerId) throws Exception {
		BankAccount result = null;
		
		try {
			String[] eqParam = {"deletedStatus","providerId.providerId"};
			Object[] eqValue = {Integer.valueOf(0),providerId};
			
			int total = getTotal(null,null,eqParam,eqValue);
			Collection<BankAccount> list = search(null,null,eqParam,eqValue,  0, total);
