...
/**
 * ScheduledPayment is a servlet controller for scheduled_payment Table.
...

{
	...
	public void setScheduledPaymentDao (ScheduledPaymentDao object){
		this.scheduledPaymentDao = object;
	}
	public ScheduledPaymentDao getScheduledPaymentDao (){
		return this.scheduledPaymentDao;
	}
	/*
	...
	*/
	public ScheduledPayment create (ScheduledPayment object,ActionUser user) throws Exception {
			...
			ScheduledPayment result = scheduledPaymentDao.create (object);
			return result;
		}
	/*
	* Method update (ScheduledPayment object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ScheduledPayment update (ScheduledPayment object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		scheduledPaymentDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ScheduledPayment trash (java.io.Serializable pkey) throws Exception {
		ScheduledPayment object = scheduledPaymentDao.get (pkey);
		scheduledPaymentDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ScheduledPayment delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ScheduledPayment object = scheduledPaymentDao.get (pkey);
	...
	*/
	...
	public ScheduledPayment delete (ScheduledPayment object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ScheduledPayment get (java.io.Serializable pkey) throws Exception{
		ScheduledPayment object = null;
		object = scheduledPaymentDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ScheduledPayment get (java.io.Serializable pkey, String[] required) throws Exception{
	    ScheduledPayment object = null;
	    object = scheduledPaymentDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = scheduledPaymentDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ScheduledPayment element = (ScheduledPayment) iter.next();
...
// unique Result
	...
	public ScheduledPayment searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = scheduledPaymentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ScheduledPayment obj = (ScheduledPayment) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ScheduledPayment searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = scheduledPaymentDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ScheduledPayment obj = (ScheduledPayment) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = scheduledPaymentDao.getDetachedCriteria();
		return dc;
	}
