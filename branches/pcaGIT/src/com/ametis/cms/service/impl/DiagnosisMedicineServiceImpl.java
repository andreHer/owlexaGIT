...
import com.ametis.cms.service.DiagnosisMedicineService;
...
/**
 * DiagnosisMedicine is a servlet controller for diagnosis_medicine Table.
...
// extends- 
{
	...
	private DiagnosisMedicineDao  diagnosisMedicineDao;

	public void setDiagnosisMedicineDao (DiagnosisMedicineDao object){
		this.diagnosisMedicineDao = object;
	}
	public DiagnosisMedicineDao getDiagnosisMedicineDao (){
		return this.diagnosisMedicineDao;
	}
	/*
	...
	*/
	public DiagnosisMedicine create (DiagnosisMedicine object,ActionUser user) throws Exception {
			...
			DiagnosisMedicine result = diagnosisMedicineDao.create (object);
			return result;
		}
	/*
	* Method update (DiagnosisMedicine object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public DiagnosisMedicine update (DiagnosisMedicine object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		diagnosisMedicineDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public DiagnosisMedicine trash (java.io.Serializable pkey) throws Exception {
		DiagnosisMedicine object = diagnosisMedicineDao.get (pkey);
		diagnosisMedicineDao.delete (object);
		return object;
	}
	...
	*/
	...
	public DiagnosisMedicine delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		DiagnosisMedicine object = diagnosisMedicineDao.get (pkey);
	...
	*/
	...
	public DiagnosisMedicine delete (DiagnosisMedicine object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public DiagnosisMedicine get (java.io.Serializable pkey) throws Exception{
		DiagnosisMedicine object = null;
		object = diagnosisMedicineDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public DiagnosisMedicine get (java.io.Serializable pkey, String[] required) throws Exception{
	    DiagnosisMedicine object = null;
	    object = diagnosisMedicineDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = diagnosisMedicineDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			DiagnosisMedicine element = (DiagnosisMedicine) iter.next();
...
// unique Result
	...
	public DiagnosisMedicine searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = diagnosisMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisMedicine obj = (DiagnosisMedicine) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public DiagnosisMedicine searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = diagnosisMedicineDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		DiagnosisMedicine obj = (DiagnosisMedicine) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = diagnosisMedicineDao.getDetachedCriteria();
		return dc;
	}
