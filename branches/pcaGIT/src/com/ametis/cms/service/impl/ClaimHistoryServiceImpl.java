...
/**
 * ClaimHistory is a servlet controller for claim_history Table.
...
// extends- 
{
	...
	public void setClaimHistoryDao (ClaimHistoryDao object){
		this.claimHistoryDao = object;
	}
	public ClaimHistoryDao getClaimHistoryDao (){
		return this.claimHistoryDao;
	}
	/*
	...
	*/
	public ClaimHistory create (ClaimHistory object,ActionUser user) throws Exception {
			...
			ClaimHistory result = claimHistoryDao.create (object);
			return result;
		}
	public ClaimHistory getLatestHistory (Integer claimId) throws Exception {
		ClaimHistory result = null;
		
		String[] eqParam = {"claimId.claimId","deletedStatus"};
		Object[] eqValue = {claimId,Integer.valueOf(0)};
		
		Collection<ClaimHistory> claimList = search(null,null,eqParam,eqValue,false,"actionTime",0,1);
		if (claimList != null){
			Iterator<ClaimHistory> iterator = claimList.iterator();
	...
	/*
	* Method update (ClaimHistory object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClaimHistory update (ClaimHistory object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public ClaimHistory trash (java.io.Serializable pkey) throws Exception {
		ClaimHistory object = claimHistoryDao.get (pkey);
		claimHistoryDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ClaimHistory delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ClaimHistory object = claimHistoryDao.get (pkey);
	...
	*/
	...
	public ClaimHistory delete (ClaimHistory object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClaimHistory get (java.io.Serializable pkey) throws Exception{
		ClaimHistory object = null;
		object = claimHistoryDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClaimHistory get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClaimHistory object = null;
	    object = claimHistoryDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = claimHistoryDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClaimHistory element = (ClaimHistory) iter.next();
	...
	//Add 20150826 by FVO, for Claim Active
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		if(inParamsValue.length >= 1)
			DaoSupportUtil.setIn("claimStatus.caseStatusId", inParamsValue,c);
		DaoSupportUtil.setLimit(index, offset, c);
		DaoSupportUtil.setOrderBy(asc,columnOrder,c);
		List list = c.list();
		for (Iterator iter = list.iterator(); iter.hasNext();) {
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
			...
			Object[] btwnParams2, String[] required,
			int index, int offset) throws Exception{
		Criteria c = claimHistoryDao.getCriteria();
		DaoSupportUtil.setLikeParam(likeColumns,likeParams,c);
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
			String[] eqColumns, Object[] eqParams, String lsthColumn, Object lsthValue, Object[] inParamsValue, boolean asc, String columnOrder[],
			String[] required,
			int index, int offset) throws Exception{
		Criteria c = claimHistoryDao.getCriteria();
		DaoSupportUtil.setLikeParam(likeColumns,likeParams,c);
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		if(lsthValue!=null && lsthColumn!=null)
...
//-- get total
	...
	//Add 20150826 by FVO for CLAIM ACTIVE REPORT
	public int getTotal (String[] likeColumns, Object[] likeParams,
	...
	public int getTotal (String[] likeColumns, Object[] likeParams,
			String[] eqColumns, Object[] eqParams, Object[] inParamsValue,
			String[] btwnColumns, Object[] btwnParams1,
				Object[] btwnParams2
			) throws Exception{
	...
	public int getTotal (String[] likeColumns, Object[] likeParams,
			String[] eqColumns, Object[] eqParams, String lsthColumn, Object lsthValue, Object[] inParamsValue) throws Exception{
	...
	public int getTotal (String[] likeColumns, Object[] likeParams,
			String[] eqColumns, Object[] eqParams, String lsthColumn, Object lsthValue, Object[] inParamsValue,
			String[] btwnColumns, Object[] btwnParams1,
				Object[] btwnParams2
			) throws Exception{
	...
	public int getTotal (String[] likeColumns, Object[] likeParams,
			String[] eqColumns, Object[] eqParams, String lsthColumn, Object lsthValue, 
			String mrthColumn, Object mrthValue, Object[] inParamsValue) throws Exception{
			...
			if(lsthValue!=null && lsthColumn!=null)
				DaoSupportUtil.setLessThanEqual(lsthValue, lsthColumn, c);
			if(mrthColumn!=null && mrthValue!=null)
				DaoSupportUtil.setGreaterThan(mrthValue, mrthColumn, c);
			if(inParamsValue.length >= 1)
				DaoSupportUtil.setIn("claimStatus.caseStatusId",inParamsValue,c);
			int total = DaoSupportUtil.getTotal(c);
			return total;
...
// unique Result
	...
	public ClaimHistory searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = claimHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClaimHistory obj = (ClaimHistory) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClaimHistory searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = claimHistoryDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClaimHistory obj = (ClaimHistory) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = claimHistoryDao.getDetachedCriteria();
		return dc;
	}
