...
import com.ametis.cms.dao.ClausulDao;
...
*/
public class ClausulServiceImpl implements ClausulService
...
private ActivityLogService activityLogService;
	...
	public void setClausulDao (ClausulDao object){
		this.clausulDao = object;
	}
	public ClausulDao getClausulDao (){
		return this.clausulDao;
	}
	/*
	* Method create (Clausul object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public Clausul create (Clausul object,ActionUser actionUser) throws Exception {
...
//			object.setCreatedDate (new java.sql.Date (System.currentTimeMillis()));
			...
			Clausul result = clausulDao.create (object);
			return result;
		}
	/*
	* Method update (Clausul object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public Clausul update (Clausul object,ActionUser actionUser) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	* place
	*/
	public Clausul trash (java.io.Serializable pkey) throws Exception {
		Clausul object = clausulDao.get (pkey);
		clausulDao.delete (object);
		return object;
	}

	/*
	* Method delete (Clausul object) berfungsi untuk melakukan penghapusan terhadap
	* sebuah object yang terdapat didalam database
	...
	*/
	...
	public Clausul delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception{
		Clausul object = clausulDao.get (pkey);
...
//		object.setDeletedDate (new java.sql.Date (System.currentTimeMillis()));
	...
	*/
	...
	public Clausul delete (Clausul object,ActionUser actionUser) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public Clausul get (java.io.Serializable pkey) throws Exception{
		Clausul object = null;
		object = clausulDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public Clausul get (java.io.Serializable pkey, String[] required) throws Exception{
	    Clausul object = null;
	    object = clausulDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clausulDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			Clausul element = (Clausul) iter.next();
...
// unique Result
	...
	public Clausul searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Clausul obj = (Clausul) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public Clausul searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clausulDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		Clausul obj = (Clausul) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clausulDao.getDetachedCriteria();
		return dc;
	}
