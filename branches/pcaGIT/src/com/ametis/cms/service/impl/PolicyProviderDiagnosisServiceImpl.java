...
import com.ametis.cms.service.PolicyProviderDiagnosisService;
...
/**
 * PolicyProviderDiagnosis is a servlet controller for policy_provider_diagnosis Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public class PolicyProviderDiagnosisServiceImpl implements PolicyProviderDiagnosisService
...

{
	...
	private PolicyProviderDiagnosisDao  policyProviderDiagnosisDao;

	public void setPolicyProviderDiagnosisDao (PolicyProviderDiagnosisDao object){
		this.policyProviderDiagnosisDao = object;
	}
	public PolicyProviderDiagnosisDao getPolicyProviderDiagnosisDao (){
		return this.policyProviderDiagnosisDao;
	}
	/*
	...
	*/
	public PolicyProviderDiagnosis create (PolicyProviderDiagnosis object,ActionUser user) throws Exception {
			...
			PolicyProviderDiagnosis result = policyProviderDiagnosisDao.create (object);
			return result;
		}
	/*
	* Method update (PolicyProviderDiagnosis object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public PolicyProviderDiagnosis update (PolicyProviderDiagnosis object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		policyProviderDiagnosisDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public PolicyProviderDiagnosis trash (java.io.Serializable pkey) throws Exception {
		PolicyProviderDiagnosis object = policyProviderDiagnosisDao.get (pkey);
		policyProviderDiagnosisDao.delete (object);
		return object;
	}
	...
	*/
	...
	public PolicyProviderDiagnosis delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		PolicyProviderDiagnosis object = policyProviderDiagnosisDao.get (pkey);
	...
	*/
	...
	public PolicyProviderDiagnosis delete (PolicyProviderDiagnosis object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public PolicyProviderDiagnosis get (java.io.Serializable pkey) throws Exception{
		PolicyProviderDiagnosis object = null;
		object = policyProviderDiagnosisDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public PolicyProviderDiagnosis get (java.io.Serializable pkey, String[] required) throws Exception{
	    PolicyProviderDiagnosis object = null;
	    object = policyProviderDiagnosisDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = policyProviderDiagnosisDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			PolicyProviderDiagnosis element = (PolicyProviderDiagnosis) iter.next();
...
// unique Result
	...
	public PolicyProviderDiagnosis searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = policyProviderDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyProviderDiagnosis obj = (PolicyProviderDiagnosis) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public PolicyProviderDiagnosis searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = policyProviderDiagnosisDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		PolicyProviderDiagnosis obj = (PolicyProviderDiagnosis) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = policyProviderDiagnosisDao.getDetachedCriteria();
		return dc;
	}
