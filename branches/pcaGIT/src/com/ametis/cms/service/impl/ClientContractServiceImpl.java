...
/**
 * ClientContract is a servlet controller for client_contract Table.
...
// extends- 
{
	...
	public void setClientContractDao (ClientContractDao object){
		this.clientContractDao = object;
	}
	public ClientContractDao getClientContractDao (){
		return this.clientContractDao;
	}
	/*
	...
	*/
	public ClientContract create (ClientContract object,ActionUser user) throws Exception {
			...
			ClientContract result = clientContractDao.create (object);
			return result;
		}
	public boolean activate (Integer clientContractId,ActionUser user) throws Exception {
		
		boolean result = false;
		
		ClientContract clientContract = get(clientContractId);
		if (clientContract != null){
			clientContract.setContractStatus(1);
			
			update(clientContract,user);
		}
		
		return result;
	}
	/*
	* Method update (ClientContract object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @return object hasil update, exception jika gagal
	*/
	public ClientContract update (ClientContract object,ActionUser user) throws Exception{
...
//		object.setUpdatedDate (new java.sql.Date (System.currentTimeMillis()));
 		...
 		clientContractDao.update (object);
      	return object;
	}
	...
	* place
	*/
	public ClientContract trash (java.io.Serializable pkey) throws Exception {
		ClientContract object = clientContractDao.get (pkey);
		clientContractDao.delete (object);
		return object;
	}
	...
	*/
	...
	public ClientContract delete (java.io.Serializable pkey,ActionUser user) throws Exception{
		ClientContract object = clientContractDao.get (pkey);
	...
	*/
	...
	public ClientContract delete (ClientContract object,ActionUser user) throws Exception{
...
// -- get section - carefull !
	...
	*/
	public ClientContract get (java.io.Serializable pkey) throws Exception{
		ClientContract object = null;
		object = clientContractDao.get(pkey);
		return object;
	}
	/*
	* Method get (Object pkey) berfungsi untuk melakukan retrieval terhadap
	...
	*/
	...
	public ClientContract get (java.io.Serializable pkey, String[] required) throws Exception{
	    ClientContract object = null;
	    object = clientContractDao.get(pkey);
...
// -- 1
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		Criteria c = clientContractDao.getCriteria();
	...
	public Collection search (String[] likeColumns, Object[] likeParams,
		...
		for (Iterator iter = list.iterator(); iter.hasNext();) {
			ClientContract element = (ClientContract) iter.next();
...
// unique Result
	...
	public ClientContract searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception{
		Criteria c = clientContractDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientContract obj = (ClientContract) c.uniqueResult();
		DaoSupportUtil.lazyInit(required,obj);
		return obj;
	}
	public ClientContract searchUnique (String eqColumns, Object eqParams)
		throws Exception{
		Criteria c = clientContractDao.getCriteria();
		DaoSupportUtil.setEqParam(eqColumns,eqParams,c);
		ClientContract obj = (ClientContract) c.uniqueResult();
...
*/
	...
	public DetachedCriteria getDetachedCriteria() throws Exception {
		DetachedCriteria dc = clientContractDao.getDetachedCriteria();
		return dc;
	}
	@Override
	public ClientContract getActiveContract(Integer clientId) throws Exception {
		// TODO Auto-generated method stub
		ClientContract result = null;
		
		
		try {
			String[] eqParam = {"deletedStatus","contractStatus","clientId.clientId"};
			Object[] eqValue = {0,SubscriptionStatus.ACTIVE,clientId};
			
			Collection<ClientContract> list = search(null,null,eqParam,eqValue,0,1);
			
			if (list != null){
				Iterator<ClientContract> iterator = list.iterator();
	...
	@Override
	public Collection<ClientContract> getClientActiveContract(Integer clientId) throws Exception {
		// TODO Auto-generated method stub
		Collection<ClientContract> result = null;
		...
		try {
			...
			result = search(null,null,eqParam,eqValue,0,1);
