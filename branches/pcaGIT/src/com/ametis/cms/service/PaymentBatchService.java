...
/**
 * PaymentBatch is a servlet controller for payment_batch Table.
...
/*
	...
	*/
	public PaymentBatch create (PaymentBatch object, Collection<Integer> paymentList, ActionUser user) throws Exception;
	public boolean confirmPayment(Integer batchId, String approvalNote, Date confirmDate,
			ActionUser user) throws Exception;

	/*
	* Method update (PaymentBatch object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public PaymentBatch update (PaymentBatch object,ActionUser user) throws Exception;	
	...
	* place
	*/
	public PaymentBatch trash (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public PaymentBatch delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public PaymentBatch delete (PaymentBatch object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public PaymentBatch get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public PaymentBatch get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public PaymentBatch searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public PaymentBatch searchUnique (String eqColumns, Object eqParams)
		throws Exception;
