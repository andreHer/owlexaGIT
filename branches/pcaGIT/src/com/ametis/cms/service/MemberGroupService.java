...
/**
 * MemberGroup is a servlet controller for member_group Table.
...
/*
	...
	*/
	public MemberGroup create (MemberGroup object,ActionUser actionUser) throws Exception;
	public ActionResult block (Integer memberGroupId, String reason,Date start, Date end, ActionUser actionUser) throws Exception;
	public ActionResult unblock (Integer memberGroupId, String reason, ActionUser actionUser) throws Exception;
/*
	* Method create (MemberGroup object) berfungsi untuk melakukan penambahan
	* sebuah object kedalam database
	* @param object adalah sebuah object yang ingin diubah
	...
	* @return object hasil kreasi,lengkap dengan assigned primary key, exception jika gagal
	*/
	public boolean activate (Integer memberGroupId,ActionUser actionUser) throws Exception;
	/*
	* Method update (MemberGroup object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public MemberGroup update (MemberGroup object,ActionUser actionUser) throws Exception;	
	...
	*/
	...
	public MemberGroup delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
	...
	*/
	...
	public MemberGroup delete (MemberGroup object,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public MemberGroup get (java.io.Serializable pkey, String[] required) throws Exception;
...
// -- 1
	...
	*/
	...
	/* Method searching objects from database with order
	* @param likeColumn kolom like
	* @param likeParams param like
	* @param eqColumn kolom equal
	* @param eqParams param equal
	* @param columnOrder kolom order
	* @param asc kolor order by
	* @param index index first
	* @param offset number of object result 
	*/
	public Collection search (String[] likeColumns, Object[] likeParams,
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public MemberGroup searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
...
*/
	...
	public Collection<MemberGroup> searchOutstandingExcessGroup (String keyword) throws Exception;
	public Collection<MemberGroup> getMemberGroupByClient(Integer clientId) throws Exception;//buatan luthfi
