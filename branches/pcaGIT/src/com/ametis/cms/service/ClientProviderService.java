...
/*
	...
	*/
	...
	public ClientProvider createUpload (ClientProvider object,MultipartFile file,ActionUser actionUser) throws Exception;

	public boolean saveClientProviders (String[] providersId, Integer clientId, ActionUser actionUser) throws Exception;
	public boolean deleteClientProviders (String[] clientProviders, ActionUser actionUser) throws Exception;
	/*
