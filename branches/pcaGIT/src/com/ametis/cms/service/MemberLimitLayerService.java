...
*/
public interface MemberLimitLayerService 
...
// -- get section - carefull !
	...
	*/
	...
	public MemberLimitLayer getSMMLayer (Integer memberId, Integer diagnosisId, Integer catergoryId) throws Exception;
	public MemberLimitLayer getAvailableLayer (Integer memberId, Integer caseCategoryId) throws Exception;
	public MemberLimitLayer getAvailableLayer (Integer memberId, Integer caseCategoryId, Integer memberProductId) throws Exception;
	public Collection<MemberLimitLayer> getAdditionalLayer (Integer memberId, Integer caseCategoryId) throws Exception;
