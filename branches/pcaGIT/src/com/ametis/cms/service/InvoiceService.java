...
/*
	...
	*/
	...
	/*
	* Method update (Invoice object) berfungsi untuk melakukan perubahan terhadap
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public Invoice searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public Invoice searchUnique (String eqColumns, Object eqParams)
		throws Exception;
