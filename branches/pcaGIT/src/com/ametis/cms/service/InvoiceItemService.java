...
/**
 * InvoiceItem is a servlet controller for invoice_item Table.
...
/*
	...
	*/
	...
	public  byte[] getAttachmentFile (Integer invoiceItemId) throws Exception;
	/*
	* Method update (InvoiceItem object) berfungsi untuk melakukan perubahan terhadap
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public InvoiceItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public InvoiceItem searchUnique (String eqColumns, Object eqParams)
		throws Exception;
