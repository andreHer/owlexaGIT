...
/**
 * TarifType is a servlet controller for tarif_type Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface TarifTypeService 
...
/*
	...
	*/
	public TarifType create (TarifType object,ActionUser user) throws Exception;

	/*
	* Method update (TarifType object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public TarifType update (TarifType object,ActionUser user) throws Exception;	
	...
	* place
	*/
	public TarifType trash (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public TarifType delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public TarifType delete (TarifType object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public TarifType get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public TarifType get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public TarifType searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public TarifType searchUnique (String eqColumns, Object eqParams)
		throws Exception;
