...
/**
 * MemberBenefit is a servlet controller for member_benefit Table.
...
/*
	...
	*/
	...
	/*
	* Method update (MemberBenefit object) berfungsi untuk melakukan perubahan terhadap
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public MemberBenefit searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public MemberBenefit searchUnique (String eqColumns, Object eqParams)
		throws Exception;
	/*
	 * getting single unique object
	 * @param Array eqColumns column for retrieve
	 * @param Array eqParams value for column
	*/
	public MemberBenefit searchUnique (String[] eqColumns, Object[] eqParams)
		throws Exception;
...
*/
	...
	public Collection<MemberBenefit> getMemberBenefitByDate (Integer memberId,Integer itemCategoryId,Integer caseCategoryId,
			Date admissionDate, Date dischargeDate,Integer layer) throws Exception;
	...
	public Collection<MemberBenefit> getMemberBenefitByDateSMM (Integer memberId,Integer itemCategoryId,Integer caseCategoryId,
			Date admissionDate, Date dischargeDate) throws Exception;
	
	public Collection<MemberBenefit> getMemberBenefitByDateSMM (Integer memberId,Integer caseCategoryId,
			Date admissionDate, Date dischargeDate) throws Exception;
	
	public MemberBenefit getActiveMemberBenefit(Integer memberId,
			Integer caseCategory,Integer itemCategoryId) throws Exception ;
	...
	public MemberBenefit getActiveMemberBenefitSMM(Integer smmLayerId,
			Integer caseCategory,Integer itemCategoryId) throws Exception;
