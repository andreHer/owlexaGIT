...
/**
 * CardPrinting is a servlet controller for card_printing Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface CardPrintingService 
...
/*
	...
	*/
	public CardPrinting create (CardPrinting object,ActionUser user) throws Exception;
	public CardPrinting create (CardPrinting object,Collection<Integer> cardList,ActionUser user) throws Exception;

	/*
	* Method update (CardPrinting object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public CardPrinting update (CardPrinting object,ActionUser user) throws Exception;	
	...
	* place
	*/
	public CardPrinting trash (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public CardPrinting delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public CardPrinting delete (CardPrinting object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public CardPrinting get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public CardPrinting get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public CardPrinting searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public CardPrinting searchUnique (String eqColumns, Object eqParams)
		throws Exception;
