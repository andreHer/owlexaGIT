...
/**
 * CaseItem is a servlet controller for case_item Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface CaseItemService 
...
/*
	...
	*/
	public CaseItem create (CaseItem object,ActionUser actionUser) throws Exception;
	public Collection<CaseItem> getCaseItem(Integer caseId) throws Exception;
	public CaseItem getCaseItem(Integer caseId, Integer itemId) throws Exception;

	/*
	* Method update (CaseItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public CaseItem update (CaseItem object,ActionUser actionUser) throws Exception;	
	...
	* place
	*/
	public CaseItem trash (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public CaseItem delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
	...
	*/
	...
	public CaseItem delete (CaseItem object,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public CaseItem get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public CaseItem get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public CaseItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public CaseItem searchUnique (String eqColumns, Object eqParams)
		throws Exception;
