...
/**
 * ProviderItem is a servlet controller for provider_item Table.
...
/*
	...
	*/
	public ProviderItem create (ProviderItem object,ActionUser actionUser) throws Exception;
	public boolean createProviderItems (Integer providerId, Collection<ProviderItem> providerItems, ActionUser actionUser) throws Exception;
	public ProviderItem createUpload (ProviderItem object,MultipartFile file,ActionUser user) throws Exception;
	/*
	* Method update (ProviderItem object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public ProviderItem update (ProviderItem object,ActionUser actionUser) throws Exception;	
	...
	*/
	...
	public ProviderItem delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
	...
	*/
	...
	public ProviderItem delete (ProviderItem object,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public ProviderItem get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public ProviderItem searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
