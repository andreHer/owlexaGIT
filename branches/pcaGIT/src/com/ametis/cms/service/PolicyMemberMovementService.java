...
/**
 * PolicyMemberMovement is a servlet controller for policy_member_movement Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface PolicyMemberMovementService 
...
/*
	...
	*/
	public PolicyMemberMovement create (PolicyMemberMovement object,byte[] data,ActionUser user) throws Exception;
	public PolicyMemberMovement activate (Integer object,ActionUser user) throws Exception;
	public boolean extract (Integer id, ActionUser user) throws Exception;
	public boolean migrate (Integer movement, ActionUser user) throws Exception;

	/*
	* Method update (PolicyMemberMovement object) berfungsi untuk melakukan perubahan terhadap
