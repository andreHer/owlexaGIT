...
/*
	...
	*/
	...
	public boolean extend (Policy object,Date extendDate, Date expireDate,String notes,ActionUser user) throws Exception;
	public boolean renewal (Policy object,Date renewalDate, Date expireDate,String notes,ActionUser user) throws Exception;
	public boolean block (Integer policyId, Date start, Date end, String notes, ActionUser user) throws Exception;
	public boolean unblock (Integer policyId, String notes, ActionUser user) throws Exception;
	//public boolean copy (Integer policyId)
	public byte[] getPolicyFile (Integer policyId, String fileName) throws Exception;
...
*/
	...
	public boolean activatePolicy (Long policyId, ActionUser user) throws Exception;
	...
	public Policy getActivePolicyByNumber (String policyNumber,Integer clientId) throws Exception;
	public boolean terminatePolicy (Long policyId, Date terminateDate, ActionUser user) throws Exception;
	public Policy getPolicyByNumber(String policyNumber, Integer clientId) throws Exception ;
