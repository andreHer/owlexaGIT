...
/**
 * CostContainment is a servlet controller for cost_containment Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface CostContainmentService 
...
/*
	...
	*/
	public CostContainment create (CostContainment object,ActionUser actionUser) throws Exception;

	/*
	* Method update (CostContainment object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah User pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public CostContainment update (CostContainment object,ActionUser actionUser) throws Exception;	
	...
	*/
	...
	public CostContainment delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
	...
	*/
	...
	public CostContainment delete (CostContainment object,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public CostContainment get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public CostContainment searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
