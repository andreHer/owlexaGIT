...
/**
 * DataImportStage is a servlet controller for data_import_stage Table.
 * All you have to do is to convert necessary data field to the named parameter
*/
public interface DataImportStageService 
...
/*
	...
	*/
	...
	/*
	* Method update (DataImportStage object) berfungsi untuk melakukan perubahan terhadap
	...
	*/
    ...
    public boolean executeAsynchronusMigration(java.io.Serializable id) throws Exception;
    public boolean executeMigration(java.io.Serializable id) throws Exception;
    public boolean executeRawMigration(java.io.Serializable id) throws Exception;
    public Integer activateMigration(java.io.Serializable id, ActionUser user) throws Exception;
    
    public boolean processUpload(java.io.Serializable id, ActionUser user) throws Exception;
