...
/*
	...
	*/
	...
	public Diagnosis getDiagnosisByAlternateCode (String diagnosisCode) throws Exception;
...
// SEARCH SECTION - PALING RUMIT !!
	...
	public Collection<Diagnosis> searchDiagnosis(String queryLike, int index, int offset) throws Exception;
...
//-- get total
	...
	* @param eqParams param equal
	*/
	public int getTotalOr (String[] likeQuery, Object[] likeObject,
		String[] eqColumns, Object[] eqParams) throws Exception;
