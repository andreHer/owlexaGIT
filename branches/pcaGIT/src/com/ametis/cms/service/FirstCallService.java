...
*/
public interface FirstCallService 
...
/*
	...
	*/
	...
	public boolean close (java.io.Serializable id,ActionUser actionUser) throws Exception;
...
//------------------------------------------------------------------
	...
	*/
	...
	public int getTotalCaseErrorLog(Integer memberId, Integer callLogType) throws Exception;
	public int getTotalClaimErrorLog(Integer memberId, Integer callLogType) throws Exception;
