...
// -- get section - carefull !
	...
	*/
	...
	public MemberProduct getMemberActiveProduct (Integer memberId, Integer caseCategoryId) throws Exception;
	public boolean updateProductGracePeriode () throws Exception;
	public boolean updateProductPolicy() throws Exception;
	//membuat status lebih dinamis
	public MemberProduct getMemberStatusProduct (Integer memberId, Integer caseCategoryId, Integer status) throws Exception;
	public MemberProduct getMemberProductByDate (Integer memberId, Integer caseCategoryId, Date admissionDate, Date dischargeDate) throws Exception;
	public Collection<MemberProduct> getMemberActiveProduct(Integer memberId) throws Exception;
...
*/
	...
	public double getRemainingBenefit(Integer memberId, Integer caseCategoryId,Date currentDate) throws Exception;
	public void updateMemberExpiredProduct (ActionUser actionUser) throws Exception;
	public void updateInconsistentFamilyPlan(ActionUser user) throws Exception;
