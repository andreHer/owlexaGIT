...
/**
 * PendingClaim is a servlet controller for pending_claim Table.
...
/*
	...
	*/
	...
	/*
	* Method update (PendingClaim object) berfungsi untuk melakukan perubahan terhadap
	...
	*/
	...
	public PendingClaim delete (java.io.Serializable pkey,ActionUser actionUser) throws Exception;
...
// -- get section - carefull !
	...
	*/
	...
	public PendingClaim get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public PendingClaim searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
