...
/**
 * PaymentInstallment is a servlet controller for payment_installment Table.
...
/*
	...
	*/
	public PaymentInstallment create (PaymentInstallment object,ActionUser user) throws Exception;
	public int getTotalInstallment (Integer paymentId) throws Exception;
	public Collection<PaymentInstallment> getInstallmentList (Integer batchId) throws Exception;
	
	public boolean confirmPayment(Long installmentId, String approvalNote,Date confirmDate,
			ActionUser user) throws Exception ;
	public int getTotalInstallmentDisposition(Integer paymentId) throws Exception;

	/*
	* Method update (PaymentInstallment object) berfungsi untuk melakukan perubahan terhadap
	* sebuah object yang terdapat didalam database
	* @param object adalah sebuah object yang ingin diubah
	* @param user adalah ActionUser pelaku aksi yang bersangkutan
	* @return object hasil update, exception jika gagal
	*/
	public PaymentInstallment update (PaymentInstallment object,ActionUser user) throws Exception;	
	...
	* place
	*/
	public PaymentInstallment trash (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public PaymentInstallment delete (java.io.Serializable pkey,ActionUser user) throws Exception;
	...
	*/
	...
	public PaymentInstallment delete (PaymentInstallment object,ActionUser user) throws Exception;
...
// -- get section - carefull !
	...
	*/
	public PaymentInstallment get (java.io.Serializable pkey) throws Exception;
	...
	*/
	...
	public PaymentInstallment get (java.io.Serializable pkey, String[] required) throws Exception;
...
// unique Result
	 ...
	 *	@param required - for lazy init problem
	*/
	public PaymentInstallment searchUnique (String eqColumns, Object eqParams, String[] required)
		throws Exception;
	/*
	 * getting single unique object
	 * @param eqColumns column for retrieve
	 * @param eqParams value for column
	*/
	public PaymentInstallment searchUnique (String eqColumns, Object eqParams)
		throws Exception;
