...
public class MoneyParser {
	...
	public static String convert(long number) {
		...
		case 0:
			...
			break;
		case 1:
			tradBillions = convertLessThanOneThousand(billions) + " milliar ";
			break;
		default:
			tradBillions = convertLessThanOneThousand(billions) + " milliar ";
		}
		...
		// remove extra spaces!
		String tempResult = result.replaceAll("satu ratus", "seratus") + " rupiah";
		return tempResult.replaceAll("^\\s+", "").replaceAll("\\b\\s{2,}\\b",
				" ");
